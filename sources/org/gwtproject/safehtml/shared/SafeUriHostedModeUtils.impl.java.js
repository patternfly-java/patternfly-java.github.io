...
class SafeUriHostedModeUtils extends j_l_Object {
 ...
 static m_maybeCheckValidUri__java_lang_String__void(/** ?string */ uri) {
  ...
  if (SafeUriHostedModeUtils.f_forceCheckValidUri__org_gwtproject_safehtml_shared_SafeUriHostedModeUtils_) {
   ...
   Asserts.$assertWithMessage__boolean__java_lang_Object__void(SafeUriHostedModeUtils.f_impl__org_gwtproject_safehtml_shared_SafeUriHostedModeUtils_.m_isValidUri__java_lang_String__boolean(uri), 'String is not a valid URI: ' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(uri));
  }
 }
 /** @nodts */
 static m_checkArgument__boolean__java_lang_String__void(/** boolean */ completeHtml, /** ?string */ message) {
  if (!completeHtml) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(IllegalArgumentException.$create__java_lang_String(message));
  }
 }
 /** @nodts */
