...
class SafeHtmlString extends j_l_Object {
 ...
 equals(/** * */ obj) {
  ...
  return j_l_String.m_equals__java_lang_String__java_lang_Object__boolean(this.f_html__org_gwtproject_safehtml_shared_SafeHtmlString_, (/**@type {SafeHtml}*/ ($Casts.$to(obj, /**@type {Function}*/ (SafeHtml)))).m_asString__java_lang_String());
 }
