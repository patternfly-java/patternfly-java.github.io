...
class SimpleHtmlSanitizer extends j_l_Object {
 ...
 static m_simpleSanitize__java_lang_String__java_lang_String(/** ?string */ text) {
  ...
  for (let $array = j_l_String.m_split__java_lang_String__java_lang_String__int__arrayOf_java_lang_String(text, '<', -1), $index = 0; $index < $array.length; $index++) {
