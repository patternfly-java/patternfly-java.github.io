...
class SafeUriString extends j_l_Object {
 ...
 $ctor__org_gwtproject_safehtml_shared_SafeUriString__java_lang_String__void(/** ?string */ uri) {
  ...
  if ($Equality.$same(uri, null)) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(NullPointerException.$create__java_lang_String('uri is null'));
  }
 ...
 equals(/** * */ obj) {
  ...
  return j_l_String.m_equals__java_lang_String__java_lang_Object__boolean(this.f_uri__org_gwtproject_safehtml_shared_SafeUriString_, (/**@type {SafeUri}*/ ($Casts.$to(obj, /**@type {Function}*/ (SafeUri)))).m_asString__java_lang_String());
 }
