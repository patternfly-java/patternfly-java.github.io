...
class OnlyToBeUsedInGeneratedCodeStringBlessedAsSafeHtml extends j_l_Object {
 ...
 $ctor__org_gwtproject_safehtml_shared_OnlyToBeUsedInGeneratedCodeStringBlessedAsSafeHtml__java_lang_String__void(/** ?string */ html) {
  ...
  if ($Equality.$same(html, null)) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(NullPointerException.$create__java_lang_String('html is null'));
  }
 ...
 equals(/** * */ obj) {
  ...
  return j_l_String.m_equals__java_lang_String__java_lang_Object__boolean(this.f_html__org_gwtproject_safehtml_shared_OnlyToBeUsedInGeneratedCodeStringBlessedAsSafeHtml_, (/**@type {SafeHtml}*/ ($Casts.$to(obj, /**@type {Function}*/ (SafeHtml)))).m_asString__java_lang_String());
 }
 /** @nodts */
 static $clinit() {
  OnlyToBeUsedInGeneratedCodeStringBlessedAsSafeHtml.$clinit = () =>{};
