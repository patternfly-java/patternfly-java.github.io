...
let Asserts = goog.forwardDeclare('javaemul.internal.Asserts$impl');
...
class SimpleEventBus extends EventBus {
 ...
 m_addHandlerToSource__org_gwtproject_event_shared_Event_Type__java_lang_Object__java_lang_Object__org_gwtproject_event_shared_HandlerRegistration(/** Type<H> */ type, /** * */ source, /** H */ handler) {
  if ($Equality.$same(source, null)) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(NullPointerException.$create__java_lang_String('Cannot add a handler with a null source'));
  }
 ...
 m_fireEventFromSource__org_gwtproject_event_shared_Event__java_lang_Object__void(/** Event<?> */ event, /** * */ source) {
  if ($Equality.$same(source, null)) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(NullPointerException.$create__java_lang_String('Cannot fire from a null source'));
  }
 ...
 m_doAdd__org_gwtproject_event_shared_Event_Type__java_lang_Object__java_lang_Object__org_gwtproject_event_shared_HandlerRegistration_$p_org_gwtproject_event_shared_SimpleEventBus(/** Type<H> */ type, /** * */ source, /** H */ handler) {
  if ($Equality.$same(type, null)) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(NullPointerException.$create__java_lang_String('Cannot add a handler with a null type'));
  }
  if ($Equality.$same(handler, null)) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(NullPointerException.$create__java_lang_String('Cannot add a null handler'));
  }
  if (this.f_firingDepth__org_gwtproject_event_shared_SimpleEventBus_ > 0) {
 ...
 m_doFire__org_gwtproject_event_shared_Event__java_lang_Object__void_$p_org_gwtproject_event_shared_SimpleEventBus(/** Event<H> */ event, /** * */ source) {
  if ($Equality.$same(event, null)) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(NullPointerException.$create__java_lang_String('Cannot fire null event'));
  }
  try {
   ...
   if (!$Equality.$same(causes, null)) {
    throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(UmbrellaException.$create__java_util_Set(causes));
   }
  } finally {
   this.f_firingDepth__org_gwtproject_event_shared_SimpleEventBus_ = this.f_firingDepth__org_gwtproject_event_shared_SimpleEventBus_ - 1 | 0;
   if (this.f_firingDepth__org_gwtproject_event_shared_SimpleEventBus_ == 0) {
 ...
 m_ensureHandlerList__org_gwtproject_event_shared_Event_Type__java_lang_Object__java_util_List_$p_org_gwtproject_event_shared_SimpleEventBus(/** Type<H> */ type, /** * */ source) {
  let sourceMap = /**@type {Map<*, List<?>>}*/ ($Casts.$to(this.f_map__org_gwtproject_event_shared_SimpleEventBus_.m_computeIfAbsent__java_lang_Object__java_util_function_Function__java_lang_Object(type, j_u_function_Function.$adapt(/**  @return {Map<*, List<?>>}*/ ((/** Type<?> */ k) =>{
   let k_1 = /**@type {Type<*>}*/ ($Casts.$to(k, Type));
   return /**@type {!HashMap<*, List<?>>}*/ (HashMap.$create__());
  }))), /**@type {Function}*/ (Map)));
  let handlers = /**@type {List<H>}*/ ($Casts.$to(sourceMap.get(source), /**@type {Function}*/ (List)));
 ...
 m_getHandlerList__org_gwtproject_event_shared_Event_Type__java_lang_Object__java_util_List_$p_org_gwtproject_event_shared_SimpleEventBus(/** Type<H> */ type, /** * */ source) {
  let sourceMap = /**@type {Map<*, List<?>>}*/ ($Casts.$to(this.f_map__org_gwtproject_event_shared_SimpleEventBus_.get(type), /**@type {Function}*/ (Map)));
  ...
  if (!$Equality.$same(this.f_deferredDeltas__org_gwtproject_event_shared_SimpleEventBus_, null)) {
   try {
    for (let $iterator = this.f_deferredDeltas__org_gwtproject_event_shared_SimpleEventBus_.m_iterator__java_util_Iterator(); $iterator.m_hasNext__boolean(); ) {
     let c = /**@type {Command}*/ ($Casts.$to($iterator.m_next__java_lang_Object(), /**@type {Function}*/ (Command)));
     {
      c.m_execute__void();
     }
    }
 ...
 m_prune__org_gwtproject_event_shared_Event_Type__java_lang_Object__void_$p_org_gwtproject_event_shared_SimpleEventBus(/** Type<?> */ type, /** * */ source) {
  let sourceMap = /**@type {Map<*, List<?>>}*/ ($Casts.$to(this.f_map__org_gwtproject_event_shared_SimpleEventBus_.get(type), /**@type {Function}*/ (Map)));
  let pruned = /**@type {List<*>}*/ ($Casts.$to(sourceMap.remove(source), /**@type {Function}*/ (List)));
  Asserts.$assertWithMessage__boolean__java_lang_Object__void(!$Equality.$same(pruned, null), 'Can\'t prune what wasn\'t there');
  Asserts.$assertWithMessage__boolean__java_lang_Object__void(pruned.isEmpty(), 'Pruned unempty list!');
 ...
 static $loadModules() {
  ...
  Asserts = goog.module.get('javaemul.internal.Asserts$impl');
