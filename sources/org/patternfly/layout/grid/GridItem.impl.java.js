...
/**
 * @extends {SubLayout<HTMLElement, GridItem>}
 */
class GridItem extends SubLayout {
 /** @protected @nodts */
 constructor() {
  super();
 }
 ...
 $ctor__org_patternfly_layout_grid_GridItem__org_jboss_elemento_HTMLContainerBuilder__void(/** HTMLContainerBuilder<E> */ builder) {
  this.$ctor__org_patternfly_layout_SubLayout__org_patternfly_layout_LayoutType__java_lang_String__elemental2_dom_HTMLElement__void(LayoutType.f_Grid__org_patternfly_layout_LayoutType, GridItem.f_SUB_LAYOUT_NAME__org_patternfly_layout_grid_GridItem, /**@type {HTMLElement}*/ ((/**@type {HTMLContainerBuilder<E>}*/ ($Casts.$to(builder.m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_layout__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_grid__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_item__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement()));
 }
 /** @nodts @return {GridItem} */
 m_span__int__org_patternfly_layout_grid_GridItem(/** number */ columns) {
  return this.m_span__org_patternfly_style_Breakpoints__org_patternfly_layout_grid_GridItem(/**@type {Breakpoints<Integer>}*/ (Breakpoints.m_breakpoints__org_patternfly_style_Breakpoint__java_lang_Object__org_patternfly_style_Breakpoints(Breakpoint.f_default___org_patternfly_style_Breakpoint, Integer.valueOf(columns))));
 }
 /** @nodts @return {GridItem} */
 m_span__org_patternfly_style_Breakpoints__org_patternfly_layout_grid_GridItem(/** Breakpoints<Integer> */ columns) {
  let modifiers = /**@type {?string}*/ ($Casts.$to(columns.m_stream__java_util_stream_Stream().m_filter__java_util_function_Predicate__java_util_stream_Stream(Predicate.$adapt(/**  @return {boolean}*/ ((/** Tuple<Breakpoint, Integer> */ bp) =>{
   ...
   return Validation.m_verifyRange__elemental2_dom_Element__java_lang_String__int__int__int__boolean(this.m_element__elemental2_dom_HTMLElement(), 'span', (/**@type {Integer}*/ ($Casts.$to(bp_1.f_value__org_patternfly_core_Tuple, Integer))).intValue(), 1, 12);
  ...
  return /**@type {GridItem}*/ ($Casts.$to(this.m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([modifiers], j_l_String))), GridItem));
 }
 /** @nodts @return {GridItem} */
 m_rowSpan__int__org_patternfly_layout_grid_GridItem(/** number */ rows) {
  return this.m_rowSpan__org_patternfly_style_Breakpoints__org_patternfly_layout_grid_GridItem(/**@type {Breakpoints<Integer>}*/ (Breakpoints.m_breakpoints__org_patternfly_style_Breakpoint__java_lang_Object__org_patternfly_style_Breakpoints(Breakpoint.f_default___org_patternfly_style_Breakpoint, Integer.valueOf(rows))));
 }
 /** @nodts @return {GridItem} */
 m_rowSpan__org_patternfly_style_Breakpoints__org_patternfly_layout_grid_GridItem(/** Breakpoints<Integer> */ rows) {
  let modifiers = /**@type {?string}*/ ($Casts.$to(rows.m_stream__java_util_stream_Stream().m_filter__java_util_function_Predicate__java_util_stream_Stream(Predicate.$adapt(/**  @return {boolean}*/ ((/** Tuple<Breakpoint, Integer> */ bp) =>{
   let bp_1 = /**@type {Tuple<Breakpoint, Integer>}*/ ($Casts.$to(bp, Tuple));
   return Validation.m_verifyRange__elemental2_dom_Element__java_lang_String__int__int__int__boolean(this.m_element__elemental2_dom_HTMLElement(), 'rowSpan', (/**@type {Integer}*/ ($Casts.$to(bp_1.f_value__org_patternfly_core_Tuple, Integer))).intValue(), 1, 12);
  }))).m_collect__java_util_stream_Collector__java_lang_Object(/**@type {Collector<Tuple<Breakpoint, Integer>, StringBuilder, ?string>}*/ (BreakpointCollector.m_modifiers__java_util_function_Function__java_util_stream_Collector(j_u_function_Function.$adapt(/**  @return {?string}*/ ((/** Integer */ row) =>{
 ...
 m_offset__int__org_patternfly_layout_grid_GridItem(/** number */ columns) {
  return this.m_offset__org_patternfly_style_Breakpoints__org_patternfly_layout_grid_GridItem(/**@type {Breakpoints<Integer>}*/ (Breakpoints.m_breakpoints__org_patternfly_style_Breakpoint__java_lang_Object__org_patternfly_style_Breakpoints(Breakpoint.f_default___org_patternfly_style_Breakpoint, Integer.valueOf(columns))));
 }
 /** @nodts @return {GridItem} */
 m_offset__org_patternfly_style_Breakpoints__org_patternfly_layout_grid_GridItem(/** Breakpoints<Integer> */ columns) {
  let modifiers = /**@type {?string}*/ ($Casts.$to(columns.m_stream__java_util_stream_Stream().m_filter__java_util_function_Predicate__java_util_stream_Stream(Predicate.$adapt(/**  @return {boolean}*/ ((/** Tuple<Breakpoint, Integer> */ bp) =>{
   let bp_1 = /**@type {Tuple<Breakpoint, Integer>}*/ ($Casts.$to(bp, Tuple));
   return Validation.m_verifyRange__elemental2_dom_Element__java_lang_String__int__int__int__boolean(this.m_element__elemental2_dom_HTMLElement(), 'offset', (/**@type {Integer}*/ ($Casts.$to(bp_1.f_value__org_patternfly_core_Tuple, Integer))).intValue(), 1, 12);
  }))).m_collect__java_util_stream_Collector__java_lang_Object(/**@type {Collector<Tuple<Breakpoint, Integer>, StringBuilder, ?string>}*/ (BreakpointCollector.m_modifiers__java_util_function_Function__java_util_stream_Collector(j_u_function_Function.$adapt(/**  @return {?string}*/ ((/** Integer */ col) =>{
   let col_1 = /**@type {Integer}*/ ($Casts.$to(col, Integer));
 ...
 /** @nodts @return {GridItem} */
 m_order__java_lang_String__org_patternfly_layout_grid_GridItem(/** ?string */ order) {
  return this.m_order__org_patternfly_style_Breakpoints__org_patternfly_layout_grid_GridItem(/**@type {Breakpoints<?string>}*/ (Breakpoints.m_breakpoints__org_patternfly_style_Breakpoint__java_lang_Object__org_patternfly_style_Breakpoints(Breakpoint.f_default___org_patternfly_style_Breakpoint, order)));
 }
 /** @nodts @return {GridItem} */
 m_order__org_patternfly_style_Breakpoints__org_patternfly_layout_grid_GridItem(/** Breakpoints<?string> */ order) {
  return /**@type {GridItem}*/ ($Casts.$to((/**@type {HTMLBuilder<HTMLElement, GridItem>}*/ (Variable.m_componentVar__java_lang_String__arrayOf_java_lang_String__org_patternfly_style_Variable(Classes.m_layout__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_grid__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$create([0], j_l_String))), /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_item__org_patternfly_style_Classes, Variables.f_Order__org_patternfly_style_Variables], j_l_String))).m_applyTo__org_jboss_elemento_HTMLElementStyleMethods__org_patternfly_style_VariableAssignments_HTMLBuilder(this))).m_set__org_patternfly_style_Breakpoints__org_jboss_elemento_TypedBuilder(order), GridItem));
 }
 /** @nodts @return {GridItem} */
...
/**@const {string} @nodts*/
GridItem.f_SUB_LAYOUT_NAME__org_patternfly_layout_grid_GridItem = 'gri';
