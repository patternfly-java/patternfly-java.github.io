...
class Split extends BaseLayout {
 ...
 $ctor__org_patternfly_layout_split_Split__org_jboss_elemento_HTMLContainerBuilder__void(/** HTMLContainerBuilder<E> */ builder) {
  this.$ctor__org_patternfly_layout_BaseLayout__org_patternfly_layout_LayoutType__elemental2_dom_HTMLElement__void(LayoutType.f_Split__org_patternfly_layout_LayoutType, /**@type {HTMLElement}*/ ((/**@type {HTMLContainerBuilder<E>}*/ ($Casts.$to(builder.m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_layout__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_split__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$create([0], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement()));
 }
 /** @nodts @return {Split} */
 ...
 m_wrap__org_patternfly_layout_split_Split() {
  return /**@type {Split}*/ ($Casts.$to(this.m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_wrap__org_patternfly_style_Classes)], j_l_String))), Split));
 }
 /** @nodts @return {Split} */
