...
/**
 * @extends {SubLayout<HTMLElement, BullseyeItem>}
 */
class BullseyeItem extends SubLayout {
 /** @protected @nodts */
 constructor() {
  super();
 }
 ...
 $ctor__org_patternfly_layout_bullseye_BullseyeItem__org_jboss_elemento_HTMLContainerBuilder__void(/** HTMLContainerBuilder<E> */ builder) {
  this.$ctor__org_patternfly_layout_SubLayout__org_patternfly_layout_LayoutType__java_lang_String__elemental2_dom_HTMLElement__void(LayoutType.f_Bullseye__org_patternfly_layout_LayoutType, BullseyeItem.f_SUB_LAYOUT_NAME__org_patternfly_layout_bullseye_BullseyeItem, /**@type {HTMLElement}*/ ((/**@type {HTMLContainerBuilder<E>}*/ ($Casts.$to(builder.m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_layout__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_bullseye__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_item__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement()));
 }
 /** @nodts @return {BullseyeItem} */
...
/**@const {string} @nodts*/
BullseyeItem.f_SUB_LAYOUT_NAME__org_patternfly_layout_bullseye_BullseyeItem = 'bei';
