...
class Gallery extends BaseLayout {
 ...
 $ctor__org_patternfly_layout_gallery_Gallery__org_jboss_elemento_HTMLContainerBuilder__void(/** HTMLContainerBuilder<E> */ builder) {
  this.$ctor__org_patternfly_layout_BaseLayout__org_patternfly_layout_LayoutType__elemental2_dom_HTMLElement__void(LayoutType.f_Gallery__org_patternfly_layout_LayoutType, /**@type {HTMLElement}*/ ((/**@type {HTMLContainerBuilder<E>}*/ ($Casts.$to(builder.m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_layout__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_gallery__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$create([0], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement()));
 }
 ...
 m_minMax__java_lang_String__org_patternfly_core_Tuple__void_$p_org_patternfly_layout_gallery_Gallery(/** ?string */ minMax, /** Tuple<Breakpoint, ?string> */ tuple) {
  ...
  Variable.m_componentVar__java_lang_String__arrayOf_java_lang_String__org_patternfly_style_Variable(Classes.m_layout__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_gallery__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$create([0], j_l_String))), /**@type {!Array<?string>}*/ ($Arrays.$stampType([Variables.f_GridTemplateColumns__org_patternfly_style_Variables, minMaxBreak], j_l_String))).m_applyTo__elemental2_dom_HTMLElement__org_patternfly_style_VariableAssignments_HTMLElement(this.m_element__elemental2_dom_HTMLElement()).m_set__java_lang_String__void(/**@type {?string}*/ ($Casts.$to(tuple.f_value__org_patternfly_core_Tuple, j_l_String)));
 }
 //Bridge method.
