...
class Direction extends Enum {
 ...
 static m_valueOf__java_lang_String__org_patternfly_layout_flex_Direction(/** string */ name) {
  ...
  if ($Equality.$same(Direction.f_namesToValuesMap__org_patternfly_layout_flex_Direction_, null)) {
   Direction.f_namesToValuesMap__org_patternfly_layout_flex_Direction_ = (/**@type {Map<?string, !Direction>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(Direction.m_values__arrayOf_org_patternfly_layout_flex_Direction())));
  }
  return /**@type {Direction}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, Direction.f_namesToValuesMap__org_patternfly_layout_flex_Direction_));
 }
 /** @nodts @return {!Array<!Direction>} */
 static m_values__arrayOf_org_patternfly_layout_flex_Direction() {
  Direction.$clinit();
  return /**@type {!Array<!Direction>}*/ ($Arrays.$stampType([Direction.$static_column__org_patternfly_layout_flex_Direction, Direction.$static_columnReverse__org_patternfly_layout_flex_Direction, Direction.$static_row__org_patternfly_layout_flex_Direction, Direction.$static_rowReverse__org_patternfly_layout_flex_Direction], Direction));
 }
 /** @nodts @return {!Direction} */
