...
class FlexShorthand extends Enum {
 ...
 static m_valueOf__java_lang_String__org_patternfly_layout_flex_FlexShorthand(/** string */ name) {
  ...
  if ($Equality.$same(FlexShorthand.f_namesToValuesMap__org_patternfly_layout_flex_FlexShorthand_, null)) {
   FlexShorthand.f_namesToValuesMap__org_patternfly_layout_flex_FlexShorthand_ = (/**@type {Map<?string, !FlexShorthand>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(FlexShorthand.m_values__arrayOf_org_patternfly_layout_flex_FlexShorthand())));
  }
  return /**@type {FlexShorthand}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, FlexShorthand.f_namesToValuesMap__org_patternfly_layout_flex_FlexShorthand_));
 }
 /** @nodts @return {!Array<!FlexShorthand>} */
 static m_values__arrayOf_org_patternfly_layout_flex_FlexShorthand() {
  FlexShorthand.$clinit();
  return /**@type {!Array<!FlexShorthand>}*/ ($Arrays.$stampType([FlexShorthand.$static_default___org_patternfly_layout_flex_FlexShorthand, FlexShorthand.$static_none__org_patternfly_layout_flex_FlexShorthand, FlexShorthand.$static__1__org_patternfly_layout_flex_FlexShorthand, FlexShorthand.$static__2__org_patternfly_layout_flex_FlexShorthand, FlexShorthand.$static__3__org_patternfly_layout_flex_FlexShorthand, FlexShorthand.$static__4__org_patternfly_layout_flex_FlexShorthand], FlexShorthand));
 }
 /** @nodts @return {!FlexShorthand} */
