...
class AlignItems extends Enum {
 ...
 static m_valueOf__java_lang_String__org_patternfly_layout_flex_AlignItems(/** string */ name) {
  ...
  if ($Equality.$same(AlignItems.f_namesToValuesMap__org_patternfly_layout_flex_AlignItems_, null)) {
   AlignItems.f_namesToValuesMap__org_patternfly_layout_flex_AlignItems_ = (/**@type {Map<?string, !AlignItems>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(AlignItems.m_values__arrayOf_org_patternfly_layout_flex_AlignItems())));
  }
  return /**@type {AlignItems}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, AlignItems.f_namesToValuesMap__org_patternfly_layout_flex_AlignItems_));
 }
 /** @nodts @return {!Array<!AlignItems>} */
 static m_values__arrayOf_org_patternfly_layout_flex_AlignItems() {
  AlignItems.$clinit();
  return /**@type {!Array<!AlignItems>}*/ ($Arrays.$stampType([AlignItems.$static_flexStart__org_patternfly_layout_flex_AlignItems, AlignItems.$static_flexEnd__org_patternfly_layout_flex_AlignItems, AlignItems.$static_center__org_patternfly_layout_flex_AlignItems, AlignItems.$static_stretch__org_patternfly_layout_flex_AlignItems, AlignItems.$static_baseline__org_patternfly_layout_flex_AlignItems], AlignItems));
 }
 /** @nodts @return {!AlignItems} */
