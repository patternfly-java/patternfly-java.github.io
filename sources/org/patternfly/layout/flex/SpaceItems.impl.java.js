...
class SpaceItems extends Enum {
 ...
 static m_valueOf__java_lang_String__org_patternfly_layout_flex_SpaceItems(/** string */ name) {
  ...
  if ($Equality.$same(SpaceItems.f_namesToValuesMap__org_patternfly_layout_flex_SpaceItems_, null)) {
   SpaceItems.f_namesToValuesMap__org_patternfly_layout_flex_SpaceItems_ = (/**@type {Map<?string, !SpaceItems>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(SpaceItems.m_values__arrayOf_org_patternfly_layout_flex_SpaceItems())));
  }
  return /**@type {SpaceItems}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, SpaceItems.f_namesToValuesMap__org_patternfly_layout_flex_SpaceItems_));
 }
 /** @nodts @return {!Array<!SpaceItems>} */
 static m_values__arrayOf_org_patternfly_layout_flex_SpaceItems() {
  SpaceItems.$clinit();
  return /**@type {!Array<!SpaceItems>}*/ ($Arrays.$stampType([SpaceItems.$static_none__org_patternfly_layout_flex_SpaceItems, SpaceItems.$static_xs__org_patternfly_layout_flex_SpaceItems, SpaceItems.$static_sm__org_patternfly_layout_flex_SpaceItems, SpaceItems.$static_md__org_patternfly_layout_flex_SpaceItems, SpaceItems.$static_lg__org_patternfly_layout_flex_SpaceItems, SpaceItems.$static_xl__org_patternfly_layout_flex_SpaceItems, SpaceItems.$static__2xl__org_patternfly_layout_flex_SpaceItems, SpaceItems.$static__3xl__org_patternfly_layout_flex_SpaceItems, SpaceItems.$static__4xl__org_patternfly_layout_flex_SpaceItems], SpaceItems));
 }
 /** @nodts @return {!SpaceItems} */
