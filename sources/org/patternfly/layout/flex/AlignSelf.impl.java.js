...
class AlignSelf extends Enum {
 ...
 static m_valueOf__java_lang_String__org_patternfly_layout_flex_AlignSelf(/** string */ name) {
  ...
  if ($Equality.$same(AlignSelf.f_namesToValuesMap__org_patternfly_layout_flex_AlignSelf_, null)) {
   AlignSelf.f_namesToValuesMap__org_patternfly_layout_flex_AlignSelf_ = (/**@type {Map<?string, !AlignSelf>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(AlignSelf.m_values__arrayOf_org_patternfly_layout_flex_AlignSelf())));
  }
  return /**@type {AlignSelf}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, AlignSelf.f_namesToValuesMap__org_patternfly_layout_flex_AlignSelf_));
 }
 /** @nodts @return {!Array<!AlignSelf>} */
 static m_values__arrayOf_org_patternfly_layout_flex_AlignSelf() {
  AlignSelf.$clinit();
  return /**@type {!Array<!AlignSelf>}*/ ($Arrays.$stampType([AlignSelf.$static_flexStart__org_patternfly_layout_flex_AlignSelf, AlignSelf.$static_flexEnd__org_patternfly_layout_flex_AlignSelf, AlignSelf.$static_center__org_patternfly_layout_flex_AlignSelf, AlignSelf.$static_stretch__org_patternfly_layout_flex_AlignSelf, AlignSelf.$static_baseline__org_patternfly_layout_flex_AlignSelf], AlignSelf));
 }
 /** @nodts @return {!AlignSelf} */
