...
class Spacer extends Enum {
 ...
 static m_valueOf__java_lang_String__org_patternfly_layout_flex_Spacer(/** string */ name) {
  ...
  if ($Equality.$same(Spacer.f_namesToValuesMap__org_patternfly_layout_flex_Spacer_, null)) {
   Spacer.f_namesToValuesMap__org_patternfly_layout_flex_Spacer_ = (/**@type {Map<?string, !Spacer>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(Spacer.m_values__arrayOf_org_patternfly_layout_flex_Spacer())));
  }
  return /**@type {Spacer}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, Spacer.f_namesToValuesMap__org_patternfly_layout_flex_Spacer_));
 }
 /** @nodts @return {!Array<!Spacer>} */
 static m_values__arrayOf_org_patternfly_layout_flex_Spacer() {
  Spacer.$clinit();
  return /**@type {!Array<!Spacer>}*/ ($Arrays.$stampType([Spacer.$static_none__org_patternfly_layout_flex_Spacer, Spacer.$static_xs__org_patternfly_layout_flex_Spacer, Spacer.$static_sm__org_patternfly_layout_flex_Spacer, Spacer.$static_md__org_patternfly_layout_flex_Spacer, Spacer.$static_lg__org_patternfly_layout_flex_Spacer, Spacer.$static_xl__org_patternfly_layout_flex_Spacer, Spacer.$static__2xl__org_patternfly_layout_flex_Spacer, Spacer.$static__3xl__org_patternfly_layout_flex_Spacer, Spacer.$static__4xl__org_patternfly_layout_flex_Spacer], Spacer));
 }
 /** @nodts @return {!Spacer} */
