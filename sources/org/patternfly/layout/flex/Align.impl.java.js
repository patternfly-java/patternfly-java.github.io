...
class Align extends Enum {
 ...
 static m_valueOf__java_lang_String__org_patternfly_layout_flex_Align(/** string */ name) {
  ...
  if ($Equality.$same(Align.f_namesToValuesMap__org_patternfly_layout_flex_Align_, null)) {
   Align.f_namesToValuesMap__org_patternfly_layout_flex_Align_ = (/**@type {Map<?string, !Align>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(Align.m_values__arrayOf_org_patternfly_layout_flex_Align())));
  }
  return /**@type {Align}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, Align.f_namesToValuesMap__org_patternfly_layout_flex_Align_));
 }
 /** @nodts @return {!Array<!Align>} */
 static m_values__arrayOf_org_patternfly_layout_flex_Align() {
  Align.$clinit();
  return /**@type {!Array<!Align>}*/ ($Arrays.$stampType([Align.$static_left__org_patternfly_layout_flex_Align, Align.$static_right__org_patternfly_layout_flex_Align], Align));
 }
 /** @nodts @return {!Align} */
