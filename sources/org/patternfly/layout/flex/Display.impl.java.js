...
class Display extends Enum {
 ...
 static m_valueOf__java_lang_String__org_patternfly_layout_flex_Display(/** string */ name) {
  ...
  if ($Equality.$same(Display.f_namesToValuesMap__org_patternfly_layout_flex_Display_, null)) {
   Display.f_namesToValuesMap__org_patternfly_layout_flex_Display_ = (/**@type {Map<?string, !Display>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(Display.m_values__arrayOf_org_patternfly_layout_flex_Display())));
  }
  return /**@type {Display}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, Display.f_namesToValuesMap__org_patternfly_layout_flex_Display_));
 }
 /** @nodts @return {!Array<!Display>} */
 static m_values__arrayOf_org_patternfly_layout_flex_Display() {
  Display.$clinit();
  return /**@type {!Array<!Display>}*/ ($Arrays.$stampType([Display.$static_flex__org_patternfly_layout_flex_Display, Display.$static_inlineFlex__org_patternfly_layout_flex_Display], Display));
 }
 /** @nodts @return {!Display} */
