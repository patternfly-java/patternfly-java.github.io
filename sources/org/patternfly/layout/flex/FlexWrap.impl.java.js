...
class FlexWrap extends Enum {
 ...
 static m_valueOf__java_lang_String__org_patternfly_layout_flex_FlexWrap(/** string */ name) {
  ...
  if ($Equality.$same(FlexWrap.f_namesToValuesMap__org_patternfly_layout_flex_FlexWrap_, null)) {
   FlexWrap.f_namesToValuesMap__org_patternfly_layout_flex_FlexWrap_ = (/**@type {Map<?string, !FlexWrap>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(FlexWrap.m_values__arrayOf_org_patternfly_layout_flex_FlexWrap())));
  }
  return /**@type {FlexWrap}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, FlexWrap.f_namesToValuesMap__org_patternfly_layout_flex_FlexWrap_));
 }
 /** @nodts @return {!Array<!FlexWrap>} */
 static m_values__arrayOf_org_patternfly_layout_flex_FlexWrap() {
  FlexWrap.$clinit();
  return /**@type {!Array<!FlexWrap>}*/ ($Arrays.$stampType([FlexWrap.$static_wrap__org_patternfly_layout_flex_FlexWrap, FlexWrap.$static_noWrap__org_patternfly_layout_flex_FlexWrap, FlexWrap.$static_wrapReverse__org_patternfly_layout_flex_FlexWrap], FlexWrap));
 }
 /** @nodts @return {!FlexWrap} */
 ...
 /** @nodts @return {!FlexWrap} */
 static get f_noWrap__org_patternfly_layout_flex_FlexWrap() {
  return (FlexWrap.$clinit(), FlexWrap.$static_noWrap__org_patternfly_layout_flex_FlexWrap);
 }
 /** @nodts @return {!FlexWrap} */
 ...
 static $clinit() {
  ...
  FlexWrap.$static_noWrap__org_patternfly_layout_flex_FlexWrap = FlexWrap.$create__java_lang_String__int__java_lang_String($Util.$makeEnumName('noWrap'), FlexWrap.$ordinal_noWrap__org_patternfly_layout_flex_FlexWrap, 'nowrap');
...
/**@const {number} @nodts*/
FlexWrap.$ordinal_noWrap__org_patternfly_layout_flex_FlexWrap = 1;
/**@const {number} @nodts*/
FlexWrap.$ordinal_wrapReverse__org_patternfly_layout_flex_FlexWrap = 2;
/**@private {!FlexWrap} @nodts*/
FlexWrap.$static_wrap__org_patternfly_layout_flex_FlexWrap;
/**@private {!FlexWrap} @nodts*/
FlexWrap.$static_noWrap__org_patternfly_layout_flex_FlexWrap;
/**@private {!FlexWrap} @nodts*/
