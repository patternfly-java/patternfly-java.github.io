...
class DataProvider extends j_l_Object {
 ...
 m_getAllItems__java_lang_Iterable() {
  return /**@type {Collection<T>}*/ (Collections.m_unmodifiableCollection__java_util_Collection__java_util_Collection(this.f_allItems__org_patternfly_dataprovider_DataProvider_.values()));
 }
 /** @nodts @return {Iterable<T>} */
 m_getFilteredItems__java_lang_Iterable() {
  return /**@type {Collection<T>}*/ (Collections.m_unmodifiableCollection__java_util_Collection__java_util_Collection(this.f_filteredItems__org_patternfly_dataprovider_DataProvider_.values()));
 }
 /** @nodts @return {Iterable<T>} */
 m_getVisibleItems__java_lang_Iterable() {
  return /**@type {Collection<T>}*/ (Collections.m_unmodifiableCollection__java_util_Collection__java_util_Collection(this.f_visibleItems__org_patternfly_dataprovider_DataProvider_.values()));
 }
 /** @nodts */
 ...
 m_selectAll__void() {
  ...
  this.f_filteredItems__org_patternfly_dataprovider_DataProvider_.m_forEach__java_util_function_BiConsumer__void(BiConsumer.$adapt((/** ?string */ id, /** T */ item) =>{
 ...
 m_selectVisible__void() {
  this.f_selectionInfo__org_patternfly_dataprovider_DataProvider_.m_reset__void_$pp_org_patternfly_dataprovider();
  this.f_visibleItems__org_patternfly_dataprovider_DataProvider_.m_forEach__java_util_function_BiConsumer__void(BiConsumer.$adapt((/** ?string */ id, /** T */ item) =>{
   let id_1 = /**@type {?string}*/ ($Casts.$to(id, j_l_String));
   this.m_selectInternal__java_lang_String__java_lang_Object__boolean__void_$p_org_patternfly_dataprovider_DataProvider(id_1, item, true);
  }));
  this.m_updateSelection__void_$p_org_patternfly_dataprovider_DataProvider();
 ...
 m_fireSelection__java_lang_Object__void_$p_org_patternfly_dataprovider_DataProvider(/** T */ item) {
  for (let $iterator = this.f_selectHandler__org_patternfly_dataprovider_DataProvider_.m_iterator__java_util_Iterator(); $iterator.m_hasNext__boolean(); ) {
   let handler = /**@type {SelectHandler<T>}*/ ($Casts.$to($iterator.m_next__java_lang_Object(), /**@type {Function}*/ (SelectHandler)));
   {
 ...
 m_updateSelection__void_$p_org_patternfly_dataprovider_DataProvider() {
  for (let $iterator = this.f_displays__org_patternfly_dataprovider_DataProvider_.m_iterator__java_util_Iterator(); $iterator.m_hasNext__boolean(); ) {
   let display = /**@type {Display<T>}*/ ($Casts.$to($iterator.m_next__java_lang_Object(), /**@type {Function}*/ (Display)));
   {
 ...
 m_paged__java_util_List__java_util_List_$p_org_patternfly_dataprovider_DataProvider(/** List<T> */ values) {
  ...
  return /**@type {List<T>}*/ ($Casts.$to(pages.getAtIndex(Math.min(this.f_pageInfo__org_patternfly_dataprovider_DataProvider_.m_getPage__int(), pages.size() - 1 | 0)), /**@type {Function}*/ (List)));
 }
 ...
 m_internalUpdate__void_$p_org_patternfly_dataprovider_DataProvider() {
  ...
  if (!this.f_filters__org_patternfly_dataprovider_DataProvider_.isEmpty()) {
   let /** Predicate<T> */ predicate = null;
   for (let $iterator = this.f_filters__org_patternfly_dataprovider_DataProvider_.values().m_iterator__java_util_Iterator(); $iterator.m_hasNext__boolean(); ) {
    let p = /**@type {Predicate<T>}*/ ($Casts.$to($iterator.m_next__java_lang_Object(), /**@type {Function}*/ (Predicate)));
    {
  ...
  for (let $iterator_1 = this.f_displays__org_patternfly_dataprovider_DataProvider_.m_iterator__java_util_Iterator(); $iterator_1.m_hasNext__boolean(); ) {
   let display = /**@type {Display<T>}*/ ($Casts.$to($iterator_1.m_next__java_lang_Object(), /**@type {Function}*/ (Display)));
   {
 ...
 m_toLinkedMap__java_util_function_Function__java_util_function_Function__java_util_stream_Collector_$p_org_patternfly_dataprovider_DataProvider(/** j_u_function_Function<?, ?> */ keyMapper, /** j_u_function_Function<?, ?> */ valueMapper) {
  return /**@type {Collector<T, *, Map<?string, T>>}*/ (Collectors.m_toMap__java_util_function_Function__java_util_function_Function__java_util_function_BinaryOperator__java_util_function_Supplier__java_util_stream_Collector(keyMapper, valueMapper, BinaryOperator.$adapt(/**  @return {T}*/ ((/** T */ u, /** T */ v) =>{
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(IllegalStateException.$create__java_lang_String('Duplicate key ' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(u)));
  })), Supplier.$adapt(/**  @return {Map<?string, T>}*/ (() =>{
