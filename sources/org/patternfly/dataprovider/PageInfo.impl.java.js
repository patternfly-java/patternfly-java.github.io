...
class PageInfo extends j_l_Object {
 ...
 /** @nodts @return {number} */
 m_getPages__int() {
  let pages = Primitives.m_coerceDivision__int__int(this.f_total__org_patternfly_dataprovider_PageInfo_ / this.f_pageSize__org_patternfly_dataprovider_PageInfo_);
  if (Primitives.m_coerceDivision__int__int(this.f_total__org_patternfly_dataprovider_PageInfo_ % this.f_pageSize__org_patternfly_dataprovider_PageInfo_) != 0) {
   pages = pages + 1 | 0;
  }
