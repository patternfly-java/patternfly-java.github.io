...
class ItemDisplay extends j_l_Object {
 ...
 $ctor__org_patternfly_dataprovider_ItemDisplay__void() {
  ...
  this.f_identifier__org_patternfly_dataprovider_ItemDisplay = j_u_function_Function.$adapt(/**  @return {?string}*/ ((/** T */ item) =>{
   return Id.m_build__java_lang_String__arrayOf_java_lang_String__java_lang_String(j_l_String.m_valueOf__java_lang_Object__java_lang_String(item), /**@type {!Array<?string>}*/ ($Arrays.$create([0], j_l_String)));
  }));
  this.f_asString__org_patternfly_dataprovider_ItemDisplay = j_u_function_Function.$adapt(/**  @return {?string}*/ ((/** T */ arg0) =>{
   return j_l_String.m_valueOf__java_lang_Object__java_lang_String(arg0);
  }));
  this.f_display__org_patternfly_dataprovider_ItemDisplay = BiConsumer.$adapt((/** HTMLContainerBuilder<E> */ element, /** T */ item_1) =>{
   let element_1 = /**@type {HTMLContainerBuilder<E>}*/ ($Casts.$to(element, HTMLContainerBuilder));
   element_1.m_text__java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {?string}*/ ($Casts.$to(this.f_asString__org_patternfly_dataprovider_ItemDisplay.m_apply__java_lang_Object__java_lang_Object(item_1), j_l_String)));
  });
 }
 ...
 m_itemId__java_lang_Object__java_lang_String(/** T */ item) {
  return Id.m_build__java_lang_String__arrayOf_java_lang_String__java_lang_String(/**@type {?string}*/ ($Casts.$to(this.f_identifier__org_patternfly_dataprovider_ItemDisplay.m_apply__java_lang_Object__java_lang_Object(item), j_l_String)), /**@type {!Array<?string>}*/ ($Arrays.$create([0], j_l_String)));
 }
 /** @nodts */
 static $clinit() {
  ItemDisplay.$clinit = () =>{};
