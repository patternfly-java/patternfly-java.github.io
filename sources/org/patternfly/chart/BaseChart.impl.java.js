goog.module('org.patternfly.chart.BaseChart$impl');
...
let SubTitlePosition = goog.forwardDeclare('org.patternfly.chart.SubTitlePosition$impl');
 ...
 */
class BaseChart extends j_l_Object {
 /** @protected @nodts */
 constructor() {
  super();
  /**@type {ChartType} @nodts*/
  this.f_chartType__org_patternfly_chart_BaseChart_;
  /**@type {E} @nodts*/
  this.f_element__org_patternfly_chart_BaseChart_;
 }
 /** @nodts */
 $ctor__org_patternfly_chart_BaseChart__org_patternfly_chart_ChartType__org_patternfly_chart_ChartElement__void(/** ChartType */ chartType, /** E */ element) {
  this.$ctor__java_lang_Object__void();
  this.f_chartType__org_patternfly_chart_BaseChart_ = (/**@type {ChartType}*/ ($Casts.$to(Objects.m_requireNonNull__java_lang_Object__java_lang_String__java_lang_Object(chartType, 'chart type required'), ChartType)));
  this.f_element__org_patternfly_chart_BaseChart_ = (/**@type {E}*/ (Js.m_uncheckedCast__java_lang_Object__java_lang_Object(Objects.m_requireNonNull__java_lang_Object__java_lang_String__java_lang_Object(element, 'element required'))));
  this.m_initOuia__java_lang_String__void(chartType.f_id__org_patternfly_chart_ChartType);
 }
 /** @override @nodts @return {?string} */
 m_ouiaComponentType__java_lang_String() {
  return this.f_chartType__org_patternfly_chart_BaseChart_.f_chartName__org_patternfly_chart_ChartType;
 }
 /** @override @nodts @return {ChartType} */
 m_chartType__org_patternfly_chart_ChartType() {
  return this.f_chartType__org_patternfly_chart_BaseChart_;
 }
 /** @nodts @return {E} */
 m_element__org_patternfly_chart_ChartElement() {
  return this.f_element__org_patternfly_chart_BaseChart_;
 }
 /** @nodts @return {B} */
 m_height__int__org_jboss_elemento_TypedBuilder(/** number */ height) {
  (/**@type {!ChartElement}*/ (this.m_element__org_patternfly_chart_ChartElement())).height = height;
  return this.m_that__org_jboss_elemento_TypedBuilder();
 }
 /** @nodts @return {B} */
 m_legendData__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/** Array<?string> */ legend) {
  (/**@type {!ChartElement}*/ (this.m_element__org_patternfly_chart_ChartElement())).legendData = this.m_legendDataArray__arrayOf_java_lang_String__elemental2_core_JsArray(legend);
  return this.m_that__org_jboss_elemento_TypedBuilder();
 }
 /** @nodts @return {B} */
 m_legendData__arrayOf_org_patternfly_chart_LegendData__org_jboss_elemento_TypedBuilder(/** Array<Object> */ legend) {
  (/**@type {!ChartElement}*/ (this.m_element__org_patternfly_chart_ChartElement())).legendData = this.m_legendDataArray__arrayOf_org_patternfly_chart_LegendData__elemental2_core_JsArray(legend);
  return this.m_that__org_jboss_elemento_TypedBuilder();
 }
 /** @nodts @return {B} */
 m_legendOrientation__org_patternfly_chart_LegendOrientation__org_jboss_elemento_TypedBuilder(/** LegendOrientation */ orientation) {
  (/**@type {!ChartElement}*/ (this.m_element__org_patternfly_chart_ChartElement())).legendOrientation = j_l_String.m_toLowerCase__java_lang_String__java_lang_String(orientation.name());
  return this.m_that__org_jboss_elemento_TypedBuilder();
 }
 /** @nodts @return {B} */
 m_legendPosition__org_patternfly_chart_LegendPosition__org_jboss_elemento_TypedBuilder(/** LegendPosition */ position) {
  (/**@type {!ChartElement}*/ (this.m_element__org_patternfly_chart_ChartElement())).legendPosition = j_l_String.m_toLowerCase__java_lang_String__java_lang_String(position.name());
  return this.m_that__org_jboss_elemento_TypedBuilder();
 }
 /** @nodts @return {B} */
 m_padding__org_patternfly_chart_Padding__org_jboss_elemento_TypedBuilder(/** Object */ padding) {
  (/**@type {!ChartElement}*/ (this.m_element__org_patternfly_chart_ChartElement())).padding = padding;
  return this.m_that__org_jboss_elemento_TypedBuilder();
 }
 /** @nodts @return {B} */
 m_subTitle__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ subTitle) {
  (/**@type {!ChartElement}*/ (this.m_element__org_patternfly_chart_ChartElement())).subTitle = subTitle;
  return this.m_that__org_jboss_elemento_TypedBuilder();
 }
 /** @nodts @return {B} */
 m_subTitlePosition__org_patternfly_chart_SubTitlePosition__org_jboss_elemento_TypedBuilder(/** SubTitlePosition */ position) {
  (/**@type {!ChartElement}*/ (this.m_element__org_patternfly_chart_ChartElement())).subTitlePosition = j_l_String.m_toLowerCase__java_lang_String__java_lang_String(position.name());
  return this.m_that__org_jboss_elemento_TypedBuilder();
 }
 /** @nodts @return {B} */
 m_themeColor__org_patternfly_chart_ChartThemeColor__org_jboss_elemento_TypedBuilder(/** ChartThemeColor */ themeColor) {
  (/**@type {!ChartElement}*/ (this.m_element__org_patternfly_chart_ChartElement())).themeColor = themeColor.f_color__org_patternfly_chart_ChartThemeColor;
  return this.m_that__org_jboss_elemento_TypedBuilder();
 }
 /** @override @nodts @return {B} */
 m_title__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ title) {
  (/**@type {!ChartElement}*/ (this.m_element__org_patternfly_chart_ChartElement())).title = title;
  return this.m_that__org_jboss_elemento_TypedBuilder();
 }
 /** @nodts @return {B} */
 m_width__int__org_jboss_elemento_TypedBuilder(/** number */ width) {
  (/**@type {!ChartElement}*/ (this.m_element__org_patternfly_chart_ChartElement())).width = width;
  return this.m_that__org_jboss_elemento_TypedBuilder();
 }
 /** @nodts @return {B} */
 m_ariaTitle__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ ariaTitle) {
  Element_$Overlay.m_setAttribute__$devirt__elemental2_dom_Element__java_lang_String__java_lang_String__void(/**@type {!Element}*/ (this.m_element__org_patternfly_chart_ChartElement()), 'aria-title', ariaTitle);
  return this.m_that__org_jboss_elemento_TypedBuilder();
 }
 /** @nodts @return {B} */
 m_ariaDesc__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ ariaDesc) {
  Element_$Overlay.m_setAttribute__$devirt__elemental2_dom_Element__java_lang_String__java_lang_String__void(/**@type {!Element}*/ (this.m_element__org_patternfly_chart_ChartElement()), 'aria-desc', ariaDesc);
  return this.m_that__org_jboss_elemento_TypedBuilder();
 }
 /** @nodts @return {Array<Object>} */
 m_dataArray__arrayOf_org_patternfly_chart_Data__elemental2_core_JsArray(/** Array<Object> */ data) {
 ...
 /** @nodts @return {Array<Object>} */
 m_legendDataArray__arrayOf_java_lang_String__elemental2_core_JsArray(/** Array<?string> */ legend) {
  let array = /**@type {!Array<Object>}*/ (new Array());
  if (!$Equality.$same(legend, null)) {
   for (let $array = legend, $index = 0; $index < $array.length; $index++) {
    let l = $array[$index];
    {
     let ld = new Object();
     ld.name = l;
 ...
 /** @nodts @return {Array<Object>} */
 m_legendDataArray__arrayOf_org_patternfly_chart_LegendData__elemental2_core_JsArray(/** Array<Object> */ legend) {
  let array = /**@type {!Array<Object>}*/ (new Array());
  if (!$Equality.$same(legend, null)) {
   array.push(...legend);
  }
 ...
 m_element__elemental2_dom_Element() {
  return this.m_element__org_patternfly_chart_ChartElement();
 }
 ...
 static $isInstance(/** ? */ instance) {
  return instance instanceof BaseChart;
 }
...
Chart.$markImplementor(BaseChart);
OuiaSupport.$markImplementor(BaseChart);
ElementAttributeMethods.$markImplementor(BaseChart);
ElementClassListMethods.$markImplementor(BaseChart);
ElementConsumerMethods.$markImplementor(BaseChart);
ElementContainerMethods.$markImplementor(BaseChart);
ElementEventMethods.$markImplementor(BaseChart);
ElementIdMethods.$markImplementor(BaseChart);
ElementQueryMethods.$markImplementor(BaseChart);
HTMLElementAttributeMethods.$markImplementor(BaseChart);
HTMLElementDataMethods.$markImplementor(BaseChart);
HTMLElementStyleMethods.$markImplementor(BaseChart);
HTMLElementVisibilityMethods.$markImplementor(BaseChart);
$Util.$setClassMetadata(BaseChart, 'org.patternfly.chart.BaseChart');
