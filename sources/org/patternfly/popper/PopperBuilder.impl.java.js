...
class PopperBuilder extends j_l_Object {
 ...
 constructor() {
  ...
  this.f_stayOpen__org_patternfly_popper_PopperBuilder_;
 ...
 $ctor__org_patternfly_popper_PopperBuilder__java_lang_String__elemental2_dom_HTMLElement__elemental2_dom_HTMLElement__void(/** ?string */ componentName, /** HTMLElement */ triggerElement, /** HTMLElement */ popperElement) {
  ...
  this.f_placement__org_patternfly_popper_PopperBuilder_ = PopperPlacement.f_auto__org_patternfly_popper_PopperPlacement;
 }
 /** @nodts @return {PopperBuilder} */
 m_animationDuration__int__org_patternfly_popper_PopperBuilder(/** number */ animationDuration) {
  ...
  if (animationDuration != org_patternfly_popper_Popper.f_UNDEFINED__org_patternfly_popper_Popper) {
   this.f_popperElement__org_patternfly_popper_PopperBuilder_.style.opacity = OpacityUnionType_$Overlay.m_of__java_lang_Object__elemental2_dom_CSSProperties_OpacityUnionType(Integer.valueOf(0));
 ...
 m_zIndex__int__org_patternfly_popper_PopperBuilder(/** number */ zIndex) {
  if (zIndex != org_patternfly_popper_Popper.f_UNDEFINED__org_patternfly_popper_Popper) {
   this.f_popperElement__org_patternfly_popper_PopperBuilder_.style.zIndex = ZIndexUnionType_$Overlay.m_of__java_lang_Object__elemental2_dom_CSSProperties_ZIndexUnionType(Integer.valueOf(zIndex));
  }
  return this;
 }
 /** @nodts @return {PopperBuilder} */
 m_placement__org_patternfly_popper_PopperPlacement__org_patternfly_popper_PopperBuilder(/** PopperPlacement */ placement) {
 ...
 m_addModifier__arrayOf_org_patternfly_popper_Modifier__org_patternfly_popper_PopperBuilder(/** Array<Object> */ modifiers) {
  this.f_modifiers__org_patternfly_popper_PopperBuilder_.push(...modifiers);
  return this;
 }
 /** @nodts @return {PopperBuilder} */
 ...
 m_registerHandler__elemental2_dom_HTMLElement__java_util_Set__java_util_function_Consumer__java_util_function_Consumer__org_patternfly_popper_PopperBuilder(/** HTMLElement */ triggerElement, /** Set<TriggerAction> */ triggerActions, /** Consumer<Event> */ show, /** Consumer<Event> */ hide) {
  if (triggerActions.contains(TriggerAction.f_mouseenter__org_patternfly_popper_TriggerAction)) {
   ...
   this.f_handlerRegistrations__org_patternfly_popper_PopperBuilder_.add(EventType.m_bind__elemental2_dom_EventTarget__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn__org_gwtproject_event_shared_HandlerRegistration(this.f_popperElement__org_patternfly_popper_PopperBuilder_, EventType.f_mouseleave__org_jboss_elemento_EventType, (/** MouseEvent */ e_6) =>{
  ...
  if (triggerActions.contains(TriggerAction.f_click__org_patternfly_popper_TriggerAction) || triggerActions.contains(TriggerAction.f_stayOpen__org_patternfly_popper_TriggerAction)) {
   this.f_handlerRegistrations__org_patternfly_popper_PopperBuilder_.add(EventType.m_bind__elemental2_dom_EventTarget__org_jboss_elemento_EventType__boolean__org_jboss_elemento_EventCallbackFn__org_gwtproject_event_shared_HandlerRegistration(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay, EventType.f_click__org_jboss_elemento_EventType, true, (/** MouseEvent */ e_12) =>{
    ...
    if (Elements.m_isVisible__elemental2_dom_HTMLElement__boolean(this.f_popperElement__org_patternfly_popper_PopperBuilder_)) {
     if (triggerActions.contains(TriggerAction.f_stayOpen__org_patternfly_popper_TriggerAction)) {
      let clickedInside = this.f_popperElement__org_patternfly_popper_PopperBuilder_.contains(/**@type {Node}*/ ($Casts.$to(e_13.target, Node_$Overlay)));
      if (!$Equality.$same(this.f_stayOpen__org_patternfly_popper_PopperBuilder_, null)) {
       if (!clickedInside && !this.f_stayOpen__org_patternfly_popper_PopperBuilder_.m_test__java_lang_Object__boolean(e_13)) {
     ...
     } else if (triggerActions.contains(TriggerAction.f_click__org_patternfly_popper_TriggerAction)) {
      if (!$Equality.$same(this.f_stayOpen__org_patternfly_popper_PopperBuilder_, null)) {
       if (!this.f_stayOpen__org_patternfly_popper_PopperBuilder_.m_test__java_lang_Object__boolean(e_13)) {
        hide.m_accept__java_lang_Object__void(e_13);
       }
      } else {
       hide.m_accept__java_lang_Object__void(e_13);
  ...
  if (!triggerActions.contains(TriggerAction.f_manual__org_patternfly_popper_TriggerAction)) {
   this.f_handlerRegistrations__org_patternfly_popper_PopperBuilder_.add(EventType.m_bind__elemental2_dom_EventTarget__org_jboss_elemento_EventType__boolean__org_jboss_elemento_EventCallbackFn__org_gwtproject_event_shared_HandlerRegistration(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay, EventType.f_keydown__org_jboss_elemento_EventType, true, (/** KeyboardEvent */ e_14) =>{
 ...
 m_removePopperOnTriggerDetach__org_patternfly_popper_PopperBuilder() {
  Elements.m_onDetach__elemental2_dom_HTMLElement__org_jboss_elemento_ObserverCallback__void(this.f_triggerElement__org_patternfly_popper_PopperBuilder_, ObserverCallback.$adapt((/** MutationRecord */ mr) =>{
   PopperBuilder.f_logger__org_patternfly_popper_PopperBuilder_.m_debug__java_lang_String__arrayOf_java_lang_Object__void('Remove popper %o on trigger element detach %o', [this.f_popperElement__org_patternfly_popper_PopperBuilder_, this.f_triggerElement__org_patternfly_popper_PopperBuilder_]);
 ...
 /** @nodts @return {PopperBuilder} */
 m_stayOpen__java_util_function_Predicate__org_patternfly_popper_PopperBuilder(/** Predicate<Event> */ stayOpen) {
  this.f_stayOpen__org_patternfly_popper_PopperBuilder_ = stayOpen;
  return this;
 }
 ...
 m_build__org_patternfly_popper_Popper() {
  ...
  if ($Equality.$same(createPopperFn, null) || Js.isTripleEqual(createPopperFn, undefined)) {
   ...
   options.placement = this.f_placement__org_patternfly_popper_PopperBuilder_.m_value__java_lang_String();
   ...
   PopperBuilder.f_logger__org_patternfly_popper_PopperBuilder_.m_debug__java_lang_String__arrayOf_java_lang_Object__void('Create popper %o for trigger element %o', [this.f_popperElement__org_patternfly_popper_PopperBuilder_, this.f_triggerElement__org_patternfly_popper_PopperBuilder_]);
 ...
 static $clinit() {
  ...
  j_l_Object.$clinit();
  PopperBuilder.f_logger__org_patternfly_popper_PopperBuilder_ = Logger.m_getLogger__java_lang_String__org_jboss_elemento_logger_Logger(Class.$get(PopperBuilder).m_getName__java_lang_String());
 }
...
/**@type {Logger} @nodts*/
PopperBuilder.f_logger__org_patternfly_popper_PopperBuilder_;
