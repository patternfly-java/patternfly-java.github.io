...
class TriggerAction extends Enum {
 ...
 static m_valueOf__java_lang_String__org_patternfly_popper_TriggerAction(/** string */ name) {
  ...
  if ($Equality.$same(TriggerAction.f_namesToValuesMap__org_patternfly_popper_TriggerAction_, null)) {
   TriggerAction.f_namesToValuesMap__org_patternfly_popper_TriggerAction_ = (/**@type {Map<?string, !TriggerAction>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(TriggerAction.m_values__arrayOf_org_patternfly_popper_TriggerAction())));
  }
  return /**@type {TriggerAction}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, TriggerAction.f_namesToValuesMap__org_patternfly_popper_TriggerAction_));
 }
 /** @nodts @return {!Array<!TriggerAction>} */
 static m_values__arrayOf_org_patternfly_popper_TriggerAction() {
  TriggerAction.$clinit();
  return /**@type {!Array<!TriggerAction>}*/ ($Arrays.$stampType([TriggerAction.f_mouseenter__org_patternfly_popper_TriggerAction, TriggerAction.f_focus__org_patternfly_popper_TriggerAction, TriggerAction.f_click__org_patternfly_popper_TriggerAction, TriggerAction.f_stayOpen__org_patternfly_popper_TriggerAction, TriggerAction.f_manual__org_patternfly_popper_TriggerAction], TriggerAction));
 }
 /** @nodts */
 static $clinit() {
  TriggerAction.$clinit = () =>{};
...
/**@const {number} @nodts*/
TriggerAction.$ordinal_stayOpen__org_patternfly_popper_TriggerAction = 3;
/**@const {number} @nodts*/
TriggerAction.$ordinal_manual__org_patternfly_popper_TriggerAction = 4;
...
/**@const {!TriggerAction} @nodts*/
TriggerAction.f_stayOpen__org_patternfly_popper_TriggerAction = /**@pureOrBreakMyCode*/ TriggerAction.$create__java_lang_String__int($Util.$makeEnumName('stayOpen'), TriggerAction.$ordinal_stayOpen__org_patternfly_popper_TriggerAction);
/**@const {!TriggerAction} @nodts*/
