...
class Theme extends Enum {
 ...
 static m_valueOf__java_lang_String__org_patternfly_style_Theme(/** string */ name) {
  ...
  if ($Equality.$same(Theme.f_namesToValuesMap__org_patternfly_style_Theme_, null)) {
   Theme.f_namesToValuesMap__org_patternfly_style_Theme_ = (/**@type {Map<?string, !Theme>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(Theme.m_values__arrayOf_org_patternfly_style_Theme())));
  }
  return /**@type {Theme}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, Theme.f_namesToValuesMap__org_patternfly_style_Theme_));
 }
 /** @nodts @return {!Array<!Theme>} */
 static m_values__arrayOf_org_patternfly_style_Theme() {
  Theme.$clinit();
  return /**@type {!Array<!Theme>}*/ ($Arrays.$stampType([Theme.f_dark__org_patternfly_style_Theme, Theme.f_light__org_patternfly_style_Theme], Theme));
 }
 /** @nodts */
 static $clinit() {
  Theme.$clinit = () =>{};
