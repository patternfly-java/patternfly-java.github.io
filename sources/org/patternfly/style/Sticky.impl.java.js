...
class Sticky extends Enum {
 ...
 static m_valueOf__java_lang_String__org_patternfly_style_Sticky(/** string */ name) {
  ...
  if ($Equality.$same(Sticky.f_namesToValuesMap__org_patternfly_style_Sticky_, null)) {
   Sticky.f_namesToValuesMap__org_patternfly_style_Sticky_ = (/**@type {Map<?string, !Sticky>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(Sticky.m_values__arrayOf_org_patternfly_style_Sticky())));
  }
  return /**@type {Sticky}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, Sticky.f_namesToValuesMap__org_patternfly_style_Sticky_));
 }
 /** @nodts @return {!Array<!Sticky>} */
 static m_values__arrayOf_org_patternfly_style_Sticky() {
  Sticky.$clinit();
  return /**@type {!Array<!Sticky>}*/ ($Arrays.$stampType([Sticky.$static_top__org_patternfly_style_Sticky, Sticky.$static_bottom__org_patternfly_style_Sticky], Sticky));
 }
 /** @nodts @return {!Sticky} */
