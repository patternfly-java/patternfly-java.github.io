...
class Inset extends Enum {
 ...
 static m_valueOf__java_lang_String__org_patternfly_style_Inset(/** string */ name) {
  ...
  if ($Equality.$same(Inset.f_namesToValuesMap__org_patternfly_style_Inset_, null)) {
   Inset.f_namesToValuesMap__org_patternfly_style_Inset_ = (/**@type {Map<?string, !Inset>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(Inset.m_values__arrayOf_org_patternfly_style_Inset())));
  }
  return /**@type {Inset}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, Inset.f_namesToValuesMap__org_patternfly_style_Inset_));
 }
 /** @nodts @return {!Array<!Inset>} */
 static m_values__arrayOf_org_patternfly_style_Inset() {
  Inset.$clinit();
  return /**@type {!Array<!Inset>}*/ ($Arrays.$stampType([Inset.$static_none__org_patternfly_style_Inset, Inset.$static_xs__org_patternfly_style_Inset, Inset.$static_sm__org_patternfly_style_Inset, Inset.$static_md__org_patternfly_style_Inset, Inset.$static_lg__org_patternfly_style_Inset, Inset.$static_xl__org_patternfly_style_Inset, Inset.$static__2xl__org_patternfly_style_Inset, Inset.$static__3xl__org_patternfly_style_Inset], Inset));
 }
 /** @nodts @return {!Inset} */
