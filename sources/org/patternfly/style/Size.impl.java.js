...
class Size extends Enum {
 ...
 static m_valueOf__java_lang_String__org_patternfly_style_Size(/** string */ name) {
  ...
  if ($Equality.$same(Size.f_namesToValuesMap__org_patternfly_style_Size_, null)) {
   Size.f_namesToValuesMap__org_patternfly_style_Size_ = (/**@type {Map<?string, !Size>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(Size.m_values__arrayOf_org_patternfly_style_Size())));
  }
  return /**@type {Size}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, Size.f_namesToValuesMap__org_patternfly_style_Size_));
 }
 /** @nodts @return {!Array<!Size>} */
 static m_values__arrayOf_org_patternfly_style_Size() {
  Size.$clinit();
  return /**@type {!Array<!Size>}*/ ($Arrays.$stampType([Size.$static_xs__org_patternfly_style_Size, Size.$static_sm__org_patternfly_style_Size, Size.$static_md__org_patternfly_style_Size, Size.$static_lg__org_patternfly_style_Size, Size.$static_xl__org_patternfly_style_Size, Size.$static__2xl__org_patternfly_style_Size, Size.$static__3xl__org_patternfly_style_Size, Size.$static__4xl__org_patternfly_style_Size], Size));
 }
 /** @nodts @return {!Size} */
