...
class Padding extends Enum {
 ...
 static m_valueOf__java_lang_String__org_patternfly_style_Padding(/** string */ name) {
  ...
  if ($Equality.$same(Padding.f_namesToValuesMap__org_patternfly_style_Padding_, null)) {
   Padding.f_namesToValuesMap__org_patternfly_style_Padding_ = (/**@type {Map<?string, !Padding>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(Padding.m_values__arrayOf_org_patternfly_style_Padding())));
  }
  return /**@type {Padding}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, Padding.f_namesToValuesMap__org_patternfly_style_Padding_));
 }
 /** @nodts @return {!Array<!Padding>} */
 static m_values__arrayOf_org_patternfly_style_Padding() {
  Padding.$clinit();
  return /**@type {!Array<!Padding>}*/ ($Arrays.$stampType([Padding.$static_padding__org_patternfly_style_Padding, Padding.$static_noPadding__org_patternfly_style_Padding], Padding));
 }
 /** @nodts @return {!Padding} */
