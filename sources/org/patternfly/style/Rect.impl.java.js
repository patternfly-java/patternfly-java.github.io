...
class Rect extends j_l_Object {
 ...
 hashCode() {
  return Objects.m_hash__arrayOf_java_lang_Object__int([Integer.valueOf(this.f_width__org_patternfly_style_Rect), Integer.valueOf(this.f_height__org_patternfly_style_Rect)]);
 }
