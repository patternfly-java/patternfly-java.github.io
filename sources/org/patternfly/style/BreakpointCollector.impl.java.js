...
class BreakpointCollector extends j_l_Object {
 ...
 static m_modifiers__java_util_stream_Collector() {
  ...
  return /**@type {!BreakpointCollector<V_1>}*/ (BreakpointCollector.$create__boolean__java_util_function_Function(false, j_u_function_Function.$adapt(/**  @return {?string}*/ ((/** V_1 */ arg0) =>{
 ...
 static m_verticalModifiers__java_util_stream_Collector() {
  BreakpointCollector.$clinit();
  return /**@type {!BreakpointCollector<V_1>}*/ (BreakpointCollector.$create__boolean__java_util_function_Function(true, j_u_function_Function.$adapt(/**  @return {?string}*/ ((/** V_1 */ arg0) =>{
   return j_l_String.m_valueOf__java_lang_Object__java_lang_String(arg0);
  }))));
 }
 /** @nodts @template V_1 @return {Collector<Tuple<Breakpoint, V_1>, StringBuilder, ?string>} */
 ...
 m_supplier__java_util_function_Supplier() {
  return Supplier.$adapt(/**  @return {StringBuilder}*/ (() =>{
 ...
 m_accumulator__java_util_function_BiConsumer() {
  return BiConsumer.$adapt((/** StringBuilder */ builder, /** Tuple<Breakpoint, V> */ tuple) =>{
   let builder_1 = /**@type {StringBuilder}*/ ($Casts.$to(builder, StringBuilder));
   let tuple_1 = /**@type {Tuple<Breakpoint, V>}*/ ($Casts.$to(tuple, Tuple));
 ...
 m_combiner__java_util_function_BinaryOperator() {
  return BinaryOperator.$adapt(/**  @return {StringBuilder}*/ ((/** StringBuilder */ r1, /** StringBuilder */ r2) =>{
 ...
 m_finisher__java_util_function_Function() {
  return j_u_function_Function.$adapt(/**  @return {?string}*/ ((/** StringBuilder */ arg0) =>{
