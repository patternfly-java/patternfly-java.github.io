...
class ExpandableModifier extends Enum {
 ...
 static m_valueOf__java_lang_String__org_patternfly_style_ExpandableModifier(/** string */ name) {
  ...
  if ($Equality.$same(ExpandableModifier.f_namesToValuesMap__org_patternfly_style_ExpandableModifier_, null)) {
   ExpandableModifier.f_namesToValuesMap__org_patternfly_style_ExpandableModifier_ = (/**@type {Map<?string, !ExpandableModifier>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(ExpandableModifier.m_values__arrayOf_org_patternfly_style_ExpandableModifier())));
  }
  return /**@type {ExpandableModifier}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, ExpandableModifier.f_namesToValuesMap__org_patternfly_style_ExpandableModifier_));
 }
 /** @nodts @return {!Array<!ExpandableModifier>} */
 static m_values__arrayOf_org_patternfly_style_ExpandableModifier() {
  ExpandableModifier.$clinit();
  return /**@type {!Array<!ExpandableModifier>}*/ ($Arrays.$stampType([ExpandableModifier.$static_expandable__org_patternfly_style_ExpandableModifier, ExpandableModifier.$static_nonExpandable__org_patternfly_style_ExpandableModifier], ExpandableModifier));
 }
 /** @nodts @return {!ExpandableModifier} */
