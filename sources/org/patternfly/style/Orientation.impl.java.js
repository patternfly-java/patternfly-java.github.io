...
class Orientation extends Enum {
 ...
 static m_valueOf__java_lang_String__org_patternfly_style_Orientation(/** string */ name) {
  ...
  if ($Equality.$same(Orientation.f_namesToValuesMap__org_patternfly_style_Orientation_, null)) {
   Orientation.f_namesToValuesMap__org_patternfly_style_Orientation_ = (/**@type {Map<?string, !Orientation>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(Orientation.m_values__arrayOf_org_patternfly_style_Orientation())));
  }
  return /**@type {Orientation}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, Orientation.f_namesToValuesMap__org_patternfly_style_Orientation_));
 }
 /** @nodts @return {!Array<!Orientation>} */
 static m_values__arrayOf_org_patternfly_style_Orientation() {
  Orientation.$clinit();
  return /**@type {!Array<!Orientation>}*/ ($Arrays.$stampType([Orientation.$static_horizontal__org_patternfly_style_Orientation, Orientation.$static_vertical__org_patternfly_style_Orientation], Orientation));
 }
 /** @nodts @return {!Orientation} */
