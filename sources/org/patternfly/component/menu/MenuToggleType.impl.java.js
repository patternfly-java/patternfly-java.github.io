...
class MenuToggleType extends Enum {
 ...
 static m_valueOf__java_lang_String__org_patternfly_component_menu_MenuToggleType(/** string */ name) {
  ...
  if ($Equality.$same(MenuToggleType.f_namesToValuesMap__org_patternfly_component_menu_MenuToggleType_, null)) {
   MenuToggleType.f_namesToValuesMap__org_patternfly_component_menu_MenuToggleType_ = (/**@type {Map<?string, !MenuToggleType>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(MenuToggleType.m_values__arrayOf_org_patternfly_component_menu_MenuToggleType())));
  }
  return /**@type {MenuToggleType}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, MenuToggleType.f_namesToValuesMap__org_patternfly_component_menu_MenuToggleType_));
 }
 /** @nodts @return {!Array<!MenuToggleType>} */
 static m_values__arrayOf_org_patternfly_component_menu_MenuToggleType() {
  MenuToggleType.$clinit();
  return /**@type {!Array<!MenuToggleType>}*/ ($Arrays.$stampType([MenuToggleType.$static_default___org_patternfly_component_menu_MenuToggleType, MenuToggleType.$static_plain__org_patternfly_component_menu_MenuToggleType, MenuToggleType.$static_plainText__org_patternfly_component_menu_MenuToggleType, MenuToggleType.$static_split__org_patternfly_component_menu_MenuToggleType, MenuToggleType.$static_typeahead__org_patternfly_component_menu_MenuToggleType], MenuToggleType));
 }
 /** @nodts @return {!MenuToggleType} */
