...
class MultiTypeahead extends MultiMenuToggleMenu {
 ...
 $ctor__org_patternfly_component_menu_MultiTypeahead__org_patternfly_component_textinputgroup_BaseFilterInput__void(/** BaseFilterInput<?> */ filterInput) {
  ...
  this.m_onLoaded__org_patternfly_handler_ComponentHandler__org_jboss_elemento_TypedBuilder(ComponentHandler.$adapt((/** Event */ e, /** MultiTypeahead */ c) =>{
   let c_1 = /**@type {MultiTypeahead}*/ ($Casts.$to(c, MultiTypeahead));
   this.f_menu__org_patternfly_component_menu_MenuToggleMenu.m_search__org_patternfly_component_menu_SearchFilter__org_patternfly_component_menu_NoResults__java_lang_String__java_util_List(this.f_searchFilter__org_patternfly_component_menu_MultiTypeahead_, this.f_noResults__org_patternfly_component_menu_MultiTypeahead_, c_1.f_menuToggle__org_patternfly_component_menu_MenuToggleMenu.m_text__java_lang_String());
  }));
  TypeaheadSupport.m_typeaheadDefaults__org_patternfly_component_menu_MenuToggleMenu__void(this);
  (/**@type {!BaseFilterInput<BaseFilterInput>}*/ ((/**@type {!BaseFilterInput<BaseFilterInput>}*/ ($Casts.$to((/**@type {!BaseTextInputGroup<BaseFilterInput>}*/ (filterInput.m_onKeyup__org_patternfly_handler_ChangeHandler__org_patternfly_component_textinputgroup_BaseTextInputGroup(ChangeHandler.$adapt((/** Event */ e_1, /** ? */ c_2, /** ?string */ value) =>{
   ...
   this.f_menu__org_patternfly_component_menu_MenuToggleMenu.m_search__org_patternfly_component_menu_SearchFilter__org_patternfly_component_menu_NoResults__java_lang_String__java_util_List(this.f_searchFilter__org_patternfly_component_menu_MultiTypeahead_, this.f_noResults__org_patternfly_component_menu_MultiTypeahead_, value_1);
   ...
   let c_5 = /**@type {?}*/ ($Casts.$to(c_4, BaseFilterInput));
   let value_3 = /**@type {?string}*/ ($Casts.$to(value_2, j_l_String));
   this.m_expand__boolean__void(false);
   this.f_menu__org_patternfly_component_menu_MenuToggleMenu.m_search__org_patternfly_component_menu_SearchFilter__org_patternfly_component_menu_NoResults__java_lang_String__java_util_List(this.f_searchFilter__org_patternfly_component_menu_MultiTypeahead_, this.f_noResults__org_patternfly_component_menu_MultiTypeahead_, value_3);
  })), BaseFilterInput))).m_noAddOnEnter__org_patternfly_component_textinputgroup_BaseFilterInput())).m_onEnter__org_patternfly_handler_ComponentHandler__org_patternfly_component_textinputgroup_BaseFilterInput(ComponentHandler.$adapt((/** Event */ e_3, /** ? */ fi) =>{
