...
class MenuList extends MenuSubComponent {
 ...
 constructor() {
  ...
  this.f_loading__org_patternfly_component_menu_MenuList_;
  /**@type {Supplier<MenuItem>} @nodts*/
  this.f_noItems__org_patternfly_component_menu_MenuList_;
  /**@type {Supplier<MenuItem>} @nodts*/
  this.f_error__org_patternfly_component_menu_MenuList_;
  /**@type {MenuItem} @nodts*/
 ...
 $ctor__org_patternfly_component_menu_MenuList__void() {
  ...
  this.f_loading__org_patternfly_component_menu_MenuList_ = MenuList.f_defaultLoading__org_patternfly_component_menu_MenuList_;
  this.f_noItems__org_patternfly_component_menu_MenuList_ = MenuList.f_defaultNoItems__org_patternfly_component_menu_MenuList_;
  this.f_error__org_patternfly_component_menu_MenuList_ = MenuList.f_defaultError__org_patternfly_component_menu_MenuList_;
 ...
 /** @nodts @return {MenuList} */
 m_loading__java_util_function_Supplier__org_patternfly_component_menu_MenuList(/** Supplier<MenuItem> */ loading) {
  this.f_loading__org_patternfly_component_menu_MenuList_ = loading;
  return this;
 }
 /** @nodts @return {MenuList} */
 m_noItems__java_util_function_Supplier__org_patternfly_component_menu_MenuList(/** Supplier<MenuItem> */ noItems) {
  this.f_noItems__org_patternfly_component_menu_MenuList_ = noItems;
  return this;
 }
 /** @nodts @return {MenuList} */
 m_error__java_util_function_Supplier__org_patternfly_component_menu_MenuList(/** Supplier<MenuItem> */ error) {
  this.f_error__org_patternfly_component_menu_MenuList_ = error;
  return this;
 }
 /** @nodts @return {MenuList} */
 ...
 m_load__elemental2_promise_Promise() {
  if ($Equality.$same(this.f_status__org_patternfly_component_menu_MenuList_, AsyncStatus.f_pending__org_patternfly_core_AsyncStatus) && !$Equality.$same(this.f_asyncItems__org_patternfly_component_menu_MenuList_, null)) {
   if (!$Equality.$same(this.f_loading__org_patternfly_component_menu_MenuList_, null)) {
    this.f_loadingItem__org_patternfly_component_menu_MenuList_ = (/**@type {MenuItem}*/ ($Casts.$to(this.f_loading__org_patternfly_component_menu_MenuList_.m_get__java_lang_Object(), MenuItem)));
   ...
   return /**@type {!Promise<!Iterable<!MenuItem>>}*/ ((/**@type {!Promise<!Iterable<!MenuItem>>}*/ ((/**@type {Promise<Iterable<MenuItem>>}*/ ($Casts.$to(this.f_asyncItems__org_patternfly_component_menu_MenuList_.m_apply__java_lang_Object__java_lang_Object(this), Promise_$Overlay))).then(/**  @return {IThenable<Iterable<MenuItem>>}*/ ((/** Iterable<MenuItem> */ items) =>{
    ...
    if (count == 0 && !$Equality.$same(this.f_noItems__org_patternfly_component_menu_MenuList_, null)) {
     this.f_noItemsItem__org_patternfly_component_menu_MenuList_ = (/**@type {MenuItem}*/ ($Casts.$to(this.f_noItems__org_patternfly_component_menu_MenuList_.m_get__java_lang_Object(), MenuItem)));
   ...
   })))).catch(/**  @return {IThenable<Iterable<MenuItem>>}*/ ((/** !* */ err) =>{
    this.f_status__org_patternfly_component_menu_MenuList_ = AsyncStatus.f_rejected__org_patternfly_core_AsyncStatus;
    Elements.m_failSafeRemoveFromParent__org_jboss_elemento_IsElement__boolean(this.f_loadingItem__org_patternfly_component_menu_MenuList_);
    MenuList.f_logger__org_patternfly_component_menu_MenuList_.m_error__java_lang_String__arrayOf_java_lang_Object__void('Unable to load items for %o: %s', [/**@type {HTMLUListElement}*/ ($Casts.$to(this.m_element__elemental2_dom_HTMLElement(), $Overlay)), err]);
    if (!$Equality.$same(this.f_error__org_patternfly_component_menu_MenuList_, null)) {
     this.f_errorItem__org_patternfly_component_menu_MenuList_ = (/**@type {MenuItem}*/ ($Casts.$to(this.f_error__org_patternfly_component_menu_MenuList_.m_get__java_lang_Object(), MenuItem)));
    ...
    return /**@type {!Promise<!Iterable<!MenuItem>>}*/ (Promise.reject(err));
   })));
  } else {
 ...
 static $clinit() {
  ...
  MenuList.f_defaultLoading__org_patternfly_component_menu_MenuList_ = Supplier.$adapt(/**  @return {MenuItem}*/ (() =>{
  ...
  MenuList.f_defaultNoItems__org_patternfly_component_menu_MenuList_ = Supplier.$adapt(/**  @return {MenuItem}*/ (() =>{
  ...
  MenuList.f_defaultError__org_patternfly_component_menu_MenuList_ = Supplier.$adapt(/**  @return {MenuItem}*/ (() =>{
...
/**@type {Supplier<MenuItem>} @nodts*/
MenuList.f_defaultLoading__org_patternfly_component_menu_MenuList_;
/**@type {Supplier<MenuItem>} @nodts*/
MenuList.f_defaultNoItems__org_patternfly_component_menu_MenuList_;
/**@type {Supplier<MenuItem>} @nodts*/
MenuList.f_defaultError__org_patternfly_component_menu_MenuList_;
