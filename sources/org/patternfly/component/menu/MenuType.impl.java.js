...
class MenuType extends Enum {
 ...
 static m_valueOf__java_lang_String__org_patternfly_component_menu_MenuType(/** string */ name) {
  ...
  if ($Equality.$same(MenuType.f_namesToValuesMap__org_patternfly_component_menu_MenuType_, null)) {
   MenuType.f_namesToValuesMap__org_patternfly_component_menu_MenuType_ = (/**@type {Map<?string, !MenuType>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(MenuType.m_values__arrayOf_org_patternfly_component_menu_MenuType())));
  }
  return /**@type {MenuType}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, MenuType.f_namesToValuesMap__org_patternfly_component_menu_MenuType_));
 }
 /** @nodts @return {!Array<!MenuType>} */
 static m_values__arrayOf_org_patternfly_component_menu_MenuType() {
  MenuType.$clinit();
  return /**@type {!Array<!MenuType>}*/ ($Arrays.$stampType([MenuType.f_menu__org_patternfly_component_menu_MenuType, MenuType.f_select__org_patternfly_component_menu_MenuType, MenuType.f_checkbox__org_patternfly_component_menu_MenuType], MenuType));
 }
 /** @nodts */
 static $clinit() {
  MenuType.$clinit = () =>{};
...
/**@const {number} @nodts*/
MenuType.$ordinal_select__org_patternfly_component_menu_MenuType = 1;
/**@const {number} @nodts*/
MenuType.$ordinal_checkbox__org_patternfly_component_menu_MenuType = 2;
...
/**@const {!MenuType} @nodts*/
MenuType.f_checkbox__org_patternfly_component_menu_MenuType = /**@pureOrBreakMyCode*/ MenuType.$create__java_lang_String__int($Util.$makeEnumName('checkbox'), MenuType.$ordinal_checkbox__org_patternfly_component_menu_MenuType);
