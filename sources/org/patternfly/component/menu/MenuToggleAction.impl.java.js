 ...
 * @implements {ElementTextMethods<HTMLButtonElement, MenuToggleAction>}
 */
class MenuToggleAction extends MenuToggleSubComponent {
 ...
 static m_menuToggleAction__org_patternfly_component_menu_MenuToggleAction() {
  MenuToggleAction.$clinit();
  return MenuToggleAction.$create__();
 }
 /** @nodts @return {MenuToggleAction} */
 static m_menuToggleAction__java_lang_String__org_patternfly_component_menu_MenuToggleAction(/** ?string */ text) {
  MenuToggleAction.$clinit();
  return /**@type {MenuToggleAction}*/ ($Casts.$to(MenuToggleAction.$create__().m_text__java_lang_String__org_jboss_elemento_TypedBuilder(text), MenuToggleAction));
 }
 /** @nodts @return {!MenuToggleAction} */
 static $create__() {
  MenuToggleAction.$clinit();
  let $instance = new MenuToggleAction();
  $instance.$ctor__org_patternfly_component_menu_MenuToggleAction__void();
  return $instance;
 }
 /** @nodts */
 $ctor__org_patternfly_component_menu_MenuToggleAction__void() {
  this.$ctor__org_patternfly_component_menu_MenuToggleSubComponent__java_lang_String__java_lang_String__elemental2_dom_HTMLElement__void(MenuToggleAction.f_SUB_COMPONENT_ID__org_patternfly_component_menu_MenuToggleAction, MenuToggleAction.f_SUB_COMPONENT_NAME__org_patternfly_component_menu_MenuToggleAction, /**@type {HTMLButtonElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLButtonElement>}*/ ($Casts.$to(Elements.m_button__org_jboss_elemento_ButtonType__org_jboss_elemento_HTMLContainerBuilder(ButtonType.f_button__org_jboss_elemento_ButtonType).m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_menuToggle__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_button__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), $Overlay)));
 }
 /** @nodts @return {MenuToggleAction} */
 ...
 /** @nodts @return {MenuToggleAction} */
 m_onClick__org_patternfly_handler_ComponentHandler__org_patternfly_component_menu_MenuToggleAction(/** ComponentHandler<MenuToggleAction> */ handler) {
  return /**@type {MenuToggleAction}*/ ($Casts.$to(this.m_on__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn__org_jboss_elemento_TypedBuilder(EventType.f_click__org_jboss_elemento_EventType, (/** MouseEvent */ e) =>{
 ...
 m_text__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ arg0) {
  return /**@type {MenuToggleAction}*/ ($Casts.$to(ElementTextMethods.m_text__$default__org_jboss_elemento_ElementTextMethods__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), MenuToggleAction));
 }
 //Default method forwarding stub.
 ...
 //Default method forwarding stub.
 /** @nodts @return {MenuToggleAction} */
 m_text__java_lang_String__org_patternfly_component_menu_MenuToggleAction(/** ?string */ arg0) {
  return /**@type {MenuToggleAction}*/ ($Casts.$to(ElementTextMethods.m_text__$default__org_jboss_elemento_ElementTextMethods__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), MenuToggleAction));
 }
 /** @nodts */
 static $clinit() {
...
/**@const {string} @nodts*/
MenuToggleAction.f_SUB_COMPONENT_ID__org_patternfly_component_menu_MenuToggleAction = 'mta';
/**@const {string} @nodts*/
MenuToggleAction.f_SUB_COMPONENT_NAME__org_patternfly_component_menu_MenuToggleAction = 'MenuToggleAction';
Disabled.$markImplementor(MenuToggleAction);
ElementTextMethods.$markImplementor(MenuToggleAction);
