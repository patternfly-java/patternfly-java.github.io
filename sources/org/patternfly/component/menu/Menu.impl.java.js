...
class Menu extends BaseComponent {
 ...
 /** @nodts @return {Menu} */
 m_error__java_util_function_Supplier__org_patternfly_component_menu_Menu(/** Supplier<MenuItem> */ error) {
  this.m_doForAllMenuLists__java_util_function_Consumer__void_$p_org_patternfly_component_menu_Menu(Consumer.$adapt((/** MenuList */ list) =>{
   let list_1 = /**@type {MenuList}*/ ($Casts.$to(list, MenuList));
   list_1.m_error__java_util_function_Supplier__org_patternfly_component_menu_MenuList(error);
  }));
  return this;
 }
 /** @nodts @return {Menu} */
 m_loading__java_util_function_Supplier__org_patternfly_component_menu_Menu(/** Supplier<MenuItem> */ loading) {
  this.m_doForAllMenuLists__java_util_function_Consumer__void_$p_org_patternfly_component_menu_Menu(Consumer.$adapt((/** MenuList */ list) =>{
   let list_1 = /**@type {MenuList}*/ ($Casts.$to(list, MenuList));
   list_1.m_loading__java_util_function_Supplier__org_patternfly_component_menu_MenuList(loading);
  }));
  return this;
 }
 /** @nodts @return {Menu} */
 m_noItems__java_util_function_Supplier__org_patternfly_component_menu_Menu(/** Supplier<MenuItem> */ noItems) {
  this.m_doForAllMenuLists__java_util_function_Consumer__void_$p_org_patternfly_component_menu_Menu(Consumer.$adapt((/** MenuList */ list) =>{
   let list_1 = /**@type {MenuList}*/ ($Casts.$to(list, MenuList));
   list_1.m_noItems__java_util_function_Supplier__org_patternfly_component_menu_MenuList(noItems);
  }));
  return this;
 }
 /** @nodts @return {Menu} */
 ...
 /** @nodts */
 m_cursorNavigation__elemental2_dom_Event__void(/** Event */ event) {
  let arrowUp = Key.f_ArrowUp__org_jboss_elemento_Key.m_match__elemental2_dom_Event__boolean(event);
  let arrowDown = Key.f_ArrowDown__org_jboss_elemento_Key.m_match__elemental2_dom_Event__boolean(event);
  if (arrowUp || arrowDown) {
   ...
   if (navigableElements.length > 0) {
    let target = this.m_getFocusableElement__elemental2_dom_HTMLElement__elemental2_dom_HTMLElement_$p_org_patternfly_component_menu_Menu(/**@type {HTMLElement}*/ ($Casts.$to(navigableElements.at(arrowDown ? 0 : navigableElements.length - 1 | 0), HTMLElement_$Overlay)));
 ...
 /** @nodts */
 m_reset__void() {
  this.m_doForAllMenuLists__java_util_function_Consumer__void_$p_org_patternfly_component_menu_Menu(Consumer.$adapt((/** MenuList */ arg0) =>{
   let arg0_1 = /**@type {MenuList}*/ ($Casts.$to(arg0, MenuList));
 ...
 /** @nodts @return {List<MenuItem>} */
 m_search__org_patternfly_component_menu_SearchFilter__org_patternfly_component_menu_NoResults__java_lang_String__java_util_List(/** SearchFilter */ searchFilter, /** NoResults */ noResults, /** ?string */ value) {
  if (this.m_hasAsyncItems__boolean()) {
   return /**@type {List<MenuItem>}*/ (Collections.m_emptyList__java_util_List());
  }
  let visibleItems = /**@type {!ArrayList<MenuItem>}*/ (ArrayList.$create__());
  for (let $iterator = this.m_items__java_util_List().m_iterator__java_util_Iterator(); $iterator.m_hasNext__boolean(); ) {
   let menuItem = /**@type {MenuItem}*/ ($Casts.$to($iterator.m_next__java_lang_Object(), MenuItem));
   {
    let visible = searchFilter.m_test__java_lang_Object__java_lang_Object__boolean(menuItem, value);
    menuItem.m_classList__org_jboss_elemento_ClassList().m_toggle__java_lang_String__boolean__void(Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_filtered__org_patternfly_style_Classes), !visible);
    if (visible) {
  ...
  if (visibleItems.isEmpty()) {
   if (!$Equality.$same(this.f_content__org_patternfly_component_menu_Menu, null) && !$Equality.$same(this.f_content__org_patternfly_component_menu_Menu.f_list__org_patternfly_component_menu_MenuContent, null)) {
    if (!$Equality.$same(noResults, null)) {
 ...
 m_clearSearch__void() {
  ...
  for (let $iterator = this.m_items__java_util_List().m_iterator__java_util_Iterator(); $iterator.m_hasNext__boolean(); ) {
   let menuItem = /**@type {MenuItem}*/ ($Casts.$to($iterator.m_next__java_lang_Object(), MenuItem));
   {
    menuItem.m_classList__org_jboss_elemento_ClassList().m_remove__arrayOf_java_lang_String__void(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_filtered__org_patternfly_style_Classes)], j_l_String)));
   }
  }
  this.m_allowTabFirstItem__void();
 }
 ...
 /** @nodts */
 m_doForAllMenuLists__java_util_function_Consumer__void_$p_org_patternfly_component_menu_Menu(/** Consumer<MenuList> */ consumer) {
  if (!$Equality.$same(this.f_content__org_patternfly_component_menu_Menu, null)) {
   for (let $iterator = this.f_content__org_patternfly_component_menu_Menu.f_groups__org_patternfly_component_menu_MenuContent.m_iterator__java_util_Iterator(); $iterator.m_hasNext__boolean(); ) {
    let group = /**@type {MenuGroup}*/ ($Casts.$to($iterator.m_next__java_lang_Object(), MenuGroup));
    {
     if (!$Equality.$same(group.f_list__org_patternfly_component_menu_MenuGroup, null)) {
      consumer.m_accept__java_lang_Object__void(group.f_list__org_patternfly_component_menu_MenuGroup);
     }
    }
   }
   if (!$Equality.$same(this.f_content__org_patternfly_component_menu_Menu.f_list__org_patternfly_component_menu_MenuContent, null)) {
    consumer.m_accept__java_lang_Object__void(this.f_content__org_patternfly_component_menu_Menu.f_list__org_patternfly_component_menu_MenuContent);
   }
  }
 }
 /** @nodts */
 ...
 m_navigableElement__elemental2_dom_HTMLElement__elemental2_core_JsArray_$p_org_patternfly_component_menu_Menu(/** HTMLElement */ element) {
  ...
  return elements.filter(/**  @return {*}*/ ((/** HTMLElement */ e, /** number */ i) =>{
   ...
   return !e_1.classList.contains(Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_filtered__org_patternfly_style_Classes)) && !e_1.classList.contains(Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_disabled__org_patternfly_style_Classes)) && !e_1.classList.contains(Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_divider__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$create([0], j_l_String))));
  }));
 }
