...
class ComponentRegistry extends j_l_Object {
 ...
 /** @nodts */
 m_registerSubComponent__org_patternfly_component_SubComponent__void(/** SubComponent<?, ?> */ subComponent) {
  this.f_subComponents__org_patternfly_component_ComponentRegistry_.put(this.m_subComponentKey__org_patternfly_component_ComponentType__java_lang_String__java_lang_String_$p_org_patternfly_component_ComponentRegistry(subComponent.f_componentType__org_patternfly_component_SubComponent, subComponent.f_subComponentId__org_patternfly_component_SubComponent), subComponent);
 }
 ...
 /** @nodts @template C, E, B @return {C} */
 m_lookupSubComponent__org_patternfly_component_ComponentType__java_lang_String__org_patternfly_component_SubComponent(/** ComponentType */ type, /** ?string */ id) {
  return /**@type {?C}*/ ($Casts.$to(this.f_subComponents__org_patternfly_component_ComponentRegistry_.get(this.m_subComponentKey__org_patternfly_component_ComponentType__java_lang_String__java_lang_String_$p_org_patternfly_component_ComponentRegistry(type, id)), SubComponent));
 }
 /** @nodts @return {?string} */
 m_subComponentKey__org_patternfly_component_ComponentType__java_lang_String__java_lang_String_$p_org_patternfly_component_ComponentRegistry(/** ComponentType */ componentType, /** ?string */ id) {
  return j_l_String.m_valueOf__java_lang_Object__java_lang_String(componentType.f_id__org_patternfly_component_ComponentType) + j_l_String.m_valueOf__java_lang_Object__java_lang_String(id);
 }
 /** @nodts */
 static $clinit() {
  ComponentRegistry.$clinit = () =>{};
