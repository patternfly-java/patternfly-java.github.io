...
class DividerType extends Enum {
 ...
 static m_valueOf__java_lang_String__org_patternfly_component_divider_DividerType(/** string */ name) {
  ...
  if ($Equality.$same(DividerType.f_namesToValuesMap__org_patternfly_component_divider_DividerType_, null)) {
   DividerType.f_namesToValuesMap__org_patternfly_component_divider_DividerType_ = (/**@type {Map<?string, !DividerType>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(DividerType.m_values__arrayOf_org_patternfly_component_divider_DividerType())));
  }
  return /**@type {DividerType}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, DividerType.f_namesToValuesMap__org_patternfly_component_divider_DividerType_));
 }
 /** @nodts @return {!Array<!DividerType>} */
 static m_values__arrayOf_org_patternfly_component_divider_DividerType() {
  DividerType.$clinit();
  return /**@type {!Array<!DividerType>}*/ ($Arrays.$stampType([DividerType.f_li__org_patternfly_component_divider_DividerType, DividerType.f_hr__org_patternfly_component_divider_DividerType, DividerType.f_div__org_patternfly_component_divider_DividerType], DividerType));
 }
 /** @nodts */
 static $clinit() {
  DividerType.$clinit = () =>{};
