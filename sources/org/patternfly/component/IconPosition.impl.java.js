...
class IconPosition extends Enum {
 ...
 static m_valueOf__java_lang_String__org_patternfly_component_IconPosition(/** string */ name) {
  ...
  if ($Equality.$same(IconPosition.f_namesToValuesMap__org_patternfly_component_IconPosition_, null)) {
   IconPosition.f_namesToValuesMap__org_patternfly_component_IconPosition_ = (/**@type {Map<?string, !IconPosition>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(IconPosition.m_values__arrayOf_org_patternfly_component_IconPosition())));
  }
  return /**@type {IconPosition}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, IconPosition.f_namesToValuesMap__org_patternfly_component_IconPosition_));
 }
 /** @nodts @return {!Array<!IconPosition>} */
 static m_values__arrayOf_org_patternfly_component_IconPosition() {
  IconPosition.$clinit();
  return /**@type {!Array<!IconPosition>}*/ ($Arrays.$stampType([IconPosition.$static_start__org_patternfly_component_IconPosition, IconPosition.$static_end__org_patternfly_component_IconPosition], IconPosition));
 }
 /** @nodts @return {!IconPosition} */
