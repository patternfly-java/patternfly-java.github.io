...
class TextAreaResize extends Enum {
 ...
 static m_valueOf__java_lang_String__org_patternfly_component_form_TextAreaResize(/** string */ name) {
  ...
  if ($Equality.$same(TextAreaResize.f_namesToValuesMap__org_patternfly_component_form_TextAreaResize_, null)) {
   TextAreaResize.f_namesToValuesMap__org_patternfly_component_form_TextAreaResize_ = (/**@type {Map<?string, !TextAreaResize>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(TextAreaResize.m_values__arrayOf_org_patternfly_component_form_TextAreaResize())));
  }
  return /**@type {TextAreaResize}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, TextAreaResize.f_namesToValuesMap__org_patternfly_component_form_TextAreaResize_));
 }
 /** @nodts @return {!Array<!TextAreaResize>} */
 static m_values__arrayOf_org_patternfly_component_form_TextAreaResize() {
  TextAreaResize.$clinit();
  return /**@type {!Array<!TextAreaResize>}*/ ($Arrays.$stampType([TextAreaResize.$static_both__org_patternfly_component_form_TextAreaResize, TextAreaResize.$static_horizontal__org_patternfly_component_form_TextAreaResize, TextAreaResize.$static_vertical__org_patternfly_component_form_TextAreaResize], TextAreaResize));
 }
 /** @nodts @return {!TextAreaResize} */
