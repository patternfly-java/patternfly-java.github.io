...
class FormSelectOption extends FormSelectSubComponent {
 ...
 static m_formSelectOption__java_lang_String__org_patternfly_component_form_FormSelectOption(/** ?string */ label) {
  ...
  return FormSelectOption.$create__java_lang_String__java_lang_String(label, Id.m_build__java_lang_String__arrayOf_java_lang_String__java_lang_String(label, /**@type {!Array<?string>}*/ ($Arrays.$create([0], j_l_String))));
 }
 /** @nodts @return {FormSelectOption} */
 ...
 $ctor__org_patternfly_component_form_FormSelectOption__java_lang_String__java_lang_String__void(/** ?string */ label, /** ?string */ value) {
  this.$ctor__org_patternfly_component_form_FormSelectSubComponent__java_lang_String__java_lang_String__elemental2_dom_HTMLElement__void(FormSelectOption.f_SUB_COMPONENT_ID__org_patternfly_component_form_FormSelectOption, FormSelectOption.f_SUB_COMPONENT_NAME__org_patternfly_component_form_FormSelectOption, /**@type {HTMLOptionElement}*/ ($Casts.$to((/**@type {HTMLElementBuilder<HTMLOptionElement>}*/ ($Casts.$to(Elements.m_option__org_jboss_elemento_HTMLElementBuilder().m_apply__java_util_function_Consumer__org_jboss_elemento_TypedBuilder(Consumer.$adapt((/** HTMLOptionElement */ o) =>{
 ...
 m_placeholder__boolean__boolean__org_patternfly_component_form_FormSelectOption(/** boolean */ placeholder, /** boolean */ selectable) {
  if (placeholder) {
   this.m_data__java_lang_String__org_jboss_elemento_TypedBuilder(Dataset.f_placeholder__org_patternfly_core_Dataset);
  }
  if (!selectable) {
...
/**@const {string} @nodts*/
FormSelectOption.f_SUB_COMPONENT_ID__org_patternfly_component_form_FormSelectOption = 'fso';
/**@const {string} @nodts*/
FormSelectOption.f_SUB_COMPONENT_NAME__org_patternfly_component_form_FormSelectOption = 'FormSelectOption';
