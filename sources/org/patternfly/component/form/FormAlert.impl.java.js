...
class FormAlert extends FormSubComponent {
 ...
 $ctor__org_patternfly_component_form_FormAlert__void() {
  this.$ctor__org_patternfly_component_form_FormSubComponent__java_lang_String__java_lang_String__elemental2_dom_HTMLElement__void(FormAlert.f_SUB_COMPONENT_ID__org_patternfly_component_form_FormAlert, FormAlert.f_SUB_COMPONENT_NAME__org_patternfly_component_form_FormAlert, /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_form__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_alert__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), $Overlay)));
 }
 /** @nodts @return {FormAlert} */
...
/**@const {string} @nodts*/
FormAlert.f_SUB_COMPONENT_ID__org_patternfly_component_form_FormAlert = 'fa';
/**@const {string} @nodts*/
FormAlert.f_SUB_COMPONENT_NAME__org_patternfly_component_form_FormAlert = 'FormAlert';
