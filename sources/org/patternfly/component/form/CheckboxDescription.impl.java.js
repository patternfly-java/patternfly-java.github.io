...
class CheckboxDescription extends CheckboxSubComponent {
 ...
 $ctor__org_patternfly_component_form_CheckboxDescription__java_lang_String__void(/** ?string */ description) {
  this.$ctor__org_patternfly_component_form_CheckboxSubComponent__java_lang_String__java_lang_String__elemental2_dom_HTMLElement__void(CheckboxDescription.f_SUB_COMPONENT_ID__org_patternfly_component_form_CheckboxDescription, CheckboxDescription.f_SUB_COMPONENT_NAME__org_patternfly_component_form_CheckboxDescription, (/**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to(Elements.m_span__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_check__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_description__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement());
 ...
 m_text__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ arg0) {
  return /**@type {CheckboxDescription}*/ ($Casts.$to(ElementTextMethods.m_text__$default__org_jboss_elemento_ElementTextMethods__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), CheckboxDescription));
 }
 ...
 //Default method forwarding stub.
 /** @nodts @return {CheckboxDescription} */
 m_text__java_lang_String__org_patternfly_component_form_CheckboxDescription(/** ?string */ arg0) {
  return /**@type {CheckboxDescription}*/ ($Casts.$to(ElementTextMethods.m_text__$default__org_jboss_elemento_ElementTextMethods__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), CheckboxDescription));
 }
 /** @nodts */
 static $clinit() {
...
/**@const {string} @nodts*/
CheckboxDescription.f_SUB_COMPONENT_ID__org_patternfly_component_form_CheckboxDescription = 'cbd';
/**@const {string} @nodts*/
CheckboxDescription.f_SUB_COMPONENT_NAME__org_patternfly_component_form_CheckboxDescription = 'CheckboxDescription';
ElementTextMethods.$markImplementor(CheckboxDescription);
