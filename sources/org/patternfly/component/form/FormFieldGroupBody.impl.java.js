...
/**@const {string} @nodts*/
FormFieldGroupBody.f_SUB_COMPONENT_ID__org_patternfly_component_form_FormFieldGroupBody = 'ffgb';
/**@const {string} @nodts*/
FormFieldGroupBody.f_SUB_COMPONENT_NAME__org_patternfly_component_form_FormFieldGroupBody = 'FormFieldGroupBody';
