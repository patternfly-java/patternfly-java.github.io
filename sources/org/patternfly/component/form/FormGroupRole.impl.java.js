...
class FormGroupRole extends Enum {
 ...
 static m_valueOf__java_lang_String__org_patternfly_component_form_FormGroupRole(/** string */ name) {
  ...
  if ($Equality.$same(FormGroupRole.f_namesToValuesMap__org_patternfly_component_form_FormGroupRole_, null)) {
   FormGroupRole.f_namesToValuesMap__org_patternfly_component_form_FormGroupRole_ = (/**@type {Map<?string, !FormGroupRole>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(FormGroupRole.m_values__arrayOf_org_patternfly_component_form_FormGroupRole())));
  }
  return /**@type {FormGroupRole}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, FormGroupRole.f_namesToValuesMap__org_patternfly_component_form_FormGroupRole_));
 }
 /** @nodts @return {!Array<!FormGroupRole>} */
 static m_values__arrayOf_org_patternfly_component_form_FormGroupRole() {
  FormGroupRole.$clinit();
  return /**@type {!Array<!FormGroupRole>}*/ ($Arrays.$stampType([FormGroupRole.f_radiogroup__org_patternfly_component_form_FormGroupRole, FormGroupRole.f_group__org_patternfly_component_form_FormGroupRole], FormGroupRole));
 }
 /** @nodts */
 static $clinit() {
  FormGroupRole.$clinit = () =>{};
