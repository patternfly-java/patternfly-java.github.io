...
class CheckboxBody extends CheckboxSubComponent {
 ...
 m_text__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ arg0) {
  return /**@type {CheckboxBody}*/ ($Casts.$to(ElementTextMethods.m_text__$default__org_jboss_elemento_ElementTextMethods__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), CheckboxBody));
 }
 ...
 //Default method forwarding stub.
 /** @nodts @return {CheckboxBody} */
 m_text__java_lang_String__org_patternfly_component_form_CheckboxBody(/** ?string */ arg0) {
  return /**@type {CheckboxBody}*/ ($Casts.$to(ElementTextMethods.m_text__$default__org_jboss_elemento_ElementTextMethods__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), CheckboxBody));
 }
 /** @nodts */
 static $clinit() {
...
/**@const {string} @nodts*/
CheckboxBody.f_SUB_COMPONENT_ID__org_patternfly_component_form_CheckboxBody = 'cbb';
/**@const {string} @nodts*/
CheckboxBody.f_SUB_COMPONENT_NAME__org_patternfly_component_form_CheckboxBody = 'CheckboxBody';
ElementTextMethods.$markImplementor(CheckboxBody);
