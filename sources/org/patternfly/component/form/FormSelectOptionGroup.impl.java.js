...
/**@const {string} @nodts*/
FormSelectOptionGroup.f_SUB_COMPONENT_ID__org_patternfly_component_form_FormSelectOptionGroup = 'fsog';
/**@const {string} @nodts*/
FormSelectOptionGroup.f_SUB_COMPONENT_NAME__org_patternfly_component_form_FormSelectOptionGroup = 'FormSelectOptionGroup';
