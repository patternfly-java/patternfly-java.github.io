...
class FormFieldGroup extends FormSubComponent {
 ...
 $ctor__org_patternfly_component_form_FormFieldGroup__boolean__void(/** boolean */ expandable) {
  this.$ctor__org_patternfly_component_form_FormSubComponent__java_lang_String__java_lang_String__elemental2_dom_HTMLElement__void(FormFieldGroup.f_SUB_COMPONENT_ID__org_patternfly_component_form_FormFieldGroup, FormFieldGroup.f_SUB_COMPONENT_NAME__org_patternfly_component_form_FormFieldGroup, /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_form__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_fieldGroup__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_attr__java_lang_String__java_lang_String__org_jboss_elemento_TypedBuilder(Attributes.f_role__org_patternfly_core_Attributes, Roles.f_group__org_patternfly_core_Roles), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), $Overlay)));
  this.f_titleId__org_patternfly_component_form_FormFieldGroup_ = Id.m_unique__java_lang_String__arrayOf_java_lang_String__java_lang_String(ComponentType.f_Form__org_patternfly_component_ComponentType.f_id__org_patternfly_component_ComponentType, /**@type {!Array<?string>}*/ ($Arrays.$stampType([FormFieldGroup.f_SUB_COMPONENT_ID__org_patternfly_component_form_FormFieldGroup, 'title'], j_l_String)));
  this.f_expandable__org_patternfly_component_form_FormFieldGroup_ = expandable;
 ...
 m_collapse__boolean__void(/** boolean */ fireEvent) {
  if (!this.f_expandable__org_patternfly_component_form_FormFieldGroup_) {
   FormFieldGroup.f_logger__org_patternfly_component_form_FormFieldGroup_.m_warn__java_lang_String__arrayOf_java_lang_Object__void('Form field group %o is not expandable. Please use FormFieldGroup.expandable() to make this an expandable field group.', [this.m_element__elemental2_dom_HTMLElement()]);
   return;
  }
 ...
 static $clinit() {
  ...
  Expandable.$clinit();
  Attachable.$clinit();
  FormFieldGroup.f_logger__org_patternfly_component_form_FormFieldGroup_ = Logger.m_getLogger__java_lang_String__org_jboss_elemento_logger_Logger(Class.$get(FormFieldGroup).m_getName__java_lang_String());
 }
...
/**@type {Logger} @nodts*/
FormFieldGroup.f_logger__org_patternfly_component_form_FormFieldGroup_;
/**@const {string} @nodts*/
FormFieldGroup.f_SUB_COMPONENT_ID__org_patternfly_component_form_FormFieldGroup = 'ffg';
/**@const {string} @nodts*/
FormFieldGroup.f_SUB_COMPONENT_NAME__org_patternfly_component_form_FormFieldGroup = 'FormFieldGroup';
