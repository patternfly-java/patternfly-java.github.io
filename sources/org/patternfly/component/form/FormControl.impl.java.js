...
class FormControl extends BaseComponent {
 ...
 static m_formControlContainer__org_jboss_elemento_HTMLContainerBuilder() {
  FormControl.$clinit();
  return /**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to(Elements.m_span__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_formControl__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$create([0], j_l_String)))], j_l_String))), HTMLContainerBuilder));
 }
 /** @nodts */
 ...
 m_disabled__boolean__org_patternfly_component_BaseComponent(/** boolean */ disabled) {
  this.m_disableControl__boolean__void_$pp_org_patternfly_component_form(disabled);
 ...
 m_validated__org_patternfly_component_ValidationStatus__org_patternfly_component_BaseComponent(/** ValidationStatus */ status) {
  if (!$Equality.$same(status, this.f_status__org_patternfly_component_form_FormControl)) {
   if (!$Equality.$same(this.f_status__org_patternfly_component_form_FormControl, null)) {
    ...
    if (!$Equality.$same(this.f_status__org_patternfly_component_form_FormControl.m_icon__org_patternfly_icon_PredefinedIcon(), null)) {
   ...
   if (!$Equality.$same(status, ValidationStatus.f_default___org_patternfly_component_ValidationStatus) && !$Equality.$same(status.m_icon__org_patternfly_icon_PredefinedIcon(), null)) {
    this.m_failSafeValidatedContainer__elemental2_dom_HTMLElement_$pp_org_patternfly_component_form().appendChild(status.m_icon__org_patternfly_icon_PredefinedIcon().m_element__org_jboss_elemento_svg_SVGElement());
   }
  }
 ...
 m_failSafeUtilitiesContainer__elemental2_dom_HTMLElement_$pp_org_patternfly_component_form() {
  if ($Equality.$same(this.f_utilitiesContainer__org_patternfly_component_form_FormControl, null)) {
   this.m_add__elemental2_dom_Node__org_jboss_elemento_TypedBuilder(this.f_utilitiesContainer__org_patternfly_component_form_FormControl = (/**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to(Elements.m_span__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_formControl__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_utilities__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement());
  }
 ...
 m_validated__org_patternfly_component_ValidationStatus__org_jboss_elemento_TypedBuilder(/** ValidationStatus */ arg0) {
  return this.m_validated__org_patternfly_component_ValidationStatus__org_patternfly_component_BaseComponent(arg0);
 }
 //Default method forwarding stub.
 /** @nodts @return {B} */
...
Validatable.$markImplementor(FormControl);
