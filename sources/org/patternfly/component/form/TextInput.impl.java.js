 ...
 * @implements {ComponentIcon<HTMLElement, TextInput>}
...
class TextInput extends FormControl {
 ...
 constructor() {
  ...
  /**@type {KicHandler<TextInput>} @nodts*/
  this.f_kicHandler__org_patternfly_component_form_TextInput_;
 ...
 $ctor__org_patternfly_component_form_TextInput__org_patternfly_component_form_TextInputType__java_lang_String__java_lang_String__void(/** TextInputType */ type, /** ?string */ id, /** ?string */ value) {
  this.$ctor__org_patternfly_component_form_FormControl__java_lang_String__elemental2_dom_HTMLElement__org_patternfly_component_ComponentType__void(id, (/**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to(FormControl.m_formControlContainer__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {HTMLInputElementBuilder<HTMLInputElement>}*/ ($Casts.$to((/**@type {HTMLInputElementBuilder<HTMLInputElement>}*/ ($Casts.$to((/**@type {HTMLInputElementBuilder<HTMLInputElement>}*/ ($Casts.$to(Elements.m_input__org_jboss_elemento_InputType__org_jboss_elemento_HTMLInputElementBuilder(/**@type {InputType}*/ ($Casts.$to(TextInput.f_typeMapping__org_patternfly_component_form_TextInput_.getOrDefault(type, InputType.f_text__org_jboss_elemento_InputType), InputType))).m_id__java_lang_String__org_jboss_elemento_TypedBuilder(id), HTMLInputElementBuilder))).m_name__java_lang_String__org_jboss_elemento_TypedBuilder(id), HTMLInputElementBuilder))).m_aria__java_lang_String__boolean__org_jboss_elemento_TypedBuilder(Aria.f_invalid__org_patternfly_core_Aria, false), HTMLInputElementBuilder))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), ComponentType.f_TextInput__org_patternfly_component_ComponentType);
  ...
  this.f_kicHandler__org_patternfly_component_form_TextInput_ = (/**@type {!KicHandler<TextInput>}*/ (KicHandler.$create__org_patternfly_component_BaseComponent__elemental2_dom_HTMLInputElement(this, this.f_inputElement__org_patternfly_component_form_TextInput_)));
  if (!$Equality.$same(value, null)) {
   this.m_value__java_lang_String__org_patternfly_component_form_TextInput(value);
  }
 }
 /** @nodts @return {TextInput} */
 m_applyTo__java_util_function_Consumer__org_patternfly_component_form_TextInput(/** Consumer<HTMLInputElementBuilder<HTMLInputElement>> */ input) {
  input.m_accept__java_lang_Object__void(/**@type {HTMLInputElementBuilder<HTMLInputElement>}*/ (Elements.m_wrapInputElement__elemental2_dom_HTMLInputElement__org_jboss_elemento_HTMLInputElementBuilder(this.f_inputElement__org_patternfly_component_form_TextInput_)));
  return this;
 }
 /** @nodts @return {TextInput} */
 ...
 m_value__java_lang_String__boolean__org_patternfly_component_form_TextInput(/** ?string */ value, /** boolean */ fireEvent) {
  ...
  if (fireEvent) {
   this.f_kicHandler__org_patternfly_component_form_TextInput_.m_fireIfChanged__java_lang_String__void(value);
  }
  return this;
 }
 /** @nodts @return {TextInput} */
 ...
 /** @nodts @return {TextInput} */
 m_onKeydown__org_patternfly_handler_ChangeHandler__org_patternfly_component_form_TextInput(/** ChangeHandler<TextInput, ?string> */ changeHandler) {
  return /**@type {TextInput}*/ ($Casts.$to(this.f_kicHandler__org_patternfly_component_form_TextInput_.m_onKeydown__org_patternfly_handler_ChangeHandler__org_patternfly_component_BaseComponent(changeHandler), TextInput));
 }
 /** @nodts @return {TextInput} */
 m_onKeyup__org_patternfly_handler_ChangeHandler__org_patternfly_component_form_TextInput(/** ChangeHandler<TextInput, ?string> */ changeHandler) {
  return /**@type {TextInput}*/ ($Casts.$to(this.f_kicHandler__org_patternfly_component_form_TextInput_.m_onKeyup__org_patternfly_handler_ChangeHandler__org_patternfly_component_BaseComponent(changeHandler), TextInput));
 }
 /** @nodts @return {TextInput} */
 m_onInput__org_patternfly_handler_ChangeHandler__org_patternfly_component_form_TextInput(/** ChangeHandler<TextInput, ?string> */ changeHandler) {
  return /**@type {TextInput}*/ ($Casts.$to(this.f_kicHandler__org_patternfly_component_form_TextInput_.m_onInput__org_patternfly_handler_ChangeHandler__org_patternfly_component_BaseComponent(changeHandler), TextInput));
 }
 /** @nodts @return {TextInput} */
 m_onChange__org_patternfly_handler_ChangeHandler__org_patternfly_component_form_TextInput(/** ChangeHandler<TextInput, ?string> */ changeHandler) {
  return /**@type {TextInput}*/ ($Casts.$to(this.f_kicHandler__org_patternfly_component_form_TextInput_.m_onChange__org_patternfly_handler_ChangeHandler__org_patternfly_component_BaseComponent(changeHandler), TextInput));
 }
 /** @nodts @return {?string} */
 ...
 m_input__org_jboss_elemento_HTMLInputElementBuilder() {
  return /**@type {HTMLInputElementBuilder<HTMLInputElement>}*/ (Elements.m_wrapInputElement__elemental2_dom_HTMLInputElement__org_jboss_elemento_HTMLInputElementBuilder(this.f_inputElement__org_patternfly_component_form_TextInput_));
 }
 /** @override @nodts */
 ...
 m_icon__org_patternfly_icon_PredefinedIcon__org_jboss_elemento_TypedBuilder(/** PredefinedIcon */ arg0) {
  return /**@type {TextInput}*/ ($Casts.$to(ComponentIcon.m_icon__$default__org_patternfly_component_ComponentIcon__org_patternfly_icon_PredefinedIcon__org_jboss_elemento_TypedBuilder(this, arg0), TextInput));
 }
 //Bridge method.
 /** @final @override @nodts @return {TextInput} */
 ...
 static $clinit() {
  ...
  TextInput.f_typeMapping__org_patternfly_component_form_TextInput_.put(TextInputType.f_password__org_patternfly_component_form_TextInputType, InputType.f_password__org_jboss_elemento_InputType);
 }
...
ComponentIcon.$markImplementor(TextInput);
