...
class FormSelect extends FormControl {
 ...
 constructor() {
  ...
  /**@type {List<ChangeHandler<FormSelect, ?string>>} @nodts*/
  this.f_changeHandlers__org_patternfly_component_form_FormSelect_;
  /**@type {?string} @nodts*/
 ...
 $ctor__org_patternfly_component_form_FormSelect__java_lang_String__java_lang_String__void(/** ?string */ id, /** ?string */ value) {
  this.$ctor__org_patternfly_component_form_FormControl__java_lang_String__elemental2_dom_HTMLElement__org_patternfly_component_ComponentType__void(id, (/**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to(FormControl.m_formControlContainer__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {HTMLSelectElementBuilder<HTMLSelectElement>}*/ ($Casts.$to((/**@type {HTMLSelectElementBuilder<HTMLSelectElement>}*/ ($Casts.$to((/**@type {HTMLSelectElementBuilder<HTMLSelectElement>}*/ ($Casts.$to(Elements.m_select__org_jboss_elemento_HTMLSelectElementBuilder().m_id__java_lang_String__org_jboss_elemento_TypedBuilder(id), HTMLSelectElementBuilder))).m_apply__java_util_function_Consumer__org_jboss_elemento_TypedBuilder(Consumer.$adapt((/** HTMLSelectElement */ s) =>{
   let s_1 = /**@type {HTMLSelectElement}*/ ($Casts.$to(s, $Overlay));
   s_1.name = id;
  })), HTMLSelectElementBuilder))).m_aria__java_lang_String__boolean__org_jboss_elemento_TypedBuilder(Aria.f_invalid__org_patternfly_core_Aria, false), HTMLSelectElementBuilder))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), ComponentType.f_FormSelect__org_patternfly_component_ComponentType);
  this.m_failSafeUtilitiesContainer__elemental2_dom_HTMLElement_$pp_org_patternfly_component_form().appendChild((/**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to(Elements.m_span__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_formControl__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_toggle__org_patternfly_style_Classes, Classes.f_icon__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(rhUi.m_caretDown__org_patternfly_icon_PredefinedIcon()), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement());
  this.f_changeHandlers__org_patternfly_component_form_FormSelect_ = (/**@type {!ArrayList<ChangeHandler<FormSelect, ?string>>}*/ (ArrayList.$create__()));
  ...
  this.f_selectElement__org_patternfly_component_form_FormSelect_.addEventListener(EventType.f_input__org_jboss_elemento_EventType.f_name__org_jboss_elemento_EventType, EventListener_$Overlay.$adapt__elemental2_dom_EventListener_$JsFunction__elemental2_dom_EventListener((/** Event */ e) =>{
   this.f_changeHandlers__org_patternfly_component_form_FormSelect_.m_forEach__java_util_function_Consumer__void(Consumer.$adapt((/** ChangeHandler<FormSelect, ?string> */ ch) =>{
    let ch_1 = /**@type {ChangeHandler<FormSelect, ?string>}*/ ($Casts.$to(ch, /**@type {Function}*/ (ChangeHandler)));
    ch_1.m_onChange__elemental2_dom_Event__java_lang_Object__java_lang_Object__void(e, this, this.f_selectElement__org_patternfly_component_form_FormSelect_.value);
   }));
  }));
 ...
 /** @nodts @return {FormSelect} */
 m_applyTo__java_util_function_Consumer__org_patternfly_component_form_FormSelect(/** Consumer<HTMLSelectElementBuilder<HTMLSelectElement>> */ select) {
  select.m_accept__java_lang_Object__void(this.m_selectElement__org_jboss_elemento_HTMLSelectElementBuilder());
  return this;
 }
 ...
 m_value__java_lang_String__boolean__org_patternfly_component_form_FormSelect(/** ?string */ value, /** boolean */ fireEvent) {
  ...
  if (fireEvent) {
   ChangeHandler.m_fireIfChanged__java_lang_Object__java_lang_Object__java_lang_Object__java_util_List__void(this, value, this.f_selectElement__org_patternfly_component_form_FormSelect_.value, this.f_changeHandlers__org_patternfly_component_form_FormSelect_);
  }
  return this;
 }
 /** @nodts */
 m_selectFirstValue__void() {
  if (this.f_selectElement__org_patternfly_component_form_FormSelect_.options.length > 0) {
   let firstValue = (/**@type {HTMLOptionElement}*/ ($Casts.$to(JsArrayLike_$Overlay.m_getAt__$devirt__jsinterop_base_JsArrayLike__int__java_lang_Object(this.f_selectElement__org_patternfly_component_form_FormSelect_.options, 0), HTMLOptionElement_$Overlay))).value;
   this.m_value__java_lang_String__org_patternfly_component_form_FormSelect(firstValue);
  }
 }
 /** @nodts */
 m_selectFirstValue__boolean__void(/** boolean */ fireEvent) {
  if (this.f_selectElement__org_patternfly_component_form_FormSelect_.options.length > 0) {
   let firstValue = (/**@type {HTMLOptionElement}*/ ($Casts.$to(JsArrayLike_$Overlay.m_getAt__$devirt__jsinterop_base_JsArrayLike__int__java_lang_Object(this.f_selectElement__org_patternfly_component_form_FormSelect_.options, 0), HTMLOptionElement_$Overlay))).value;
   this.m_value__java_lang_String__boolean__org_patternfly_component_form_FormSelect(firstValue, fireEvent);
  }
 }
 /** @nodts @return {FormSelect} */
 ...
 m_onChange__org_patternfly_handler_ChangeHandler__org_patternfly_component_form_FormSelect(/** ChangeHandler<FormSelect, ?string> */ changeHandler) {
  this.f_changeHandlers__org_patternfly_component_form_FormSelect_.add(changeHandler);
  return this;
 }
 /** @nodts @return {?string} */
 ...
 m_containsValue__java_lang_String__boolean(/** ?string */ value) {
  for (let i = 0; i < this.f_selectElement__org_patternfly_component_form_FormSelect_.options.length; i = i + 1 | 0) {
   if (j_l_String.m_equals__java_lang_String__java_lang_Object__boolean((/**@type {HTMLOptionElement}*/ ($Casts.$to(JsArrayLike_$Overlay.m_getAt__$devirt__jsinterop_base_JsArrayLike__int__java_lang_Object(this.f_selectElement__org_patternfly_component_form_FormSelect_.options, i), HTMLOptionElement_$Overlay))).value, value)) {
    return true;
   }
  }
  return false;
 ...
 m_selectElement__org_jboss_elemento_HTMLSelectElementBuilder() {
  return /**@type {HTMLSelectElementBuilder<HTMLSelectElement>}*/ (Elements.m_wrapSelectElement__elemental2_dom_HTMLSelectElement__org_jboss_elemento_HTMLSelectElementBuilder(this.f_selectElement__org_patternfly_component_form_FormSelect_));
 }
 /** @override @nodts */
