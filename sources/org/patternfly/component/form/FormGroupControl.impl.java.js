...
class FormGroupControl extends SubComponent {
 ...
 $ctor__org_patternfly_component_form_FormGroupControl__void() {
  this.$ctor__org_patternfly_component_SubComponent__org_patternfly_component_ComponentType__java_lang_String__java_lang_String__elemental2_dom_HTMLElement__void(ComponentType.f_Form__org_patternfly_component_ComponentType, FormGroupControl.f_SUB_COMPONENT_ID__org_patternfly_component_form_FormGroupControl, FormGroupControl.f_SUB_COMPONENT_NAME__org_patternfly_component_form_FormGroupControl, /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_form__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_group__org_patternfly_style_Classes, Classes.f_control__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay)));
 ...
 m_attach__elemental2_dom_MutationRecord__void(/** MutationRecord */ mutationRecord) {
  ...
  if (!$Equality.$same(this.f_control__org_patternfly_component_form_FormGroupControl_, null) && !j_l_String.m_equals__java_lang_String__java_lang_Object__boolean(formGroup.m_identifier__java_lang_String(), this.f_control__org_patternfly_component_form_FormGroupControl_.f_id__org_patternfly_component_form_FormControl)) {
   FormGroupControl.f_logger__org_patternfly_component_form_FormGroupControl_.m_error__java_lang_String__arrayOf_java_lang_Object__void('The identifier of the form group %o is different to the id of its control %o: \'%s\' != \'%s\'', [formGroup.m_element__elemental2_dom_HTMLElement(), this.m_element__elemental2_dom_HTMLElement(), formGroup.m_identifier__java_lang_String(), this.f_control__org_patternfly_component_form_FormGroupControl_.f_id__org_patternfly_component_form_FormControl]);
  }
  for (let $iterator = this.f_checkboxes__org_patternfly_component_form_FormGroupControl_.m_iterator__java_util_Iterator(); $iterator.m_hasNext__boolean(); ) {
   ...
   {
    checkbox.m_inputElement__org_jboss_elemento_HTMLInputElementBuilder().m_name__java_lang_String__org_jboss_elemento_TypedBuilder(formGroup.m_identifier__java_lang_String());
   }
  }
  for (let $iterator_1 = this.f_radios__org_patternfly_component_form_FormGroupControl_.m_iterator__java_util_Iterator(); $iterator_1.m_hasNext__boolean(); ) {
   ...
   {
    radio.m_inputElement__org_jboss_elemento_HTMLInputElementBuilder().m_name__java_lang_String__org_jboss_elemento_TypedBuilder(formGroup.m_identifier__java_lang_String());
   }
  }
 }
 ...
 /** @nodts @return {FormGroupControl} */
 m_addInputGroup__org_patternfly_component_inputgroup_InputGroup__org_patternfly_component_form_FormGroupControl(/** InputGroup */ inputGroup) {
  return this.m_add__org_patternfly_component_inputgroup_InputGroup__org_patternfly_component_form_FormGroupControl(inputGroup);
 }
 /** @nodts @return {FormGroupControl} */
 m_add__org_patternfly_component_inputgroup_InputGroup__org_patternfly_component_form_FormGroupControl(/** InputGroup */ inputGroup) {
  return /**@type {FormGroupControl}*/ ($Casts.$to(this.m_add__elemental2_dom_Node__org_jboss_elemento_TypedBuilder(inputGroup.m_element__elemental2_dom_HTMLElement()), FormGroupControl));
 }
 /** @nodts @return {FormGroupControl} */
 ...
 /** @nodts */
 m_removeHelperText__void() {
  for (let $iterator = this.m_querySelectorAll__org_jboss_elemento_By__java_lang_Iterable(By.m_classname__java_lang_String__org_jboss_elemento_By(Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_form__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_helperText__org_patternfly_style_Classes], j_l_String))))).m_iterator__java_util_Iterator(); $iterator.m_hasNext__boolean(); ) {
   let helperText = /**@type {HTMLElement}*/ ($Casts.$to($iterator.m_next__java_lang_Object(), $Overlay));
   {
    Elements.m_failSafeRemoveFromParent__elemental2_dom_Element__boolean(helperText);
   }
  }
 }
 //Bridge method.
 ...
 static $clinit() {
  ...
  Inline.$clinit();
  Attachable.$clinit();
  FormGroupControl.f_logger__org_patternfly_component_form_FormGroupControl_ = Logger.m_getLogger__java_lang_String__org_jboss_elemento_logger_Logger(Class.$get(FormGroupControl).m_getName__java_lang_String());
 }
...
FormGroupControl.f_logger__org_patternfly_component_form_FormGroupControl_;
/**@const {string} @nodts*/
FormGroupControl.f_SUB_COMPONENT_ID__org_patternfly_component_form_FormGroupControl = 'fgc';
/**@const {string} @nodts*/
FormGroupControl.f_SUB_COMPONENT_NAME__org_patternfly_component_form_FormGroupControl = 'FormGroupControl';
