...
/**
 * @extends {BaseComponent<HTMLElement, Progress>}
...
class Progress extends BaseComponent {
 ...
 constructor() {
  ...
  /**@type {boolean} @nodts*/
  this.f_hideStatusIcon__org_patternfly_component_progress_Progress_ = false;
  /**@type {Status} @nodts*/
  ...
  /**@type {List<ChangeHandler<Progress, Integer>>} @nodts*/
 ...
 $ctor__org_patternfly_component_progress_Progress__void() {
  ...
  this.f_progressbarElement__org_patternfly_component_progress_Progress_ = (/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_progress__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_bar__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_attr__java_lang_String__java_lang_String__org_jboss_elemento_TypedBuilder(Attributes.f_role__org_patternfly_core_Attributes, Roles.f_progressbar__org_patternfly_core_Roles), HTMLContainerBuilder))).m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(this.f_indicatorElement__org_patternfly_component_progress_Progress_ = (/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_progress__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_indicator__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder)))), HTMLContainerBuilder)));
 ...
 m_measureLocation__org_patternfly_component_progress_MeasureLocation__org_patternfly_component_progress_Progress(/** MeasureLocation */ location) {
  ...
  this.m_classList__org_jboss_elemento_ClassList().m_remove__arrayOf_java_lang_String__void(/**@type {!Array<?string>}*/ ($Arrays.$stampType([MeasureLocation.f_outside__org_patternfly_component_progress_MeasureLocation.f_modifier__org_patternfly_component_progress_MeasureLocation, MeasureLocation.f_inside__org_patternfly_component_progress_MeasureLocation.f_modifier__org_patternfly_component_progress_MeasureLocation], j_l_String)));
  if ($Equality.$same(location, MeasureLocation.f_inside__org_patternfly_component_progress_MeasureLocation) || $Equality.$same(location, MeasureLocation.f_outside__org_patternfly_component_progress_MeasureLocation)) {
   this.m_classList__org_jboss_elemento_ClassList().m_add__arrayOf_java_lang_String__void(/**@type {!Array<?string>}*/ ($Arrays.$stampType([location.f_modifier__org_patternfly_component_progress_MeasureLocation], j_l_String)));
   if ($Equality.$same(location, MeasureLocation.f_inside__org_patternfly_component_progress_MeasureLocation)) {
    this.m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Size.f_lg__org_patternfly_style_Size.m_modifier__java_lang_String()], j_l_String)));
   }
  }
 ...
 /** @nodts @return {Progress} */
 m_hideStatusIcon__org_patternfly_component_progress_Progress() {
  this.f_hideStatusIcon__org_patternfly_component_progress_Progress_ = true;
  return this;
 }
 /** @nodts @return {Progress} */
 m_status__org_patternfly_style_Status__org_patternfly_component_progress_Progress(/** Status */ status) {
  if (Validation.m_verifyEnum__elemental2_dom_Element__java_lang_String__java_lang_Enum__java_lang_Enum__arrayOf_java_lang_Enum__boolean(this.m_element__elemental2_dom_HTMLElement(), 'status', status, Status.f_info__org_patternfly_style_Status, /**@type {!Array<Status>}*/ ($Arrays.$stampType([Status.f_danger__org_patternfly_style_Status, Status.f_success__org_patternfly_style_Status, Status.f_warning__org_patternfly_style_Status], Status)))) {
   if (!$Equality.$same(this.f_status__org_patternfly_component_progress_Progress_, null)) {
    this.m_classList__org_jboss_elemento_ClassList().m_remove__arrayOf_java_lang_String__void(/**@type {!Array<?string>}*/ ($Arrays.$stampType([this.f_status__org_patternfly_component_progress_Progress_.m_modifier__java_lang_String()], j_l_String)));
   }
   if (!$Equality.$same(status, Status.f_info__org_patternfly_style_Status)) {
    this.m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([status.m_modifier__java_lang_String()], j_l_String)));
   }
   ...
   if (!this.f_hideStatusIcon__org_patternfly_component_progress_Progress_) {
    switch (status.ordinal()) {
     case Status.$ordinal_danger__org_patternfly_style_Status:
      this.m_failSafeIconContainer__elemental2_dom_HTMLElement_$p_org_patternfly_component_progress_Progress().appendChild(rhUi.m_errorFill__org_patternfly_icon_PredefinedIcon().m_element__org_jboss_elemento_svg_SVGElement());
      break;
     case Status.$ordinal_warning__org_patternfly_style_Status:
      this.m_failSafeIconContainer__elemental2_dom_HTMLElement_$p_org_patternfly_component_progress_Progress().appendChild(rhUi.m_warningFill__org_patternfly_icon_PredefinedIcon().m_element__org_jboss_elemento_svg_SVGElement());
      break;
     case Status.$ordinal_success__org_patternfly_style_Status:
      this.m_failSafeIconContainer__elemental2_dom_HTMLElement_$p_org_patternfly_component_progress_Progress().appendChild(rhUi.m_checkCircleFill__org_patternfly_icon_PredefinedIcon().m_element__org_jboss_elemento_svg_SVGElement());
      break;
 ...
 m_value__int__org_patternfly_component_progress_Progress(/** number */ value) {
  this.f_value__org_patternfly_component_progress_Progress_.m_set__java_lang_Object__void(Integer.valueOf(value));
  return this;
 }
 /** @nodts @return {Progress} */
 ...
 m_onChange__org_patternfly_handler_ChangeHandler__org_patternfly_component_progress_Progress(/** ChangeHandler<Progress, Integer> */ changeHandler) {
  this.f_changeHandler__org_patternfly_component_progress_Progress_.add(changeHandler);
  return this;
 }
 /** @nodts */
 m_decrease__void() {
  let newValue = Math.max(this.f_min__org_patternfly_component_progress_Progress_, (/**@type {Integer}*/ ($Casts.$to(this.f_value__org_patternfly_component_progress_Progress_.m_get__java_lang_Object(), Integer))).intValue() - this.f_step__org_patternfly_component_progress_Progress_ | 0);
  this.m_value__int__org_patternfly_component_progress_Progress(newValue);
 }
 /** @nodts */
 m_increase__void() {
  let newValue = Math.min(this.f_max__org_patternfly_component_progress_Progress_, (/**@type {Integer}*/ ($Casts.$to(this.f_value__org_patternfly_component_progress_Progress_.m_get__java_lang_Object(), Integer))).intValue() + this.f_step__org_patternfly_component_progress_Progress_ | 0);
  this.m_value__int__org_patternfly_component_progress_Progress(newValue);
 }
 /** @nodts @return {number} */
 m_min__int() {
 ...
 m_range__arrayOf_int() {
  return /**@type {!Array<number>}*/ ($Arrays.$stampType([this.f_min__org_patternfly_component_progress_Progress_, this.f_max__org_patternfly_component_progress_Progress_, this.f_step__org_patternfly_component_progress_Progress_], $int));
 }
 ...
 m_onValueChanged__int__int__void_$p_org_patternfly_component_progress_Progress(/** number */ current, /** number */ previous) {
  ...
  if (current != previous) {
   this.f_changeHandler__org_patternfly_component_progress_Progress_.m_forEach__java_util_function_Consumer__void(Consumer.$adapt((/** ChangeHandler<Progress, Integer> */ ch) =>{
    let ch_1 = /**@type {ChangeHandler<Progress, Integer>}*/ ($Casts.$to(ch, /**@type {Function}*/ (ChangeHandler)));
    ch_1.m_onChange__elemental2_dom_Event__java_lang_Object__java_lang_Object__void(new Event(''), this, /**@type {Integer}*/ ($Casts.$to(this.f_value__org_patternfly_component_progress_Progress_.m_get__java_lang_Object(), Integer)));
   }));
  }
 }
 ...
 m_failSafeTitleElement__elemental2_dom_HTMLElement_$p_org_patternfly_component_progress_Progress() {
  if ($Equality.$same(this.f_titleElement__org_patternfly_component_progress_Progress_, null)) {
   this.m_classList__org_jboss_elemento_ClassList().m_remove__arrayOf_java_lang_String__void(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_singleline__org_patternfly_style_Classes)], j_l_String)));
   let id = Id.m_unique__java_lang_String__arrayOf_java_lang_String__java_lang_String(this.m_componentType__org_patternfly_component_ComponentType().f_id__org_patternfly_component_ComponentType, /**@type {!Array<?string>}*/ ($Arrays.$stampType(['description'], j_l_String)));
   Elements.m_insertFirst__elemental2_dom_Element__elemental2_dom_Element__void(this.m_element__elemental2_dom_HTMLElement(), this.f_titleElement__org_patternfly_component_progress_Progress_ = (/**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_progress__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_description__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_id__java_lang_String__org_jboss_elemento_TypedBuilder(id), HTMLContainerBuilder))).m_aria__java_lang_String__boolean__org_jboss_elemento_TypedBuilder(Aria.f_hidden__org_patternfly_core_Aria, true), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay))));
 ...
 m_failSafeIconContainer__elemental2_dom_HTMLElement_$p_org_patternfly_component_progress_Progress() {
  if ($Equality.$same(this.f_iconContainer__org_patternfly_component_progress_Progress_, null)) {
   this.f_statusElement__org_patternfly_component_progress_Progress_.m_add__elemental2_dom_Node__org_jboss_elemento_TypedBuilder(this.f_iconContainer__org_patternfly_component_progress_Progress_ = (/**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to(Elements.m_span__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_progress__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_status__org_patternfly_style_Classes, Classes.f_icon__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement());
  }
