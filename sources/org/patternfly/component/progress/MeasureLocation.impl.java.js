...
class MeasureLocation extends Enum {
 ...
 static m_valueOf__java_lang_String__org_patternfly_component_progress_MeasureLocation(/** string */ name) {
  ...
  if ($Equality.$same(MeasureLocation.f_namesToValuesMap__org_patternfly_component_progress_MeasureLocation_, null)) {
   MeasureLocation.f_namesToValuesMap__org_patternfly_component_progress_MeasureLocation_ = (/**@type {Map<?string, !MeasureLocation>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(MeasureLocation.m_values__arrayOf_org_patternfly_component_progress_MeasureLocation())));
  }
  return /**@type {MeasureLocation}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, MeasureLocation.f_namesToValuesMap__org_patternfly_component_progress_MeasureLocation_));
 }
 /** @nodts @return {!Array<!MeasureLocation>} */
 static m_values__arrayOf_org_patternfly_component_progress_MeasureLocation() {
  MeasureLocation.$clinit();
  return /**@type {!Array<!MeasureLocation>}*/ ($Arrays.$stampType([MeasureLocation.$static_none__org_patternfly_component_progress_MeasureLocation, MeasureLocation.$static_outside__org_patternfly_component_progress_MeasureLocation, MeasureLocation.$static_inside__org_patternfly_component_progress_MeasureLocation, MeasureLocation.$static_top__org_patternfly_component_progress_MeasureLocation], MeasureLocation));
 }
 /** @nodts @return {!MeasureLocation} */
