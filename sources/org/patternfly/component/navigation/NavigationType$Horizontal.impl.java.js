...
class Horizontal extends Enum {
 ...
 static m_valueOf__java_lang_String__org_patternfly_component_navigation_NavigationType_Horizontal(/** string */ name) {
  ...
  if ($Equality.$same(Horizontal.f_namesToValuesMap__org_patternfly_component_navigation_NavigationType_Horizontal_, null)) {
   Horizontal.f_namesToValuesMap__org_patternfly_component_navigation_NavigationType_Horizontal_ = (/**@type {Map<?string, !Horizontal>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(Horizontal.m_values__arrayOf_org_patternfly_component_navigation_NavigationType_Horizontal())));
  }
  return /**@type {Horizontal}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, Horizontal.f_namesToValuesMap__org_patternfly_component_navigation_NavigationType_Horizontal_));
 }
 /** @nodts @return {!Array<!Horizontal>} */
 static m_values__arrayOf_org_patternfly_component_navigation_NavigationType_Horizontal() {
  Horizontal.$clinit();
  return /**@type {!Array<!Horizontal>}*/ ($Arrays.$stampType([Horizontal.f_primary__org_patternfly_component_navigation_NavigationType_Horizontal, Horizontal.f_secondary__org_patternfly_component_navigation_NavigationType_Horizontal], Horizontal));
 }
 /** @nodts */
 static $clinit() {
  Horizontal.$clinit = () =>{};
