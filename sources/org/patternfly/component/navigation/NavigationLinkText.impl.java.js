...
class NavigationLinkText extends NavigationSubComponent {
 ...
 $ctor__org_patternfly_component_navigation_NavigationLinkText__void() {
  this.$ctor__org_patternfly_component_navigation_NavigationSubComponent__java_lang_String__java_lang_String__elemental2_dom_HTMLElement__void(NavigationLinkText.f_SUB_COMPONENT_ID__org_patternfly_component_navigation_NavigationLinkText, NavigationLinkText.f_SUB_COMPONENT_NAME__org_patternfly_component_navigation_NavigationLinkText, (/**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to(Elements.m_span__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_nav__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_link__org_patternfly_style_Classes, Classes.f_text__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement());
 }
 /** @nodts @return {NavigationLinkText} */
 ...
 m_text__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ arg0) {
  return /**@type {NavigationLinkText}*/ ($Casts.$to(ElementTextMethods.m_text__$default__org_jboss_elemento_ElementTextMethods__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), NavigationLinkText));
 }
 ...
 //Default method forwarding stub.
 /** @nodts @return {NavigationLinkText} */
 m_text__java_lang_String__org_patternfly_component_navigation_NavigationLinkText(/** ?string */ arg0) {
  return /**@type {NavigationLinkText}*/ ($Casts.$to(ElementTextMethods.m_text__$default__org_jboss_elemento_ElementTextMethods__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), NavigationLinkText));
 }
 /** @nodts */
 static $clinit() {
...
/**@const {string} @nodts*/
NavigationLinkText.f_SUB_COMPONENT_ID__org_patternfly_component_navigation_NavigationLinkText = 'nlt';
/**@const {string} @nodts*/
NavigationLinkText.f_SUB_COMPONENT_NAME__org_patternfly_component_navigation_NavigationLinkText = 'NavigationLinkText';
ElementTextMethods.$markImplementor(NavigationLinkText);
