...
class Shape extends Enum {
 ...
 static m_valueOf__java_lang_String__org_patternfly_component_skeleton_Shape(/** string */ name) {
  ...
  if ($Equality.$same(Shape.f_namesToValuesMap__org_patternfly_component_skeleton_Shape_, null)) {
   Shape.f_namesToValuesMap__org_patternfly_component_skeleton_Shape_ = (/**@type {Map<?string, !Shape>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(Shape.m_values__arrayOf_org_patternfly_component_skeleton_Shape())));
  }
  return /**@type {Shape}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, Shape.f_namesToValuesMap__org_patternfly_component_skeleton_Shape_));
 }
 /** @nodts @return {!Array<!Shape>} */
 static m_values__arrayOf_org_patternfly_component_skeleton_Shape() {
  Shape.$clinit();
  return /**@type {!Array<!Shape>}*/ ($Arrays.$stampType([Shape.$static_circle__org_patternfly_component_skeleton_Shape, Shape.$static_square__org_patternfly_component_skeleton_Shape], Shape));
 }
 /** @nodts @return {!Shape} */
