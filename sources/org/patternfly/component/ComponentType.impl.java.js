...
/**@const {number} @nodts*/
ComponentType.$ordinal_Popover__org_patternfly_component_ComponentType = 50;
/**@const {number} @nodts*/
ComponentType.$ordinal_Progress__org_patternfly_component_ComponentType = 51;
/**@const {number} @nodts*/
ComponentType.$ordinal_ProgressStepper__org_patternfly_component_ComponentType = 52;
/**@const {number} @nodts*/
ComponentType.$ordinal_Radio__org_patternfly_component_ComponentType = 53;
/**@const {number} @nodts*/
ComponentType.$ordinal_SearchInput__org_patternfly_component_ComponentType = 54;
/**@const {number} @nodts*/
ComponentType.$ordinal_ServiceCard__org_patternfly_component_ComponentType = 55;
/**@const {number} @nodts*/
ComponentType.$ordinal_Sidebar__org_patternfly_component_ComponentType = 56;
/**@const {number} @nodts*/
ComponentType.$ordinal_SimpleList__org_patternfly_component_ComponentType = 57;
/**@const {number} @nodts*/
ComponentType.$ordinal_SingleSelect__org_patternfly_component_ComponentType = 58;
/**@const {number} @nodts*/
ComponentType.$ordinal_SingleTypeahead__org_patternfly_component_ComponentType = 59;
/**@const {number} @nodts*/
ComponentType.$ordinal_Skeleton__org_patternfly_component_ComponentType = 60;
/**@const {number} @nodts*/
ComponentType.$ordinal_SkipToContent__org_patternfly_component_ComponentType = 61;
/**@const {number} @nodts*/
ComponentType.$ordinal_Slider__org_patternfly_component_ComponentType = 62;
/**@const {number} @nodts*/
ComponentType.$ordinal_Spinner__org_patternfly_component_ComponentType = 63;
/**@const {number} @nodts*/
ComponentType.$ordinal_Switch__org_patternfly_component_ComponentType = 64;
/**@const {number} @nodts*/
ComponentType.$ordinal_Tabs__org_patternfly_component_ComponentType = 65;
/**@const {number} @nodts*/
ComponentType.$ordinal_Table__org_patternfly_component_ComponentType = 66;
/**@const {number} @nodts*/
ComponentType.$ordinal_TextInput__org_patternfly_component_ComponentType = 67;
/**@const {number} @nodts*/
ComponentType.$ordinal_TextInputGroup__org_patternfly_component_ComponentType = 68;
/**@const {number} @nodts*/
ComponentType.$ordinal_ThemeSelector__org_patternfly_component_ComponentType = 69;
/**@const {number} @nodts*/
ComponentType.$ordinal_Timestamp__org_patternfly_component_ComponentType = 70;
/**@const {number} @nodts*/
ComponentType.$ordinal_Title__org_patternfly_component_ComponentType = 71;
/**@const {number} @nodts*/
ComponentType.$ordinal_ToggleGroup__org_patternfly_component_ComponentType = 72;
/**@const {number} @nodts*/
ComponentType.$ordinal_Toolbar__org_patternfly_component_ComponentType = 73;
/**@const {number} @nodts*/
ComponentType.$ordinal_Tooltip__org_patternfly_component_ComponentType = 74;
/**@const {number} @nodts*/
ComponentType.$ordinal_TreeView__org_patternfly_component_ComponentType = 75;
/**@const {number} @nodts*/
ComponentType.$ordinal_Truncate__org_patternfly_component_ComponentType = 76;
/**@const {number} @nodts*/
ComponentType.$ordinal_Wizard__org_patternfly_component_ComponentType = 77;
