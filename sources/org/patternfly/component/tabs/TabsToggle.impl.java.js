 ...
 * @implements {ElementTextMethods<HTMLElement, TabsToggle>}
 */
class TabsToggle extends TabSubComponent {
 ...
 $ctor__org_patternfly_component_tabs_TabsToggle__void() {
  this.$ctor__org_patternfly_component_tabs_TabSubComponent__java_lang_String__java_lang_String__elemental2_dom_HTMLElement__void(TabsToggle.f_SUB_COMPONENT_ID__org_patternfly_component_tabs_TabsToggle, TabsToggle.f_SUB_COMPONENT_NAME__org_patternfly_component_tabs_TabsToggle, /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_tabs__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_toggle__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), $Overlay)));
  let toggleButtonId = Id.m_unique__java_lang_String__arrayOf_java_lang_String__java_lang_String(ComponentType.f_Tabs__org_patternfly_component_ComponentType.f_id__org_patternfly_component_ComponentType, /**@type {!Array<?string>}*/ ($Arrays.$stampType(['toggle', 'button'], j_l_String)));
  let toggleTextId = Id.m_unique__java_lang_String__arrayOf_java_lang_String__java_lang_String(ComponentType.f_Tabs__org_patternfly_component_ComponentType.f_id__org_patternfly_component_ComponentType, /**@type {!Array<?string>}*/ ($Arrays.$stampType(['toggle', 'text'], j_l_String)));
  this.m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_tabs__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_toggle__org_patternfly_style_Classes, Classes.f_button__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(this.f_button__org_patternfly_component_tabs_TabsToggle_ = (/**@type {Button}*/ ($Casts.$to((/**@type {Button}*/ ($Casts.$to((/**@type {Button}*/ ($Casts.$to((/**@type {Button}*/ ($Casts.$to((/**@type {Button}*/ ($Casts.$to((/**@type {Button}*/ ($Casts.$to(Button.m_button__org_patternfly_component_button_Button().m_plain__org_jboss_elemento_TypedBuilder(), Button))).m_iconAndText__org_patternfly_icon_PredefinedIcon__java_lang_String__org_jboss_elemento_TypedBuilder(rhMicrons.m_caretDown__org_patternfly_icon_PredefinedIcon(), ''), Button))).m_id__java_lang_String__org_jboss_elemento_TypedBuilder(toggleButtonId), Button))).m_aria__java_lang_String__boolean__org_jboss_elemento_TypedBuilder(Aria.f_expanded__org_patternfly_core_Aria, false), Button))).m_aria__java_lang_String__java_lang_String__org_jboss_elemento_TypedBuilder(Aria.f_labelledBy__org_patternfly_core_Aria, j_l_String.m_valueOf__java_lang_Object__java_lang_String(toggleButtonId) + ' ' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(toggleTextId)), Button))).m_on__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn__org_jboss_elemento_TypedBuilder(EventType.f_click__org_jboss_elemento_EventType, (/** MouseEvent */ e) =>{
   let e_1 = /**@type {MouseEvent}*/ ($Casts.$to(e, MouseEvent_$Overlay));
   this.m_toggle__void_$p_org_patternfly_component_tabs_TabsToggle();
  }), Button)))), HTMLContainerBuilder)));
 }
 /** @nodts @return {TabsToggle} */
 m_text__java_lang_String__org_patternfly_component_tabs_TabsToggle(/** ?string */ text) {
  this.f_button__org_patternfly_component_tabs_TabsToggle_.m_text__java_lang_String__org_patternfly_component_button_Button(text);
  return this;
 }
 /** @nodts @return {TabsToggle} */
 ...
 m_text__java_lang_String() {
  return this.f_button__org_patternfly_component_tabs_TabsToggle_.m_text__java_lang_String();
 }
 /** @nodts @return {boolean} */
 m_noText__boolean_$pp_org_patternfly_component_tabs() {
  return $Equality.$same(this.f_button__org_patternfly_component_tabs_TabsToggle_.m_text__java_lang_String(), null) || j_l_String.m_isEmpty__java_lang_String__boolean(this.f_button__org_patternfly_component_tabs_TabsToggle_.m_text__java_lang_String());
 }
 /** @nodts */
 ...
 m_text__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ arg0) {
  return this.m_text__java_lang_String__org_patternfly_component_tabs_TabsToggle(arg0);
 }
 //Default method forwarding stub.
 /** @nodts @return {TabsToggle} */
...
/**@const {string} @nodts*/
TabsToggle.f_SUB_COMPONENT_ID__org_patternfly_component_tabs_TabsToggle = 'tt';
/**@const {string} @nodts*/
TabsToggle.f_SUB_COMPONENT_NAME__org_patternfly_component_tabs_TabsToggle = 'TabsToggle';
Disabled.$markImplementor(TabsToggle);
ElementTextMethods.$markImplementor(TabsToggle);
