 ...
 * @implements {ElementTextMethods<HTMLDivElement, CardBody>}
...
class CardBody extends CardSubComponent {
 ...
 $ctor__org_patternfly_component_card_CardBody__void() {
  this.$ctor__org_patternfly_component_card_CardSubComponent__java_lang_String__java_lang_String__elemental2_dom_HTMLElement__void(CardBody.f_SUB_COMPONENT_ID__org_patternfly_component_card_CardBody, CardBody.f_SUB_COMPONENT_NAME__org_patternfly_component_card_CardBody, /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_card__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_body__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), $Overlay)));
 }
 /** @nodts @return {CardBody} */
 ...
 m_text__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ arg0) {
  return /**@type {CardBody}*/ ($Casts.$to(ElementTextMethods.m_text__$default__org_jboss_elemento_ElementTextMethods__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), CardBody));
 }
 ...
 //Default method forwarding stub.
 /** @nodts @return {CardBody} */
 m_text__java_lang_String__org_patternfly_component_card_CardBody(/** ?string */ arg0) {
  return /**@type {CardBody}*/ ($Casts.$to(ElementTextMethods.m_text__$default__org_jboss_elemento_ElementTextMethods__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), CardBody));
 }
 //Default method forwarding stub.
 /** @nodts @return {CardBody} */
...
/**@const {string} @nodts*/
CardBody.f_SUB_COMPONENT_ID__org_patternfly_component_card_CardBody = 'cb';
/**@const {string} @nodts*/
CardBody.f_SUB_COMPONENT_NAME__org_patternfly_component_card_CardBody = 'CardBody';
ElementTextMethods.$markImplementor(CardBody);
