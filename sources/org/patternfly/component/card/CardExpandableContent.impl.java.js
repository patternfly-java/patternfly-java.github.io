...
class CardExpandableContent extends CardSubComponent {
 ...
 $ctor__org_patternfly_component_card_CardExpandableContent__void() {
  this.$ctor__org_patternfly_component_card_CardSubComponent__java_lang_String__java_lang_String__elemental2_dom_HTMLElement__void(CardExpandableContent.f_SUB_COMPONENT_ID__org_patternfly_component_card_CardExpandableContent, CardExpandableContent.f_SUB_COMPONENT_NAME__org_patternfly_component_card_CardExpandableContent, /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_card__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_expandableContent__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_apply__java_util_function_Consumer__org_jboss_elemento_TypedBuilder(Consumer.$adapt((/** HTMLDivElement */ e) =>{
...
/**@const {string} @nodts*/
CardExpandableContent.f_SUB_COMPONENT_ID__org_patternfly_component_card_CardExpandableContent = 'cec';
/**@const {string} @nodts*/
CardExpandableContent.f_SUB_COMPONENT_NAME__org_patternfly_component_card_CardExpandableContent = 'CardExpandableContent';
