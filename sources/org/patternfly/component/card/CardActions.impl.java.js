...
class CardActions extends CardSubComponent {
 ...
 m_noOffset__org_jboss_elemento_TypedBuilder() {
  return /**@type {CardActions}*/ ($Casts.$to(NoOffset.m_noOffset__$default__org_patternfly_style_Modifiers_NoOffset__org_jboss_elemento_TypedBuilder(this), CardActions));
 }
 //Bridge method.
 /** @final @override @nodts @return {CardActions} */
 m_noOffset__boolean__org_jboss_elemento_TypedBuilder(/** boolean */ arg0) {
  return /**@type {CardActions}*/ ($Casts.$to(NoOffset.m_noOffset__$default__org_patternfly_style_Modifiers_NoOffset__boolean__org_jboss_elemento_TypedBuilder(this, arg0), CardActions));
 }
 ...
 //Default method forwarding stub.
 /** @nodts @return {CardActions} */
 m_noOffset__boolean__org_patternfly_component_card_CardActions(/** boolean */ arg0) {
  return /**@type {CardActions}*/ ($Casts.$to(NoOffset.m_noOffset__$default__org_patternfly_style_Modifiers_NoOffset__boolean__org_jboss_elemento_TypedBuilder(this, arg0), CardActions));
 }
 /** @nodts */
 static $clinit() {
...
/**@const {string} @nodts*/
CardActions.f_SUB_COMPONENT_ID__org_patternfly_component_card_CardActions = 'ca';
/**@const {string} @nodts*/
CardActions.f_SUB_COMPONENT_NAME__org_patternfly_component_card_CardActions = 'CardActions';
NoOffset.$markImplementor(CardActions);
