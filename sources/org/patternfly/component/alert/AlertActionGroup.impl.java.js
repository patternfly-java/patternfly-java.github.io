...
class AlertActionGroup extends AlertSubComponent {
 ...
 $ctor__org_patternfly_component_alert_AlertActionGroup__void() {
  this.$ctor__org_patternfly_component_alert_AlertSubComponent__java_lang_String__java_lang_String__elemental2_dom_HTMLElement__void(AlertActionGroup.f_SUB_COMPONENT_ID__org_patternfly_component_alert_AlertActionGroup, AlertActionGroup.f_SUB_COMPONENT_NAME__org_patternfly_component_alert_AlertActionGroup, /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_alert__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_actionGroup__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), $Overlay)));
 }
 /** @nodts @return {AlertActionGroup} */
 ...
 m_addAction__org_patternfly_component_button_Button__org_patternfly_handler_ComponentHandler__org_patternfly_component_alert_AlertActionGroup(/** Button */ action, /** ComponentHandler<Alert> */ handler) {
  if (!$Equality.$same(handler, null)) {
   action.m_on__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn__org_jboss_elemento_TypedBuilder(EventType.f_click__org_jboss_elemento_EventType, (/** MouseEvent */ e) =>{
...
/**@const {string} @nodts*/
AlertActionGroup.f_SUB_COMPONENT_ID__org_patternfly_component_alert_AlertActionGroup = 'aag';
/**@const {string} @nodts*/
AlertActionGroup.f_SUB_COMPONENT_NAME__org_patternfly_component_alert_AlertActionGroup = 'AlertActionGroup';
