...
class AlertGroupType extends Enum {
 ...
 static m_valueOf__java_lang_String__org_patternfly_component_alert_AlertGroupType(/** string */ name) {
  ...
  if ($Equality.$same(AlertGroupType.f_namesToValuesMap__org_patternfly_component_alert_AlertGroupType_, null)) {
   AlertGroupType.f_namesToValuesMap__org_patternfly_component_alert_AlertGroupType_ = (/**@type {Map<?string, !AlertGroupType>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(AlertGroupType.m_values__arrayOf_org_patternfly_component_alert_AlertGroupType())));
  }
  return /**@type {AlertGroupType}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, AlertGroupType.f_namesToValuesMap__org_patternfly_component_alert_AlertGroupType_));
 }
 /** @nodts @return {!Array<!AlertGroupType>} */
 static m_values__arrayOf_org_patternfly_component_alert_AlertGroupType() {
  AlertGroupType.$clinit();
  return /**@type {!Array<!AlertGroupType>}*/ ($Arrays.$stampType([AlertGroupType.f_staticInline__org_patternfly_component_alert_AlertGroupType, AlertGroupType.f_toast__org_patternfly_component_alert_AlertGroupType, AlertGroupType.f_dynamic__org_patternfly_component_alert_AlertGroupType], AlertGroupType));
 }
 /** @nodts */
 static $clinit() {
  AlertGroupType.$clinit = () =>{};
