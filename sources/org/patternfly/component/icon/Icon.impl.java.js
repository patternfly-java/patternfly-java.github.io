 ...
 * @implements {ComponentProgress<HTMLElement, Icon>}
 */
class Icon extends BaseComponent {
 ...
 constructor() {
  ...
  /**@type {IconSize} @nodts*/
  this.f_progressIconSize__org_patternfly_component_icon_Icon_;
  /**@type {Spinner} @nodts*/
 ...
 $ctor__org_patternfly_component_icon_Icon__elemental2_dom_Element__void(/** Element */ icon) {
  this.$ctor__org_patternfly_component_BaseComponent__org_patternfly_component_ComponentType__elemental2_dom_HTMLElement__void(ComponentType.f_Icon__org_patternfly_component_ComponentType, (/**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to(Elements.m_span__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_icon__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$create([0], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to(Elements.m_span__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_icon__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_content__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_add__elemental2_dom_Node__org_jboss_elemento_TypedBuilder(icon), HTMLContainerBuilder))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement());
  this.f_content__org_patternfly_component_icon_Icon_ = this.m_querySelector__org_jboss_elemento_By__elemental2_dom_HTMLElement(By.m_classname__java_lang_String__org_jboss_elemento_By(Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_icon__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_content__org_patternfly_style_Classes], j_l_String)))));
 }
 /** @nodts @return {Icon} */
 m_size__org_patternfly_component_icon_IconSize__org_patternfly_component_icon_Icon(/** IconSize */ size) {
  return /**@type {Icon}*/ ($Casts.$to(TypedModifier.m_swap__org_jboss_elemento_TypedBuilder__elemental2_dom_Element__org_patternfly_style_TypedModifier__org_patternfly_style_TypedModifier__java_lang_Runnable__org_jboss_elemento_TypedBuilder(this, this.m_element__elemental2_dom_HTMLElement(), size, this.f_size__org_patternfly_component_icon_Icon_, Runnable.$adapt(() =>{
   this.f_size__org_patternfly_component_icon_Icon_ = size;
  })), Icon));
 }
 /** @nodts @return {Icon} */
 m_iconSize__org_patternfly_component_icon_IconSize__org_patternfly_component_icon_Icon(/** IconSize */ iconSize) {
  return /**@type {Icon}*/ ($Casts.$to(TypedModifier.m_swap__org_jboss_elemento_TypedBuilder__elemental2_dom_Element__org_patternfly_style_TypedModifier__org_patternfly_style_TypedModifier__java_lang_Runnable__org_jboss_elemento_TypedBuilder(this, this.f_content__org_patternfly_component_icon_Icon_, iconSize, this.f_iconSize__org_patternfly_component_icon_Icon_, Runnable.$adapt(() =>{
   this.f_iconSize__org_patternfly_component_icon_Icon_ = iconSize;
  })), Icon));
 }
 /** @nodts @return {Icon} */
 m_progressIconSize__org_patternfly_component_icon_IconSize__org_patternfly_component_icon_Icon(/** IconSize */ progressIconSize) {
  this.f_progressIconSize__org_patternfly_component_icon_Icon_ = progressIconSize;
  return this;
 }
 /** @nodts @return {Icon} */
 m_status__org_patternfly_style_Status__org_patternfly_component_icon_Icon(/** Status */ status) {
  return /**@type {Icon}*/ ($Casts.$to(TypedModifier.m_swap__org_jboss_elemento_TypedBuilder__elemental2_dom_Element__org_patternfly_style_TypedModifier__arrayOf_org_patternfly_style_TypedModifier__org_jboss_elemento_TypedBuilder(this, this.f_content__org_patternfly_component_icon_Icon_, status, Status.m_values__arrayOf_org_patternfly_style_Status()), Icon));
 }
 /** @nodts @return {Icon} */
 m_progress__boolean__java_lang_String__java_util_function_Consumer__org_patternfly_component_icon_Icon(/** boolean */ inProgress, /** ?string */ label, /** Consumer<Spinner> */ spinnerConsumer) {
  ...
  if (inProgress) {
   ...
   if ($Equality.$same(this.f_spinner__org_patternfly_component_icon_Icon_, null)) {
    ...
    if (!$Equality.$same(this.f_progressIconSize__org_patternfly_component_icon_Icon_, null)) {
     this.f_spinner__org_patternfly_component_icon_Icon_.m_size__org_patternfly_style_Size__org_patternfly_component_spinner_Spinner(this.f_progressIconSize__org_patternfly_component_icon_Icon_.m_asSize__org_patternfly_style_Size_$pp_org_patternfly_component_icon());
    } else if (!$Equality.$same(this.f_iconSize__org_patternfly_component_icon_Icon_, null)) {
     this.f_spinner__org_patternfly_component_icon_Icon_.m_size__org_patternfly_style_Size__org_patternfly_component_spinner_Spinner(this.f_iconSize__org_patternfly_component_icon_Icon_.m_asSize__org_patternfly_style_Size_$pp_org_patternfly_component_icon());
    } else if (!$Equality.$same(this.f_size__org_patternfly_component_icon_Icon_, null)) {
     this.f_spinner__org_patternfly_component_icon_Icon_.m_size__org_patternfly_style_Size__org_patternfly_component_spinner_Spinner(this.f_size__org_patternfly_component_icon_Icon_.m_asSize__org_patternfly_style_Size_$pp_org_patternfly_component_icon());
    } else {
 ...
 m_startProgress__org_jboss_elemento_TypedBuilder() {
  return /**@type {Icon}*/ ($Casts.$to(ComponentProgress.m_startProgress__$default__org_patternfly_component_ComponentProgress__org_jboss_elemento_TypedBuilder(this), Icon));
 }
 //Bridge method.
 /** @final @override @nodts @return {Icon} */
 m_stopProgress__org_jboss_elemento_TypedBuilder() {
  return /**@type {Icon}*/ ($Casts.$to(ComponentProgress.m_stopProgress__$default__org_patternfly_component_ComponentProgress__org_jboss_elemento_TypedBuilder(this), Icon));
 }
 //Bridge method.
 /** @final @override @nodts @return {Icon} */
 m_toggleProgress__org_jboss_elemento_TypedBuilder() {
  return /**@type {Icon}*/ ($Casts.$to(ComponentProgress.m_toggleProgress__$default__org_patternfly_component_ComponentProgress__org_jboss_elemento_TypedBuilder(this), Icon));
 }
 //Bridge method.
 /** @final @override @nodts @return {Icon} */
 m_progress__boolean__org_jboss_elemento_TypedBuilder(/** boolean */ arg0) {
  return /**@type {Icon}*/ ($Casts.$to(ComponentProgress.m_progress__$default__org_patternfly_component_ComponentProgress__boolean__org_jboss_elemento_TypedBuilder(this, arg0), Icon));
 }
 //Bridge method.
 /** @final @override @nodts @return {Icon} */
 m_progress__boolean__java_lang_String__org_jboss_elemento_TypedBuilder(/** boolean */ arg0, /** ?string */ arg1) {
  return /**@type {Icon}*/ ($Casts.$to(ComponentProgress.m_progress__$default__org_patternfly_component_ComponentProgress__boolean__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0, arg1), Icon));
 }
 //Bridge method.
 /** @final @override @nodts @return {Icon} */
 m_progress__boolean__java_util_function_Consumer__org_jboss_elemento_TypedBuilder(/** boolean */ arg0, /** Consumer<Spinner> */ arg1) {
  return /**@type {Icon}*/ ($Casts.$to(ComponentProgress.m_progress__$default__org_patternfly_component_ComponentProgress__boolean__java_util_function_Consumer__org_jboss_elemento_TypedBuilder(this, arg0, arg1), Icon));
 }
 //Bridge method.
 /** @final @override @nodts @return {Icon} */
...
ComponentProgress.$markImplementor(Icon);
