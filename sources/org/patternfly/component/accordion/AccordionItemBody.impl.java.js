 ...
 * @implements {ElementTextMethods<HTMLDivElement, AccordionItemBody>}
 */
class AccordionItemBody extends AccordionSubComponent {
 ...
 $ctor__org_patternfly_component_accordion_AccordionItemBody__void() {
  this.$ctor__org_patternfly_component_accordion_AccordionSubComponent__java_lang_String__java_lang_String__elemental2_dom_HTMLElement__void(AccordionItemBody.f_SUB_COMPONENT_ID__org_patternfly_component_accordion_AccordionItemBody, AccordionItemBody.f_SUB_COMPONENT_NAME__org_patternfly_component_accordion_AccordionItemBody, /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_accordion__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_expandableContent__org_patternfly_style_Classes, Classes.f_body__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), $Overlay)));
 }
 /** @nodts @return {AccordionItemBody} */
 ...
 m_text__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ arg0) {
  return /**@type {AccordionItemBody}*/ ($Casts.$to(ElementTextMethods.m_text__$default__org_jboss_elemento_ElementTextMethods__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), AccordionItemBody));
 }
 ...
 //Default method forwarding stub.
 /** @nodts @return {AccordionItemBody} */
 m_text__java_lang_String__org_patternfly_component_accordion_AccordionItemBody(/** ?string */ arg0) {
  return /**@type {AccordionItemBody}*/ ($Casts.$to(ElementTextMethods.m_text__$default__org_jboss_elemento_ElementTextMethods__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), AccordionItemBody));
 }
 /** @nodts */
 static $clinit() {
...
/**@const {string} @nodts*/
AccordionItemBody.f_SUB_COMPONENT_ID__org_patternfly_component_accordion_AccordionItemBody = 'acicb';
/**@const {string} @nodts*/
AccordionItemBody.f_SUB_COMPONENT_NAME__org_patternfly_component_accordion_AccordionItemBody = 'AccordionItemBody';
ElementTextMethods.$markImplementor(AccordionItemBody);
