 ...
 * @implements {ElementTextMethods<HTMLDivElement, PanelFooter>}
 */
class PanelFooter extends PanelSubComponent {
 ...
 m_text__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ arg0) {
  return /**@type {PanelFooter}*/ ($Casts.$to(ElementTextMethods.m_text__$default__org_jboss_elemento_ElementTextMethods__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), PanelFooter));
 }
 ...
 //Default method forwarding stub.
 /** @nodts @return {PanelFooter} */
 m_text__java_lang_String__org_patternfly_component_panel_PanelFooter(/** ?string */ arg0) {
  return /**@type {PanelFooter}*/ ($Casts.$to(ElementTextMethods.m_text__$default__org_jboss_elemento_ElementTextMethods__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), PanelFooter));
 }
 /** @nodts */
 static $clinit() {
...
/**@const {string} @nodts*/
PanelFooter.f_SUB_COMPONENT_ID__org_patternfly_component_panel_PanelFooter = 'pf';
/**@const {string} @nodts*/
PanelFooter.f_SUB_COMPONENT_NAME__org_patternfly_component_panel_PanelFooter = 'PanelFooter';
ElementTextMethods.$markImplementor(PanelFooter);
