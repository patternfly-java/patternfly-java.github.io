...
class TextInputGroupUtilities extends TextInputGroupSubComponent {
 ...
 $ctor__org_patternfly_component_textinputgroup_TextInputGroupUtilities__void() {
  this.$ctor__org_patternfly_component_textinputgroup_TextInputGroupSubComponent__java_lang_String__java_lang_String__elemental2_dom_HTMLElement__void(TextInputGroupUtilities.f_SUB_COMPONENT_ID__org_patternfly_component_textinputgroup_TextInputGroupUtilities, TextInputGroupUtilities.f_SUB_COMPONENT_NAME__org_patternfly_component_textinputgroup_TextInputGroupUtilities, /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_textInputGroup__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_utilities__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), $Overlay)));
 }
 /** @nodts @return {TextInputGroupUtilities} */
...
/**@const {string} @nodts*/
TextInputGroupUtilities.f_SUB_COMPONENT_ID__org_patternfly_component_textinputgroup_TextInputGroupUtilities = 'tigu';
/**@const {string} @nodts*/
TextInputGroupUtilities.f_SUB_COMPONENT_NAME__org_patternfly_component_textinputgroup_TextInputGroupUtilities = 'TextInputGroupUtilities';
