...
class SimpleListType extends Enum {
 ...
 static m_valueOf__java_lang_String__org_patternfly_component_list_SimpleListType(/** string */ name) {
  ...
  if ($Equality.$same(SimpleListType.f_namesToValuesMap__org_patternfly_component_list_SimpleListType_, null)) {
   SimpleListType.f_namesToValuesMap__org_patternfly_component_list_SimpleListType_ = (/**@type {Map<?string, !SimpleListType>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(SimpleListType.m_values__arrayOf_org_patternfly_component_list_SimpleListType())));
  }
  return /**@type {SimpleListType}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, SimpleListType.f_namesToValuesMap__org_patternfly_component_list_SimpleListType_));
 }
 /** @nodts @return {!Array<!SimpleListType>} */
 static m_values__arrayOf_org_patternfly_component_list_SimpleListType() {
  SimpleListType.$clinit();
  return /**@type {!Array<!SimpleListType>}*/ ($Arrays.$stampType([SimpleListType.f_undefined__org_patternfly_component_list_SimpleListType, SimpleListType.f_items__org_patternfly_component_list_SimpleListType, SimpleListType.f_groups__org_patternfly_component_list_SimpleListType], SimpleListType));
 }
 /** @nodts */
 static $clinit() {
  SimpleListType.$clinit = () =>{};
