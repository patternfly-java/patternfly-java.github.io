 ...
 * @implements {SVGElementDataMethods<E, B>}
 * @implements {SVGElementStyleMethods<E, B>}
 */
class BaseComponentSVG extends j_l_Object {
 ...
 $ctor__org_patternfly_component_BaseComponentSVG__org_patternfly_component_ComponentType__org_jboss_elemento_svg_SVGElement__void(/** ComponentType */ componentType, /** E */ element) {
  ...
  Ouia.m_ouia__org_jboss_elemento_svg_SVGElement__java_lang_String__void(/**@type {SVGElement}*/ (element), componentType.f_componentName__org_patternfly_component_ComponentType);
 }
 /** @nodts @return {B} */
 m_ouiaId__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ id) {
  Ouia.m_ouia__org_jboss_elemento_svg_SVGElement__java_lang_String__java_lang_String__void(/**@type {SVGElement}*/ (this.m_element__org_jboss_elemento_svg_SVGElement()), id, this.m_componentType__org_patternfly_component_ComponentType().f_componentName__org_patternfly_component_ComponentType);
 ...
 m_data__java_lang_String__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ arg0, /** ?string */ arg1) {
  return SVGElementDataMethods.m_data__$default__org_jboss_elemento_svg_SVGElementDataMethods__java_lang_String__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0, arg1);
 }
 //Default method forwarding stub.
 /** @override @nodts @return {B} */
 m_style__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ arg0) {
  return SVGElementStyleMethods.m_style__$default__org_jboss_elemento_svg_SVGElementStyleMethods__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0);
 }
 //Default method forwarding stub.
 /** @override @nodts @return {B} */
 m_style__java_lang_String__boolean__org_jboss_elemento_TypedBuilder(/** ?string */ arg0, /** boolean */ arg1) {
  return SVGElementStyleMethods.m_style__$default__org_jboss_elemento_svg_SVGElementStyleMethods__java_lang_String__boolean__org_jboss_elemento_TypedBuilder(this, arg0, arg1);
 }
 //Default method forwarding stub.
 /** @override @nodts @return {B} */
 m_style__java_lang_String__int__org_jboss_elemento_TypedBuilder(/** ?string */ arg0, /** number */ arg1) {
  return SVGElementStyleMethods.m_style__$default__org_jboss_elemento_svg_SVGElementStyleMethods__java_lang_String__int__org_jboss_elemento_TypedBuilder(this, arg0, arg1);
 }
 //Default method forwarding stub.
 /** @override @nodts @return {B} */
 m_style__java_lang_String__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ arg0, /** ?string */ arg1) {
  return SVGElementStyleMethods.m_style__$default__org_jboss_elemento_svg_SVGElementStyleMethods__java_lang_String__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0, arg1);
 }
 //Default method forwarding stub.
 /** @override @nodts @return {B} */
 m_style__java_lang_String__int__boolean__org_jboss_elemento_TypedBuilder(/** ?string */ arg0, /** number */ arg1, /** boolean */ arg2) {
  return SVGElementStyleMethods.m_style__$default__org_jboss_elemento_svg_SVGElementStyleMethods__java_lang_String__int__boolean__org_jboss_elemento_TypedBuilder(this, arg0, arg1, arg2);
 }
 //Default method forwarding stub.
 /** @override @nodts @return {B} */
 m_style__java_lang_String__java_lang_String__boolean__org_jboss_elemento_TypedBuilder(/** ?string */ arg0, /** ?string */ arg1, /** boolean */ arg2) {
  return SVGElementStyleMethods.m_style__$default__org_jboss_elemento_svg_SVGElementStyleMethods__java_lang_String__java_lang_String__boolean__org_jboss_elemento_TypedBuilder(this, arg0, arg1, arg2);
 }
 /** @nodts */
 static $clinit() {
...
ElementAttributeMethods.$markImplementor(BaseComponentSVG);
ElementClassListMethods.$markImplementor(BaseComponentSVG);
ElementConsumerMethods.$markImplementor(BaseComponentSVG);
ElementContainerMethods.$markImplementor(BaseComponentSVG);
ElementEventMethods.$markImplementor(BaseComponentSVG);
ElementIdMethods.$markImplementor(BaseComponentSVG);
ElementQueryMethods.$markImplementor(BaseComponentSVG);
SVGElementDataMethods.$markImplementor(BaseComponentSVG);
SVGElementStyleMethods.$markImplementor(BaseComponentSVG);
