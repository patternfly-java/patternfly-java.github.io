goog.module('org.patternfly.component.ComponentIconAndText$impl');
...
class ComponentIconAndText {
 ...
 static m_iconAndText__$default__org_patternfly_component_ComponentIconAndText__org_patternfly_icon_PredefinedIcon__java_lang_String__org_jboss_elemento_TypedBuilder(/** !ComponentIconAndText<E, B> */ $thisArg, /** PredefinedIcon */ icon, /** ?string */ text) {
 ...
 /** @nodts @template E, B @return {B} */
 static m_iconAndText__$default__org_patternfly_component_ComponentIconAndText__org_patternfly_icon_PredefinedIcon__java_lang_String__org_patternfly_component_IconPosition__org_jboss_elemento_TypedBuilder(/** !ComponentIconAndText<E, B> */ $thisArg, /** PredefinedIcon */ icon, /** ?string */ text, /** IconPosition */ position) {
  ComponentIconAndText.$clinit();
 ...
 static $clinit() {
  ComponentIconAndText.$clinit = () =>{};
  ComponentIconAndText.$loadModules();
 }
 
 static $markImplementor(/** Function */ ctor) {
  TypedBuilder.$markImplementor(ctor);
  IsElement.$markImplementor(ctor);
  ctor.prototype.$implements__org_patternfly_component_ComponentIconAndText = true;
 }
 /** @nodts @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance != null && !!instance.$implements__org_patternfly_component_ComponentIconAndText;
 }
...
ComponentIconAndText.$markImplementor(/**@type {Function}*/ (ComponentIconAndText));
$Util.$setClassMetadataForInterface(/**@type {Function}*/ (ComponentIconAndText), 'org.patternfly.component.ComponentIconAndText');

exports = ComponentIconAndText;

//# sourceMappingURL=ComponentIconAndText.js.map
