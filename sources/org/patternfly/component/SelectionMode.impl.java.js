...
class SelectionMode extends Enum {
 ...
 static m_valueOf__java_lang_String__org_patternfly_component_SelectionMode(/** string */ name) {
  ...
  if ($Equality.$same(SelectionMode.f_namesToValuesMap__org_patternfly_component_SelectionMode_, null)) {
   SelectionMode.f_namesToValuesMap__org_patternfly_component_SelectionMode_ = (/**@type {Map<?string, !SelectionMode>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(SelectionMode.m_values__arrayOf_org_patternfly_component_SelectionMode())));
  }
  return /**@type {SelectionMode}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, SelectionMode.f_namesToValuesMap__org_patternfly_component_SelectionMode_));
 }
 /** @nodts @return {!Array<!SelectionMode>} */
 static m_values__arrayOf_org_patternfly_component_SelectionMode() {
  SelectionMode.$clinit();
  return /**@type {!Array<!SelectionMode>}*/ ($Arrays.$stampType([SelectionMode.f_click__org_patternfly_component_SelectionMode, SelectionMode.f_single__org_patternfly_component_SelectionMode, SelectionMode.f_group__org_patternfly_component_SelectionMode, SelectionMode.f_multi__org_patternfly_component_SelectionMode], SelectionMode));
 }
 /** @nodts */
 static $clinit() {
  SelectionMode.$clinit = () =>{};
...
/**@const {number} @nodts*/
SelectionMode.$ordinal_group__org_patternfly_component_SelectionMode = 2;
/**@const {number} @nodts*/
SelectionMode.$ordinal_multi__org_patternfly_component_SelectionMode = 3;
...
/**@const {!SelectionMode} @nodts*/
SelectionMode.f_group__org_patternfly_component_SelectionMode = /**@pureOrBreakMyCode*/ SelectionMode.$create__java_lang_String__int($Util.$makeEnumName('group'), SelectionMode.$ordinal_group__org_patternfly_component_SelectionMode);
/**@const {!SelectionMode} @nodts*/
