...
class Spinner extends BaseComponentSVG {
 ...
 m_size__org_patternfly_style_Size__org_patternfly_component_spinner_Spinner(/** Size */ size) {
  return /**@type {Spinner}*/ ($Casts.$to(TypedModifier.m_swap__org_jboss_elemento_TypedBuilder__elemental2_dom_Element__org_patternfly_style_TypedModifier__arrayOf_org_patternfly_style_TypedModifier__org_jboss_elemento_TypedBuilder(this, this.m_element__org_jboss_elemento_svg_SVGElement(), size, Size.m_values__arrayOf_org_patternfly_style_Size()), Spinner));
 }
 /** @nodts @return {Spinner} */
 m_diameter__java_lang_String__org_patternfly_component_spinner_Spinner(/** ?string */ diameter) {
  return /**@type {Spinner}*/ ($Casts.$to((/**@type {SVGBuilder<SVGElement, Spinner>}*/ (Variable.m_componentVar__java_lang_String__arrayOf_java_lang_String__org_patternfly_style_Variable(Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_spinner__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$create([0], j_l_String))), /**@type {!Array<?string>}*/ ($Arrays.$stampType(['diameter'], j_l_String))).m_applyTo__org_jboss_elemento_svg_SVGElementStyleMethods__org_patternfly_style_VariableAssignments_SVGBuilder(this))).m_set__java_lang_String__org_jboss_elemento_TypedBuilder(diameter), Spinner));
 }
 /** @nodts @return {Spinner} */
