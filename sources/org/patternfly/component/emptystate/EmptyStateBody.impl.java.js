 ...
 * @implements {ElementTextMethods<HTMLDivElement, EmptyStateBody>}
 */
class EmptyStateBody extends EmptyStateSubComponent {
 ...
 m_text__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ arg0) {
  return /**@type {EmptyStateBody}*/ ($Casts.$to(ElementTextMethods.m_text__$default__org_jboss_elemento_ElementTextMethods__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), EmptyStateBody));
 }
 ...
 //Default method forwarding stub.
 /** @nodts @return {EmptyStateBody} */
 m_text__java_lang_String__org_patternfly_component_emptystate_EmptyStateBody(/** ?string */ arg0) {
  return /**@type {EmptyStateBody}*/ ($Casts.$to(ElementTextMethods.m_text__$default__org_jboss_elemento_ElementTextMethods__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), EmptyStateBody));
 }
 /** @nodts */
 static $clinit() {
...
/**@const {string} @nodts*/
EmptyStateBody.f_SUB_COMPONENT_ID__org_patternfly_component_emptystate_EmptyStateBody = 'esb';
/**@const {string} @nodts*/
EmptyStateBody.f_SUB_COMPONENT_NAME__org_patternfly_component_emptystate_EmptyStateBody = 'EmptyStateBody';
ElementTextMethods.$markImplementor(EmptyStateBody);
