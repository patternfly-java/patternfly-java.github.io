...
/**@const {string} @nodts*/
EmptyStateActions.f_SUB_COMPONENT_ID__org_patternfly_component_emptystate_EmptyStateActions = 'esa';
/**@const {string} @nodts*/
EmptyStateActions.f_SUB_COMPONENT_NAME__org_patternfly_component_emptystate_EmptyStateActions = 'EmptyStateActions';
