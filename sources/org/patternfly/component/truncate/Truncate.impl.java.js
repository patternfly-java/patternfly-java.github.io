 ...
 */
class Truncate extends BaseComponent {
 /** @protected @nodts */
 constructor() {
  super();
  /**@type {Tooltip} @nodts*/
 ...
 $ctor__org_patternfly_component_truncate_Truncate__java_lang_String__org_patternfly_component_truncate_TruncatePosition__void(/** ?string */ text, /** TruncatePosition */ position) {
  this.$ctor__org_patternfly_component_BaseComponent__org_patternfly_component_ComponentType__elemental2_dom_HTMLElement__void(ComponentType.f_Truncate__org_patternfly_component_ComponentType, (/**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to(Elements.m_span__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_truncate__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$create([0], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement());
 ...
 m_text__java_lang_String() {
  return this.f_text__org_patternfly_component_truncate_Truncate_;
 }
 /** @nodts */
 m_internalUpdate__org_patternfly_component_truncate_TruncatePosition__org_patternfly_component_truncate_TruncatePosition__void_$p_org_patternfly_component_truncate_Truncate(/** TruncatePosition */ current, /** TruncatePosition */ previous) {
  switch (current.ordinal()) {
   ...
   case TruncatePosition.$ordinal_end__org_patternfly_component_truncate_TruncatePosition:
    ...
    this.m_failSafePrimaryTextElement__org_jboss_elemento_HTMLContainerBuilder_$p_org_patternfly_component_truncate_Truncate().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_truncate__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([current.f_suffix__org_patternfly_component_truncate_TruncatePosition], j_l_String)))], j_l_String)));
  ...
  this.f_tooltip__org_patternfly_component_truncate_Truncate_.m_text__java_lang_String__org_jboss_elemento_TypedBuilder(this.f_text__org_patternfly_component_truncate_Truncate_);
 }
 /** @nodts */
  ...
  if (!$Equality.$same(text, null)) {
   switch ((/**@type {TruncatePosition}*/ ($Casts.$to(this.f_position__org_patternfly_component_truncate_Truncate_.m_get__java_lang_Object(), TruncatePosition))).ordinal()) {
    ...
    case TruncatePosition.$ordinal_middle__org_patternfly_component_truncate_TruncatePosition:
     break;
    case TruncatePosition.$ordinal_end__org_patternfly_component_truncate_TruncatePosition:
     this.m_failSafePrimaryTextElement__org_jboss_elemento_HTMLContainerBuilder_$p_org_patternfly_component_truncate_Truncate().m_text__java_lang_String__org_jboss_elemento_TypedBuilder(text);
     break;
   }
   this.f_tooltip__org_patternfly_component_truncate_Truncate_.m_text__java_lang_String__org_jboss_elemento_TypedBuilder(text);
  }
 }
 /** @nodts */
 m_updatePrimaryText__java_lang_String__void_$p_org_patternfly_component_truncate_Truncate(/** ?string */ text) {
  ...
  if ($Equality.$same(this.f_position__org_patternfly_component_truncate_Truncate_.m_get__java_lang_Object(), TruncatePosition.f_end__org_patternfly_component_truncate_TruncatePosition)) {
   ...
   this.m_failSafePrimaryTextElement__org_jboss_elemento_HTMLContainerBuilder_$p_org_patternfly_component_truncate_Truncate().m_html__org_gwtproject_safehtml_shared_SafeHtml__org_jboss_elemento_TypedBuilder(safeHtml);
  }
 }
 /** @nodts */
 m_updateMiddleText__java_lang_String__void_$p_org_patternfly_component_truncate_Truncate(/** ?string */ text) {
  ...
  if (j_l_String.m_length__java_lang_String__int(first) > Truncate.f_MIN_WIDTH_CHARACTERS__org_patternfly_component_truncate_Truncate_) {
   (/**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to(this.m_failSafePrimaryTextElement__org_jboss_elemento_HTMLContainerBuilder_$p_org_patternfly_component_truncate_Truncate().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_truncate__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_start__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_text__java_lang_String__org_jboss_elemento_TypedBuilder(first);
   (/**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to(this.m_failSafeSecondaryTextElement__org_jboss_elemento_HTMLContainerBuilder_$p_org_patternfly_component_truncate_Truncate().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_truncate__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_end__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_text__java_lang_String__org_jboss_elemento_TypedBuilder(j_l_String.m_substring__java_lang_String__int__java_lang_String(text, j_l_String.m_length__java_lang_String__int(text) - this.f_trailingNumChars__org_patternfly_component_truncate_Truncate_ | 0));
  } else {
...
ElementTextMethods.$markImplementor(Truncate);
