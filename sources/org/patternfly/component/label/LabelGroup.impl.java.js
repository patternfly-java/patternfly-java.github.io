 ...
 * @implements {HasItems<HTMLDivElement, LabelGroup, Label>}
...
class LabelGroup extends BaseComponent {
 ...
 constructor() {
  ...
  this.f_items__org_patternfly_component_label_LabelGroup_;
  /**@type {AurHandler<LabelGroup, Label>} @nodts*/
  this.f_aur__org_patternfly_component_label_LabelGroup_;
  /**@type {List<CloseHandler<LabelGroup>>} @nodts*/
 ...
 $ctor__org_patternfly_component_label_LabelGroup__java_lang_String__void(/** ?string */ category) {
  this.$ctor__org_patternfly_component_BaseComponent__org_patternfly_component_ComponentType__elemental2_dom_HTMLElement__void(ComponentType.f_LabelGroup__org_patternfly_component_ComponentType, /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_labelGroup__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$create([0], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay)));
  this.f_items__org_patternfly_component_label_LabelGroup_ = (/**@type {!LinkedHashMap<?string, Label>}*/ (LinkedHashMap.$create__()));
  this.f_aur__org_patternfly_component_label_LabelGroup_ = (/**@type {!AurHandler<LabelGroup, Label>}*/ (AurHandler.$create__org_patternfly_component_HasItems(this)));
  this.f_closeHandler__org_patternfly_component_label_LabelGroup_ = (/**@type {!ArrayList<CloseHandler<LabelGroup>>}*/ (ArrayList.$create__()));
  this.f_expanded__org_patternfly_component_label_LabelGroup_ = false;
 ...
 m_detach__elemental2_dom_MutationRecord__void(/** MutationRecord */ mutationRecord) {
  if (!$Equality.$same(this.f_tooltipToggle__org_patternfly_component_label_LabelGroup_, null)) {
   this.f_tooltipToggle__org_patternfly_component_label_LabelGroup_.m_stop__void();
  }
 }
 /** @nodts @return {LabelGroup} */
 m_add__org_patternfly_component_label_Label__org_patternfly_component_label_LabelGroup(/** Label */ label) {
  this.f_items__org_patternfly_component_label_LabelGroup_.put(label.m_identifier__java_lang_String(), label);
  let itemElement = /**@type {HTMLLIElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLLIElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLLIElement>}*/ ($Casts.$to(Elements.m_li__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_labelGroup__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_list__org_patternfly_style_Classes, Classes.f_item__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(label), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), HTMLLIElement_$Overlay));
  ...
  return /**@type {LabelGroup}*/ ($Casts.$to(this.f_aur__org_patternfly_component_label_LabelGroup_.m_added__org_patternfly_component_HasIdentifier__org_patternfly_component_HasItems(label), LabelGroup));
 }
 /** @nodts @return {LabelGroup} */
 m_category__java_lang_String__org_patternfly_component_label_LabelGroup(/** ?string */ category) {
  if ($Equality.$same(this.f_categoryElement__org_patternfly_component_label_LabelGroup_, null)) {
   this.m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_category__org_patternfly_style_Classes)], j_l_String)));
   let categoryId = Id.m_unique__java_lang_String__arrayOf_java_lang_String__java_lang_String(this.m_componentType__org_patternfly_component_ComponentType().f_id__org_patternfly_component_ComponentType, /**@type {!Array<?string>}*/ ($Arrays.$stampType(['category'], j_l_String)));
   this.f_categoryElement__org_patternfly_component_label_LabelGroup_ = (/**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to(Elements.m_span__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_labelGroup__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_label__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_id__java_lang_String__org_jboss_elemento_TypedBuilder(categoryId), HTMLContainerBuilder))).m_aria__java_lang_String__boolean__org_jboss_elemento_TypedBuilder(Aria.f_hidden__org_patternfly_core_Aria, true), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement();
 ...
 m_closable__org_patternfly_handler_CloseHandler__org_patternfly_component_label_LabelGroup(/** CloseHandler<LabelGroup> */ closeHandler) {
  this.f_closeHandler__org_patternfly_component_label_LabelGroup_.add(closeHandler);
  let closeId = Id.m_unique__java_lang_String__arrayOf_java_lang_String__java_lang_String(this.m_componentType__org_patternfly_component_ComponentType().f_id__org_patternfly_component_ComponentType, /**@type {!Array<?string>}*/ ($Arrays.$stampType(['close'], j_l_String)));
 ...
 /** @nodts @return {LabelGroup} */
 m_onAdd__org_patternfly_component_AddItemHandler__org_patternfly_component_label_LabelGroup(/** AddItemHandler<LabelGroup, Label> */ onAdd) {
  return /**@type {LabelGroup}*/ ($Casts.$to(this.f_aur__org_patternfly_component_label_LabelGroup_.m_onAdd__org_patternfly_component_AddItemHandler__org_patternfly_component_HasItems(onAdd), LabelGroup));
 }
 /** @nodts @return {LabelGroup} */
 ...
 /** @nodts @return {LabelGroup} */
 m_onUpdate__org_patternfly_component_UpdateItemHandler__org_patternfly_component_label_LabelGroup(/** UpdateItemHandler<LabelGroup, Label> */ onUpdate) {
  return /**@type {LabelGroup}*/ ($Casts.$to(this.f_aur__org_patternfly_component_label_LabelGroup_.m_onUpdate__org_patternfly_component_UpdateItemHandler__org_patternfly_component_HasItems(onUpdate), LabelGroup));
 }
 /** @nodts @return {LabelGroup} */
 m_onRemove__org_patternfly_component_RemoveItemHandler__org_patternfly_component_label_LabelGroup(/** RemoveItemHandler<LabelGroup, Label> */ onRemove) {
  return /**@type {LabelGroup}*/ ($Casts.$to(this.f_aur__org_patternfly_component_label_LabelGroup_.m_onRemove__org_patternfly_component_RemoveItemHandler__org_patternfly_component_HasItems(onRemove), LabelGroup));
 }
 /** @override @nodts */
 m_close__elemental2_dom_Event__boolean__void(/** Event */ event, /** boolean */ fireEvent) {
  if (CloseHandler.m_shouldClose__java_lang_Object__java_util_List__elemental2_dom_Event__boolean__boolean(this, this.f_closeHandler__org_patternfly_component_label_LabelGroup_, event, fireEvent)) {
   Elements.m_failSafeRemoveFromParent__org_jboss_elemento_IsElement__boolean(this);
   CloseHandler.m_fireEvent__java_lang_Object__java_util_List__elemental2_dom_Event__boolean__void(this, this.f_closeHandler__org_patternfly_component_label_LabelGroup_, event, fireEvent);
  }
 }
 /** @override @nodts @return {Iterator<Label>} */
 m_iterator__java_util_Iterator() {
  return this.f_items__org_patternfly_component_label_LabelGroup_.values().m_iterator__java_util_Iterator();
 }
 /** @override @nodts @return {number} */
 m_size__int() {
  return this.f_items__org_patternfly_component_label_LabelGroup_.size();
 }
 /** @override @nodts @return {boolean} */
 m_isEmpty__boolean() {
  return this.f_items__org_patternfly_component_label_LabelGroup_.isEmpty();
 }
 /** @override @nodts @return {boolean} */
 m_contains__java_lang_String__boolean(/** ?string */ identifier) {
  return this.f_items__org_patternfly_component_label_LabelGroup_.containsKey(identifier);
 }
 /** @nodts @return {Label} */
 m_item__java_lang_String__org_patternfly_component_label_Label(/** ?string */ identifier) {
  return /**@type {Label}*/ ($Casts.$to(this.f_items__org_patternfly_component_label_LabelGroup_.get(identifier), Label));
 }
 /** @nodts */
 m_updateItem__org_patternfly_component_label_Label__void(/** Label */ item) {
  this.m_replaceItemElement__org_patternfly_component_HasIdentifier__java_util_function_BiConsumer__void(item, BiConsumer.$adapt((/** Label */ oldItem, /** Label */ newItem) =>{
   let oldItem_1 = /**@type {Label}*/ ($Casts.$to(oldItem, Label));
   let newItem_1 = /**@type {Label}*/ ($Casts.$to(newItem, Label));
   this.f_items__org_patternfly_component_label_LabelGroup_.put(newItem_1.m_identifier__java_lang_String(), newItem_1);
   this.f_aur__org_patternfly_component_label_LabelGroup_.m_updated__org_patternfly_component_HasIdentifier__org_patternfly_component_HasIdentifier__org_patternfly_component_HasItems(oldItem_1, newItem_1);
  }));
 }
 /** @override @nodts */
 m_removeItem__java_lang_String__void(/** ?string */ identifier) {
  let item = /**@type {Label}*/ ($Casts.$to(this.f_items__org_patternfly_component_label_LabelGroup_.remove(identifier), Label));
  Elements.m_failSafeRemoveFromParent__org_jboss_elemento_IsElement__boolean(item);
  this.f_aur__org_patternfly_component_label_LabelGroup_.m_removed__org_patternfly_component_HasIdentifier__org_patternfly_component_HasItems(item);
 }
 /** @override @nodts */
 m_clear__void() {
  ...
  let iterator = this.f_items__org_patternfly_component_label_LabelGroup_.values().m_iterator__java_util_Iterator();
  while (iterator.m_hasNext__boolean()) {
   let item = /**@type {Label}*/ ($Casts.$to(iterator.m_next__java_lang_Object(), Label));
 ...
 m_close__org_patternfly_component_label_Label__void_$pp_org_patternfly_component_label(/** Label */ label) {
  this.f_items__org_patternfly_component_label_LabelGroup_.remove(label.m_identifier__java_lang_String());
  ...
  this.m_overflow__void_$p_org_patternfly_component_label_LabelGroup();
  this.f_aur__org_patternfly_component_label_LabelGroup_.m_removed__org_patternfly_component_HasIdentifier__org_patternfly_component_HasItems(label);
 }
 /** @nodts */
 m_overflow__void_$p_org_patternfly_component_label_LabelGroup() {
  if (this.f_items__org_patternfly_component_label_LabelGroup_.size() > this.f_numLabels__org_patternfly_component_label_LabelGroup_ && $Equality.$same(this.f_overflowItem__org_patternfly_component_label_LabelGroup_, null) && $Equality.$same(this.f_overflowLabel__org_patternfly_component_label_LabelGroup_, null)) {
   let identifier = Id.m_unique__java_lang_String__arrayOf_java_lang_String__java_lang_String(this.m_componentType__org_patternfly_component_ComponentType().f_id__org_patternfly_component_ComponentType, /**@type {!Array<?string>}*/ ($Arrays.$stampType(['overflow'], j_l_String)));
   this.f_overflowItem__org_patternfly_component_label_LabelGroup_ = (/**@type {HTMLLIElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLLIElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLLIElement>}*/ ($Casts.$to(Elements.m_li__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_chipGroup__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_list__org_patternfly_style_Classes, Classes.f_item__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(this.f_overflowLabel__org_patternfly_component_label_LabelGroup_ = (/**@type {Label}*/ ($Casts.$to((/**@type {Label}*/ ($Casts.$to(Label.m_label__org_jboss_elemento_HTMLContainerBuilder__java_lang_String__java_lang_String__org_patternfly_style_Color__org_patternfly_component_label_Label(Elements.m_button__org_jboss_elemento_ButtonType__org_jboss_elemento_HTMLContainerBuilder(ButtonType.f_button__org_jboss_elemento_ButtonType), identifier, '', Color.f_grey__org_patternfly_style_Color).m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_overflow__org_patternfly_style_Classes)], j_l_String))), Label))).m_on__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn__org_jboss_elemento_TypedBuilder(EventType.f_click__org_jboss_elemento_EventType, (/** MouseEvent */ event) =>{
    let event_1 = /**@type {MouseEvent}*/ ($Casts.$to(event, MouseEvent_$Overlay));
  ...
  let index = 0;
  for (let $iterator = this.f_items__org_patternfly_component_label_LabelGroup_.values().m_iterator__java_util_Iterator(); $iterator.m_hasNext__boolean(); ) {
 ...
 //Default method forwarding stub.
 /** @override @nodts @return {Spliterator<Label>} */
 m_spliterator__java_util_Spliterator() {
  return /**@type {Spliterator<Label>}*/ (Iterable.m_spliterator__$default__java_lang_Iterable__java_util_Spliterator(this));
 }
 //Bridge method.
 /** @final @override @nodts @template T @return {LabelGroup} */
 m_addItems__java_lang_Iterable__java_util_function_Function__org_patternfly_component_HasItems(/** Iterable<T> */ arg0, /** j_u_function_Function<T, Label> */ arg1) {
  return /**@type {LabelGroup}*/ ($Casts.$to(HasItems.m_addItems__$default__org_patternfly_component_HasItems__java_lang_Iterable__java_util_function_Function__org_patternfly_component_HasItems(this, arg0, arg1), LabelGroup));
 }
 //Bridge method.
 /** @final @override @nodts @return {LabelGroup} */
 m_addItem__org_patternfly_component_HasIdentifier__org_patternfly_component_HasItems(/** Label */ arg0) {
  return /**@type {LabelGroup}*/ ($Casts.$to(HasItems.m_addItem__$default__org_patternfly_component_HasItems__org_patternfly_component_HasIdentifier__org_patternfly_component_HasItems(this, /**@type {Label}*/ ($Casts.$to(arg0, Label))), LabelGroup));
 }
 //Bridge method.
 /** @final @override @nodts @return {LabelGroup} */
 m_add__org_patternfly_component_HasIdentifier__org_patternfly_component_HasItems(/** Label */ arg0) {
  return this.m_add__org_patternfly_component_label_Label__org_patternfly_component_label_LabelGroup(/**@type {Label}*/ ($Casts.$to(arg0, Label)));
 }
 //Bridge method.
 /** @final @override @nodts @return {LabelGroup} */
 m_onAdd__org_patternfly_component_AddItemHandler__org_patternfly_component_HasItems(/** AddItemHandler<LabelGroup, Label> */ arg0) {
  return this.m_onAdd__org_patternfly_component_AddItemHandler__org_patternfly_component_label_LabelGroup(arg0);
 }
 //Default method forwarding stub.
 /** @override @nodts @return {List<Label>} */
 m_items__java_util_List() {
  return /**@type {List<Label>}*/ (HasItems.m_items__$default__org_patternfly_component_HasItems__java_util_List(this));
 }
 //Bridge method.
 /** @final @override @nodts @return {Label} */
 m_item__java_lang_String__org_patternfly_component_HasIdentifier(/** ?string */ arg0) {
  return this.m_item__java_lang_String__org_patternfly_component_label_Label(arg0);
 }
 //Default method forwarding stub.
 /** @override @nodts @template T */
 m_updateItem__java_lang_Object__java_util_function_Function__void(/** T */ arg0, /** j_u_function_Function<T, Label> */ arg1) {
 ...
 m_updateItem__org_patternfly_component_HasIdentifier__void(/** Label */ arg0) {
  this.m_updateItem__org_patternfly_component_label_Label__void(/**@type {Label}*/ ($Casts.$to(arg0, Label)));
 }
 //Bridge method.
 /** @final @override @nodts @return {LabelGroup} */
 m_onUpdate__org_patternfly_component_UpdateItemHandler__org_patternfly_component_HasItems(/** UpdateItemHandler<LabelGroup, Label> */ arg0) {
  return this.m_onUpdate__org_patternfly_component_UpdateItemHandler__org_patternfly_component_label_LabelGroup(arg0);
 }
 //Bridge method.
 /** @final @override @nodts */
 m_replaceItemElement__org_patternfly_component_HasIdentifier__java_util_function_BiConsumer__void(/** Label */ arg0, /** BiConsumer<Label, Label> */ arg1) {
  HasItems.m_replaceItemElement__$default__org_patternfly_component_HasItems__org_patternfly_component_HasIdentifier__java_util_function_BiConsumer__void(this, /**@type {Label}*/ ($Casts.$to(arg0, Label)), arg1);
 }
 //Bridge method.
 /** @final @override @nodts @return {LabelGroup} */
 m_onRemove__org_patternfly_component_RemoveItemHandler__org_patternfly_component_HasItems(/** RemoveItemHandler<LabelGroup, Label> */ arg0) {
  return this.m_onRemove__org_patternfly_component_RemoveItemHandler__org_patternfly_component_label_LabelGroup(arg0);
 }
 //Bridge method.
 /** @final @override @nodts @return {LabelGroup} */
 ...
 m_addItems__java_lang_Iterable__java_util_function_Function__org_patternfly_component_label_LabelGroup(/** Iterable<T> */ arg0, /** j_u_function_Function<T, Label> */ arg1) {
  return /**@type {LabelGroup}*/ ($Casts.$to(HasItems.m_addItems__$default__org_patternfly_component_HasItems__java_lang_Iterable__java_util_function_Function__org_patternfly_component_HasItems(this, arg0, arg1), LabelGroup));
 }
 //Default method forwarding stub.
 /** @nodts @return {LabelGroup} */
 m_addItem__org_patternfly_component_label_Label__org_patternfly_component_label_LabelGroup(/** Label */ arg0) {
  return /**@type {LabelGroup}*/ ($Casts.$to(HasItems.m_addItem__$default__org_patternfly_component_HasItems__org_patternfly_component_HasIdentifier__org_patternfly_component_HasItems(this, arg0), LabelGroup));
 }
 //Default method forwarding stub.
 /** @nodts */
 m_replaceItemElement__org_patternfly_component_label_Label__java_util_function_BiConsumer__void(/** Label */ arg0, /** BiConsumer<Label, Label> */ arg1) {
...
HasItems.$markImplementor(LabelGroup);
