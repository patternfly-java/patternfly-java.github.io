...
class TooltipToggle extends j_l_Object {
  ...
  DomGlobal_$Overlay.m_setTimeout__elemental2_dom_DomGlobal_SetTimeoutCallbackFn__double__arrayOf_java_lang_Object__double((.../** ...* */ __) =>{
   ...
   if (enableTooltip) {
    if ($Equality.$same(this.f_tooltip__org_patternfly_component_tooltip_TooltipToggle, null)) {
     TooltipToggle.f_logger__org_patternfly_component_tooltip_TooltipToggle_.m_debug__java_lang_String__arrayOf_java_lang_Object__void('Tooltip toggle enabled for %o', [this.f_textElement__org_patternfly_component_tooltip_TooltipToggle]);
     this.f_tooltip__org_patternfly_component_tooltip_TooltipToggle = Tooltip.m_tooltip__elemental2_dom_HTMLElement__java_lang_String__org_patternfly_component_tooltip_Tooltip(this.f_textElement__org_patternfly_component_tooltip_TooltipToggle, this.f_textElement__org_patternfly_component_tooltip_TooltipToggle.textContent);
     DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay.body.appendChild(/**@type {HTMLDivElement}*/ ($Casts.$to(this.f_tooltip__org_patternfly_component_tooltip_TooltipToggle.m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay)));
    } else {
     this.f_tooltip__org_patternfly_component_tooltip_TooltipToggle.m_text__java_lang_String__org_jboss_elemento_TypedBuilder(this.f_textElement__org_patternfly_component_tooltip_TooltipToggle.textContent);
    }
 ...
 m_stop__void() {
  if (!$Equality.$same(this.f_tooltip__org_patternfly_component_tooltip_TooltipToggle, null)) {
   TooltipToggle.f_logger__org_patternfly_component_tooltip_TooltipToggle_.m_debug__java_lang_String__arrayOf_java_lang_Object__void('Stop tooltip toggle for %o', [this.f_textElement__org_patternfly_component_tooltip_TooltipToggle]);
 ...
 static $clinit() {
  ...
  j_l_Object.$clinit();
  TooltipToggle.f_logger__org_patternfly_component_tooltip_TooltipToggle_ = Logger.m_getLogger__java_lang_String__org_jboss_elemento_logger_Logger(Class.$get(TooltipToggle).m_getName__java_lang_String());
 }
...
/**@type {Logger} @nodts*/
TooltipToggle.f_logger__org_patternfly_component_tooltip_TooltipToggle_;
