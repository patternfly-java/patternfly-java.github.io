 ...
 * @implements {ElementTextMethods<HTMLDivElement, PopoverBody>}
 */
class PopoverBody extends PopoverSubComponent {
 ...
 m_text__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ arg0) {
  return /**@type {PopoverBody}*/ ($Casts.$to(ElementTextMethods.m_text__$default__org_jboss_elemento_ElementTextMethods__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), PopoverBody));
 }
 ...
 //Default method forwarding stub.
 /** @nodts @return {PopoverBody} */
 m_text__java_lang_String__org_patternfly_component_popover_PopoverBody(/** ?string */ arg0) {
  return /**@type {PopoverBody}*/ ($Casts.$to(ElementTextMethods.m_text__$default__org_jboss_elemento_ElementTextMethods__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), PopoverBody));
 }
 /** @nodts */
 static $clinit() {
...
/**@const {string} @nodts*/
PopoverBody.f_SUB_COMPONENT_ID__org_patternfly_component_popover_PopoverBody = 'npb';
/**@const {string} @nodts*/
PopoverBody.f_SUB_COMPONENT_NAME__org_patternfly_component_popover_PopoverBody = 'PopoverBody';
ElementTextMethods.$markImplementor(PopoverBody);
