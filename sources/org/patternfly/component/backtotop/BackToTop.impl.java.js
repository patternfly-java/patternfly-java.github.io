 ...
 * @implements {ElementTextMethods<HTMLElement, BackToTop>}
 */
class BackToTop extends BaseComponent {
 ...
 $ctor__org_patternfly_component_backtotop_BackToTop__java_lang_String__void(/** ?string */ text) {
  this.$ctor__org_patternfly_component_BaseComponent__org_patternfly_component_ComponentType__elemental2_dom_HTMLElement__void(ComponentType.f_BackToTop__org_patternfly_component_ComponentType, /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_backToTop__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$create([0], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay)));
  this.f_alwaysVisible__org_patternfly_component_backtotop_BackToTop_ = false;
 ...
 m_attach__elemental2_dom_MutationRecord__void(/** MutationRecord */ mutationRecord) {
  if (!this.f_alwaysVisible__org_patternfly_component_backtotop_BackToTop_) {
   this.m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_hidden__org_patternfly_style_Classes)], j_l_String)));
   ...
   if ($Equality.$same(this.f_element__org_patternfly_component_backtotop_BackToTop_, null)) {
    this.f_hr__org_patternfly_component_backtotop_BackToTop_ = EventType.m_bind__elemental2_dom_EventTarget__java_lang_String__elemental2_dom_EventListener__org_gwtproject_event_shared_HandlerRegistration(goog.global.window, EventType.f_scroll__org_jboss_elemento_EventType.f_name__org_jboss_elemento_EventType, EventListener_$Overlay.$adapt__elemental2_dom_EventListener_$JsFunction__elemental2_dom_EventListener((/** Event */ __) =>{
     this.m_toggleVisible__int__void_$p_org_patternfly_component_backtotop_BackToTop(Primitives.m_narrowDoubleToInt__int__int(goog.global.window.scrollY));
    }));
   } else {
    this.f_hr__org_patternfly_component_backtotop_BackToTop_ = EventType.m_bind__elemental2_dom_EventTarget__java_lang_String__elemental2_dom_EventListener__org_gwtproject_event_shared_HandlerRegistration(this.f_element__org_patternfly_component_backtotop_BackToTop_, EventType.f_scroll__org_jboss_elemento_EventType.f_name__org_jboss_elemento_EventType, EventListener_$Overlay.$adapt__elemental2_dom_EventListener_$JsFunction__elemental2_dom_EventListener((/** Event */ ___1) =>{
     this.m_toggleVisible__int__void_$p_org_patternfly_component_backtotop_BackToTop(Primitives.m_narrowDoubleToInt__int__int(this.f_element__org_patternfly_component_backtotop_BackToTop_.scrollTop));
    }));
   }
  }
 }
 ...
 m_scrollableSelector__java_lang_String__org_patternfly_component_backtotop_BackToTop(/** ?string */ selector) {
  return this.m_scrollableSelector__java_util_function_Supplier__org_patternfly_component_backtotop_BackToTop(Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
 ...
 m_text__java_lang_String() {
  return this.f_button__org_patternfly_component_backtotop_BackToTop_.m_text__java_lang_String();
 }
 /** @nodts */
...
ElementTextMethods.$markImplementor(BackToTop);
