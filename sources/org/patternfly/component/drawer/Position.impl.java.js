...
class Position extends Enum {
 ...
 static m_valueOf__java_lang_String__org_patternfly_component_drawer_Position(/** string */ name) {
  ...
  if ($Equality.$same(Position.f_namesToValuesMap__org_patternfly_component_drawer_Position_, null)) {
   Position.f_namesToValuesMap__org_patternfly_component_drawer_Position_ = (/**@type {Map<?string, !Position>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(Position.m_values__arrayOf_org_patternfly_component_drawer_Position())));
  }
  return /**@type {Position}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, Position.f_namesToValuesMap__org_patternfly_component_drawer_Position_));
 }
 /** @nodts @return {!Array<!Position>} */
 static m_values__arrayOf_org_patternfly_component_drawer_Position() {
  Position.$clinit();
  return /**@type {!Array<!Position>}*/ ($Arrays.$stampType([Position.$static_start__org_patternfly_component_drawer_Position, Position.$static_end__org_patternfly_component_drawer_Position, Position.$static_bottom__org_patternfly_component_drawer_Position], Position));
 }
 /** @nodts @return {!Position} */
