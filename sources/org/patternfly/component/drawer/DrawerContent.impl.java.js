...
class DrawerContent extends DrawerSubComponent {
 ...
 $ctor__org_patternfly_component_drawer_DrawerContent__void() {
  this.$ctor__org_patternfly_component_drawer_DrawerSubComponent__java_lang_String__java_lang_String__elemental2_dom_HTMLElement__void(DrawerContent.f_SUB_COMPONENT_ID__org_patternfly_component_drawer_DrawerContent, DrawerContent.f_SUB_COMPONENT_NAME__org_patternfly_component_drawer_DrawerContent, /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_drawer__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_content__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), $Overlay)));
 }
 /** @nodts @return {DrawerContent} */
 m_addBody__org_patternfly_component_drawer_DrawerBody__org_patternfly_component_drawer_DrawerContent(/** DrawerBody */ body) {
 ...
 m_color__org_patternfly_component_drawer_DrawerColor__org_patternfly_component_drawer_DrawerContent(/** DrawerColor */ color) {
  return /**@type {DrawerContent}*/ ($Casts.$to(this.m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([color.f_modifier__org_patternfly_component_drawer_DrawerColor], j_l_String))), DrawerContent));
 }
 /** @nodts @return {DrawerContent} */
...
/**@const {string} @nodts*/
DrawerContent.f_SUB_COMPONENT_ID__org_patternfly_component_drawer_DrawerContent = 'dc';
/**@const {string} @nodts*/
DrawerContent.f_SUB_COMPONENT_NAME__org_patternfly_component_drawer_DrawerContent = 'DrawerContent';
