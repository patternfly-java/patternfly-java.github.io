...
class DrawerCloseButton extends DrawerSubComponent {
 ...
 m_close__void_$p_org_patternfly_component_drawer_DrawerCloseButton() {
  let drawer = /**@type {Drawer}*/ ($Casts.$to(this.m_lookupComponent__org_patternfly_component_BaseComponent(), Drawer));
...
/**@const {string} @nodts*/
DrawerCloseButton.f_SUB_COMPONENT_ID__org_patternfly_component_drawer_DrawerCloseButton = 'dcbtn';
/**@const {string} @nodts*/
DrawerCloseButton.f_SUB_COMPONENT_NAME__org_patternfly_component_drawer_DrawerCloseButton = 'DrawerCloseButton';
