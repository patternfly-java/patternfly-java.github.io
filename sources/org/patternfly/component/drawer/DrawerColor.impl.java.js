...
class DrawerColor extends Enum {
 ...
 static m_valueOf__java_lang_String__org_patternfly_component_drawer_DrawerColor(/** string */ name) {
  ...
  if ($Equality.$same(DrawerColor.f_namesToValuesMap__org_patternfly_component_drawer_DrawerColor_, null)) {
   DrawerColor.f_namesToValuesMap__org_patternfly_component_drawer_DrawerColor_ = (/**@type {Map<?string, !DrawerColor>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(DrawerColor.m_values__arrayOf_org_patternfly_component_drawer_DrawerColor())));
  }
  return /**@type {DrawerColor}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, DrawerColor.f_namesToValuesMap__org_patternfly_component_drawer_DrawerColor_));
 }
 /** @nodts @return {!Array<!DrawerColor>} */
 static m_values__arrayOf_org_patternfly_component_drawer_DrawerColor() {
  DrawerColor.$clinit();
  return /**@type {!Array<!DrawerColor>}*/ ($Arrays.$stampType([DrawerColor.$static_light200__org_patternfly_component_drawer_DrawerColor, DrawerColor.$static_noBackground__org_patternfly_component_drawer_DrawerColor], DrawerColor));
 }
 /** @nodts @return {!DrawerColor} */
