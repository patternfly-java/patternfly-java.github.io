...
let DrawerBody = goog.forwardDeclare('org.patternfly.component.drawer.DrawerBody$impl');
 ...
 * @implements {Glass<HTMLDivElement, DrawerPanel>}
 * @implements {NoPlainOnGlass<HTMLDivElement, DrawerPanel>}
 */
class DrawerPanel extends DrawerSubComponent {
 ...
 constructor() {
  ...
  /**@type {List<ResizeHandler<DrawerPanel>>} @nodts*/
 ...
 $ctor__org_patternfly_component_drawer_DrawerPanel__void() {
  this.$ctor__org_patternfly_component_drawer_DrawerSubComponent__java_lang_String__java_lang_String__elemental2_dom_HTMLElement__void(DrawerPanel.f_SUB_COMPONENT_ID__org_patternfly_component_drawer_DrawerPanel, DrawerPanel.f_SUB_COMPONENT_NAME__org_patternfly_component_drawer_DrawerPanel, /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_drawer__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_panel__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), $Overlay)));
  ...
  this.f_resizeHandler__org_patternfly_component_drawer_DrawerPanel_ = (/**@type {!ArrayList<ResizeHandler<DrawerPanel>>}*/ (ArrayList.$create__()));
 ...
 m_attach__elemental2_dom_MutationRecord__void(/** MutationRecord */ mutationRecord) {
  if (this.f_resizable__org_patternfly_component_drawer_DrawerPanel_) {
   this.f_drawer__org_patternfly_component_drawer_DrawerPanel_ = (/**@type {Drawer}*/ ($Casts.$to(this.m_lookupComponent__org_patternfly_component_BaseComponent(), Drawer)));
   ...
   if (!$Equality.$same(this.f_drawer__org_patternfly_component_drawer_DrawerPanel_.f_position__org_patternfly_component_drawer_Drawer, Position.f_bottom__org_patternfly_component_drawer_Position)) {
    this.f_splitterElement__org_patternfly_component_drawer_DrawerPanel_.m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_vertical__org_patternfly_style_Classes)], j_l_String)));
   }
   let mainContainer = /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_drawer__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_panel__org_patternfly_style_Classes, Classes.f_main__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), $Overlay));
   ...
   this.f_keyDownHandler__org_patternfly_component_drawer_DrawerPanel_ = EventType.m_bind__org_jboss_elemento_IsElement__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn__org_gwtproject_event_shared_HandlerRegistration(this.f_splitterElement__org_patternfly_component_drawer_DrawerPanel_, EventType.f_keydown__org_jboss_elemento_EventType, (/** KeyboardEvent */ arg0_4) =>{
 ...
 /** @nodts @return {DrawerPanel} */
 m_addBody__org_patternfly_component_drawer_DrawerBody__org_patternfly_component_drawer_DrawerPanel(/** DrawerBody */ body) {
 ...
 m_defaultSize__java_lang_String__org_patternfly_component_drawer_DrawerPanel(/** ?string */ defaultSize) {
  return /**@type {DrawerPanel}*/ ($Casts.$to((/**@type {HTMLBuilder<HTMLDivElement, DrawerPanel>}*/ (Variable.m_componentVar__java_lang_String__arrayOf_java_lang_String__org_patternfly_style_Variable(Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_drawer__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_panel__org_patternfly_style_Classes], j_l_String))), /**@type {!Array<?string>}*/ ($Arrays.$stampType([Breakpoint.f_md__org_patternfly_style_Breakpoint.f_value__org_patternfly_style_Breakpoint, Variables.f_FlexBasis__org_patternfly_style_Variables], j_l_String))).m_applyTo__org_jboss_elemento_HTMLElementStyleMethods__org_patternfly_style_VariableAssignments_HTMLBuilder(this))).m_set__java_lang_String__org_jboss_elemento_TypedBuilder(defaultSize), DrawerPanel));
 }
 /** @nodts @return {DrawerPanel} */
 m_minSize__java_lang_String__org_patternfly_component_drawer_DrawerPanel(/** ?string */ minSize) {
  return /**@type {DrawerPanel}*/ ($Casts.$to((/**@type {HTMLBuilder<HTMLDivElement, DrawerPanel>}*/ (Variable.m_componentVar__java_lang_String__arrayOf_java_lang_String__org_patternfly_style_Variable(Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_drawer__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_panel__org_patternfly_style_Classes], j_l_String))), /**@type {!Array<?string>}*/ ($Arrays.$stampType([Breakpoint.f_md__org_patternfly_style_Breakpoint.f_value__org_patternfly_style_Breakpoint, Variables.f_FlexBasis__org_patternfly_style_Variables, 'min'], j_l_String))).m_applyTo__org_jboss_elemento_HTMLElementStyleMethods__org_patternfly_style_VariableAssignments_HTMLBuilder(this))).m_set__java_lang_String__org_jboss_elemento_TypedBuilder(minSize), DrawerPanel));
 }
 /** @nodts @return {DrawerPanel} */
 m_maxSize__java_lang_String__org_patternfly_component_drawer_DrawerPanel(/** ?string */ maxSize) {
  return /**@type {DrawerPanel}*/ ($Casts.$to((/**@type {HTMLBuilder<HTMLDivElement, DrawerPanel>}*/ (Variable.m_componentVar__java_lang_String__arrayOf_java_lang_String__org_patternfly_style_Variable(Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_drawer__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_panel__org_patternfly_style_Classes], j_l_String))), /**@type {!Array<?string>}*/ ($Arrays.$stampType([Breakpoint.f_md__org_patternfly_style_Breakpoint.f_value__org_patternfly_style_Breakpoint, Variables.f_FlexBasis__org_patternfly_style_Variables, 'max'], j_l_String))).m_applyTo__org_jboss_elemento_HTMLElementStyleMethods__org_patternfly_style_VariableAssignments_HTMLBuilder(this))).m_set__java_lang_String__org_jboss_elemento_TypedBuilder(maxSize), DrawerPanel));
 }
 /** @nodts @return {DrawerPanel} */
 m_color__org_patternfly_component_drawer_DrawerColor__org_patternfly_component_drawer_DrawerPanel(/** DrawerColor */ color) {
  return /**@type {DrawerPanel}*/ ($Casts.$to(this.m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([color.f_modifier__org_patternfly_component_drawer_DrawerColor], j_l_String))), DrawerPanel));
 }
 /** @nodts @return {DrawerPanel} */
 ...
 m_resizable__org_patternfly_component_drawer_DrawerPanel() {
  ...
  return /**@type {DrawerPanel}*/ ($Casts.$to(this.m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_resizable__org_patternfly_style_Classes)], j_l_String))), DrawerPanel));
 }
 /** @nodts @return {DrawerPanel} */
 ...
 /** @nodts @return {DrawerPanel} */
 m_widths__org_patternfly_style_Width__org_patternfly_component_drawer_DrawerPanel(/** Width */ widths) {
  return this.m_widths__org_patternfly_style_Breakpoints__org_patternfly_component_drawer_DrawerPanel(/**@type {Breakpoints<Width>}*/ (Breakpoints.m_breakpoints__org_patternfly_style_Breakpoint__java_lang_Object__org_patternfly_style_Breakpoints(Breakpoint.f_default___org_patternfly_style_Breakpoint, widths)));
 }
 /** @nodts @return {DrawerPanel} */
 m_widths__org_patternfly_style_Breakpoints__org_patternfly_component_drawer_DrawerPanel(/** Breakpoints<Width> */ widths) {
  return /**@type {DrawerPanel}*/ ($Casts.$to(this.m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([widths.m_modifiers__java_lang_String()], j_l_String))), DrawerPanel));
 }
 /** @nodts @return {DrawerPanel} */
 ...
 m_onResize__org_patternfly_handler_ResizeHandler__org_patternfly_component_drawer_DrawerPanel(/** ResizeHandler<DrawerPanel> */ resizeHandler) {
  this.f_resizeHandler__org_patternfly_component_drawer_DrawerPanel_.add(resizeHandler);
  return this;
 }
 /** @nodts @return {number} */
 ...
 m_calcValueNow__int_$p_org_patternfly_component_drawer_DrawerPanel() {
  ...
  return Primitives.m_narrowLongToInt__long__int($LongUtils.divide(Math.m_round__double__long((newSplitterPos + JsNumber_$Overlay.f_EPSILON__elemental2_core_JsNumber_$Overlay) * 100), $Long.fromInt(100)));
 }
 /** @nodts */
 m_handleMouseDown__elemental2_dom_MouseEvent__void_$p_org_patternfly_component_drawer_DrawerPanel(/** MouseEvent */ event) {
  if (this.m_resizableDrawer__boolean_$p_org_patternfly_component_drawer_DrawerPanel()) {
   ...
   this.f_drawer__org_patternfly_component_drawer_DrawerPanel_.m_classList__org_jboss_elemento_ClassList().m_add__arrayOf_java_lang_String__void(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_resizing__org_patternfly_style_Classes)], j_l_String)));
 ...
 m_handleTouchStart__elemental2_dom_TouchEvent__void_$p_org_patternfly_component_drawer_DrawerPanel(/** TouchEvent */ event) {
  if (this.m_resizableDrawer__boolean_$p_org_patternfly_component_drawer_DrawerPanel()) {
   ...
   this.f_touchMoveHandler__org_patternfly_component_drawer_DrawerPanel_ = EventType.m_bind__elemental2_dom_EventTarget__org_jboss_elemento_EventType__elemental2_dom_AddEventListenerOptions__org_jboss_elemento_EventCallbackFn__org_gwtproject_event_shared_HandlerRegistration(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay, EventType.f_touchmove__org_jboss_elemento_EventType, options, (/** TouchEvent */ arg0) =>{
    let arg0_1 = /**@type {TouchEvent}*/ ($Casts.$to(arg0, TouchEvent_$Overlay));
    this.m_handleTouchMove__elemental2_dom_TouchEvent__void_$p_org_patternfly_component_drawer_DrawerPanel(arg0_1);
   });
   this.f_touchEndHandler__org_patternfly_component_drawer_DrawerPanel_ = EventType.m_bind__elemental2_dom_EventTarget__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn__org_gwtproject_event_shared_HandlerRegistration(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay, EventType.f_touchend__org_jboss_elemento_EventType, (/** TouchEvent */ arg0_2) =>{
    let arg0_3 = /**@type {TouchEvent}*/ ($Casts.$to(arg0_2, TouchEvent_$Overlay));
    this.m_handleTouchEnd__elemental2_dom_TouchEvent__void_$p_org_patternfly_component_drawer_DrawerPanel(arg0_3);
   });
   this.f_isResizing__org_patternfly_component_drawer_DrawerPanel_ = true;
  }
 }
 ...
 m_handleMouseUp__elemental2_dom_MouseEvent__void_$p_org_patternfly_component_drawer_DrawerPanel(/** MouseEvent */ event) {
  if (this.m_resizableDrawer__boolean_$p_org_patternfly_component_drawer_DrawerPanel() && this.f_isResizing__org_patternfly_component_drawer_DrawerPanel_) {
   this.f_drawer__org_patternfly_component_drawer_DrawerPanel_.m_classList__org_jboss_elemento_ClassList().m_remove__arrayOf_java_lang_String__void(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_resizing__org_patternfly_style_Classes)], j_l_String)));
   this.f_isResizing__org_patternfly_component_drawer_DrawerPanel_ = false;
   if (!this.f_resizeHandler__org_patternfly_component_drawer_DrawerPanel_.isEmpty()) {
    for (let $iterator = this.f_resizeHandler__org_patternfly_component_drawer_DrawerPanel_.m_iterator__java_util_Iterator(); $iterator.m_hasNext__boolean(); ) {
     let rh = /**@type {ResizeHandler<DrawerPanel>}*/ ($Casts.$to($iterator.m_next__java_lang_Object(), /**@type {Function}*/ (ResizeHandler)));
     {
      rh.m_onResize__java_lang_Object__void(this);
     }
    }
   }
   this.f_setInitialVals__org_patternfly_component_drawer_DrawerPanel_ = true;
 ...
 m_handleTouchEnd__elemental2_dom_TouchEvent__void_$p_org_patternfly_component_drawer_DrawerPanel(/** TouchEvent */ event) {
  if (this.m_resizableDrawer__boolean_$p_org_patternfly_component_drawer_DrawerPanel()) {
   ...
   if (this.f_isResizing__org_patternfly_component_drawer_DrawerPanel_) {
    this.f_isResizing__org_patternfly_component_drawer_DrawerPanel_ = false;
    this.f_resizeHandler__org_patternfly_component_drawer_DrawerPanel_.m_forEach__java_util_function_Consumer__void(Consumer.$adapt((/** ResizeHandler<DrawerPanel> */ rh) =>{
     let rh_1 = /**@type {ResizeHandler<DrawerPanel>}*/ ($Casts.$to(rh, /**@type {Function}*/ (ResizeHandler)));
     rh_1.m_onResize__java_lang_Object__void(this);
    }));
    this.f_touchMoveHandler__org_patternfly_component_drawer_DrawerPanel_.m_removeHandler__void();
    this.f_touchEndHandler__org_patternfly_component_drawer_DrawerPanel_.m_removeHandler__void();
   }
 ...
 m_updateSize__double__void_$p_org_patternfly_component_drawer_DrawerPanel(/** number */ newSize) {
  ...
  this.f_splitterElement__org_patternfly_component_drawer_DrawerPanel_.m_aria__java_lang_String__int__org_jboss_elemento_TypedBuilder(Aria.f_valueNow__org_patternfly_core_Aria, this.m_calcValueNow__int_$p_org_patternfly_component_drawer_DrawerPanel());
  (/**@type {HTMLBuilder<HTMLDivElement, DrawerPanel>}*/ (Variable.m_componentVar__java_lang_String__arrayOf_java_lang_String__org_patternfly_style_Variable(Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_drawer__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_panel__org_patternfly_style_Classes], j_l_String))), /**@type {!Array<?string>}*/ ($Arrays.$stampType([Breakpoint.f_md__org_patternfly_style_Breakpoint.f_value__org_patternfly_style_Breakpoint, Variables.f_FlexBasis__org_patternfly_style_Variables], j_l_String))).m_applyTo__org_jboss_elemento_HTMLElementStyleMethods__org_patternfly_style_VariableAssignments_HTMLBuilder(this))).m_set__java_lang_String__org_jboss_elemento_TypedBuilder(newSize + 'px');
 }
 ...
 m_glass__org_jboss_elemento_TypedBuilder() {
  return /**@type {DrawerPanel}*/ ($Casts.$to(Glass.m_glass__$default__org_patternfly_style_Modifiers_Glass__org_jboss_elemento_TypedBuilder(this), DrawerPanel));
 }
 //Bridge method.
 /** @final @override @nodts @return {DrawerPanel} */
 m_glass__boolean__org_jboss_elemento_TypedBuilder(/** boolean */ arg0) {
  return /**@type {DrawerPanel}*/ ($Casts.$to(Glass.m_glass__$default__org_patternfly_style_Modifiers_Glass__boolean__org_jboss_elemento_TypedBuilder(this, arg0), DrawerPanel));
 }
 //Bridge method.
 /** @final @override @nodts @return {DrawerPanel} */
 m_noPlainOnGlass__org_jboss_elemento_TypedBuilder() {
  return /**@type {DrawerPanel}*/ ($Casts.$to(NoPlainOnGlass.m_noPlainOnGlass__$default__org_patternfly_style_Modifiers_NoPlainOnGlass__org_jboss_elemento_TypedBuilder(this), DrawerPanel));
 }
 //Bridge method.
 /** @final @override @nodts @return {DrawerPanel} */
 m_noPlainOnGlass__boolean__org_jboss_elemento_TypedBuilder(/** boolean */ arg0) {
  return /**@type {DrawerPanel}*/ ($Casts.$to(NoPlainOnGlass.m_noPlainOnGlass__$default__org_patternfly_style_Modifiers_NoPlainOnGlass__boolean__org_jboss_elemento_TypedBuilder(this, arg0), DrawerPanel));
 }
 //Default method forwarding stub.
 /** @nodts @return {DrawerPanel} */
 m_glass__org_patternfly_component_drawer_DrawerPanel() {
  return /**@type {DrawerPanel}*/ ($Casts.$to(Glass.m_glass__$default__org_patternfly_style_Modifiers_Glass__org_jboss_elemento_TypedBuilder(this), DrawerPanel));
 }
 //Default method forwarding stub.
 /** @nodts @return {DrawerPanel} */
 m_glass__boolean__org_patternfly_component_drawer_DrawerPanel(/** boolean */ arg0) {
  return /**@type {DrawerPanel}*/ ($Casts.$to(Glass.m_glass__$default__org_patternfly_style_Modifiers_Glass__boolean__org_jboss_elemento_TypedBuilder(this, arg0), DrawerPanel));
 }
 //Default method forwarding stub.
 /** @nodts @return {DrawerPanel} */
 m_noPlainOnGlass__org_patternfly_component_drawer_DrawerPanel() {
  return /**@type {DrawerPanel}*/ ($Casts.$to(NoPlainOnGlass.m_noPlainOnGlass__$default__org_patternfly_style_Modifiers_NoPlainOnGlass__org_jboss_elemento_TypedBuilder(this), DrawerPanel));
 }
 //Default method forwarding stub.
 /** @nodts @return {DrawerPanel} */
 m_noPlainOnGlass__boolean__org_patternfly_component_drawer_DrawerPanel(/** boolean */ arg0) {
  return /**@type {DrawerPanel}*/ ($Casts.$to(NoPlainOnGlass.m_noPlainOnGlass__$default__org_patternfly_style_Modifiers_NoPlainOnGlass__boolean__org_jboss_elemento_TypedBuilder(this, arg0), DrawerPanel));
 }
 /** @nodts */
 static $clinit() {
 ...
 static $loadModules() {
  ...
  ResizeHandler = goog.module.get('org.patternfly.handler.ResizeHandler$impl');
...
/**@const {string} @nodts*/
DrawerPanel.f_SUB_COMPONENT_ID__org_patternfly_component_drawer_DrawerPanel = 'dp';
/**@const {string} @nodts*/
DrawerPanel.f_SUB_COMPONENT_NAME__org_patternfly_component_drawer_DrawerPanel = 'DrawerPanel';
Attachable.$markImplementor(DrawerPanel);
Glass.$markImplementor(DrawerPanel);
NoPlainOnGlass.$markImplementor(DrawerPanel);
