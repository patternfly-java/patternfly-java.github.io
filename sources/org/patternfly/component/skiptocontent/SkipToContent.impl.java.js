...
class SkipToContent extends BaseComponent {
 ...
 $ctor__org_patternfly_component_skiptocontent_SkipToContent__java_lang_String__java_lang_String__void(/** ?string */ mainId, /** ?string */ text) {
  this.$ctor__org_patternfly_component_BaseComponent__org_patternfly_component_ComponentType__elemental2_dom_HTMLElement__void(ComponentType.f_SkipToContent__org_patternfly_component_ComponentType, /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_skipToContent__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$create([0], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), $Overlay)));
  this.m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(this.f_button__org_patternfly_component_skiptocontent_SkipToContent_ = (/**@type {Button}*/ ($Casts.$to(Button.m_button__java_lang_String__java_lang_String__org_patternfly_component_button_Button(text, '#' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(mainId)).m_primary__org_jboss_elemento_TypedBuilder(), Button))));
 }
 /** @nodts @return {SkipToContent} */
 ...
 m_text__java_lang_String() {
  return this.f_button__org_patternfly_component_skiptocontent_SkipToContent_.m_text__java_lang_String();
 }
 //Bridge method.
...
ElementTextMethods.$markImplementor(SkipToContent);
