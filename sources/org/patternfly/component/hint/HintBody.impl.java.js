 ...
 * @implements {ElementTextMethods<HTMLDivElement, HintBody>}
 */
class HintBody extends HintSubComponent {
 ...
 $ctor__org_patternfly_component_hint_HintBody__void() {
  this.$ctor__org_patternfly_component_hint_HintSubComponent__java_lang_String__java_lang_String__elemental2_dom_HTMLElement__void(HintBody.f_SUB_COMPONENT_ID__org_patternfly_component_hint_HintBody, HintBody.f_SUB_COMPONENT_NAME__org_patternfly_component_hint_HintBody, /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_hint__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_body__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), $Overlay)));
 }
 /** @nodts @return {HintBody} */
 ...
 m_text__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ arg0) {
  return /**@type {HintBody}*/ ($Casts.$to(ElementTextMethods.m_text__$default__org_jboss_elemento_ElementTextMethods__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), HintBody));
 }
 ...
 //Default method forwarding stub.
 /** @nodts @return {HintBody} */
 m_text__java_lang_String__org_patternfly_component_hint_HintBody(/** ?string */ arg0) {
  return /**@type {HintBody}*/ ($Casts.$to(ElementTextMethods.m_text__$default__org_jboss_elemento_ElementTextMethods__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), HintBody));
 }
 /** @nodts */
 static $clinit() {
...
/**@const {string} @nodts*/
HintBody.f_SUB_COMPONENT_ID__org_patternfly_component_hint_HintBody = 'hb';
/**@const {string} @nodts*/
HintBody.f_SUB_COMPONENT_NAME__org_patternfly_component_hint_HintBody = 'HintBody';
ElementTextMethods.$markImplementor(HintBody);
