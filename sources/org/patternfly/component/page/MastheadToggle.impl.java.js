...
class MastheadToggle extends MastheadSubComponent {
 ...
 $ctor__org_patternfly_component_page_MastheadToggle__void() {
  this.$ctor__org_patternfly_component_page_MastheadSubComponent__java_lang_String__java_lang_String__elemental2_dom_HTMLElement__void(MastheadToggle.f_SUB_COMPONENT_ID__org_patternfly_component_page_MastheadToggle, MastheadToggle.f_SUB_COMPONENT_NAME__org_patternfly_component_page_MastheadToggle, /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_masthead__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_toggle__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), $Overlay)));
  this.m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(this.f_toggleButton__org_patternfly_component_page_MastheadToggle_ = (/**@type {Button}*/ ($Casts.$to((/**@type {Button}*/ ($Casts.$to(Button.m_button__org_patternfly_component_button_Button().m_hamburger__org_patternfly_component_button_Button().m_aria__java_lang_String__java_lang_String__org_jboss_elemento_TypedBuilder(Aria.f_label__org_patternfly_core_Aria, 'Global Navigation'), Button))).m_aria__java_lang_String__boolean__org_jboss_elemento_TypedBuilder(Aria.f_expanded__org_patternfly_core_Aria, true), Button))));
 }
 /** @nodts @return {MastheadToggle} */
 m_toggleSidebar__org_patternfly_component_page_MastheadToggle() {
  this.f_toggleButton__org_patternfly_component_page_MastheadToggle_.m_on__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn__org_jboss_elemento_TypedBuilder(EventType.f_click__org_jboss_elemento_EventType, (/** MouseEvent */ e) =>{
...
/**@const {string} @nodts*/
MastheadToggle.f_SUB_COMPONENT_ID__org_patternfly_component_page_MastheadToggle = 'mht';
/**@const {string} @nodts*/
MastheadToggle.f_SUB_COMPONENT_NAME__org_patternfly_component_page_MastheadToggle = 'MastheadToggle';
