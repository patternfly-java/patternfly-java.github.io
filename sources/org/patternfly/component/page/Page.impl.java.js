...
class Page extends BaseComponent {
 ...
 constructor() {
  ...
  /**@type {List<ResizeHandler<Page>>} @nodts*/
  ...
  /**@type {Drawer} @nodts*/
  this.f_drawer__org_patternfly_component_page_Page_;
  /**@type {NotificationDrawer} @nodts*/
  this.f_notificationDrawer__org_patternfly_component_page_Page_;
 ...
 $ctor__org_patternfly_component_page_Page__void() {
  this.$ctor__org_patternfly_component_BaseComponent__org_patternfly_component_ComponentType__elemental2_dom_HTMLElement__void(ComponentType.f_Page__org_patternfly_component_ComponentType, /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_page__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$create([0], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), $Overlay)));
  this.f_rect__org_patternfly_component_page_Page_ = (/**@type {ObservableValue<Rect>}*/ (ObservableValue.m_ov__java_lang_Object__org_patternfly_core_ObservableValue(Rect.$create__()))).m_subscribe__org_patternfly_core_ObservableValue_Subscriber__org_patternfly_core_ObservableValue(Subscriber.$adapt((/** Rect */ arg0, /** Rect */ arg1) =>{
  ...
  this.f_resizeHandler__org_patternfly_component_page_Page_ = (/**@type {!ArrayList<ResizeHandler<Page>>}*/ (ArrayList.$create__()));
 ...
 m_attach__elemental2_dom_MutationRecord__void(/** MutationRecord */ mutationRecord) {
  ...
  this.f_cleanup__org_patternfly_component_page_Page_ = Elements.m_resizeObserver__elemental2_dom_HTMLElement__org_jboss_elemento_ResizeCallback__org_jboss_elemento_ResizeObserverCleanup(/**@type {HTMLDivElement}*/ ($Casts.$to(this.m_element__elemental2_dom_HTMLElement(), $Overlay)), () =>{
   this.f_resizeHandler__org_patternfly_component_page_Page_.m_forEach__java_util_function_Consumer__void(Consumer.$adapt((/** ResizeHandler<Page> */ rh) =>{
    let rh_1 = /**@type {ResizeHandler<Page>}*/ ($Casts.$to(rh, /**@type {Function}*/ (ResizeHandler)));
 ...
 m_add__org_patternfly_component_page_PageSidebar__org_patternfly_component_page_Page(/** PageSidebar */ sidebar) {
  ...
  } else if (!$Equality.$same(this.f_notificationDrawer__org_patternfly_component_page_Page_, null)) {
   Elements.m_insertBefore__org_jboss_elemento_IsElement__elemental2_dom_Element__void(this.f_sidebar__org_patternfly_component_page_Page_, this.f_notificationDrawer__org_patternfly_component_page_Page_.m_element__elemental2_dom_HTMLElement());
  } else {
 ...
 m_add__org_patternfly_component_page_PageMain__org_patternfly_component_page_Page(/** PageMain */ main) {
  ...
  if (!$Equality.$same(this.f_drawer__org_patternfly_component_page_Page_, null) && !$Equality.$same(this.f_notificationDrawer__org_patternfly_component_page_Page_, null)) {
   this.f_drawer__org_patternfly_component_page_Page_.m_content__org_patternfly_component_drawer_DrawerContent().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(main);
  } else {
   this.m_add__elemental2_dom_Node__org_jboss_elemento_TypedBuilder(main.m_element__elemental2_dom_HTMLElement());
  }
  return this;
 }
 /** @nodts @return {Page} */
 m_addNotificationDrawer__org_patternfly_component_notification_NotificationDrawer__org_patternfly_component_page_Page(/** NotificationDrawer */ notificationDrawer) {
  return this.m_add__org_patternfly_component_notification_NotificationDrawer__org_patternfly_component_page_Page(notificationDrawer);
 }
 /** @nodts @return {Page} */
 m_add__org_patternfly_component_notification_NotificationDrawer__org_patternfly_component_page_Page(/** NotificationDrawer */ notificationDrawer) {
  Elements.m_failSafeRemoveFromParent__org_jboss_elemento_IsElement__boolean(this.f_main__org_patternfly_component_page_Page_);
  Elements.m_failSafeRemoveFromParent__org_jboss_elemento_IsElement__boolean(this.f_drawer__org_patternfly_component_page_Page_);
  Elements.m_failSafeRemoveFromParent__org_jboss_elemento_IsElement__boolean(this.f_notificationDrawer__org_patternfly_component_page_Page_);
  this.f_notificationDrawer__org_patternfly_component_page_Page_ = notificationDrawer;
  this.m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_page__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_drawer__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(this.f_drawer__org_patternfly_component_page_Page_ = Drawer.m_drawer__org_patternfly_component_drawer_Drawer().m_addContent__org_patternfly_component_drawer_DrawerContent__org_patternfly_component_drawer_Drawer(/**@type {DrawerContent}*/ ($Casts.$to(DrawerContent.m_drawerContent__org_patternfly_component_drawer_DrawerContent().m_run__java_util_function_Consumer__org_jboss_elemento_TypedBuilder(Consumer.$adapt((/** DrawerContent */ content) =>{
   let content_1 = /**@type {DrawerContent}*/ ($Casts.$to(content, DrawerContent));
   if (!$Equality.$same(this.f_main__org_patternfly_component_page_Page_, null)) {
    content_1.m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(this.f_main__org_patternfly_component_page_Page_);
   }
  })), DrawerContent))).m_addPanel__org_patternfly_component_drawer_DrawerPanel__org_patternfly_component_drawer_Drawer(/**@type {DrawerPanel}*/ ($Casts.$to(DrawerPanel.m_drawerPanel__org_patternfly_component_drawer_DrawerPanel().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(notificationDrawer), DrawerPanel)))), HTMLContainerBuilder)));
  return this;
 }
 /** @nodts @return {Page} */
 ...
 /** @nodts @return {Page} */
 m_noSidebar__org_patternfly_component_page_Page() {
  return /**@type {Page}*/ ($Casts.$to(this.m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_noSidebar__org_patternfly_style_Classes)], j_l_String))), Page));
 }
 /** @nodts @return {Page} */
 ...
 m_onResize__org_patternfly_handler_ResizeHandler__org_patternfly_component_page_Page(/** ResizeHandler<Page> */ resizeHandler) {
  this.f_resizeHandler__org_patternfly_component_page_Page_.add(resizeHandler);
  return this;
 }
 /** @nodts */
 m_wire__org_patternfly_component_notification_NotificationBadge__org_patternfly_component_notification_NotificationDrawer__void(/** NotificationBadge */ notificationBadge, /** NotificationDrawer */ notificationDrawer) {
  notificationBadge.m_onClick__org_patternfly_handler_ComponentHandler__org_patternfly_component_notification_NotificationBadge(ComponentHandler.$adapt((/** Event */ event, /** NotificationBadge */ component) =>{
   let component_1 = /**@type {NotificationBadge}*/ ($Casts.$to(component, NotificationBadge));
   component_1.m_toggle__void();
   this.f_drawer__org_patternfly_component_page_Page_.m_toggle__void();
  }));
  notificationDrawer.m_onClose__org_patternfly_handler_CloseHandler__org_patternfly_component_notification_NotificationDrawer(CloseHandler.$adapt((/** Event */ event_1, /** NotificationDrawer */ component_2) =>{
   let component_3 = /**@type {NotificationDrawer}*/ ($Casts.$to(component_2, NotificationDrawer));
   notificationBadge.m_collapse__void();
   this.f_drawer__org_patternfly_component_page_Page_.m_collapse__void();
  }));
 }
 ...
 /** @nodts @return {Drawer} */
 m_drawer__org_patternfly_component_drawer_Drawer() {
  return this.f_drawer__org_patternfly_component_page_Page_;
 }
 /** @nodts @return {NotificationDrawer} */
 m_notificationDrawer__org_patternfly_component_notification_NotificationDrawer() {
  return this.f_notificationDrawer__org_patternfly_component_page_Page_;
 }
 /** @nodts @return {boolean} */
 m_belowXl__boolean_$pp_org_patternfly_component_page() {
 ...
 m_onChangedRect__org_patternfly_style_Rect__org_patternfly_style_Rect__void_$p_org_patternfly_component_page_Page(/** Rect */ current, /** Rect */ previous) {
  this.m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_resizeObserver__org_patternfly_style_Classes)], j_l_String)));
  let previousBreakpoint = !$Equality.$same(this.f_breakpointFn__org_patternfly_component_page_Page_, null) ? /**@type {Breakpoint}*/ ($Casts.$to(this.f_breakpointFn__org_patternfly_component_page_Page_.m_apply__java_lang_Object__java_lang_Object(Integer.valueOf(previous.f_width__org_patternfly_style_Rect)), Breakpoint)) : Breakpoint.m_breakpoint__int__org_patternfly_style_Breakpoint(previous.f_width__org_patternfly_style_Rect);
  let currentBreakpoint = !$Equality.$same(this.f_breakpointFn__org_patternfly_component_page_Page_, null) ? /**@type {Breakpoint}*/ ($Casts.$to(this.f_breakpointFn__org_patternfly_component_page_Page_.m_apply__java_lang_Object__java_lang_Object(Integer.valueOf(current.f_width__org_patternfly_style_Rect)), Breakpoint)) : Breakpoint.m_breakpoint__int__org_patternfly_style_Breakpoint(current.f_width__org_patternfly_style_Rect);
  if (!$Equality.$same(previousBreakpoint, currentBreakpoint)) {
   this.m_classList__org_jboss_elemento_ClassList().m_remove__arrayOf_java_lang_String__void(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_modifier__java_lang_String__java_lang_String('breakpoint-' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(previousBreakpoint.f_value__org_patternfly_style_Breakpoint))], j_l_String)));
   this.m_classList__org_jboss_elemento_ClassList().m_add__arrayOf_java_lang_String__void(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_modifier__java_lang_String__java_lang_String('breakpoint-' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(currentBreakpoint.f_value__org_patternfly_style_Breakpoint))], j_l_String)));
  }
  let previousVerticalBreakpoint = !$Equality.$same(this.f_breakpointFn__org_patternfly_component_page_Page_, null) ? /**@type {Breakpoint}*/ ($Casts.$to(this.f_verticalBreakpointFn__org_patternfly_component_page_Page_.m_apply__java_lang_Object__java_lang_Object(Integer.valueOf(previous.f_height__org_patternfly_style_Rect)), Breakpoint)) : Breakpoint.m_verticalBreakpoint__int__org_patternfly_style_Breakpoint(previous.f_height__org_patternfly_style_Rect);
  let currentVerticalBreakpoint = !$Equality.$same(this.f_breakpointFn__org_patternfly_component_page_Page_, null) ? /**@type {Breakpoint}*/ ($Casts.$to(this.f_verticalBreakpointFn__org_patternfly_component_page_Page_.m_apply__java_lang_Object__java_lang_Object(Integer.valueOf(current.f_height__org_patternfly_style_Rect)), Breakpoint)) : Breakpoint.m_verticalBreakpoint__int__org_patternfly_style_Breakpoint(current.f_height__org_patternfly_style_Rect);
  if (!$Equality.$same(previousVerticalBreakpoint, currentVerticalBreakpoint)) {
   this.m_classList__org_jboss_elemento_ClassList().m_remove__arrayOf_java_lang_String__void(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_modifier__java_lang_String__java_lang_String('height-breakpoint-' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(previousVerticalBreakpoint.f_value__org_patternfly_style_Breakpoint))], j_l_String)));
   this.m_classList__org_jboss_elemento_ClassList().m_add__arrayOf_java_lang_String__void(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_modifier__java_lang_String__java_lang_String('height-breakpoint-' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(currentVerticalBreakpoint.f_value__org_patternfly_style_Breakpoint))], j_l_String)));
  }
  ...
  if (!$Equality.$same(this.f_sidebar__org_patternfly_component_page_Page_, null)) {
   if (this.m_belowXl__boolean_$pp_org_patternfly_component_page()) {
