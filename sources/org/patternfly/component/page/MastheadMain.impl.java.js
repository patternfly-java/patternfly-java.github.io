...
class MastheadMain extends MastheadSubComponent {
 ...
 $ctor__org_patternfly_component_page_MastheadMain__void() {
  this.$ctor__org_patternfly_component_page_MastheadSubComponent__java_lang_String__java_lang_String__elemental2_dom_HTMLElement__void(MastheadMain.f_SUB_COMPONENT_ID__org_patternfly_component_page_MastheadMain, MastheadMain.f_SUB_COMPONENT_NAME__org_patternfly_component_page_MastheadMain, /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_masthead__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_main__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), $Overlay)));
 }
 /** @nodts @return {MastheadMain} */
 m_addToggle__org_patternfly_component_page_MastheadToggle__org_patternfly_component_page_MastheadMain(/** MastheadToggle */ toggle) {
...
/**@const {string} @nodts*/
MastheadMain.f_SUB_COMPONENT_ID__org_patternfly_component_page_MastheadMain = 'mhm';
/**@const {string} @nodts*/
MastheadMain.f_SUB_COMPONENT_NAME__org_patternfly_component_page_MastheadMain = 'MastheadMain';
