 ...
 * @implements {ElementTextMethods<HTMLDivElement, MastheadContent>}
 */
class MastheadContent extends MastheadSubComponent {
 ...
 $ctor__org_patternfly_component_page_MastheadContent__void() {
  this.$ctor__org_patternfly_component_page_MastheadSubComponent__java_lang_String__java_lang_String__elemental2_dom_HTMLElement__void(MastheadContent.f_SUB_COMPONENT_ID__org_patternfly_component_page_MastheadContent, MastheadContent.f_SUB_COMPONENT_NAME__org_patternfly_component_page_MastheadContent, /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_masthead__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_content__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), $Overlay)));
 }
 /** @nodts @return {MastheadContent} */
 ...
 m_text__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ arg0) {
  return /**@type {MastheadContent}*/ ($Casts.$to(ElementTextMethods.m_text__$default__org_jboss_elemento_ElementTextMethods__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), MastheadContent));
 }
 ...
 //Default method forwarding stub.
 /** @nodts @return {MastheadContent} */
 m_text__java_lang_String__org_patternfly_component_page_MastheadContent(/** ?string */ arg0) {
  return /**@type {MastheadContent}*/ ($Casts.$to(ElementTextMethods.m_text__$default__org_jboss_elemento_ElementTextMethods__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), MastheadContent));
 }
 /** @nodts */
 static $clinit() {
...
/**@const {string} @nodts*/
MastheadContent.f_SUB_COMPONENT_ID__org_patternfly_component_page_MastheadContent = 'mhc';
/**@const {string} @nodts*/
MastheadContent.f_SUB_COMPONENT_NAME__org_patternfly_component_page_MastheadContent = 'MastheadContent';
ElementTextMethods.$markImplementor(MastheadContent);
