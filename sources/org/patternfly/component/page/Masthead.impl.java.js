...
let Display = goog.forwardDeclare('org.patternfly.component.page.Display$impl');
...
class Masthead extends BaseComponent {
 ...
 $ctor__org_patternfly_component_page_Masthead__void() {
  this.$ctor__org_patternfly_component_BaseComponent__org_patternfly_component_ComponentType__elemental2_dom_HTMLElement__void(ComponentType.f_Masthead__org_patternfly_component_ComponentType, (/**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to(Elements.m_header__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_masthead__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$create([0], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement());
  this.f_displayModifiers__org_patternfly_component_page_Masthead_ = (/**@type {Breakpoints<Display>}*/ (Breakpoints.m_breakpoints__org_patternfly_style_Breakpoint__java_lang_Object__org_patternfly_style_Breakpoints(Breakpoint.f_md__org_patternfly_style_Breakpoint, Display.f_inline__org_patternfly_component_page_Display)));
  this.m_classList__org_jboss_elemento_ClassList().m_add__arrayOf_java_lang_String__void(/**@type {!Array<?string>}*/ ($Arrays.$stampType([this.f_displayModifiers__org_patternfly_component_page_Masthead_.m_modifiers__java_lang_String()], j_l_String)));
 }
 /** @nodts @return {Masthead} */
 ...
 /** @nodts @return {Masthead} */
 m_display__org_patternfly_component_page_Display__org_patternfly_component_page_Masthead(/** Display */ displayModifiers) {
  return this.m_display__org_patternfly_style_Breakpoints__org_patternfly_component_page_Masthead(/**@type {Breakpoints<Display>}*/ (Breakpoints.m_breakpoints__org_patternfly_style_Breakpoint__java_lang_Object__org_patternfly_style_Breakpoints(Breakpoint.f_default___org_patternfly_style_Breakpoint, displayModifiers)));
 }
 /** @nodts @return {Masthead} */
 m_display__org_patternfly_style_Breakpoints__org_patternfly_component_page_Masthead(/** Breakpoints<Display> */ displayModifiers) {
  if (!$Equality.$same(this.f_displayModifiers__org_patternfly_component_page_Masthead_, null)) {
   this.m_classList__org_jboss_elemento_ClassList().m_remove__arrayOf_java_lang_String__void(/**@type {!Array<?string>}*/ ($Arrays.$stampType([this.f_displayModifiers__org_patternfly_component_page_Masthead_.m_modifiers__java_lang_String()], j_l_String)));
  }
 ...
 /** @nodts @return {Masthead} */
 m_inset__org_patternfly_style_Inset__org_patternfly_component_page_Masthead(/** Inset */ insetModifiers) {
  return this.m_inset__org_patternfly_style_Breakpoints__org_patternfly_component_page_Masthead(/**@type {Breakpoints<Inset>}*/ (Breakpoints.m_breakpoints__org_patternfly_style_Breakpoint__java_lang_Object__org_patternfly_style_Breakpoints(Breakpoint.f_default___org_patternfly_style_Breakpoint, insetModifiers)));
 }
 /** @nodts @return {Masthead} */
 m_inset__org_patternfly_style_Breakpoints__org_patternfly_component_page_Masthead(/** Breakpoints<Inset> */ insetModifiers) {
  if (!$Equality.$same(this.f_insetModifiers__org_patternfly_component_page_Masthead_, null)) {
   this.m_classList__org_jboss_elemento_ClassList().m_remove__arrayOf_java_lang_String__void(/**@type {!Array<?string>}*/ ($Arrays.$stampType([this.f_insetModifiers__org_patternfly_component_page_Masthead_.m_modifiers__java_lang_String()], j_l_String)));
  }
  this.f_insetModifiers__org_patternfly_component_page_Masthead_ = insetModifiers;
  this.m_classList__org_jboss_elemento_ClassList().m_add__arrayOf_java_lang_String__void(/**@type {!Array<?string>}*/ ($Arrays.$stampType([this.f_insetModifiers__org_patternfly_component_page_Masthead_.m_modifiers__java_lang_String()], j_l_String)));
  this.f_insetModifiers__org_patternfly_component_page_Masthead_ = insetModifiers;
  return this;
 }
 /** @nodts @return {Masthead} */
 ...
 m_onPageResize__org_patternfly_style_Rect__org_patternfly_style_Rect__void_$pp_org_patternfly_component_page(/** Rect */ currentPageRect, /** Rect */ previousPageRect) {
  if (!$Equality.$same(this.f_displayModifiers__org_patternfly_component_page_Masthead_, null)) {
   this.m_classList__org_jboss_elemento_ClassList().m_remove__arrayOf_java_lang_String__void(/**@type {!Array<?string>}*/ ($Arrays.$stampType([this.f_displayModifiers__org_patternfly_component_page_Masthead_.m_modifier__org_patternfly_style_Breakpoint__java_lang_String(Breakpoint.m_breakpoint__int__org_patternfly_style_Breakpoint(previousPageRect.f_width__org_patternfly_style_Rect))], j_l_String)));
   this.m_classList__org_jboss_elemento_ClassList().m_add__arrayOf_java_lang_String__void(/**@type {!Array<?string>}*/ ($Arrays.$stampType([this.f_displayModifiers__org_patternfly_component_page_Masthead_.m_modifier__org_patternfly_style_Breakpoint__java_lang_String(Breakpoint.m_breakpoint__int__org_patternfly_style_Breakpoint(currentPageRect.f_width__org_patternfly_style_Rect))], j_l_String)));
  }
  if (!$Equality.$same(this.f_insetModifiers__org_patternfly_component_page_Masthead_, null)) {
   this.m_classList__org_jboss_elemento_ClassList().m_remove__arrayOf_java_lang_String__void(/**@type {!Array<?string>}*/ ($Arrays.$stampType([this.f_insetModifiers__org_patternfly_component_page_Masthead_.m_modifier__org_patternfly_style_Breakpoint__java_lang_String(Breakpoint.m_breakpoint__int__org_patternfly_style_Breakpoint(previousPageRect.f_width__org_patternfly_style_Rect))], j_l_String)));
   this.m_classList__org_jboss_elemento_ClassList().m_add__arrayOf_java_lang_String__void(/**@type {!Array<?string>}*/ ($Arrays.$stampType([this.f_insetModifiers__org_patternfly_component_page_Masthead_.m_modifier__org_patternfly_style_Breakpoint__java_lang_String(Breakpoint.m_breakpoint__int__org_patternfly_style_Breakpoint(currentPageRect.f_width__org_patternfly_style_Rect))], j_l_String)));
  }
 }
 //Bridge method.
 ...
 static $loadModules() {
  ...
  Display = goog.module.get('org.patternfly.component.page.Display$impl');
