...
class PageSidebarBody extends PageSubComponent {
 ...
 /** @nodts @return {PageSidebarBody} */
 m_contextSelector__org_patternfly_component_page_PageSidebarBody() {
  return /**@type {PageSidebarBody}*/ ($Casts.$to(this.m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_contextSelector__org_patternfly_style_Classes)], j_l_String))), PageSidebarBody));
 }
 /** @nodts @return {PageSidebarBody} */
 m_inset__org_patternfly_component_page_PageSidebarBody() {
  return /**@type {PageSidebarBody}*/ ($Casts.$to(this.m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_pageInsets__org_patternfly_style_Classes)], j_l_String))), PageSidebarBody));
 }
 /** @nodts @return {PageSidebarBody} */
 m_noInset__org_patternfly_component_page_PageSidebarBody() {
  return /**@type {PageSidebarBody}*/ ($Casts.$to(this.m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_insetNone__org_patternfly_style_Classes)], j_l_String))), PageSidebarBody));
 }
 /** @nodts @return {PageSidebarBody} */
...
/**@const {string} @nodts*/
PageSidebarBody.f_SUB_COMPONENT_ID__org_patternfly_component_page_PageSidebarBody = 'psbb';
/**@const {string} @nodts*/
PageSidebarBody.f_SUB_COMPONENT_NAME__org_patternfly_component_page_PageSidebarBody = 'PageSidebarBody';
