...
class SliderActions extends SliderSubComponent {
 ...
 $ctor__org_patternfly_component_slider_SliderActions__void() {
  this.$ctor__org_patternfly_component_slider_SliderSubComponent__java_lang_String__java_lang_String__elemental2_dom_HTMLElement__void(SliderActions.f_SUB_COMPONENT_ID__org_patternfly_component_slider_SliderActions, SliderActions.f_SUB_COMPONENT_NAME__org_patternfly_component_slider_SliderActions, /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_slider__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_actions__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), $Overlay)));
...
/**@const {string} @nodts*/
SliderActions.f_SUB_COMPONENT_ID__org_patternfly_component_slider_SliderActions = 'sa';
/**@const {string} @nodts*/
SliderActions.f_SUB_COMPONENT_NAME__org_patternfly_component_slider_SliderActions = 'SliderActions';
