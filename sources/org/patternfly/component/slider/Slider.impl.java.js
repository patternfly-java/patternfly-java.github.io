...
class Slider extends BaseComponent {
 ...
 constructor() {
  ...
  /**@type {List<ChangeHandler<Slider, ?number>>} @nodts*/
 ...
 $ctor__org_patternfly_component_slider_Slider__void() {
  this.$ctor__org_patternfly_component_BaseComponent__org_patternfly_component_ComponentType__elemental2_dom_HTMLElement__void(ComponentType.f_Slider__org_patternfly_component_ComponentType, /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_slider__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$create([0], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), $Overlay)));
  ...
  this.f_changeHandler__org_patternfly_component_slider_Slider_ = (/**@type {!ArrayList<ChangeHandler<Slider, ?number>>}*/ (ArrayList.$create__()));
  this.f_main__org_patternfly_component_slider_Slider_ = (/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_slider__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_main__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(this.f_sliderRail__org_patternfly_component_slider_Slider_ = (/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_slider__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_rail__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_on__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn__org_jboss_elemento_TypedBuilder(EventType.f_click__org_jboss_elemento_EventType, (/** MouseEvent */ arg0) =>{
  ...
  }), HTMLContainerBuilder))).m_on__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn__org_jboss_elemento_TypedBuilder(EventType.f_touchstart__org_jboss_elemento_EventType, (/** TouchEvent */ arg0_4) =>{
  ...
  }), HTMLContainerBuilder))).m_on__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn__org_jboss_elemento_TypedBuilder(EventType.f_click__org_jboss_elemento_EventType, (/** MouseEvent */ arg0_6) =>{
  ...
  }), HTMLContainerBuilder))).m_on__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn__org_jboss_elemento_TypedBuilder(EventType.f_keydown__org_jboss_elemento_EventType, (/** KeyboardEvent */ arg0_8) =>{
 ...
 m_attach__elemental2_dom_MutationRecord__void(/** MutationRecord */ mutationRecord) {
  ...
  if (!$Equality.$same(this.f_customSteps__org_patternfly_component_slider_Slider_, null)) {
   ...
   for (let $iterator = this.f_customSteps__org_patternfly_component_slider_Slider_.m_iterator__java_util_Iterator(); $iterator.m_hasNext__boolean(); ) {
    ...
    {
     let stepElement = /**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_slider__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_step__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_data__java_lang_String__java_lang_String__org_jboss_elemento_TypedBuilder(Dataset.f_sliderStepValue__org_patternfly_core_Dataset, j_l_String.m_valueOf__double__java_lang_String(step.f_value__org_patternfly_component_slider_SliderStep)), HTMLContainerBuilder));
     (/**@type {HTMLBuilder<HTMLDivElement, HTMLContainerBuilder<HTMLDivElement>>}*/ (Slider.f_sliderStepStart__org_patternfly_component_slider_Slider_.m_applyTo__org_jboss_elemento_HTMLElementStyleMethods__org_patternfly_style_VariableAssignments_HTMLBuilder(stepElement))).m_set__java_lang_String__org_jboss_elemento_TypedBuilder(step.m_percentage__double_$pp_org_patternfly_component_slider() + '%');
     stepElement.m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_slider__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_step__org_patternfly_style_Classes, Classes.f_tick__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder)));
     if (!step.f_labelHidden__org_patternfly_component_slider_SliderStep) {
      stepElement.m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_slider__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_step__org_patternfly_style_Classes, Classes.f_label__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_text__java_lang_String__org_jboss_elemento_TypedBuilder(step.f_label__org_patternfly_component_slider_SliderStep), HTMLContainerBuilder)));
     }
   ...
   if (this.f_showBoundaries__org_patternfly_component_slider_Slider_ || this.f_showTicks__org_patternfly_component_slider_Slider_) {
    for (let index = this.f_min__org_patternfly_component_slider_Slider_; index <= this.f_max__org_patternfly_component_slider_Slider_; index += this.f_step__org_patternfly_component_slider_Slider_) {
     ...
     (/**@type {HTMLBuilder<HTMLDivElement, HTMLContainerBuilder<HTMLDivElement>>}*/ (Slider.f_sliderStepStart__org_patternfly_component_slider_Slider_.m_applyTo__org_jboss_elemento_HTMLElementStyleMethods__org_patternfly_style_VariableAssignments_HTMLBuilder(stepElement_1))).m_set__java_lang_String__org_jboss_elemento_TypedBuilder(Numbers.m_percentage__double__double__double__double(index, this.f_min__org_patternfly_component_slider_Slider_, this.f_max__org_patternfly_component_slider_Slider_) + '%');
     ...
     if (this.f_showBoundaries__org_patternfly_component_slider_Slider_ && (index == this.f_min__org_patternfly_component_slider_Slider_ || index == this.f_max__org_patternfly_component_slider_Slider_)) {
      stepElement_1.m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_slider__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_step__org_patternfly_style_Classes, Classes.f_label__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_text__java_lang_String__org_jboss_elemento_TypedBuilder(j_l_String.m_valueOf__double__java_lang_String(index)), HTMLContainerBuilder)));
     }
  ...
  if (this.f_tooltipOnThumb__org_patternfly_component_slider_Slider_) {
   this.f_tooltip__org_patternfly_component_slider_Slider_ = Tooltip.m_tooltip__elemental2_dom_HTMLElement__org_patternfly_component_tooltip_Tooltip(/**@type {HTMLDivElement}*/ ($Casts.$to(this.f_thumb__org_patternfly_component_slider_Slider_.m_element__elemental2_dom_HTMLElement(), $Overlay))).m_entryDelay__int__org_patternfly_component_tooltip_Tooltip(0);
   this.m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(this.f_tooltip__org_patternfly_component_slider_Slider_);
  }
  ...
  this.f_value__org_patternfly_component_slider_Slider_.m_subscribe__org_patternfly_core_ObservableValue_Subscriber__org_patternfly_core_ObservableValue(Subscriber.$adapt((/** ?number */ arg0, /** ?number */ arg1) =>{
 ...
 m_addValueInput__org_patternfly_component_form_TextInput__org_patternfly_component_slider_SliderInputPosition__org_patternfly_component_slider_Slider(/** TextInput */ textInput, /** SliderInputPosition */ inputPosition) {
  if ($Equality.$same(this.f_textInput__org_patternfly_component_slider_Slider_, null)) {
   ...
   Slider.f_logger__org_patternfly_component_slider_Slider_.m_warn__java_lang_String__arrayOf_java_lang_Object__void('Value input already added for slider %o.', [this.m_element__elemental2_dom_HTMLElement()]);
  }
  return this;
 }
 /** @nodts @return {Slider} */
  ...
  if ($Equality.$same(this.f_inputGroup__org_patternfly_component_slider_Slider_, null)) {
   ...
   if (!$Equality.$same(inputGroupItem, null)) {
    if (TextInput.$isInstance(inputGroupItem.m_formControl__org_patternfly_component_form_FormControl())) {
     ...
     Slider.f_logger__org_patternfly_component_slider_Slider_.m_error__java_lang_String__arrayOf_java_lang_Object__void('Value input in slider %o does not contain a text input', [this.m_element__elemental2_dom_HTMLElement()]);
    }
   } else {
    Slider.f_logger__org_patternfly_component_slider_Slider_.m_error__java_lang_String__arrayOf_java_lang_Object__void('Value input in slider %o does not contain a form control', [this.m_element__elemental2_dom_HTMLElement()]);
   }
  } else {
   Slider.f_logger__org_patternfly_component_slider_Slider_.m_error__java_lang_String__arrayOf_java_lang_Object__void('Value input already added for slider %o', [this.m_element__elemental2_dom_HTMLElement()]);
  }
  return this;
 }
 /** @nodts @return {Slider} */
 ...
 m_onChange__org_patternfly_handler_ChangeHandler__org_patternfly_component_slider_Slider(/** ChangeHandler<Slider, ?number> */ changeHandler) {
  this.f_changeHandler__org_patternfly_component_slider_Slider_.add(changeHandler);
  return this;
 }
 /** @nodts */
 m_decrease__void() {
 ...
 /** @nodts @return {number} */
 m_intValue__int() {
  return Primitives.m_narrowDoubleToInt__int__int(Double.m_doubleValue__java_lang_Double__double(this.m_value__java_lang_Double()));
 }
 ...
 m_onValueChanged__double__double__void_$p_org_patternfly_component_slider_Slider(/** number */ current, /** number */ previous) {
  ...
  Slider.f_sliderValue__org_patternfly_component_slider_Slider_.m_applyTo__elemental2_dom_HTMLElement__org_patternfly_style_VariableAssignments_HTMLElement(this.m_element__elemental2_dom_HTMLElement()).m_set__java_lang_String__void(percentage + '%');
  ...
  if (!$Equality.$same(this.f_textInput__org_patternfly_component_slider_Slider_, null)) {
   ...
   Slider.f_sliderValueInputWidth__org_patternfly_component_slider_Slider_.m_applyTo__elemental2_dom_HTMLElement__org_patternfly_style_VariableAssignments_HTMLElement(this.m_element__elemental2_dom_HTMLElement()).m_set__int__void(j_l_String.m_length__java_lang_String__int(this.f_textInput__org_patternfly_component_slider_Slider_.m_value__java_lang_String()));
  }
  if (!$Equality.$same(this.f_tooltip__org_patternfly_component_slider_Slider_, null)) {
   this.f_tooltip__org_patternfly_component_slider_Slider_.m_text__java_lang_String__org_jboss_elemento_TypedBuilder(labelOrValue);
  }
  this.f_changeHandler__org_patternfly_component_slider_Slider_.m_forEach__java_util_function_Consumer__void(Consumer.$adapt((/** ChangeHandler<Slider, ?number> */ ch) =>{
   let ch_1 = /**@type {ChangeHandler<Slider, ?number>}*/ ($Casts.$to(ch, /**@type {Function}*/ (ChangeHandler)));
   ch_1.m_onChange__elemental2_dom_Event__java_lang_Object__java_lang_Object__void(new Event(''), this, current);
  }));
 }
 /** @nodts @return {?string} */
 ...
 m_disabledInternal__boolean__void_$p_org_patternfly_component_slider_Slider(/** boolean */ disabled) {
  (/**@type {HTMLDivElement}*/ ($Casts.$to(this.f_thumb__org_patternfly_component_slider_Slider_.m_element__elemental2_dom_HTMLElement(), $Overlay))).tabIndex = disabled ? -1 : 0;
 ...
 m_addValueInputInternal__elemental2_dom_HTMLElement__org_patternfly_component_slider_SliderInputPosition__void_$p_org_patternfly_component_slider_Slider(/** HTMLElement */ element, /** SliderInputPosition */ inputPosition) {
  if ($Equality.$same(inputPosition, SliderInputPosition.f_aboveThumb__org_patternfly_component_slider_SliderInputPosition)) {
   this.f_main__org_patternfly_component_slider_Slider_.m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_slider__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_value__org_patternfly_style_Classes], j_l_String))), Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_floating__org_patternfly_style_Classes)], j_l_String))), HTMLContainerBuilder))).m_add__elemental2_dom_Node__org_jboss_elemento_TypedBuilder(element), HTMLContainerBuilder)));
  } else if ($Equality.$same(inputPosition, SliderInputPosition.f_end__org_patternfly_component_slider_SliderInputPosition)) {
   Elements.m_insertAfter__elemental2_dom_Element__elemental2_dom_Element__void(/**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_slider__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_value__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_add__elemental2_dom_Node__org_jboss_elemento_TypedBuilder(element), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), $Overlay)), /**@type {HTMLDivElement}*/ ($Casts.$to(this.f_main__org_patternfly_component_slider_Slider_.m_element__elemental2_dom_HTMLElement(), $Overlay)));
  } else {
   if (!$Equality.$same(inputPosition, null)) {
    Slider.f_logger__org_patternfly_component_slider_Slider_.m_warn__java_lang_String__arrayOf_java_lang_Object__void('Unsupported input position \'%s\' for slider %o: ', [inputPosition.name(), element]);
   } else {
    Slider.f_logger__org_patternfly_component_slider_Slider_.m_error__java_lang_String__arrayOf_java_lang_Object__void('No input position specified for slider %o', [this.m_element__elemental2_dom_HTMLElement()]);
   }
  }
 }
 /** @nodts */
 m_bindValueInput__org_patternfly_component_form_TextInput__void_$p_org_patternfly_component_slider_Slider(/** TextInput */ textInput) {
  ...
  (/**@type {HTMLInputElementBuilder<HTMLInputElement>}*/ ($Casts.$to((/**@type {HTMLInputElementBuilder<HTMLInputElement>}*/ ($Casts.$to((/**@type {HTMLInputElementBuilder<HTMLInputElement>}*/ ($Casts.$to(this.f_textInput__org_patternfly_component_slider_Slider_.m_input__org_jboss_elemento_HTMLInputElementBuilder().m_on__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn__org_jboss_elemento_TypedBuilder(EventType.f_keyup__org_jboss_elemento_EventType, (/** KeyboardEvent */ arg0) =>{
  ...
  }), HTMLInputElementBuilder))).m_on__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn__org_jboss_elemento_TypedBuilder(EventType.f_click__org_jboss_elemento_EventType, (/** MouseEvent */ arg0_2) =>{
   let arg0_3 = /**@type {MouseEvent}*/ ($Casts.$to(arg0_2, MouseEvent_$Overlay));
   arg0_3.stopPropagation();
  }), HTMLInputElementBuilder))).m_on__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn__org_jboss_elemento_TypedBuilder(EventType.f_focus__org_jboss_elemento_EventType, (/** FocusEvent */ arg0_4) =>{
   let arg0_5 = /**@type {FocusEvent}*/ ($Casts.$to(arg0_4, FocusEvent_$Overlay));
   arg0_5.stopPropagation();
  }), HTMLInputElementBuilder))).m_on__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn__org_jboss_elemento_TypedBuilder(EventType.f_blur__org_jboss_elemento_EventType, (/** FocusEvent */ arg0_6) =>{
 ...
 m_handleThumbMove__elemental2_dom_Event__void_$p_org_patternfly_component_slider_Slider(/** Event */ event) {
  ...
  let newValue = Primitives.m_widenLongToDouble__long__double(j_l_Math.m_round__double__long(percentageMinMax * 100)) / 100;
  if ($Equality.$same(this.f_customSteps__org_patternfly_component_slider_Slider_, null)) {
   newValue = Primitives.m_widenLongToDouble__long__double(j_l_Math.m_round__double__long((Primitives.m_widenLongToDouble__long__double(j_l_Math.m_round__double__long((newValue - localMin) / this.f_step__org_patternfly_component_slider_Slider_)) * this.f_step__org_patternfly_component_slider_Slider_ + localMin) * 100)) / 100;
 ...
 static $clinit() {
  ...
  Disabled.$clinit();
  Attachable.$clinit();
  Slider.f_logger__org_patternfly_component_slider_Slider_ = Logger.m_getLogger__java_lang_String__org_jboss_elemento_logger_Logger(Class.$get(Slider).m_getName__java_lang_String());
  Slider.f_sliderValue__org_patternfly_component_slider_Slider_ = Variable.m_componentVar__java_lang_String__arrayOf_java_lang_String__org_patternfly_style_Variable(Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_slider__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$create([0], j_l_String))), /**@type {!Array<?string>}*/ ($Arrays.$stampType(['value'], j_l_String)));
  Slider.f_sliderValueInputWidth__org_patternfly_component_slider_Slider_ = Variable.m_componentVar__java_lang_String__arrayOf_java_lang_String__org_patternfly_style_Variable(Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_slider__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_value__org_patternfly_style_Classes], j_l_String))), /**@type {!Array<?string>}*/ ($Arrays.$stampType(['c-form-control', 'width-chars'], j_l_String)));
  Slider.f_sliderStepStart__org_patternfly_component_slider_Slider_ = Variable.m_componentVar__java_lang_String__arrayOf_java_lang_String__org_patternfly_style_Variable(Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_slider__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_step__org_patternfly_style_Classes], j_l_String))), /**@type {!Array<?string>}*/ ($Arrays.$stampType(['InsetInlineStart'], j_l_String)));
 }
...
/**@type {Logger} @nodts*/
Slider.f_logger__org_patternfly_component_slider_Slider_;
/**@type {Variable} @nodts*/
