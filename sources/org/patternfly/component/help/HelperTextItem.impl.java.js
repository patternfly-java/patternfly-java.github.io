 ...
 * @implements {ComponentIcon<HTMLElement, HelperTextItem>}
 * @implements {ComponentIconAndText<HTMLElement, HelperTextItem>}
 * @implements {ElementTextMethods<HTMLElement, HelperTextItem>}
...
class HelperTextItem extends HelperTextSubComponent {
 ...
 static m_helperTextItem__org_patternfly_component_help_HelperTextItem() {
  ...
  return HelperTextItem.$create__org_jboss_elemento_HTMLContainerBuilder(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder()).m_status__org_patternfly_component_ValidationStatus__org_patternfly_component_help_HelperTextItem(ValidationStatus.f_default___org_patternfly_component_ValidationStatus);
 }
 /** @nodts @return {HelperTextItem} */
 static m_helperTextItem__java_lang_String__org_patternfly_component_help_HelperTextItem(/** ?string */ text) {
  HelperTextItem.$clinit();
  return HelperTextItem.$create__org_jboss_elemento_HTMLContainerBuilder(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder()).m_text__java_lang_String__org_patternfly_component_help_HelperTextItem(text).m_status__org_patternfly_component_ValidationStatus__org_patternfly_component_help_HelperTextItem(ValidationStatus.f_default___org_patternfly_component_ValidationStatus);
 }
 /** @nodts @return {HelperTextItem} */
 ...
 static m_helperTextItem__org_jboss_elemento_HTMLContainerBuilder__org_patternfly_component_help_HelperTextItem(/** HTMLContainerBuilder<E> */ builder) {
  HelperTextItem.$clinit();
  return HelperTextItem.$create__org_jboss_elemento_HTMLContainerBuilder(builder).m_status__org_patternfly_component_ValidationStatus__org_patternfly_component_help_HelperTextItem(ValidationStatus.f_default___org_patternfly_component_ValidationStatus);
 }
 /** @nodts @template E @return {HelperTextItem} */
 static m_helperTextItem__org_jboss_elemento_HTMLContainerBuilder__java_lang_String__org_patternfly_component_help_HelperTextItem(/** HTMLContainerBuilder<E> */ builder, /** ?string */ text) {
  HelperTextItem.$clinit();
  return HelperTextItem.$create__org_jboss_elemento_HTMLContainerBuilder(builder).m_text__java_lang_String__org_patternfly_component_help_HelperTextItem(text).m_status__org_patternfly_component_ValidationStatus__org_patternfly_component_help_HelperTextItem(ValidationStatus.f_default___org_patternfly_component_ValidationStatus);
 }
 /** @nodts @template E @return {HelperTextItem} */
 static m_helperTextItem__org_jboss_elemento_HTMLContainerBuilder__java_lang_String__org_patternfly_component_ValidationStatus__org_patternfly_component_help_HelperTextItem(/** HTMLContainerBuilder<E> */ builder, /** ?string */ text, /** ValidationStatus */ status) {
  HelperTextItem.$clinit();
  return HelperTextItem.$create__org_jboss_elemento_HTMLContainerBuilder(builder).m_text__java_lang_String__org_patternfly_component_help_HelperTextItem(text).m_status__org_patternfly_component_ValidationStatus__org_patternfly_component_help_HelperTextItem(status);
 }
 /** @nodts @template E @return {!HelperTextItem} */
 static $create__org_jboss_elemento_HTMLContainerBuilder(/** HTMLContainerBuilder<E> */ builder) {
  HelperTextItem.$clinit();
  let $instance = new HelperTextItem();
  $instance.$ctor__org_patternfly_component_help_HelperTextItem__org_jboss_elemento_HTMLContainerBuilder__void(builder);
  return $instance;
 }
 /** @nodts @template E */
 $ctor__org_patternfly_component_help_HelperTextItem__org_jboss_elemento_HTMLContainerBuilder__void(/** HTMLContainerBuilder<E> */ builder) {
  this.$ctor__org_patternfly_component_help_HelperTextSubComponent__java_lang_String__java_lang_String__elemental2_dom_HTMLElement__void(HelperTextItem.f_SUB_COMPONENT_ID__org_patternfly_component_help_HelperTextItem, HelperTextItem.f_SUB_COMPONENT_NAME__org_patternfly_component_help_HelperTextItem, /**@type {HTMLElement}*/ ((/**@type {HTMLContainerBuilder<E>}*/ ($Casts.$to(builder.m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_helperText__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_item__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement()));
  this.f_customScreenReaderText__org_patternfly_component_help_HelperTextItem_ = false;
  this.m_element__elemental2_dom_HTMLElement().appendChild(this.f_textElement__org_patternfly_component_help_HelperTextItem_ = (/**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to(Elements.m_span__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_helperText__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_item__org_patternfly_style_Classes, Classes.f_text__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement());
 }
 /** @nodts @return {HelperTextItem} */
 m_dynamic__org_patternfly_component_help_HelperTextItem() {
  ...
  return /**@type {HelperTextItem}*/ ($Casts.$to(this.m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_dynamic__org_patternfly_style_Classes)], j_l_String))), HelperTextItem));
 }
 /** @nodts @return {HelperTextItem} */
 ...
 m_removeIcon__org_patternfly_component_help_HelperTextItem() {
  ...
  this.f_iconContainer__org_patternfly_component_help_HelperTextItem_ = null;
  return this;
 }
 /** @nodts @return {HelperTextItem} */
 ...
 m_status__org_patternfly_component_ValidationStatus__org_patternfly_component_help_HelperTextItem(/** ValidationStatus */ status) {
  return this.m_status__org_patternfly_component_ValidationStatus__elemental2_dom_Element__org_patternfly_component_help_HelperTextItem(status, !$Equality.$same(status.m_icon__org_patternfly_icon_PredefinedIcon(), null) ? status.m_icon__org_patternfly_icon_PredefinedIcon().m_element__org_jboss_elemento_svg_SVGElement() : null);
 }
 /** @nodts @return {HelperTextItem} */
 ...
 m_status__org_patternfly_component_ValidationStatus__elemental2_dom_Element__org_patternfly_component_help_HelperTextItem(/** ValidationStatus */ status, /** Element */ icon) {
  if (!$Equality.$same(this.f_status__org_patternfly_component_help_HelperTextItem_, null) && !$Equality.$same(this.f_status__org_patternfly_component_help_HelperTextItem_, ValidationStatus.f_default___org_patternfly_component_ValidationStatus)) {
  ...
  if (!$Equality.$same(icon, null)) {
   ...
   this.m_removeIcon__org_patternfly_component_help_HelperTextItem();
  }
  if (!this.f_customScreenReaderText__org_patternfly_component_help_HelperTextItem_) {
   this.m_defaultScreenReaderText__void_$p_org_patternfly_component_help_HelperTextItem();
  }
 ...
 m_text__java_lang_String__org_patternfly_component_help_HelperTextItem(/** ?string */ text) {
  Elements.m_textNode__elemental2_dom_Element__java_lang_String__void(this.f_textElement__org_patternfly_component_help_HelperTextItem_, text);
  return this;
 }
 /** @nodts @return {HelperTextItem} */
 ...
 m_value__java_lang_String() {
  return Elements.m_textNode__elemental2_dom_Element__java_lang_String(this.f_textElement__org_patternfly_component_help_HelperTextItem_);
 }
 ...
 m_failSafeScreenReaderElement__elemental2_dom_HTMLElement_$p_org_patternfly_component_help_HelperTextItem() {
  if ($Equality.$same(this.f_screenReaderElement__org_patternfly_component_help_HelperTextItem_, null)) {
   this.f_textElement__org_patternfly_component_help_HelperTextItem_.appendChild(this.f_screenReaderElement__org_patternfly_component_help_HelperTextItem_ = (/**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to(Elements.m_span__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_screenReader__org_patternfly_style_Classes], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement());
  }
 ...
 m_icon__org_patternfly_icon_PredefinedIcon__org_jboss_elemento_TypedBuilder(/** PredefinedIcon */ arg0) {
  return /**@type {HelperTextItem}*/ ($Casts.$to(ComponentIcon.m_icon__$default__org_patternfly_component_ComponentIcon__org_patternfly_icon_PredefinedIcon__org_jboss_elemento_TypedBuilder(this, arg0), HelperTextItem));
 }
 //Bridge method.
 /** @final @override @nodts @return {HelperTextItem} */
 ...
 m_iconAndText__org_patternfly_icon_PredefinedIcon__java_lang_String__org_jboss_elemento_TypedBuilder(/** PredefinedIcon */ arg0, /** ?string */ arg1) {
  return /**@type {HelperTextItem}*/ ($Casts.$to(ComponentIconAndText.m_iconAndText__$default__org_patternfly_component_ComponentIconAndText__org_patternfly_icon_PredefinedIcon__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0, arg1), HelperTextItem));
 }
 //Bridge method.
 /** @final @override @nodts @return {HelperTextItem} */
 m_iconAndText__org_patternfly_icon_PredefinedIcon__java_lang_String__org_patternfly_component_IconPosition__org_jboss_elemento_TypedBuilder(/** PredefinedIcon */ arg0, /** ?string */ arg1, /** IconPosition */ arg2) {
  return /**@type {HelperTextItem}*/ ($Casts.$to(ComponentIconAndText.m_iconAndText__$default__org_patternfly_component_ComponentIconAndText__org_patternfly_icon_PredefinedIcon__java_lang_String__org_patternfly_component_IconPosition__org_jboss_elemento_TypedBuilder(this, arg0, arg1, arg2), HelperTextItem));
 }
 //Bridge method.
 /** @final @override @nodts @return {HelperTextItem} */
...
/**@const {string} @nodts*/
HelperTextItem.f_SUB_COMPONENT_ID__org_patternfly_component_help_HelperTextItem = 'hti';
/**@const {string} @nodts*/
HelperTextItem.f_SUB_COMPONENT_NAME__org_patternfly_component_help_HelperTextItem = 'HelperTextItem';
ComponentIcon.$markImplementor(HelperTextItem);
ComponentIconAndText.$markImplementor(HelperTextItem);
ElementTextMethods.$markImplementor(HelperTextItem);
