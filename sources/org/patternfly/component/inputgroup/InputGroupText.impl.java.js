 ...
 * @implements {ComponentIcon<HTMLElement, InputGroupText>}
 * @implements {ElementContainerDelegate<HTMLElement, InputGroupText>}
 * @implements {ElementTextDelegate<HTMLElement, InputGroupText>}
...
class InputGroupText extends InputGroupSubComponent {
 ...
 $ctor__org_patternfly_component_inputgroup_InputGroupText__java_lang_String__void(/** ?string */ text) {
  this.$ctor__org_patternfly_component_inputgroup_InputGroupSubComponent__java_lang_String__java_lang_String__elemental2_dom_HTMLElement__void(InputGroupText.f_SUB_COMPONENT_ID__org_patternfly_component_inputgroup_InputGroupText, InputGroupText.f_SUB_COMPONENT_NAME__org_patternfly_component_inputgroup_InputGroupText, /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_inputGroup__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_item__org_patternfly_style_Classes], j_l_String))), Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_box__org_patternfly_style_Classes)], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay)));
  this.m_element__elemental2_dom_HTMLElement().appendChild(this.f_textElement__org_patternfly_component_inputgroup_InputGroupText_ = (/**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to(Elements.m_span__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_inputGroup__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_text__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement());
 ...
 m_icon__org_patternfly_icon_PredefinedIcon__org_jboss_elemento_TypedBuilder(/** PredefinedIcon */ arg0) {
  return /**@type {InputGroupText}*/ ($Casts.$to(ComponentIcon.m_icon__$default__org_patternfly_component_ComponentIcon__org_patternfly_icon_PredefinedIcon__org_jboss_elemento_TypedBuilder(this, arg0), InputGroupText));
 }
 //Bridge method.
 /** @final @override @nodts @return {InputGroupText} */
 ...
 m_add__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ arg0) {
  return /**@type {InputGroupText}*/ ($Casts.$to(ElementContainerDelegate.m_add__$default__org_jboss_elemento_ElementContainerDelegate__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), InputGroupText));
 }
 //Bridge method.
 /** @final @override @nodts @return {InputGroupText} */
 m_add__elemental2_dom_Node__org_jboss_elemento_TypedBuilder(/** Node */ arg0) {
  return /**@type {InputGroupText}*/ ($Casts.$to(ElementContainerDelegate.m_add__$default__org_jboss_elemento_ElementContainerDelegate__elemental2_dom_Node__org_jboss_elemento_TypedBuilder(this, arg0), InputGroupText));
 }
 //Bridge method.
 /** @final @override @nodts @return {InputGroupText} */
 m_add__java_util_function_Supplier__org_jboss_elemento_TypedBuilder(/** Supplier<Node> */ arg0) {
  return /**@type {InputGroupText}*/ ($Casts.$to(ElementContainerDelegate.m_add__$default__org_jboss_elemento_ElementContainerDelegate__java_util_function_Supplier__org_jboss_elemento_TypedBuilder(this, arg0), InputGroupText));
 }
 //Bridge method.
 /** @final @override @nodts @return {InputGroupText} */
 m_text__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ arg0) {
  return /**@type {InputGroupText}*/ ($Casts.$to(ElementTextDelegate.m_text__$default__org_jboss_elemento_ElementTextDelegate__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), InputGroupText));
 }
 ...
 //Default method forwarding stub.
 /** @nodts @return {InputGroupText} */
 m_add__java_util_function_Supplier__org_patternfly_component_inputgroup_InputGroupText(/** Supplier<Node> */ arg0) {
  return /**@type {InputGroupText}*/ ($Casts.$to(ElementContainerDelegate.m_add__$default__org_jboss_elemento_ElementContainerDelegate__java_util_function_Supplier__org_jboss_elemento_TypedBuilder(this, arg0), InputGroupText));
 }
 //Default method forwarding stub.
 /** @nodts @return {InputGroupText} */
 m_text__java_lang_String__org_patternfly_component_inputgroup_InputGroupText(/** ?string */ arg0) {
  return /**@type {InputGroupText}*/ ($Casts.$to(ElementTextDelegate.m_text__$default__org_jboss_elemento_ElementTextDelegate__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), InputGroupText));
 }
 //Default method forwarding stub.
 /** @nodts @return {InputGroupText} */
...
/**@const {string} @nodts*/
InputGroupText.f_SUB_COMPONENT_ID__org_patternfly_component_inputgroup_InputGroupText = 'igt';
/**@const {string} @nodts*/
InputGroupText.f_SUB_COMPONENT_NAME__org_patternfly_component_inputgroup_InputGroupText = 'InputGroupText';
ComponentIcon.$markImplementor(InputGroupText);
ElementContainerDelegate.$markImplementor(InputGroupText);
ElementTextDelegate.$markImplementor(InputGroupText);
