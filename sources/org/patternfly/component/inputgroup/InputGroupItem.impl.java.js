...
class InputGroupItem extends InputGroupSubComponent {
 ...
 $ctor__org_patternfly_component_inputgroup_InputGroupItem__void() {
  this.$ctor__org_patternfly_component_inputgroup_InputGroupSubComponent__java_lang_String__java_lang_String__elemental2_dom_HTMLElement__void(InputGroupItem.f_SUB_COMPONENT_ID__org_patternfly_component_inputgroup_InputGroupItem, InputGroupItem.f_SUB_COMPONENT_NAME__org_patternfly_component_inputgroup_InputGroupItem, /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_inputGroup__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.f_item__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay)));
 }
 /** @nodts @return {InputGroupItem} */
 ...
 /** @nodts @return {InputGroupItem} */
 m_addControl__org_patternfly_component_form_FormControl__org_patternfly_component_inputgroup_InputGroupItem(/** FormControl<?, ?> */ formControl) {
...
/**@const {string} @nodts*/
InputGroupItem.f_SUB_COMPONENT_ID__org_patternfly_component_inputgroup_InputGroupItem = 'igi';
/**@const {string} @nodts*/
InputGroupItem.f_SUB_COMPONENT_NAME__org_patternfly_component_inputgroup_InputGroupItem = 'InputGroupItem';
