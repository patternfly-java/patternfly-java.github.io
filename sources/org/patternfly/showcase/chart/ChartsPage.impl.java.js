goog.module('org.patternfly.showcase.chart.ChartsPage$impl');
 ...
 */
class ChartsPage extends OverviewPage {
 /** @protected @nodts */
 constructor() {
  super();
 }
 /** @nodts @return {!ChartsPage} */
 static $create__() {
  ChartsPage.$clinit();
  let $instance = new ChartsPage();
  $instance.$ctor__org_patternfly_showcase_chart_ChartsPage__void();
  return $instance;
 }
 /** @nodts */
 $ctor__org_patternfly_showcase_chart_ChartsPage__void() {
  this.$ctor__org_patternfly_showcase_OverviewPage__java_lang_String__void('Charts');
 }
 /** @override @nodts */
...
$Util.$setClassMetadata(ChartsPage, 'org.patternfly.showcase.chart.ChartsPage');

exports = ChartsPage;

//# sourceMappingURL=ChartsPage.js.map
