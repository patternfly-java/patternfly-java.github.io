goog.module('org.patternfly.showcase.model.User.$Overlay$impl');
...
class $Overlay {
 ...
 static m_fullName__$devirt__org_patternfly_showcase_model_User__java_lang_String(/** !Object */ $thisArg) {
  $Overlay.$clinit();
 ...
 static m_match__$devirt__org_patternfly_showcase_model_User__java_lang_String__boolean(/** !Object */ $thisArg, /** ?string */ query) {
  $Overlay.$clinit();
 ...
 static get f_BIRTHDAY_COMPARATOR__org_patternfly_showcase_model_User_$Overlay() {
  return ($Overlay.$clinit(), $Overlay.$static_BIRTHDAY_COMPARATOR__org_patternfly_showcase_model_User_$Overlay);
 }
 /** @nodts @return {Comparator<Object>} */
 static get f_REGISTERED_COMPARATOR__org_patternfly_showcase_model_User_$Overlay() {
  return ($Overlay.$clinit(), $Overlay.$static_REGISTERED_COMPARATOR__org_patternfly_showcase_model_User_$Overlay);
 }
 /** @nodts */
 static $clinit() {
  $Overlay.$clinit = () =>{};
  $Overlay.$loadModules();
  $Overlay.$static_BIRTHDAY_COMPARATOR__org_patternfly_showcase_model_User_$Overlay = Comparator.$adapt(/**  @return {number}*/ ((/** Object */ u1, /** Object */ u2) =>{
   let u1_1 = /**@type {Object}*/ ($Casts.$to(u1, $Overlay));
   let u2_1 = /**@type {Object}*/ ($Casts.$to(u2, $Overlay));
   return Primitives.m_narrowDoubleToInt__int__int($Overlay.m_getBirthday__$devirt__org_patternfly_showcase_model_User__elemental2_core_JsDate(u1_1).getTime() - $Overlay.m_getBirthday__$devirt__org_patternfly_showcase_model_User__elemental2_core_JsDate(u2_1).getTime());
  }));
  $Overlay.$static_REGISTERED_COMPARATOR__org_patternfly_showcase_model_User_$Overlay = Comparator.$adapt(/**  @return {number}*/ ((/** Object */ u1_2, /** Object */ u2_2) =>{
   let u1_3 = /**@type {Object}*/ ($Casts.$to(u1_2, $Overlay));
   let u2_3 = /**@type {Object}*/ ($Casts.$to(u2_2, $Overlay));
   return Primitives.m_narrowDoubleToInt__int__int($Overlay.m_getRegistered__$devirt__org_patternfly_showcase_model_User__elemental2_core_JsDate(u1_3).getTime() - $Overlay.m_getRegistered__$devirt__org_patternfly_showcase_model_User__elemental2_core_JsDate(u2_3).getTime());
  }));
 }
...
$Overlay.$static_BIRTHDAY_COMPARATOR__org_patternfly_showcase_model_User_$Overlay;
/**@private {Comparator<Object>} @nodts*/
$Overlay.$static_REGISTERED_COMPARATOR__org_patternfly_showcase_model_User_$Overlay;
