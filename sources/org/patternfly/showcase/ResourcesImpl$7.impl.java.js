goog.module('org.patternfly.showcase.ResourcesImpl.$7$impl');
...
class $7 extends TextResourcePrototype {
 /** @protected @nodts */
 constructor() {
  super();
  /**@type {!ResourcesImpl} @nodts*/
  this.$outer_this__org_patternfly_showcase_ResourcesImpl_7;
 }
 /** @nodts @return {!$7} */
 static $create__org_patternfly_showcase_ResourcesImpl(/** !ResourcesImpl */ $outer_this) {
  $7.$clinit();
  let $instance = new $7();
  $instance.$ctor__org_patternfly_showcase_ResourcesImpl_7__org_patternfly_showcase_ResourcesImpl__void($outer_this);
  return $instance;
 }
 /** @nodts */
 $ctor__org_patternfly_showcase_ResourcesImpl_7__org_patternfly_showcase_ResourcesImpl__void(/** !ResourcesImpl */ $outer_this) {
  this.$outer_this__org_patternfly_showcase_ResourcesImpl_7 = $outer_this;
...
$Util.$setClassMetadata($7, 'org.patternfly.showcase.ResourcesImpl$7');

exports = $7;

//# sourceMappingURL=ResourcesImpl$7.js.map
