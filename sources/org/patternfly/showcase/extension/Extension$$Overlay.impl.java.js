goog.module('org.patternfly.showcase.extension.Extension.$Overlay$impl');
...
class $Overlay {
 ...
 static m_implemented__$devirt__org_patternfly_showcase_extension_Extension__boolean(/** !Object */ $thisArg) {
  $Overlay.$clinit();
  return !$Equality.$same($thisArg.clazz, null) && !$Equality.$same($thisArg.route, null);
 }
 /** @final @nodts @return {SafeHtml} */
 static m_summary__$devirt__org_patternfly_showcase_extension_Extension__org_gwtproject_safehtml_shared_SafeHtml(/** !Object */ $thisArg) {
  $Overlay.$clinit();
 ...
 static m_apiDoc__$devirt__org_patternfly_showcase_extension_Extension__java_lang_String(/** !Object */ $thisArg) {
  $Overlay.$clinit();
...
//# sourceMappingURL=Extension$$Overlay.js.map
