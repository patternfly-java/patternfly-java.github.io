...
let $11 = goog.forwardDeclare('org.patternfly.showcase.ResourcesImpl.$11$impl');
...
let wordsInitializer = goog.forwardDeclare('org.patternfly.showcase.ResourcesImpl.wordsInitializer$impl');
...
class ResourcesImpl extends j_l_Object {
 ...
 /** @nodts */
 m_wordsInitializer__void_$p_org_patternfly_showcase_ResourcesImpl() {
  ResourcesImpl.$static_words__org_patternfly_showcase_ResourcesImpl_ = $11.$create__org_patternfly_showcase_ResourcesImpl(this);
 }
 /** @override @nodts @return {TextResource} */
 m_words__org_treblereel_j2cl_processors_common_resources_TextResource() {
  return wordsInitializer.m_get__org_treblereel_j2cl_processors_common_resources_TextResource();
 }
 ...
 m_getResource__java_lang_String__org_treblereel_j2cl_processors_common_resources_ResourcePrototype(/** ?string */ name) {
  if ($Equality.$same(this.f_resourceMap__org_patternfly_showcase_ResourcesImpl_, null)) {
   ...
   this.f_resourceMap__org_patternfly_showcase_ResourcesImpl_.put('words', this.m_words__org_treblereel_j2cl_processors_common_resources_TextResource());
  }
 ...
 /** @nodts @return {TextResource} */
 static get f_words__org_patternfly_showcase_ResourcesImpl_() {
  return (ResourcesImpl.$clinit(), ResourcesImpl.$static_words__org_patternfly_showcase_ResourcesImpl_);
 }
 /** @nodts */
 static set f_words__org_patternfly_showcase_ResourcesImpl_(/** TextResource */ value) {
  (ResourcesImpl.$clinit(), ResourcesImpl.$static_words__org_patternfly_showcase_ResourcesImpl_ = value);
 }
 /** @nodts */
 static $clinit() {
 ...
 static $loadModules() {
  ...
  $11 = goog.module.get('org.patternfly.showcase.ResourcesImpl.$11$impl');
  ...
  wordsInitializer = goog.module.get('org.patternfly.showcase.ResourcesImpl.wordsInitializer$impl');
...
/**@private {TextResource} @nodts*/
ResourcesImpl.$static_words__org_patternfly_showcase_ResourcesImpl_;
