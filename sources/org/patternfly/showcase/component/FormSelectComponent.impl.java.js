...
class FormSelectComponent extends SnippetPage {
 ...
 $ctor__org_patternfly_showcase_component_FormSelectComponent__void() {
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('form-select-basic', 'Basic', Code.m_code__java_lang_String__java_lang_String('form-select-basic'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
   let values = /**@type {!Array<?string>}*/ ($Arrays.$stampType(['Mr', 'Miss', 'Mrs', 'Ms', 'Dr', 'Other'], j_l_String));
   return /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(FormSelect.m_formSelect__java_lang_String__java_lang_String__org_patternfly_component_form_FormSelect('basic-form-select-0', Id.m_build__java_lang_String__arrayOf_java_lang_String__java_lang_String('Mrs', /**@type {!Array<?string>}*/ ($Arrays.$create([0], j_l_String)))).m_addOption__org_patternfly_component_form_FormSelectOption__org_patternfly_component_form_FormSelect(FormSelectOption.m_formSelectOption__java_lang_String__org_patternfly_component_form_FormSelectOption('Select one').m_placeholder__org_patternfly_component_form_FormSelectOption()).m_addOptions__java_lang_Iterable__java_util_function_Function__org_patternfly_component_form_FormSelect(/**@type {List<?string>}*/ (Arrays.m_asList__arrayOf_java_lang_Object__java_util_List(values)), j_u_function_Function.$adapt(/**  @return {FormSelectOption}*/ ((/** ?string */ arg0) =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('form-select-validated', 'Validated', Code.m_code__java_lang_String__java_lang_String('form-select-validated'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
   ...
   let formSelect = FormSelect.m_formSelect__java_lang_String__org_patternfly_component_form_FormSelect('validated-form-select-0').m_onChange__org_patternfly_handler_ChangeHandler__org_patternfly_component_form_FormSelect(ChangeHandler.$adapt((/** Event */ e, /** FormSelect */ fs, /** ?string */ value) =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('form-select-grouped', 'Grouped', Code.m_code__java_lang_String__java_lang_String('form-select-grouped'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
