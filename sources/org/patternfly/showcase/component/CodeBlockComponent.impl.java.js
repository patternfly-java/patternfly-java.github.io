...
class CodeBlockComponent extends SnippetPage {
 ...
 $ctor__org_patternfly_showcase_component_CodeBlockComponent__void() {
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('code-block-basic', 'Basic', Code.m_code__java_lang_String__java_lang_String('code-block-basic'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(CodeBlock.m_codeBlock__org_patternfly_component_codeblock_CodeBlock().m_addAction__org_patternfly_component_codeblock_CodeBlockAction__org_patternfly_component_codeblock_CodeBlock(CodeBlockAction.m_codeBlockCopyToClipboardAction__org_patternfly_component_codeblock_CodeBlockAction()).m_addAction__org_patternfly_component_codeblock_CodeBlockAction__org_patternfly_component_codeblock_CodeBlock(CodeBlockAction.m_codeBlockAction__org_patternfly_icon_PredefinedIcon__org_patternfly_component_codeblock_CodeBlockAction(fas.m_play__org_patternfly_icon_PredefinedIcon()).m_ariaLabel__java_lang_String__org_patternfly_component_codeblock_CodeBlockAction('Play').m_onClick__org_patternfly_handler_ComponentHandler__org_patternfly_component_codeblock_CodeBlockAction(ComponentHandler.$adapt((/** Event */ action, /** CodeBlock */ codeBlock) =>{
    let codeBlock_1 = /**@type {CodeBlock}*/ ($Casts.$to(codeBlock, CodeBlock));
    goog.global.console.log('Play not yet implemented');
   }))).m_code__java_lang_String__org_patternfly_component_codeblock_CodeBlock(CodeBlockComponent.f_CODE__org_patternfly_showcase_component_CodeBlockComponent_)), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  }))));
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('code-block-expandable', 'Expandable', Code.m_code__java_lang_String__java_lang_String('code-block-expandable'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(CodeBlock.m_codeBlock__org_patternfly_component_codeblock_CodeBlock().m_addAction__org_patternfly_component_codeblock_CodeBlockAction__org_patternfly_component_codeblock_CodeBlock(CodeBlockAction.m_codeBlockCopyToClipboardAction__org_patternfly_component_codeblock_CodeBlockAction()).m_addAction__org_patternfly_component_codeblock_CodeBlockAction__org_patternfly_component_codeblock_CodeBlock(CodeBlockAction.m_codeBlockAction__org_patternfly_icon_PredefinedIcon__org_patternfly_component_codeblock_CodeBlockAction(fas.m_play__org_patternfly_icon_PredefinedIcon()).m_ariaLabel__java_lang_String__org_patternfly_component_codeblock_CodeBlockAction('Play').m_onClick__org_patternfly_handler_ComponentHandler__org_patternfly_component_codeblock_CodeBlockAction(ComponentHandler.$adapt((/** Event */ action_1, /** CodeBlock */ codeBlock_2) =>{
    let codeBlock_3 = /**@type {CodeBlock}*/ ($Casts.$to(codeBlock_2, CodeBlock));
    goog.global.console.log('Play not yet implemented');
   }))).m_truncate__org_patternfly_component_codeblock_CodeBlock().m_code__java_lang_String__org_patternfly_component_codeblock_CodeBlock(CodeBlockComponent.f_CODE__org_patternfly_showcase_component_CodeBlockComponent_)), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  }))));
 ...
 static $loadModules() {
  ...
  CodeBlockAction = goog.module.get('org.patternfly.component.codeblock.CodeBlockAction$impl');
