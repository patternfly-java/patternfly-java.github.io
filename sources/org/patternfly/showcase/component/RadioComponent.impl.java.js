...
class RadioComponent extends SnippetPage {
 ...
 $ctor__org_patternfly_showcase_component_RadioComponent__void() {
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('radio-basic', 'Basic', Code.m_code__java_lang_String__java_lang_String('radio-basic'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('radio-reversed', 'Reversed', Code.m_code__java_lang_String__java_lang_String('radio-reversed'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('radio-disabled', 'Disabled', Code.m_code__java_lang_String__java_lang_String('radio-disabled'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('radio-description', 'Radio with description', Code.m_code__java_lang_String__java_lang_String('radio-description'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('radio-body', 'Radio with body', Code.m_code__java_lang_String__java_lang_String('radio-body'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('radio-description-body', 'Radio with description and body', Code.m_code__java_lang_String__java_lang_String('radio-description-body'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('radio-standalone', 'Standalone input', Code.m_code__java_lang_String__java_lang_String('radio-standalone'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
