...
class BackToTopComponent extends SnippetPage {
 ...
 $ctor__org_patternfly_showcase_component_BackToTopComponent__void() {
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('btt-basic', 'Basic', Code.m_code__java_lang_String__java_lang_String('btt-basic'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
