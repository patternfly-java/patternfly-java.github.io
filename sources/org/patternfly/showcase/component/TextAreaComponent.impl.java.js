...
class TextAreaComponent extends SnippetPage {
 ...
 $ctor__org_patternfly_showcase_component_TextAreaComponent__void() {
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('text-area-basic', 'Basic', Code.m_code__java_lang_String__java_lang_String('text-area-basic'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('text-area-invalid', 'Invalid', Code.m_code__java_lang_String__java_lang_String('text-area-invalid'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('text-area-validated', 'Validated', Code.m_code__java_lang_String__java_lang_String('text-area-validated'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
   ...
   let textArea = TextArea.m_textArea__java_lang_String__org_patternfly_component_form_TextArea('validated-text-area-0').m_onKeyup__org_patternfly_handler_ChangeHandler__org_patternfly_component_form_TextArea(ChangeHandler.$adapt((/** Event */ e, /** TextArea */ ta, /** ?string */ value) =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('text-area-horizontal', 'Horizontally resizable', Code.m_code__java_lang_String__java_lang_String('text-area-horizontal'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('text-area-both', 'Vertically and horizontally resizable', Code.m_code__java_lang_String__java_lang_String('text-area-both'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('text-area-disabled', 'Disabled', Code.m_code__java_lang_String__java_lang_String('text-area-disabled'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('text-area-readonly', 'Read only', Code.m_code__java_lang_String__java_lang_String('text-area-readonly'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('text-auto-size', 'Auto resizing', Code.m_code__java_lang_String__java_lang_String('text-auto-size'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
