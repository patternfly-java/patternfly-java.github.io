...
let Resources = goog.forwardDeclare('org.patternfly.showcase.Resources$impl');
...
class AvatarComponent extends SnippetPage {
 ...
 $ctor__org_patternfly_showcase_component_AvatarComponent__void() {
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('avatar-basic', 'Basic', Code.m_code__java_lang_String__java_lang_String('avatar-basic'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(Avatar.m_avatar__java_lang_String__java_lang_String__org_patternfly_component_avatar_Avatar(Resources.m_avatarData__java_lang_String(), 'avatar')), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  }))));
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('avatar-size', 'Size variations', Code.m_code__java_lang_String__java_lang_String('avatar-size'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('avatar-bordered', 'Bordered', Code.m_code__java_lang_String__java_lang_String('avatar-bordered'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {Avatar}*/ ($Casts.$to(Avatar.m_avatar__java_lang_String__java_lang_String__org_patternfly_component_avatar_Avatar(Resources.m_avatarData__java_lang_String(), 'avatar').m_bordered__org_jboss_elemento_TypedBuilder(), Avatar))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  }))));
 ...
 static $loadModules() {
  ...
  Resources = goog.module.get('org.patternfly.showcase.Resources$impl');
