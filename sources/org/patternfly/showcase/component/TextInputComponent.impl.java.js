...
class TextInputComponent extends SnippetPage {
 ...
 $ctor__org_patternfly_showcase_component_TextInputComponent__void() {
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('text-input-basic', 'Basic', Code.m_code__java_lang_String__java_lang_String('text-input-basic'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('text-input-disabled', 'Disabled', Code.m_code__java_lang_String__java_lang_String('text-input-disabled'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('text-input-readonly', 'Read only', Code.m_code__java_lang_String__java_lang_String('text-input-readonly'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('text-input-invalid', 'Invalid', Code.m_code__java_lang_String__java_lang_String('text-input-invalid'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('text-input-custom-icon', 'Custom icon', Code.m_code__java_lang_String__java_lang_String('text-input-custom-icon'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {TextInput}*/ ($Casts.$to((/**@type {TextInput}*/ ($Casts.$to(TextInput.m_textInput__java_lang_String__org_patternfly_component_form_TextInput('custom-icon-text-input-0').m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType([Classes.m_util__java_lang_String__java_lang_String('mb-sm')], j_l_String))), TextInput))).m_icon__org_patternfly_icon_PredefinedIcon__org_jboss_elemento_TypedBuilder(fas.m_calendar__org_patternfly_icon_PredefinedIcon()), TextInput))), HTMLContainerBuilder))).m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {TextInput}*/ ($Casts.$to(TextInput.m_textInput__java_lang_String__org_patternfly_component_form_TextInput('custom-icon-text-input-1').m_icon__org_patternfly_icon_PredefinedIcon__org_jboss_elemento_TypedBuilder(fas.m_clock__org_patternfly_icon_PredefinedIcon()), TextInput))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  }))));
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('text-input-custom-icon-and-invalid', 'Custom icon and invalid', Code.m_code__java_lang_String__java_lang_String('text-input-custom-icon-and-invalid'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
