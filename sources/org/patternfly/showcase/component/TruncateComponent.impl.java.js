...
class TruncateComponent extends SnippetPage {
 ...
 $ctor__org_patternfly_showcase_component_TruncateComponent__void() {
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('truncate-default', 'Default', Code.m_code__java_lang_String__java_lang_String('truncate-default'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType(['truncate-example-resize'], j_l_String))), HTMLContainerBuilder))).m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(Truncate.m_truncate__java_lang_String__org_patternfly_component_truncate_Truncate(LoremIpsum.m_words__java_lang_String())), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  }))));
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('truncate-middle', 'Middle', Code.m_code__java_lang_String__java_lang_String('truncate-middle'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('truncate-start', 'Start', Code.m_code__java_lang_String__java_lang_String('truncate-start'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType(['truncate-example-resize'], j_l_String))), HTMLContainerBuilder))).m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(Truncate.m_truncate__java_lang_String__org_patternfly_component_truncate_TruncatePosition__org_patternfly_component_truncate_Truncate(LoremIpsum.m_words__java_lang_String(), TruncatePosition.f_start__org_patternfly_component_truncate_TruncatePosition)), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  }))));
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('truncate-max-chars', 'Based on max characters', Code.m_code__java_lang_String__java_lang_String('truncate-max-chars'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
   let fullText = LoremIpsum.m_words__java_lang_String();
   let maxChars = 20;
   let truncatedText = j_l_String.m_length__java_lang_String__int(fullText) > maxChars ? j_l_String.m_valueOf__java_lang_Object__java_lang_String(j_l_String.m_substring__java_lang_String__int__int__java_lang_String(fullText, 0, maxChars)) + '...' : fullText;
   return /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(Truncate.m_truncate__java_lang_String__org_patternfly_component_truncate_Truncate(truncatedText)), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  }))));
