...
class $Overlay {
 ...
 static m_illustration__$devirt__org_patternfly_showcase_component_Component__java_lang_String(/** !Object */ $thisArg) {
  $Overlay.$clinit();
  return 'https://raw.githubusercontent.com/patternfly-java/patternfly-java/refs/heads/main/showcase/src/web/images/' + j_l_String.m_valueOf__java_lang_Object__java_lang_String($thisArg.illustration);
 }
 /** @nodts */
 static $clinit() {
  $Overlay.$clinit = () =>{};
