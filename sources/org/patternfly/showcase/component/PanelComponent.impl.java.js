...
class PanelComponent extends SnippetPage {
 ...
 $ctor__org_patternfly_showcase_component_PanelComponent__void() {
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('panel-basic', 'Basic', Code.m_code__java_lang_String__java_lang_String('panel-basic'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('panel-header', 'Header', Code.m_code__java_lang_String__java_lang_String('panel-header'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('panel-footer', 'Footer', Code.m_code__java_lang_String__java_lang_String('panel-footer'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('panel-header-footer', 'Header and footer', Code.m_code__java_lang_String__java_lang_String('panel-header-footer'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to(Panel.m_panel__org_patternfly_component_panel_Panel().m_addHeader__java_lang_String__org_patternfly_component_panel_Panel('Header content').m_addDivider__org_patternfly_component_panel_Panel().m_addMain__java_lang_String__org_patternfly_component_panel_Panel('Main content').m_addFooter__java_lang_String__org_patternfly_component_panel_Panel('Footer content').m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  }))));
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('panel-no-body', 'No body', Code.m_code__java_lang_String__java_lang_String('panel-no-body'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to(Panel.m_panel__org_patternfly_component_panel_Panel().m_addMain__org_patternfly_component_panel_PanelMain__org_patternfly_component_panel_Panel(/**@type {PanelMain}*/ ($Casts.$to(PanelMain.m_panelMain__org_patternfly_component_panel_PanelMain().m_apply__java_util_function_Consumer__org_jboss_elemento_TypedBuilder(Consumer.$adapt((/** HTMLElement */ main) =>{
    let main_1 = /**@type {HTMLElement}*/ ($Casts.$to(main, HTMLElement_$Overlay));
    main_1.textContent = 'Main content';
   })), PanelMain))).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  }))));
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('panel-raised', 'Raised', Code.m_code__java_lang_String__java_lang_String('panel-raised'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('panel-bordered', 'Bordered', Code.m_code__java_lang_String__java_lang_String('panel-bordered'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('panel-scrollable', 'Scrollable', Code.m_code__java_lang_String__java_lang_String('panel-scrollable'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('panel-scrollable-header-footer', 'Scrollable with header and footer', Code.m_code__java_lang_String__java_lang_String('panel-scrollable-header-footer'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('panel-secondary', 'Secondary', Code.m_code__java_lang_String__java_lang_String('panel-secondary'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to(Panel.m_panel__org_patternfly_component_panel_Panel().m_secondary__org_patternfly_component_panel_Panel().m_addMain__java_lang_String__org_patternfly_component_panel_Panel('Main content').m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  }))));
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('panel-pill', 'Pill', Code.m_code__java_lang_String__java_lang_String('panel-pill'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to(Panel.m_panel__org_patternfly_component_panel_Panel().m_pill__org_patternfly_component_panel_Panel().m_addMain__java_lang_String__org_patternfly_component_panel_Panel('Pill panel content').m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  }))));
