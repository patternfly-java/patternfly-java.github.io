...
class SpinnerComponent extends SnippetPage {
 ...
 $ctor__org_patternfly_showcase_component_SpinnerComponent__void() {
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('spinner-basic', 'Basic', Code.m_code__java_lang_String__java_lang_String('spinner-basic'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('spinner-sizes', 'Sizes', Code.m_code__java_lang_String__java_lang_String('spinner-sizes'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('spinner-custom-size', 'Custom size', Code.m_code__java_lang_String__java_lang_String('spinner-custom-size'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('spinner-inline-size', 'Inline size', Code.m_code__java_lang_String__java_lang_String('spinner-inline-size'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {Content}*/ ($Casts.$to((/**@type {Content}*/ ($Casts.$to((/**@type {Content}*/ ($Casts.$to((/**@type {Content}*/ ($Casts.$to((/**@type {Content}*/ ($Casts.$to(Content.m_content__org_patternfly_component_content_Content().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {HTMLContainerBuilder<HTMLHeadingElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLHeadingElement>}*/ ($Casts.$to(Elements.m_h__int__org_jboss_elemento_HTMLContainerBuilder(1).m_add__java_lang_String__org_jboss_elemento_TypedBuilder('Heading '), HTMLContainerBuilder))).m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {Spinner}*/ ($Casts.$to(Spinner.m_spinner__java_lang_String__org_patternfly_component_spinner_Spinner('Spinner in heading').m_inline__org_jboss_elemento_TypedBuilder(), Spinner))), HTMLContainerBuilder))), Content))).m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {HTMLContainerBuilder<HTMLParagraphElement>}*/ ($Casts.$to(Elements.m_p__org_jboss_elemento_HTMLContainerBuilder().m_text__java_lang_String__org_jboss_elemento_TypedBuilder(LoremIpsum.m_paragraphs__int__java_lang_String(1)), HTMLContainerBuilder))), Content))).m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {HTMLContainerBuilder<HTMLHeadingElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLHeadingElement>}*/ ($Casts.$to(Elements.m_h__int__org_jboss_elemento_HTMLContainerBuilder(2).m_add__java_lang_String__org_jboss_elemento_TypedBuilder('Second level '), HTMLContainerBuilder))).m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {Spinner}*/ ($Casts.$to(Spinner.m_spinner__java_lang_String__org_patternfly_component_spinner_Spinner('Spinner in subheading').m_inline__org_jboss_elemento_TypedBuilder(), Spinner))), HTMLContainerBuilder))), Content))).m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {HTMLContainerBuilder<HTMLParagraphElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLParagraphElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLParagraphElement>}*/ ($Casts.$to(Elements.m_p__org_jboss_elemento_HTMLContainerBuilder().m_add__java_lang_String__org_jboss_elemento_TypedBuilder(j_l_String.m_valueOf__java_lang_Object__java_lang_String(LoremIpsum.m_paragraphs__int__java_lang_String(2)) + ' '), HTMLContainerBuilder))).m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {Spinner}*/ ($Casts.$to(Spinner.m_spinner__java_lang_String__org_patternfly_component_spinner_Spinner('Spinner in paragraph').m_inline__org_jboss_elemento_TypedBuilder(), Spinner))), HTMLContainerBuilder))).m_add__java_lang_String__org_jboss_elemento_TypedBuilder(' ' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(LoremIpsum.m_paragraphs__int__java_lang_String(3))), HTMLContainerBuilder))), Content))).m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to(Elements.m_small__org_jboss_elemento_HTMLContainerBuilder().m_add__java_lang_String__org_jboss_elemento_TypedBuilder('Sometimes you need small text '), HTMLContainerBuilder))).m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {Spinner}*/ ($Casts.$to(Spinner.m_spinner__java_lang_String__org_patternfly_component_spinner_Spinner('Spinner in small element').m_inline__org_jboss_elemento_TypedBuilder(), Spinner))), HTMLContainerBuilder))), Content))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  }))));
