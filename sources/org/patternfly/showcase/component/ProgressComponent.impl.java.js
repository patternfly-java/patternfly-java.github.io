...
class ProgressComponent extends SnippetPage {
 ...
 $ctor__org_patternfly_showcase_component_ProgressComponent__void() {
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-basic', 'Basic', Code.m_code__java_lang_String__java_lang_String('progress-basic'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-small', 'Small', Code.m_code__java_lang_String__java_lang_String('progress-small'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-large', 'Large', Code.m_code__java_lang_String__java_lang_String('progress-large'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-outside', 'Outside', Code.m_code__java_lang_String__java_lang_String('progress-outside'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-inside', 'Inside', Code.m_code__java_lang_String__java_lang_String('progress-inside'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-success', 'Success', Code.m_code__java_lang_String__java_lang_String('progress-success'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-failure', 'Failure', Code.m_code__java_lang_String__java_lang_String('progress-failure'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(Progress.m_progress__org_patternfly_component_progress_Progress().m_status__org_patternfly_style_Status__org_patternfly_component_progress_Progress(Status.f_danger__org_patternfly_style_Status).m_title__java_lang_String__org_patternfly_component_progress_Progress('Title').m_value__int__org_patternfly_component_progress_Progress(33)), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  }))));
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-warning', 'Warning', Code.m_code__java_lang_String__java_lang_String('progress-warning'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-inside-success', 'Inside success', Code.m_code__java_lang_String__java_lang_String('progress-inside-success'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-inside-warning', 'Inside warning', Code.m_code__java_lang_String__java_lang_String('progress-inside-warning'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(Progress.m_progress__org_patternfly_component_progress_Progress().m_status__org_patternfly_style_Status__org_patternfly_component_progress_Progress(Status.f_warning__org_patternfly_style_Status).m_measureLocation__org_patternfly_component_progress_MeasureLocation__org_patternfly_component_progress_Progress(MeasureLocation.f_inside__org_patternfly_component_progress_MeasureLocation).m_title__java_lang_String__org_patternfly_component_progress_Progress('Title').m_value__int__org_patternfly_component_progress_Progress(60)), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  }))));
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-outside-failure', 'Outside failure', Code.m_code__java_lang_String__java_lang_String('progress-outside-failure'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-single-line', 'Single line', Code.m_code__java_lang_String__java_lang_String('progress-single-line'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-no-measure', 'Without measure', Code.m_code__java_lang_String__java_lang_String('progress-no-measure'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(Progress.m_progress__org_patternfly_component_progress_Progress().m_measureLocation__org_patternfly_component_progress_MeasureLocation__org_patternfly_component_progress_Progress(MeasureLocation.f_none__org_patternfly_component_progress_MeasureLocation).m_title__java_lang_String__org_patternfly_component_progress_Progress('Title').m_value__int__org_patternfly_component_progress_Progress(33)), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  }))));
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-no-measure-failure', 'Failure without measure', Code.m_code__java_lang_String__java_lang_String('progress-no-measure-failure'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(Progress.m_progress__org_patternfly_component_progress_Progress().m_status__org_patternfly_style_Status__org_patternfly_component_progress_Progress(Status.f_danger__org_patternfly_style_Status).m_measureLocation__org_patternfly_component_progress_MeasureLocation__org_patternfly_component_progress_Progress(MeasureLocation.f_none__org_patternfly_component_progress_MeasureLocation).m_title__java_lang_String__org_patternfly_component_progress_Progress('Title').m_value__int__org_patternfly_component_progress_Progress(33)), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  }))));
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-finite-step', 'Finite step', Code.m_code__java_lang_String__java_lang_String('progress-finite-step'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(Progress.m_progress__org_patternfly_component_progress_Progress().m_label__org_patternfly_component_progress_ProgressLabel__org_patternfly_component_progress_Progress(ProgressLabel.$adapt(/**  @return {?string}*/ ((/** number */ min, /** number */ max, /** number */ step, /** number */ value) =>{
    return value + ' of ' + max;
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-step-instruction', 'Progress with step instructions', Code.m_code__java_lang_String__java_lang_String('progress-step-instruction'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
   let instructions = /**@type {Tuples<Integer, ?string>}*/ (Tuples.m_tuples__arrayOf_org_patternfly_core_Tuple__org_patternfly_core_Tuples(/**@type {!Array<Tuple<Integer, ?string>>}*/ ($Arrays.$stampType([/**@type {Tuple<Integer, ?string>}*/ (Tuple.m_tuple__java_lang_Object__java_lang_Object__org_patternfly_core_Tuple(Integer.valueOf(0), 'Preparing')), /**@type {Tuple<Integer, ?string>}*/ (Tuple.m_tuple__java_lang_Object__java_lang_Object__org_patternfly_core_Tuple(Integer.valueOf(1), 'Collecting files')), /**@type {Tuple<Integer, ?string>}*/ (Tuple.m_tuple__java_lang_Object__java_lang_Object__org_patternfly_core_Tuple(Integer.valueOf(2), 'Copying files')), /**@type {Tuple<Integer, ?string>}*/ (Tuple.m_tuple__java_lang_Object__java_lang_Object__org_patternfly_core_Tuple(Integer.valueOf(3), 'Verifying files')), /**@type {Tuple<Integer, ?string>}*/ (Tuple.m_tuple__java_lang_Object__java_lang_Object__org_patternfly_core_Tuple(Integer.valueOf(4), 'Restarting server')), /**@type {Tuple<Integer, ?string>}*/ (Tuple.m_tuple__java_lang_Object__java_lang_Object__org_patternfly_core_Tuple(Integer.valueOf(5), 'Cleanup'))], Tuple))));
   return /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(Progress.m_progress__org_patternfly_component_progress_Progress().m_label__org_patternfly_component_progress_ProgressLabel__org_patternfly_component_progress_Progress(ProgressLabel.$adapt(/**  @return {?string}*/ ((/** number */ min_1, /** number */ max_1, /** number */ step_1, /** number */ value_1) =>{
    return 'Step ' + value_1 + ': ' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(/**@type {?string}*/ ($Casts.$to(instructions.m_value__java_lang_Object__java_lang_Object(Integer.valueOf(value_1)), j_l_String)));
   }))).m_range__int__int__org_patternfly_component_progress_Progress(0, 5).m_title__java_lang_String__org_patternfly_component_progress_Progress('Title').m_value__int__org_patternfly_component_progress_Progress(2)), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  }))));
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-truncate', 'Truncate', Code.m_code__java_lang_String__java_lang_String('progress-truncate'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-outer-title', 'Title outside of progress bar', Code.m_code__java_lang_String__java_lang_String('progress-outer-title'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {DescriptionList}*/ ($Casts.$to(DescriptionList.m_descriptionList__org_patternfly_component_list_DescriptionList().m_addItem__org_patternfly_component_HasIdentifier__org_patternfly_component_HasItems(DescriptionListGroup.m_descriptionListGroup__java_lang_String__org_patternfly_component_list_DescriptionListGroup('progress-outer-title-0').m_addTerm__org_patternfly_component_list_DescriptionListTerm__org_patternfly_component_list_DescriptionListGroup(/**@type {DescriptionListTerm}*/ ($Casts.$to(DescriptionListTerm.m_descriptionListTerm__java_lang_String__org_patternfly_component_list_DescriptionListTerm('Title outside of progress bar').m_id__java_lang_String__org_jboss_elemento_TypedBuilder('title-outside-progress-example-label'), DescriptionListTerm))).m_addDescription__org_patternfly_component_list_DescriptionListDescription__org_patternfly_component_list_DescriptionListGroup(/**@type {DescriptionListDescription}*/ ($Casts.$to(DescriptionListDescription.m_descriptionListDescription__org_patternfly_component_list_DescriptionListDescription().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(Progress.m_progress__org_patternfly_component_progress_Progress().m_ariaLabeledBy__java_lang_String__org_patternfly_component_progress_Progress('title-outside-progress-example-label').m_measureLocation__org_patternfly_component_progress_MeasureLocation__org_patternfly_component_progress_Progress(MeasureLocation.f_outside__org_patternfly_component_progress_MeasureLocation).m_value__int__org_patternfly_component_progress_Progress(33)), DescriptionListDescription)))), DescriptionList))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  }))));
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-helper-text', 'Helper text', Code.m_code__java_lang_String__java_lang_String('progress-helper-text'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
   let status = /**@type {Tuples<Status, ?string>}*/ (Tuples.m_tuples__arrayOf_org_patternfly_core_Tuple__org_patternfly_core_Tuples(/**@type {!Array<Tuple<Status, ?string>>}*/ ($Arrays.$stampType([/**@type {Tuple<Status, ?string>}*/ (Tuple.m_tuple__java_lang_Object__java_lang_Object__org_patternfly_core_Tuple(Status.f_info__org_patternfly_style_Status, 'Default variant')), /**@type {Tuple<Status, ?string>}*/ (Tuple.m_tuple__java_lang_Object__java_lang_Object__org_patternfly_core_Tuple(Status.f_success__org_patternfly_style_Status, 'Success variant')), /**@type {Tuple<Status, ?string>}*/ (Tuple.m_tuple__java_lang_Object__java_lang_Object__org_patternfly_core_Tuple(Status.f_warning__org_patternfly_style_Status, 'Warning variant')), /**@type {Tuple<Status, ?string>}*/ (Tuple.m_tuple__java_lang_Object__java_lang_Object__org_patternfly_core_Tuple(Status.f_danger__org_patternfly_style_Status, 'Danger variant'))], Tuple))));
  ...
  this.m_addApiDoc__java_lang_Class__org_patternfly_showcase_ApiDoc_Type__void(Class.$get(/**@type {Function}*/ (ProgressLabel)), Type.f_subcomponent__org_patternfly_showcase_ApiDoc_Type);
 }
 /** @nodts */
 static $clinit() {
  ProgressComponent.$clinit = () =>{};
