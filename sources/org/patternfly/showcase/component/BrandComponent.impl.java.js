...
class BrandComponent extends SnippetPage {
 ...
 $ctor__org_patternfly_showcase_component_BrandComponent__void() {
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('brand-basic', 'Basic', Code.m_code__java_lang_String__java_lang_String('brand-basic'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(Brand.m_brand__java_lang_String__java_lang_String__org_patternfly_component_brand_Brand('https://raw.githubusercontent.com/patternfly/patternfly/refs/heads/main/static/assets/images/PF-HorizontalLogo-Color.svg', 'PatternFly logo')), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  }))));
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('brand-responsive', 'Responsive', Code.m_code__java_lang_String__java_lang_String('brand-responsive'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(Brand.m_brand__org_patternfly_component_brand_Brand().m_widths__org_patternfly_style_Breakpoints__org_patternfly_component_brand_Brand(/**@type {Breakpoints<?string>}*/ (Breakpoints.m_breakpoints__org_patternfly_style_Breakpoint__java_lang_Object__org_patternfly_style_Breakpoint__java_lang_Object__org_patternfly_style_Breakpoint__java_lang_Object__org_patternfly_style_Breakpoints(Breakpoint.f_default___org_patternfly_style_Breakpoint, '40px', Breakpoint.f_sm__org_patternfly_style_Breakpoint, '60px', Breakpoint.f_md__org_patternfly_style_Breakpoint, '220px'))).m_addSource__java_lang_String__java_lang_String__org_patternfly_component_brand_Brand('https://raw.githubusercontent.com/patternfly/patternfly/refs/heads/main/static/assets/images/PF-HorizontalLogo-Color.svg', '(min-width: 1200px)').m_addSource__java_lang_String__java_lang_String__org_patternfly_component_brand_Brand('https://raw.githubusercontent.com/patternfly/patternfly/refs/heads/main/static/assets/images/PF-HorizontalLogo-Color.svg', '(min-width: 992px)').m_addSource__java_lang_String__java_lang_String__org_patternfly_component_brand_Brand('https://raw.githubusercontent.com/patternfly/patternfly/refs/heads/main/static/assets/images/PF-HorizontalLogo-Color.svg', '(min-width: 768px)').m_addSource__java_lang_String__java_lang_String__org_patternfly_component_brand_Brand('https://raw.githubusercontent.com/patternfly/patternfly/refs/heads/main/static/assets/images/PF-IconLogo-color.svg', '(min-width: 576px)').m_addSource__java_lang_String__java_lang_String__org_patternfly_component_brand_Brand('https://www.patternfly.org/assets/images/pf-c-brand__logo.svg', '(min-width: 320px)').m_addImg__org_jboss_elemento_HTMLElementBuilder__org_patternfly_component_brand_Brand(/**@type {HTMLElementBuilder<HTMLImageElement>}*/ ($Casts.$to(Elements.m_img__java_lang_String__org_jboss_elemento_HTMLElementBuilder('https://raw.githubusercontent.com/patternfly/patternfly/refs/heads/main/static/assets/images/PF-HorizontalLogo-Color.svg').m_apply__java_util_function_Consumer__org_jboss_elemento_TypedBuilder(Consumer.$adapt((/** HTMLImageElement */ i) =>{
