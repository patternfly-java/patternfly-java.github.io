...
class LevelLayout extends SnippetPage {
 ...
 $ctor__org_patternfly_showcase_layout_LevelLayout__void() {
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('level-basic', 'Basic', Code.m_code__java_lang_String__java_lang_String('level-basic'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$stampType(['ws-core-l-level'], j_l_String))), HTMLContainerBuilder))).m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(Level.m_level__org_patternfly_layout_level_Level().m_addItem__org_patternfly_layout_level_LevelItem__org_patternfly_layout_level_Level(/**@type {LevelItem}*/ ($Casts.$to(LevelItem.m_levelItem__org_patternfly_layout_level_LevelItem().m_text__java_lang_String__org_jboss_elemento_TypedBuilder('Level item'), LevelItem))).m_addItem__org_patternfly_layout_level_LevelItem__org_patternfly_layout_level_Level(/**@type {LevelItem}*/ ($Casts.$to(LevelItem.m_levelItem__org_patternfly_layout_level_LevelItem().m_text__java_lang_String__org_jboss_elemento_TypedBuilder('Level item'), LevelItem))).m_addItem__org_patternfly_layout_level_LevelItem__org_patternfly_layout_level_Level(/**@type {LevelItem}*/ ($Casts.$to(LevelItem.m_levelItem__org_patternfly_layout_level_LevelItem().m_text__java_lang_String__org_jboss_elemento_TypedBuilder('Level item'), LevelItem)))), HTMLContainerBuilder))).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  }))));
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('level-gutter', 'With gutters', Code.m_code__java_lang_String__java_lang_String('level-gutter'), Supplier.$adapt(/**  @return {HTMLElement}*/ (() =>{
