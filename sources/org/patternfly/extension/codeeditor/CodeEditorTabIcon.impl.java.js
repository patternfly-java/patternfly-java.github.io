goog.module('org.patternfly.extension.codeeditor.CodeEditorTabIcon$impl');
...
class CodeEditorTabIcon extends CodeEditorSubComponent {
 ...
 static m_codeEditorTabIcon__org_patternfly_extension_codeeditor_CodeEditorTabIcon() {
  CodeEditorTabIcon.$clinit();
  return CodeEditorTabIcon.$create__elemental2_dom_Element(null);
 }
 /** @nodts @return {CodeEditorTabIcon} */
 static m_codeEditorTabIcon__org_patternfly_icon_PredefinedIcon__org_patternfly_extension_codeeditor_CodeEditorTabIcon(/** PredefinedIcon */ icon) {
  CodeEditorTabIcon.$clinit();
  return CodeEditorTabIcon.$create__elemental2_dom_Element(icon.m_element__org_jboss_elemento_svg_SVGElement());
 }
 /** @nodts @return {CodeEditorTabIcon} */
 static m_codeEditorTabIcon__elemental2_dom_Element__org_patternfly_extension_codeeditor_CodeEditorTabIcon(/** Element */ icon) {
  CodeEditorTabIcon.$clinit();
...
/**@const {string} @nodts*/
CodeEditorTabIcon.f_SUB_COMPONENT_ID__org_patternfly_extension_codeeditor_CodeEditorTabIcon = 'ceti';
/**@const {string} @nodts*/
CodeEditorTabIcon.f_SUB_COMPONENT_NAME__org_patternfly_extension_codeeditor_CodeEditorTabIcon = 'CodeEditorTabIcon';
$Util.$setClassMetadata(CodeEditorTabIcon, 'org.patternfly.extension.codeeditor.CodeEditorTabIcon');
