...
class Tuples extends j_l_Object {
 ...
 static m_tuples__arrayOf_org_patternfly_core_Tuple__org_patternfly_core_Tuples(/** Array<Tuple<K_1, V_1>> */ tuples) {
  Tuples.$clinit();
  return /**@type {!Tuples<K_1, V_1>}*/ (Tuples.$create__java_lang_Iterable(/**@type {List<Tuple<K_1, V_1>>}*/ (Arrays.m_asList__arrayOf_java_lang_Object__java_util_List(tuples))));
 }
 /** @nodts @template K_1, V_1 @return {Tuples<K_1, V_1>} */
 ...
 toString() {
  return /**@type {?string}*/ ($Casts.$to((/**@type {Stream<?string>}*/ (this.f_tuples__org_patternfly_core_Tuples_.m_stream__java_util_stream_Stream().m_map__java_util_function_Function__java_util_stream_Stream(j_u_function_Function.$adapt(/**  @return {?string}*/ ((/** Tuple<K, V> */ arg0) =>{
   let arg0_1 = /**@type {Tuple<K, V>}*/ ($Casts.$to(arg0, Tuple));
