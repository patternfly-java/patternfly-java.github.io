...
/**@const {string} @nodts*/
Attributes.f_popover__org_patternfly_core_Attributes = 'popover';
/**@const {string} @nodts*/
Attributes.f_role__org_patternfly_core_Attributes = 'role';
/**@const {string} @nodts*/
Attributes.f_required__org_patternfly_core_Attributes = 'required';
/**@const {string} @nodts*/
Attributes.f_scope__org_patternfly_core_Attributes = 'scope';
/**@const {string} @nodts*/
Attributes.f_type__org_patternfly_core_Attributes = 'type';
Attributes.$markImplementor(/**@type {Function}*/ (Attributes));
$Util.$setClassMetadataForInterface(/**@type {Function}*/ (Attributes), 'org.patternfly.core.Attributes');
