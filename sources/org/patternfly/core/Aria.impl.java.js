...
/**@const {string} @nodts*/
Aria.f_hasPopup__org_patternfly_core_Aria = 'aria-haspopup';
/**@const {string} @nodts*/
...
/**@const {string} @nodts*/
Aria.f_level__org_patternfly_core_Aria = 'aria-level';
/**@const {string} @nodts*/
...
/**@const {string} @nodts*/
Aria.f_posinset__org_patternfly_core_Aria = 'aria-posinset';
/**@const {string} @nodts*/
Aria.f_readonly__org_patternfly_core_Aria = 'aria-readonly';
/**@const {string} @nodts*/
Aria.f_required__org_patternfly_core_Aria = 'aria-required';
/**@const {string} @nodts*/
Aria.f_relevant__org_patternfly_core_Aria = 'aria-relevant';
/**@const {string} @nodts*/
Aria.f_selected__org_patternfly_core_Aria = 'aria-selected';
/**@const {string} @nodts*/
Aria.f_setsize__org_patternfly_core_Aria = 'aria-setsize';
/**@const {string} @nodts*/
...
$Util.$setClassMetadataForInterface(/**@type {Function}*/ (Aria), 'org.patternfly.core.Aria');
