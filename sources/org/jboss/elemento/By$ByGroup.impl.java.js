...
class ByGroup extends By {
 ...
 m_selector__java_lang_String() {
  return /**@type {?string}*/ ($Casts.$to((/**@type {Stream<?string>}*/ ((/**@type {Stream<By>}*/ (Arrays.m_stream__arrayOf_java_lang_Object__java_util_stream_Stream(this.f_selectors__org_jboss_elemento_By_ByGroup_))).m_map__java_util_function_Function__java_util_stream_Stream(j_u_function_Function.$adapt(/**  @return {?string}*/ ((/** By */ arg0) =>{
   let arg0_1 = /**@type {By}*/ ($Casts.$to(arg0, By));
   return arg0_1.m_selector__java_lang_String();
