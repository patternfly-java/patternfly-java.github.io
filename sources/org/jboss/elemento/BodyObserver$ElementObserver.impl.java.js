...
class ElementObserver extends j_l_Object {
 ...
 constructor() {
  ...
  this.f_element__org_jboss_elemento_BodyObserver_ElementObserver_;
  /**@type {ObserverCallback} @nodts*/
  this.f_callback__org_jboss_elemento_BodyObserver_ElementObserver_;
 }
 /** @nodts @return {!ElementObserver} */
 static $create__java_lang_String__elemental2_dom_HTMLElement__org_jboss_elemento_ObserverCallback(/** ?string */ id, /** HTMLElement */ element, /** ObserverCallback */ callback) {
  ElementObserver.$clinit();
  let $instance = new ElementObserver();
  $instance.$ctor__org_jboss_elemento_BodyObserver_ElementObserver__java_lang_String__elemental2_dom_HTMLElement__org_jboss_elemento_ObserverCallback__void(id, element, callback);
  return $instance;
 }
 /** @nodts */
 $ctor__org_jboss_elemento_BodyObserver_ElementObserver__java_lang_String__elemental2_dom_HTMLElement__org_jboss_elemento_ObserverCallback__void(/** ?string */ id, /** HTMLElement */ element, /** ObserverCallback */ callback) {
  this.$ctor__java_lang_Object__void();
  this.f_id__org_jboss_elemento_BodyObserver_ElementObserver_ = id;
  this.f_element__org_jboss_elemento_BodyObserver_ElementObserver_ = element;
