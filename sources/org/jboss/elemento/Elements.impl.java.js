...
let ElementContainerDelegate = goog.forwardDeclare('org.jboss.elemento.ElementContainerDelegate$impl');
...
let HTMLSelectElementBuilder = goog.forwardDeclare('org.jboss.elemento.HTMLSelectElementBuilder$impl');
...
class Elements extends j_l_Object {
 ...
 static m_h__int__java_lang_String__org_jboss_elemento_HTMLContainerBuilder(/** number */ n, /** ?string */ text) {
  Elements.$clinit();
  return /**@type {HTMLContainerBuilder<HTMLHeadingElement>}*/ ($Casts.$to(Elements.m_h__int__org_jboss_elemento_HTMLContainerBuilder(n).m_text__java_lang_String__org_jboss_elemento_TypedBuilder(text), HTMLContainerBuilder));
 }
 /** @nodts @return {HTMLContainerBuilder<HTMLHeadingElement>} */
 ...
 static m_b__java_lang_String__org_jboss_elemento_HTMLContainerBuilder(/** ?string */ text) {
  Elements.$clinit();
  return /**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLElement>}*/ (Elements.m_htmlContainer__java_lang_String__java_lang_Class__org_jboss_elemento_HTMLContainerBuilder('b', Class.$get($JavaScriptObject)))).m_text__java_lang_String__org_jboss_elemento_TypedBuilder(text), HTMLContainerBuilder));
 }
 /** @nodts @return {HTMLContainerBuilder<HTMLElement>} */
 ...
 static m_cite__java_lang_String__org_jboss_elemento_HTMLContainerBuilder(/** ?string */ text) {
  Elements.$clinit();
  return /**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLElement>}*/ (Elements.m_htmlContainer__java_lang_String__java_lang_Class__org_jboss_elemento_HTMLContainerBuilder('cite', Class.$get($JavaScriptObject)))).m_text__java_lang_String__org_jboss_elemento_TypedBuilder(text), HTMLContainerBuilder));
 }
 /** @nodts @return {HTMLContainerBuilder<HTMLElement>} */
 ...
 static m_code__java_lang_String__org_jboss_elemento_HTMLContainerBuilder(/** ?string */ text) {
  Elements.$clinit();
  return /**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLElement>}*/ (Elements.m_htmlContainer__java_lang_String__java_lang_Class__org_jboss_elemento_HTMLContainerBuilder('code', Class.$get($JavaScriptObject)))).m_text__java_lang_String__org_jboss_elemento_TypedBuilder(text), HTMLContainerBuilder));
 }
 /** @nodts @return {HTMLContainerBuilder<HTMLElement>} */
 ...
 static m_dfn__java_lang_String__org_jboss_elemento_HTMLContainerBuilder(/** ?string */ text) {
  Elements.$clinit();
  return /**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLElement>}*/ (Elements.m_htmlContainer__java_lang_String__java_lang_Class__org_jboss_elemento_HTMLContainerBuilder('dfn', Class.$get($JavaScriptObject)))).m_text__java_lang_String__org_jboss_elemento_TypedBuilder(text), HTMLContainerBuilder));
 }
 /** @nodts @return {HTMLContainerBuilder<HTMLElement>} */
 ...
 static m_em__java_lang_String__org_jboss_elemento_HTMLContainerBuilder(/** ?string */ text) {
  Elements.$clinit();
  return /**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLElement>}*/ (Elements.m_htmlContainer__java_lang_String__java_lang_Class__org_jboss_elemento_HTMLContainerBuilder('em', Class.$get($JavaScriptObject)))).m_text__java_lang_String__org_jboss_elemento_TypedBuilder(text), HTMLContainerBuilder));
 }
 /** @nodts @return {HTMLContainerBuilder<HTMLElement>} */
 ...
 static m_i__java_lang_String__org_jboss_elemento_HTMLContainerBuilder(/** ?string */ text) {
  Elements.$clinit();
  return /**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLElement>}*/ (Elements.m_htmlContainer__java_lang_String__java_lang_Class__org_jboss_elemento_HTMLContainerBuilder('i', Class.$get($JavaScriptObject)))).m_text__java_lang_String__org_jboss_elemento_TypedBuilder(text), HTMLContainerBuilder));
 }
 /** @nodts @return {HTMLContainerBuilder<HTMLElement>} */
 ...
 static m_kbd__java_lang_String__org_jboss_elemento_HTMLContainerBuilder(/** ?string */ text) {
  Elements.$clinit();
  return /**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLElement>}*/ (Elements.m_htmlContainer__java_lang_String__java_lang_Class__org_jboss_elemento_HTMLContainerBuilder('kbd', Class.$get($JavaScriptObject)))).m_text__java_lang_String__org_jboss_elemento_TypedBuilder(text), HTMLContainerBuilder));
 }
 /** @nodts @return {HTMLContainerBuilder<HTMLElement>} */
 ...
 static m_mark__java_lang_String__org_jboss_elemento_HTMLContainerBuilder(/** ?string */ text) {
  Elements.$clinit();
  return /**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLElement>}*/ (Elements.m_htmlContainer__java_lang_String__java_lang_Class__org_jboss_elemento_HTMLContainerBuilder('mark', Class.$get($JavaScriptObject)))).m_text__java_lang_String__org_jboss_elemento_TypedBuilder(text), HTMLContainerBuilder));
 }
 /** @nodts @return {HTMLContainerBuilder<HTMLElement>} */
 ...
 static m_small__java_lang_String__org_jboss_elemento_HTMLContainerBuilder(/** ?string */ text) {
  Elements.$clinit();
  return /**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLElement>}*/ (Elements.m_htmlContainer__java_lang_String__java_lang_Class__org_jboss_elemento_HTMLContainerBuilder('small', Class.$get($JavaScriptObject)))).m_text__java_lang_String__org_jboss_elemento_TypedBuilder(text), HTMLContainerBuilder));
 }
 /** @nodts @return {HTMLContainerBuilder<HTMLElement>} */
 ...
 static m_strong__java_lang_String__org_jboss_elemento_HTMLContainerBuilder(/** ?string */ text) {
  Elements.$clinit();
  return /**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLElement>}*/ (Elements.m_htmlContainer__java_lang_String__java_lang_Class__org_jboss_elemento_HTMLContainerBuilder('strong', Class.$get($JavaScriptObject)))).m_text__java_lang_String__org_jboss_elemento_TypedBuilder(text), HTMLContainerBuilder));
 }
 /** @nodts @return {HTMLContainerBuilder<HTMLElement>} */
 ...
 static m_sub__java_lang_String__org_jboss_elemento_HTMLContainerBuilder(/** ?string */ text) {
  Elements.$clinit();
  return /**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLElement>}*/ (Elements.m_htmlContainer__java_lang_String__java_lang_Class__org_jboss_elemento_HTMLContainerBuilder('sub', Class.$get($JavaScriptObject)))).m_text__java_lang_String__org_jboss_elemento_TypedBuilder(text), HTMLContainerBuilder));
 }
 /** @nodts @return {HTMLContainerBuilder<HTMLElement>} */
 ...
 static m_sup__java_lang_String__org_jboss_elemento_HTMLContainerBuilder(/** ?string */ text) {
  Elements.$clinit();
  return /**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLElement>}*/ (Elements.m_htmlContainer__java_lang_String__java_lang_Class__org_jboss_elemento_HTMLContainerBuilder('sup', Class.$get($JavaScriptObject)))).m_text__java_lang_String__org_jboss_elemento_TypedBuilder(text), HTMLContainerBuilder));
 }
 /** @nodts @return {HTMLContainerBuilder<HTMLElement>} */
 ...
 static m_time__java_lang_String__org_jboss_elemento_HTMLContainerBuilder(/** ?string */ text) {
  Elements.$clinit();
  return /**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLElement>}*/ (Elements.m_htmlContainer__java_lang_String__java_lang_Class__org_jboss_elemento_HTMLContainerBuilder('time', Class.$get($JavaScriptObject)))).m_text__java_lang_String__org_jboss_elemento_TypedBuilder(text), HTMLContainerBuilder));
 }
 /** @nodts @return {HTMLContainerBuilder<HTMLElement>} */
 ...
 static m_u__java_lang_String__org_jboss_elemento_HTMLContainerBuilder(/** ?string */ text) {
  Elements.$clinit();
  return /**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLElement>}*/ (Elements.m_htmlContainer__java_lang_String__java_lang_Class__org_jboss_elemento_HTMLContainerBuilder('u', Class.$get($JavaScriptObject)))).m_text__java_lang_String__org_jboss_elemento_TypedBuilder(text), HTMLContainerBuilder));
 }
 /** @nodts @return {HTMLContainerBuilder<HTMLElement>} */
 ...
 static m_var__java_lang_String__org_jboss_elemento_HTMLContainerBuilder(/** ?string */ text) {
  Elements.$clinit();
  return /**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLElement>}*/ (Elements.m_htmlContainer__java_lang_String__java_lang_Class__org_jboss_elemento_HTMLContainerBuilder('var', Class.$get($JavaScriptObject)))).m_text__java_lang_String__org_jboss_elemento_TypedBuilder(text), HTMLContainerBuilder));
 }
 /** @nodts @return {HTMLContainerBuilder<HTMLElement>} */
 ...
 static m_ins__java_lang_String__org_jboss_elemento_HTMLContainerBuilder(/** ?string */ text) {
  Elements.$clinit();
  return /**@type {HTMLContainerBuilder<HTMLModElement>}*/ ($Casts.$to((/**@type {HTMLContainerBuilder<HTMLModElement>}*/ (Elements.m_htmlContainer__java_lang_String__java_lang_Class__org_jboss_elemento_HTMLContainerBuilder('ins', Class.$get($JavaScriptObject)))).m_text__java_lang_String__org_jboss_elemento_TypedBuilder(text), HTMLContainerBuilder));
 }
 /** @nodts @return {HTMLContainerBuilder<HTMLModElement>} */
 ...
 /** @nodts @return {HTMLContainerBuilder<HTMLButtonElement>} */
 static m_button__org_jboss_elemento_ButtonType__org_jboss_elemento_HTMLContainerBuilder(/** ButtonType */ type) {
  Elements.$clinit();
  let button = /**@type {HTMLButtonElement}*/ ($Casts.$to(Elements.m_createHtmlElement__java_lang_String__java_lang_Class__elemental2_dom_HTMLElement('button', Class.$get($JavaScriptObject)), HTMLButtonElement_$Overlay));
  button.type = type.name();
  return /**@type {!HTMLContainerBuilder<HTMLButtonElement>}*/ (HTMLContainerBuilder.$create__elemental2_dom_HTMLElement(button));
 }
 /** @nodts @return {HTMLContainerBuilder<HTMLButtonElement>} */
 static m_button__java_lang_String__org_jboss_elemento_HTMLContainerBuilder(/** ?string */ text) {
  Elements.$clinit();
  return /**@type {HTMLContainerBuilder<HTMLButtonElement>}*/ ($Casts.$to(Elements.m_button__org_jboss_elemento_HTMLContainerBuilder().m_text__java_lang_String__org_jboss_elemento_TypedBuilder(text), HTMLContainerBuilder));
 }
 /** @nodts @return {HTMLContainerBuilder<HTMLButtonElement>} */
 ...
 static m_input__org_jboss_elemento_InputType__org_jboss_elemento_HTMLInputElementBuilder(/** InputType */ type) {
  Elements.$clinit();
  return Elements.m_input__java_lang_String__org_jboss_elemento_HTMLInputElementBuilder(type.name());
 }
 /** @nodts @return {HTMLInputElementBuilder<HTMLInputElement>} */
 static m_input__java_lang_String__org_jboss_elemento_HTMLInputElementBuilder(/** ?string */ type) {
  Elements.$clinit();
  return /**@type {HTMLInputElementBuilder<HTMLInputElement>}*/ (Elements.m_input__java_lang_String__java_lang_Class__org_jboss_elemento_HTMLInputElementBuilder(type, Class.$get($JavaScriptObject)));
 }
 /** @nodts @template E @return {HTMLInputElementBuilder<E>} */
 static m_input__java_lang_String__java_lang_Class__org_jboss_elemento_HTMLInputElementBuilder(/** ?string */ type, /** Class<E> */ jType) {
  Elements.$clinit();
  ...
  return /**@type {!HTMLInputElementBuilder<E>}*/ (HTMLInputElementBuilder.$create__elemental2_dom_HTMLInputElement(input));
 }
 /** @nodts @return {HTMLInputElementBuilder<HTMLInputElement>} */
 static m_input__elemental2_dom_Element__org_jboss_elemento_HTMLInputElementBuilder(/** Element */ element) {
  Elements.$clinit();
  return /**@type {HTMLInputElementBuilder<HTMLInputElement>}*/ (Elements.m_wrapInputElement__elemental2_dom_HTMLInputElement__org_jboss_elemento_HTMLInputElementBuilder(/**@type {HTMLInputElement}*/ ($Casts.$to(Js.m_cast__java_lang_Object__java_lang_Object(element), HTMLInputElement_$Overlay))));
 }
 ...
 static m_label__java_lang_String__org_jboss_elemento_HTMLContainerBuilder(/** ?string */ text) {
  Elements.$clinit();
  return /**@type {HTMLContainerBuilder<HTMLLabelElement>}*/ ($Casts.$to(Elements.m_label__org_jboss_elemento_HTMLContainerBuilder().m_text__java_lang_String__org_jboss_elemento_TypedBuilder(text), HTMLContainerBuilder));
 }
 /** @nodts @return {HTMLContainerBuilder<HTMLLabelElement>} */
 ...
 static m_option__java_lang_String__org_jboss_elemento_HTMLElementBuilder(/** ?string */ text) {
  Elements.$clinit();
  return /**@type {HTMLElementBuilder<HTMLOptionElement>}*/ ($Casts.$to(Elements.m_option__org_jboss_elemento_HTMLElementBuilder().m_text__java_lang_String__org_jboss_elemento_TypedBuilder(text), HTMLElementBuilder));
 }
 /** @nodts @return {HTMLElementBuilder<HTMLOptionElement>} */
 ...
 /** @nodts @return {HTMLSelectElementBuilder<HTMLSelectElement>} */
 static m_select__org_jboss_elemento_HTMLSelectElementBuilder() {
  Elements.$clinit();
  let el = /**@type {HTMLSelectElement}*/ ($Casts.$to(Elements.m_createHtmlElement__java_lang_String__java_lang_Class__elemental2_dom_HTMLElement('select', Class.$get($JavaScriptObject)), HTMLSelectElement_$Overlay));
  return /**@type {!HTMLSelectElementBuilder<HTMLSelectElement>}*/ (HTMLSelectElementBuilder.$create__elemental2_dom_HTMLSelectElement(el));
 }
 /** @nodts @return {HTMLSelectElementBuilder<HTMLSelectElement>} */
 static m_select__elemental2_dom_Element__org_jboss_elemento_HTMLSelectElementBuilder(/** Element */ element) {
  Elements.$clinit();
  return /**@type {HTMLSelectElementBuilder<HTMLSelectElement>}*/ (Elements.m_wrapSelectElement__elemental2_dom_HTMLSelectElement__org_jboss_elemento_HTMLSelectElementBuilder(/**@type {HTMLSelectElement}*/ ($Casts.$to(Js.m_cast__java_lang_Object__java_lang_Object(element), HTMLSelectElement_$Overlay))));
 }
 /** @nodts @return {HTMLTextAreaElementBuilder<HTMLTextAreaElement>} */
 static m_textarea__org_jboss_elemento_HTMLTextAreaElementBuilder() {
  Elements.$clinit();
  let el = /**@type {HTMLTextAreaElement}*/ ($Casts.$to(Elements.m_createHtmlElement__java_lang_String__java_lang_Class__elemental2_dom_HTMLElement('textarea', Class.$get($JavaScriptObject)), HTMLTextAreaElement_$Overlay));
  return /**@type {!HTMLTextAreaElementBuilder<HTMLTextAreaElement>}*/ (HTMLTextAreaElementBuilder.$create__elemental2_dom_HTMLTextAreaElement(el));
 }
 /** @nodts @return {HTMLTextAreaElementBuilder<HTMLTextAreaElement>} */
 static m_textarea__elemental2_dom_Element__org_jboss_elemento_HTMLTextAreaElementBuilder(/** Element */ element) {
  Elements.$clinit();
  return /**@type {HTMLTextAreaElementBuilder<HTMLTextAreaElement>}*/ (Elements.m_wrapTextAreaElement__elemental2_dom_HTMLTextAreaElement__org_jboss_elemento_HTMLTextAreaElementBuilder(/**@type {HTMLTextAreaElement}*/ ($Casts.$to(Js.m_cast__java_lang_Object__java_lang_Object(element), HTMLTextAreaElement_$Overlay))));
 }
 ...
 /** @nodts @template E @return {HTMLInputElementBuilder<E>} */
 static m_wrapInputElement__elemental2_dom_HTMLInputElement__org_jboss_elemento_HTMLInputElementBuilder(/** E */ element) {
  Elements.$clinit();
  return /**@type {!HTMLInputElementBuilder<E>}*/ (HTMLInputElementBuilder.$create__elemental2_dom_HTMLInputElement(element));
 }
 /** @nodts @template E @return {HTMLSelectElementBuilder<E>} */
 static m_wrapSelectElement__elemental2_dom_HTMLSelectElement__org_jboss_elemento_HTMLSelectElementBuilder(/** E */ element) {
  Elements.$clinit();
  return /**@type {!HTMLSelectElementBuilder<E>}*/ (HTMLSelectElementBuilder.$create__elemental2_dom_HTMLSelectElement(element));
 }
 /** @nodts @template E @return {HTMLTextAreaElementBuilder<E>} */
 static m_wrapTextAreaElement__elemental2_dom_HTMLTextAreaElement__org_jboss_elemento_HTMLTextAreaElementBuilder(/** E */ element) {
  Elements.$clinit();
  return /**@type {!HTMLTextAreaElementBuilder<E>}*/ (HTMLTextAreaElementBuilder.$create__elemental2_dom_HTMLTextAreaElement(element));
 }
 /** @nodts @return {Iterable<HTMLElement>} */
 static m_querySelectorAll__elemental2_dom_Node__org_jboss_elemento_By__java_lang_Iterable(/** Node */ node, /** By */ selector) {
  Elements.$clinit();
  if (!$Equality.$same(node, null)) {
   let nodes = node.querySelectorAll(selector.m_selector__java_lang_String());
   ...
   return Iterable.$adapt(/**  @return {Iterator<HTMLElement>}*/ (() =>{
 ...
 static m_querySelectorAll__org_jboss_elemento_IsElement__org_jboss_elemento_By__java_lang_Iterable(/** IsElement<E> */ element, /** By */ selector) {
  Elements.$clinit();
  if (!$Equality.$same(element, null)) {
   return Elements.m_querySelectorAll__elemental2_dom_Node__org_jboss_elemento_By__java_lang_Iterable(/**@type {Node}*/ (element.m_element__elemental2_dom_Element()), selector);
  }
  return /**@type {List<HTMLElement>}*/ (Collections.m_emptyList__java_util_List());
 }
 /** @nodts @template E @return {E} */
 static m_querySelector__elemental2_dom_Node__org_jboss_elemento_By__elemental2_dom_HTMLElement(/** Node */ node, /** By */ selector) {
  Elements.$clinit();
  if (!$Equality.$same(node, null)) {
   return /**@type {E}*/ ($Casts.$to(Js.m_cast__java_lang_Object__java_lang_Object(node.querySelector(selector.m_selector__java_lang_String())), HTMLElement_$Overlay));
  }
  return null;
 }
 /** @nodts @template E, F @return {F} */
 static m_querySelector__org_jboss_elemento_IsElement__org_jboss_elemento_By__elemental2_dom_HTMLElement(/** IsElement<E> */ element, /** By */ selector) {
  Elements.$clinit();
  if (!$Equality.$same(element, null)) {
   return Elements.m_querySelector__elemental2_dom_Node__org_jboss_elemento_By__elemental2_dom_HTMLElement(/**@type {Node}*/ (element.m_element__elemental2_dom_Element()), selector);
  }
  return null;
 }
 /** @nodts @template E @return {E} */
 static m_closest__elemental2_dom_Element__org_jboss_elemento_By__elemental2_dom_HTMLElement(/** Element */ element, /** By */ selector) {
  Elements.$clinit();
  if (!$Equality.$same(element, null)) {
   return /**@type {E}*/ ($Casts.$to(Js.m_cast__java_lang_Object__java_lang_Object(element.closest(selector.m_selector__java_lang_String())), HTMLElement_$Overlay));
  }
  return null;
 }
 /** @nodts @template E, F @return {F} */
 static m_closest__org_jboss_elemento_IsElement__org_jboss_elemento_By__elemental2_dom_HTMLElement(/** IsElement<E> */ element, /** By */ selector) {
  Elements.$clinit();
  if (!$Equality.$same(element, null)) {
   return /**@type {F}*/ ($Casts.$to(Js.m_cast__java_lang_Object__java_lang_Object((/**@type {!Element}*/ (element.m_element__elemental2_dom_Element())).closest(selector.m_selector__java_lang_String())), HTMLElement_$Overlay));
  }
  return null;
 }
 ...
 static m_elements__jsinterop_base_JsArrayLike__java_lang_Iterable(/** IArrayLike<E> */ nodes) {
  Elements.$clinit();
  return Iterable.$adapt(/**  @return {Iterator<E>}*/ (() =>{
 ...
 static m_children__elemental2_dom_Node__java_lang_Iterable(/** Node */ parent) {
  Elements.$clinit();
  return Iterable.$adapt(/**  @return {Iterator<Node>}*/ (() =>{
 ...
 static m_lazyAppend__elemental2_dom_Element__org_jboss_elemento_IsElement__void(/** Element */ parent, /** IsElement<E> */ child) {
  Elements.$clinit();
  if (!$Equality.$same(parent, null) && !$Equality.$same(child, null)) {
 ...
 static m_insertAfter__elemental2_dom_Element__elemental2_dom_Element__void(/** Element */ newElement, /** Element */ after) {
  Elements.$clinit();
  if (!$Equality.$same(newElement, null) && !$Equality.$same(after, null)) {
 ...
 static m_lazyInsertAfter__elemental2_dom_Element__elemental2_dom_Element__void(/** Element */ newElement, /** Element */ after) {
  Elements.$clinit();
  if (!$Equality.$same(newElement, null) && !$Equality.$same(after, null) && !after.parentNode.contains(newElement)) {
   after.parentNode.insertBefore(newElement, after.nextSibling);
  }
 }
 /** @nodts @template E */
 ...
 static m_lazyInsertAfter__elemental2_dom_Element__elemental2_dom_Element__elemental2_dom_Element__void(/** Element */ parent, /** Element */ newElement, /** Element */ after) {
  Elements.$clinit();
  if (!$Equality.$same(parent, null) && !$Equality.$same(newElement, null) && !$Equality.$same(after, null) && !parent.contains(newElement)) {
 ...
 static m_lazyInsertAfter__elemental2_dom_Element__org_jboss_elemento_IsElement__elemental2_dom_Element__void(/** Element */ parent, /** IsElement<E> */ newElement, /** Element */ after) {
  Elements.$clinit();
  if (!$Equality.$same(parent, null) && !$Equality.$same(newElement, null) && !$Equality.$same(after, null)) {
 ...
 static m_insertBefore__elemental2_dom_Element__elemental2_dom_Element__void(/** Element */ newElement, /** Element */ before) {
  Elements.$clinit();
  if (!$Equality.$same(newElement, null) && !$Equality.$same(before, null)) {
 ...
 static m_lazyInsertBefore__elemental2_dom_Element__elemental2_dom_Element__void(/** Element */ newElement, /** Element */ before) {
  Elements.$clinit();
  if (!$Equality.$same(newElement, null) && !$Equality.$same(before, null) && !before.parentNode.contains(newElement)) {
   before.parentNode.insertBefore(newElement, before);
  }
 }
 /** @nodts @template E */
 ...
 static m_lazyInsertBefore__elemental2_dom_Element__elemental2_dom_Element__elemental2_dom_Element__void(/** Element */ parent, /** Element */ newElement, /** Element */ before) {
  Elements.$clinit();
  if (!$Equality.$same(parent, null) && !$Equality.$same(newElement, null) && !$Equality.$same(before, null) && !parent.contains(newElement)) {
 ...
 static m_lazyInsertBefore__elemental2_dom_Element__org_jboss_elemento_IsElement__elemental2_dom_Element__void(/** Element */ parent, /** IsElement<E> */ newElement, /** Element */ before) {
  Elements.$clinit();
  if (!$Equality.$same(parent, null) && !$Equality.$same(newElement, null) && !$Equality.$same(before, null)) {
 ...
 static m_insertFirst__elemental2_dom_Element__elemental2_dom_Element__void(/** Element */ parent, /** Element */ newElement) {
  Elements.$clinit();
  if (!$Equality.$same(parent, null) && !$Equality.$same(newElement, null)) {
 ...
 static m_removeChildrenFrom__org_jboss_elemento_IsElement__void(/** IsElement<E> */ element) {
  Elements.$clinit();
  if (!$Equality.$same(element, null)) {
   let /** ElementContainerDelegate<?, ?> */ ecd;
   if (ElementContainerDelegate.$isInstance(element) && (ecd = (/**@type {!ElementContainerDelegate<Element, TypedBuilder>}*/ ($Casts.$to(element, /**@type {Function}*/ (ElementContainerDelegate)))), true)) {
    Elements.m_removeChildrenFrom__elemental2_dom_Element__void(ecd.m_containerDelegate__elemental2_dom_Element());
   } else {
 ...
 static m_isVisible__elemental2_dom_HTMLElement__boolean(/** HTMLElement */ element) {
  Elements.$clinit();
  return !$Equality.$same(element, null) && (!j_l_String.m_equals__java_lang_String__java_lang_Object__boolean('none', element.style.display) || !j_l_String.m_equals__java_lang_String__java_lang_Object__boolean('none', DomGlobal_$Overlay.f_window__org_jboss_elemento_DomGlobal_$Overlay.getComputedStyle(element).display));
 }
 /** @nodts @template E @return {boolean} */
 ...
 /** @nodts @template E @return {boolean} */
 static m_isElementInView__org_jboss_elemento_IsElement__boolean(/** IsElement<E> */ element) {
  Elements.$clinit();
  return Elements.m_isElementInView__elemental2_dom_HTMLElement__boolean(/**@type {HTMLElement}*/ ($Casts.$to(element.m_element__elemental2_dom_Element(), HTMLElement_$Overlay)));
 }
 /** @nodts @return {boolean} */
 static m_isElementInView__elemental2_dom_HTMLElement__boolean(/** HTMLElement */ element) {
  Elements.$clinit();
  let elementStyle = DomGlobal_$Overlay.f_window__org_jboss_elemento_DomGlobal_$Overlay.getComputedStyle(element);
  if (j_l_String.m_startsWith__java_lang_String__java_lang_String__boolean(HeightUnionType_$Overlay.m_asString__$devirt__elemental2_dom_CSSProperties_HeightUnionType__java_lang_String(elementStyle.height), '0') || j_l_String.m_equals__java_lang_String__java_lang_Object__boolean(elementStyle.display, 'none') || j_l_String.m_equals__java_lang_String__java_lang_Object__boolean(OpacityUnionType_$Overlay.m_asString__$devirt__elemental2_dom_CSSProperties_OpacityUnionType__java_lang_String(elementStyle.opacity), '0') || j_l_String.m_equals__java_lang_String__java_lang_Object__boolean(elementStyle.visibility, 'hidden') || j_l_String.m_equals__java_lang_String__java_lang_Object__boolean(elementStyle.clipPath, 'circle(0px at 50% 50%)') || j_l_String.m_equals__java_lang_String__java_lang_Object__boolean(elementStyle.transform, 'scale(0)') || element.hasAttribute('hidden')) {
   return false;
  }
  let rect = element.getBoundingClientRect();
  let elementLeft = Primitives.m_narrowDoubleToInt__int__int(Math.ceil(rect.left));
  let elementRight = Primitives.m_narrowDoubleToInt__int__int(Math.ceil(rect.right));
  let elementTop = Primitives.m_narrowDoubleToInt__int__int(Math.ceil(rect.top));
  let elementBottom = Primitives.m_narrowDoubleToInt__int__int(Math.ceil(rect.bottom));
  return elementTop >= 0 && elementLeft >= 0 && elementBottom <= goog.global.window.innerHeight && elementRight <= goog.global.window.innerWidth;
 }
 /** @nodts @template E @return {boolean} */
 ...
 static m_isElementInView__elemental2_dom_HTMLElement__elemental2_dom_HTMLElement__boolean__boolean(/** HTMLElement */ container, /** HTMLElement */ element, /** boolean */ partial) {
  ...
  if (!$Equality.$same(container, null) && !$Equality.$same(element, null)) {
   ...
   let containerBoundsLeft = Primitives.m_narrowDoubleToInt__int__int(Math.ceil(containerBounds.left));
   let containerBoundsRight = Primitives.m_narrowDoubleToInt__int__int(Math.floor(containerBounds.right));
   let elementBoundsLeft = Primitives.m_narrowDoubleToInt__int__int(Math.ceil(elementBounds.left));
   let elementBoundsRight = Primitives.m_narrowDoubleToInt__int__int(Math.floor(elementBounds.right));
 ...
 /** @nodts */
 static m_innerHtml__elemental2_dom_Element__org_gwtproject_safehtml_shared_SafeHtml__void(/** Element */ element, /** SafeHtml */ html) {
  Elements.$clinit();
  if (!$Equality.$same(element, null)) {
 ...
 static m_innerHtml__org_jboss_elemento_IsElement__org_gwtproject_safehtml_shared_SafeHtml__void(/** IsElement<E> */ element, /** SafeHtml */ html) {
  Elements.$clinit();
  if (!$Equality.$same(element, null)) {
   Elements.m_innerHtml__elemental2_dom_Element__org_gwtproject_safehtml_shared_SafeHtml__void(/**@type {Element}*/ (element.m_element__elemental2_dom_Element()), html);
  }
 }
 /** @nodts @return {?string} */
 static m_textNode__elemental2_dom_Element__java_lang_String(/** Element */ element) {
  Elements.$clinit();
  let textNode = Elements.m_firstTextNode__elemental2_dom_Element__elemental2_dom_Node(element);
  if (!$Equality.$same(textNode, null)) {
 ...
 static m_textNode__org_jboss_elemento_IsElement__java_lang_String(/** IsElement<E> */ element) {
  Elements.$clinit();
  if (!$Equality.$same(element, null)) {
   return Elements.m_textNode__elemental2_dom_Element__java_lang_String(/**@type {Element}*/ (element.m_element__elemental2_dom_Element()));
  }
  return null;
 }
 /** @nodts */
 static m_textNode__elemental2_dom_Element__java_lang_String__void(/** Element */ element, /** ?string */ text) {
  Elements.$clinit();
  let textNode = Elements.m_firstTextNode__elemental2_dom_Element__elemental2_dom_Node(element);
  if (!$Equality.$same(textNode, null)) {
   textNode.nodeValue = $Equality.$same(text, null) ? '' : text;
  } else {
   element.appendChild(Document_$Overlay.m_createTextNode__$devirt__elemental2_dom_Document__java_lang_String__elemental2_dom_Text(element.ownerDocument, text));
  }
 }
 /** @nodts @template E */
 static m_textNode__org_jboss_elemento_IsElement__java_lang_String__void(/** IsElement<E> */ element, /** ?string */ text) {
  Elements.$clinit();
  if (!$Equality.$same(element, null)) {
   Elements.m_textNode__elemental2_dom_Element__java_lang_String__void(/**@type {Element}*/ (element.m_element__elemental2_dom_Element()), text);
  }
 }
 /** @nodts @return {Node} */
 static m_firstTextNode__elemental2_dom_Element__elemental2_dom_Node(/** Element */ element) {
 ...
 static $loadModules() {
  ...
  ElementContainerDelegate = goog.module.get('org.jboss.elemento.ElementContainerDelegate$impl');
  ...
  HTMLSelectElementBuilder = goog.module.get('org.jboss.elemento.HTMLSelectElementBuilder$impl');
