...
class AttributeOperator extends Enum {
 ...
 static m_valueOf__java_lang_String__org_jboss_elemento_By_AttributeOperator(/** string */ name) {
  ...
  if ($Equality.$same(AttributeOperator.f_namesToValuesMap__org_jboss_elemento_By_AttributeOperator_, null)) {
   AttributeOperator.f_namesToValuesMap__org_jboss_elemento_By_AttributeOperator_ = (/**@type {Map<?string, !AttributeOperator>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(AttributeOperator.m_values__arrayOf_org_jboss_elemento_By_AttributeOperator())));
  }
  return /**@type {AttributeOperator}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, AttributeOperator.f_namesToValuesMap__org_jboss_elemento_By_AttributeOperator_));
 }
 /** @nodts @return {!Array<!AttributeOperator>} */
 static m_values__arrayOf_org_jboss_elemento_By_AttributeOperator() {
  AttributeOperator.$clinit();
  return /**@type {!Array<!AttributeOperator>}*/ ($Arrays.$stampType([AttributeOperator.f_STARTS_WITH__org_jboss_elemento_By_AttributeOperator, AttributeOperator.f_ENDS_WITH__org_jboss_elemento_By_AttributeOperator, AttributeOperator.f_CONTAINS__org_jboss_elemento_By_AttributeOperator, AttributeOperator.f_CONTAINS_WORD__org_jboss_elemento_By_AttributeOperator, AttributeOperator.f_CONTAINS_TOKEN__org_jboss_elemento_By_AttributeOperator], AttributeOperator));
 }
 /** @nodts */
 static $clinit() {
  AttributeOperator.$clinit = () =>{};
