...
class By extends j_l_Object {
 ...
 static m_classname__java_lang_String__org_jboss_elemento_By(/** ?string */ classname) {
  By.$clinit();
  return ByClassname.$create__arrayOf_java_lang_String(/**@type {!Array<?string>}*/ ($Arrays.$stampType([classname], j_l_String)));
 }
 /** @nodts @return {By} */
 ...
 hashCode() {
  return Objects.m_hashCode__java_lang_Object__int(this.m_selector__java_lang_String());
 }
 ...
 equals(/** * */ o) {
  ...
  return j_l_String.m_equals__java_lang_String__java_lang_Object__boolean(this.m_selector__java_lang_String(), by.m_selector__java_lang_String());
 }
 /** @override @return {?string} */
 toString() {
  return this.m_selector__java_lang_String();
 }
 /** @nodts */
 static $clinit() {
  By.$clinit = () =>{};
