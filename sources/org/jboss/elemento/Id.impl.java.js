...
class Id extends j_l_Object {
 ...
 static m_uuid__java_lang_String() {
  ...
  if ($Overlay.f_isSecureContext__elemental2_dom_DomGlobal_$Overlay) {
   ...
   let msb = j_l_Math.m_abs__long__long(Primitives.m_narrowDoubleToLong__int__long(Math.random() * Primitives.m_widenLongToDouble__long__double(Long.f_MAX_VALUE__java_lang_Long)));
   let lsb = j_l_Math.m_abs__long__long(Primitives.m_narrowDoubleToLong__int__long(Math.random() * Primitives.m_widenLongToDouble__long__double(Long.f_MAX_VALUE__java_lang_Long)));
 ...
 static m_build__java_lang_String__char__arrayOf_java_lang_String__java_lang_String(/** ?string */ id, /** number */ separator, /** Array<?string> */ additionalIds) {
  ...
  if ($Equality.$same(id, null) || j_l_String.m_length__java_lang_String__int(j_l_String.m_trim__java_lang_String__java_lang_String(id)) == 0) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(IllegalArgumentException.$create__java_lang_String('ID must not be null or empty.'));
  }
  ...
  return /**@type {?string}*/ ($Casts.$to((/**@type {Stream<?string>}*/ (ids.m_stream__java_util_stream_Stream().m_map__java_util_function_Function__java_util_stream_Stream(j_u_function_Function.$adapt(/**  @return {?string}*/ ((/** ?string */ arg0) =>{
   let arg0_1 = /**@type {?string}*/ ($Casts.$to(arg0, j_l_String));
   return Id.m_asId__java_lang_String__java_lang_String(arg0_1);
  }))))).m_filter__java_util_function_Predicate__java_util_stream_Stream(Predicate.$adapt(/**  @return {boolean}*/ ((/** ?string */ arg0_2) =>{
 ...
 static m_asId__java_lang_String__java_lang_String(/** ?string */ text) {
  ...
  if (sanitized.isEmpty()) {
   ...
   return /**@type {?string}*/ ($Casts.$to((/**@type {Stream<?string>}*/ (sanitized.m_stream__java_util_stream_Stream().m_filter__java_util_function_Predicate__java_util_stream_Stream(Predicate.$adapt(/**  @return {boolean}*/ ((/** ?string */ s_1) =>{
   ...
   }))).m_map__java_util_function_Function__java_util_stream_Stream(j_u_function_Function.$adapt(/**  @return {?string}*/ ((/** ?string */ arg0) =>{
    let arg0_1 = /**@type {?string}*/ ($Casts.$to(arg0, j_l_String));
