...
let AttachableElement = goog.forwardDeclare('org.jboss.elemento.AttachableElement$impl');
...
class Attachable {
 ...
 /** @nodts @template E */
 static m_register__org_jboss_elemento_AttachableElement__void(/** AttachableElement<E> */ attachableElement) {
  Attachable.$clinit();
  if (!$Equality.$same(attachableElement, null)) {
   Attachable.m_register__elemental2_dom_HTMLElement__org_jboss_elemento_Attachable__void(/**@type {HTMLElement}*/ ($Casts.$to(attachableElement.m_element__elemental2_dom_Element(), HTMLElement_$Overlay)), attachableElement);
  }
 }
 /** @nodts */
...
$Util.$setClassMetadataForInterface(/**@type {Function}*/ (Attachable), 'org.jboss.elemento.Attachable');
