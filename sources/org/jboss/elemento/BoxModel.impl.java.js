...
class BoxModel extends Enum {
 ...
 static m_valueOf__java_lang_String__org_jboss_elemento_BoxModel(/** string */ name) {
  ...
  if ($Equality.$same(BoxModel.f_namesToValuesMap__org_jboss_elemento_BoxModel_, null)) {
   BoxModel.f_namesToValuesMap__org_jboss_elemento_BoxModel_ = (/**@type {Map<?string, !BoxModel>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(BoxModel.m_values__arrayOf_org_jboss_elemento_BoxModel())));
  }
  return /**@type {BoxModel}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, BoxModel.f_namesToValuesMap__org_jboss_elemento_BoxModel_));
 }
 /** @nodts @return {!Array<!BoxModel>} */
 static m_values__arrayOf_org_jboss_elemento_BoxModel() {
  BoxModel.$clinit();
  return /**@type {!Array<!BoxModel>}*/ ($Arrays.$stampType([BoxModel.f_contentBox__org_jboss_elemento_BoxModel, BoxModel.f_borderBox__org_jboss_elemento_BoxModel, BoxModel.f_devicePixelContentBox__org_jboss_elemento_BoxModel], BoxModel));
 }
 /** @nodts */
 static $clinit() {
  BoxModel.$clinit = () =>{};
