...
class JsArrayElementIterator extends j_l_Object {
 ...
 /** @override @return {IIterableResult<HTMLElement>} */
 next() {
  return /**@type {IIterableResult<HTMLElement>}*/ (Iterator.m__private_jsNext____$default__java_util_Iterator__javaemul_internal_JsIterableHelper_IIterableResult(this));
 }
 //Bridge method.
