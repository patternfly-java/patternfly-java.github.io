...
class Key extends Enum {
 ...
 static $clinit() {
  ...
  Key.$static_ArrowDown__org_jboss_elemento_Key = Key.$create__java_lang_String__int__java_lang_String__arrayOf_java_lang_String($Util.$makeEnumName('ArrowDown'), Key.$ordinal_ArrowDown__org_jboss_elemento_Key, 'ArrowDown', /**@type {!Array<?string>}*/ ($Arrays.$stampType(['Down'], j_l_String)));
  Key.$static_ArrowLeft__org_jboss_elemento_Key = Key.$create__java_lang_String__int__java_lang_String__arrayOf_java_lang_String($Util.$makeEnumName('ArrowLeft'), Key.$ordinal_ArrowLeft__org_jboss_elemento_Key, 'ArrowLeft', /**@type {!Array<?string>}*/ ($Arrays.$stampType(['Left'], j_l_String)));
  Key.$static_ArrowRight__org_jboss_elemento_Key = Key.$create__java_lang_String__int__java_lang_String__arrayOf_java_lang_String($Util.$makeEnumName('ArrowRight'), Key.$ordinal_ArrowRight__org_jboss_elemento_Key, 'ArrowRight', /**@type {!Array<?string>}*/ ($Arrays.$stampType(['Right'], j_l_String)));
  Key.$static_ArrowUp__org_jboss_elemento_Key = Key.$create__java_lang_String__int__java_lang_String__arrayOf_java_lang_String($Util.$makeEnumName('ArrowUp'), Key.$ordinal_ArrowUp__org_jboss_elemento_Key, 'ArrowUp', /**@type {!Array<?string>}*/ ($Arrays.$stampType(['Up'], j_l_String)));
  ...
  Key.$static_ContextMenu__org_jboss_elemento_Key = Key.$create__java_lang_String__int__java_lang_String__arrayOf_java_lang_String($Util.$makeEnumName('ContextMenu'), Key.$ordinal_ContextMenu__org_jboss_elemento_Key, 'ContextMenu', /**@type {!Array<?string>}*/ ($Arrays.$stampType(['Apps'], j_l_String)));
  ...
  Key.$static_CrSel__org_jboss_elemento_Key = Key.$create__java_lang_String__int__java_lang_String__arrayOf_java_lang_String($Util.$makeEnumName('CrSel'), Key.$ordinal_CrSel__org_jboss_elemento_Key, 'CrSel', /**@type {!Array<?string>}*/ ($Arrays.$stampType(['Crsel'], j_l_String)));
  ...
  Key.$static_Delete__org_jboss_elemento_Key = Key.$create__java_lang_String__int__java_lang_String__arrayOf_java_lang_String($Util.$makeEnumName('Delete'), Key.$ordinal_Delete__org_jboss_elemento_Key, 'Delete', /**@type {!Array<?string>}*/ ($Arrays.$stampType(['Del'], j_l_String)));
  ...
  Key.$static_Escape__org_jboss_elemento_Key = Key.$create__java_lang_String__int__java_lang_String__arrayOf_java_lang_String($Util.$makeEnumName('Escape'), Key.$ordinal_Escape__org_jboss_elemento_Key, 'Escape', /**@type {!Array<?string>}*/ ($Arrays.$stampType(['Esc'], j_l_String)));
  ...
  Key.$static_ExSel__org_jboss_elemento_Key = Key.$create__java_lang_String__int__java_lang_String__arrayOf_java_lang_String($Util.$makeEnumName('ExSel'), Key.$ordinal_ExSel__org_jboss_elemento_Key, 'ExSel', /**@type {!Array<?string>}*/ ($Arrays.$stampType(['Exsel'], j_l_String)));
  ...
  Key.$static_ScrollLock__org_jboss_elemento_Key = Key.$create__java_lang_String__int__java_lang_String__arrayOf_java_lang_String($Util.$makeEnumName('ScrollLock'), Key.$ordinal_ScrollLock__org_jboss_elemento_Key, 'ScrollLock', /**@type {!Array<?string>}*/ ($Arrays.$stampType(['Scroll'], j_l_String)));
  ...
  Key.$static_Spacebar__org_jboss_elemento_Key = Key.$create__java_lang_String__int__java_lang_String__arrayOf_java_lang_String($Util.$makeEnumName('Spacebar'), Key.$ordinal_Spacebar__org_jboss_elemento_Key, ' ', /**@type {!Array<?string>}*/ ($Arrays.$stampType(['Spacebar'], j_l_String)));
