...
class $LambdaAdaptor extends j_l_Object {
 ...
 /** @nodts */
 $ctor__org_jboss_elemento_router_AfterPlaceHandler_$LambdaAdaptor__org_jboss_elemento_router_AfterPlaceHandler_$JsFunction__void(/** ?function(PlaceManager, Place):void */ fn) {
  this.$ctor__java_lang_Object__void();
  this.f_fn__org_jboss_elemento_router_AfterPlaceHandler_$LambdaAdaptor = fn;
 }
 /** @override @nodts */
 m_afterPlace__org_jboss_elemento_router_PlaceManager__org_jboss_elemento_router_Place__void(/** PlaceManager */ arg0, /** Place */ arg1) {
  {
