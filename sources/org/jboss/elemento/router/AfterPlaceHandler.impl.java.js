...
class AfterPlaceHandler {
 /** @abstract @nodts */
 m_afterPlace__org_jboss_elemento_router_PlaceManager__org_jboss_elemento_router_Place__void(/** PlaceManager */ placeManager, /** Place */ place) {}
...
$Util.$setClassMetadataForInterface(/**@type {Function}*/ (AfterPlaceHandler), 'org.jboss.elemento.router.AfterPlaceHandler');
