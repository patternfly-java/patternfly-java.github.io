...
class EventType extends j_l_Object {
 ...
 /** @nodts @return {EventType<FocusEvent, Element>} */
 static get f_focusin__org_jboss_elemento_EventType() {
  return (EventType.$clinit(), EventType.$static_focusin__org_jboss_elemento_EventType);
 }
 /** @nodts @return {EventType<FocusEvent, Element>} */
 ...
 /** @nodts @return {EventType<FocusEvent, Element>} */
 static get f_focusout__org_jboss_elemento_EventType() {
  return (EventType.$clinit(), EventType.$static_focusout__org_jboss_elemento_EventType);
 }
 ...
 /** @nodts @return {EventType<ToggleEvent, Element>} */
 static get f_beforetoggle__org_jboss_elemento_EventType() {
  return (EventType.$clinit(), EventType.$static_beforetoggle__org_jboss_elemento_EventType);
 }
 /** @nodts @return {EventType<ToggleEvent, Element>} */
 static get f_toggle__org_jboss_elemento_EventType() {
  return (EventType.$clinit(), EventType.$static_toggle__org_jboss_elemento_EventType);
 }
 ...
 static $clinit() {
  ...
  EventType.$static_focusin__org_jboss_elemento_EventType = (/**@type {EventType<FocusEvent, Element>}*/ (EventType.m_of__java_lang_String__org_jboss_elemento_EventType('focusin')));
  ...
  EventType.$static_focusout__org_jboss_elemento_EventType = (/**@type {EventType<FocusEvent, Element>}*/ (EventType.m_of__java_lang_String__org_jboss_elemento_EventType('focusout')));
  ...
  EventType.$static_beforetoggle__org_jboss_elemento_EventType = (/**@type {EventType<ToggleEvent, Element>}*/ (EventType.m_of__java_lang_String__org_jboss_elemento_EventType('beforetoggle')));
  EventType.$static_toggle__org_jboss_elemento_EventType = (/**@type {EventType<ToggleEvent, Element>}*/ (EventType.m_of__java_lang_String__org_jboss_elemento_EventType('toggle')));
...
/**@private {EventType<FocusEvent, Element>} @nodts*/
EventType.$static_focusin__org_jboss_elemento_EventType;
/**@private {EventType<FocusEvent, Element>} @nodts*/
EventType.$static_blur__org_jboss_elemento_EventType;
/**@private {EventType<FocusEvent, Element>} @nodts*/
EventType.$static_focusout__org_jboss_elemento_EventType;
...
/**@private {EventType<ToggleEvent, Element>} @nodts*/
EventType.$static_beforetoggle__org_jboss_elemento_EventType;
/**@private {EventType<ToggleEvent, Element>} @nodts*/
EventType.$static_toggle__org_jboss_elemento_EventType;
