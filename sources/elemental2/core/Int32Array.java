...
public class Int32Array extends TypedArray {
  ...
  public static native <S extends @Nullable Object> Int32Array from(
  ...
  @JsOverlay
  public static final <S extends @Nullable Object> Int32Array from(
  ...
  public static final <S extends @Nullable Object> Int32Array from(
      ...
      Int32Array.FromMapFn mapFn,
      S thisArg) {
    return from(Js.<Int32Array.FromSourceUnionType>uncheckedCast(source), mapFn, thisArg);
  }

  @JsOverlay
  public static final Int32Array from(
      JsIterable<Double, @Nullable Object, @Nullable Object> source, Int32Array.FromMapFn mapFn) {
    return from(Js.<Int32Array.FromSourceUnionType>uncheckedCast(source), mapFn);
  }
  ...
  @JsOverlay
  public static final <S extends @Nullable Object> Int32Array from(
      String source, Int32Array.FromMapFn mapFn, S thisArg) {
    return from(Js.<Int32Array.FromSourceUnionType>uncheckedCast(source), mapFn, thisArg);
  }
  ...
  @JsOverlay
  public static final <S extends @Nullable Object> Int32Array from(
      double[] source, Int32Array.FromMapFn mapFn, S thisArg) {
  ...
  public Int32Array(
      Int32Array.@Nullable ConstructorLengthUnionType length, int byteOffset, int length0) {}
