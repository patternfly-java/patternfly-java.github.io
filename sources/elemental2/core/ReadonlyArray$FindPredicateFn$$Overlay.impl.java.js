...
class $Overlay {
 ...
 static m_onInvoke__$devirt__elemental2_core_ReadonlyArray_FindPredicateFn__java_lang_Object__double__arrayOf_java_lang_Object__java_lang_Object(/** function(T, number, Array<T>):* */ $thisArg, /** T */ p0, /** number */ p1, /** Array<T> */ p2) {
  $Overlay.$clinit();
