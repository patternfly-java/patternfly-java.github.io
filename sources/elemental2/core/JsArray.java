...
public class JsArray<T extends @Nullable Object>
    implements JsIterable<T, @Nullable Object, @Nullable Object>, ReadonlyArray<T>, JsArrayLike<T> {
  ...
  public static native <
          T extends @Nullable Object, S extends @Nullable Object, R extends @Nullable Object>
      JsArray<R> from(
          JsArray.FromArrayLikeUnionType<T> arrayLike,
          JsArray.FromMapFn<? super T, ? extends R> mapFn,
          S this_);

  public static native <T extends @Nullable Object, R extends @Nullable Object> JsArray<R> from(
  ...
  @JsOverlay
  public static final <T extends @Nullable Object, R extends @Nullable Object> JsArray<R> from(
  ...
  public static final <
          T extends @Nullable Object, S extends @Nullable Object, R extends @Nullable Object>
      JsArray<R> from(
          JsIterable<T, @Nullable Object, @Nullable Object> arrayLike,
          JsArray.FromMapFn<? super T, ? extends R> mapFn,
          S this_) {
    return from(Js.<JsArray.FromArrayLikeUnionType<T>>uncheckedCast(arrayLike), mapFn, this_);
  }
  ...
  public static final <
          T extends @Nullable Object, S extends @Nullable Object, R extends @Nullable Object>
      JsArray<R> from(String arrayLike, JsArray.FromMapFn<? super T, ? extends R> mapFn, S this_) {
    return from(Js.<JsArray.FromArrayLikeUnionType<T>>uncheckedCast(arrayLike), mapFn, this_);
  }
  ...
  public native <S extends @Nullable Object> boolean every(
      ReadonlyArray.@Nullable EveryCallbackFn<? super T> callback, S thisobj);
  ...
  public native <S extends @Nullable Object> JsArray<T> filter(
      ReadonlyArray.@Nullable FilterCallbackFn<? super T> callback, S thisobj);

  public native JsArray<T> filter(ReadonlyArray.@Nullable FilterCallbackFn<? super T> callback);

  public native <S extends @Nullable Object> T find(
      ReadonlyArray.FindPredicateFn<T> predicateFn, S this_);

  public native T find(ReadonlyArray.FindPredicateFn<T> predicateFn);

  public native <S extends @Nullable Object> int findIndex(
  ...
  public native <S extends @Nullable Object> T findLast(
  ...
  public native <S extends @Nullable Object> int findLastIndex(
      ReadonlyArray.FindLastIndexPredicateFn<T> predicateFn, S this_);
  ...
  public native <THIS extends @Nullable Object, S extends @Nullable Object> JsArray<S> flatMap(
      ReadonlyArray.FlatMapCallbackFn<S, T> callback, THIS thisArg);

  public native <S extends @Nullable Object> JsArray<S> flatMap(
      ReadonlyArray.FlatMapCallbackFn<S, T> callback);

  public native <S extends @Nullable Object> void forEach(
      ReadonlyArray.@Nullable ForEachCallbackFn<? super T> callback, S thisobj);
  ...
  public native <S extends @Nullable Object, R extends @Nullable Object> JsArray<R> map(
      ReadonlyArray.@Nullable MapCallbackFn<? extends R, ? super T> callback, S thisobj);

  public native <R extends @Nullable Object> JsArray<R> map(
      ReadonlyArray.@Nullable MapCallbackFn<? extends R, ? super T> callback);

  public native T pop();

  public native int push(T... var_args);

  public native <R extends @Nullable Object> R reduce(
      ReadonlyArray.@Nullable ReduceCallbackFn<? extends R, ? super T> callback,
      @Nullable Object initialValue);

  public native <R extends @Nullable Object> R reduce(
      ReadonlyArray.@Nullable ReduceCallbackFn<? extends R, ? super T> callback);

  public native <R extends @Nullable Object> R reduceRight(
      ReadonlyArray.@Nullable ReduceRightCallbackFn<? extends R, ? super T> callback,
      @Nullable Object initialValue);
  ...
  public native <S extends @Nullable Object> boolean some(
      ReadonlyArray.@Nullable SomeCallbackFn<? super T> callback, S thisobj);
