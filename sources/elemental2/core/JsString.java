...
public class JsString implements JsIterable<String, @Nullable Object, @Nullable Object> {
  ...
  public final int localeCompare(
      @Nullable String compareString, JsArray<String> locales, @Nullable JsObject options) {
    return localeCompare(
        compareString,
        Js.<JsString.@Nullable LocaleCompareLocalesUnionType>uncheckedCast(locales),
        options);
  }

  @JsOverlay
  public final int localeCompare(
      @Nullable String compareString, JsArray<String> locales, @Nullable Object options) {
  ...
  public final int localeCompare(@Nullable String compareString, JsArray<String> locales) {
    return localeCompare(
        compareString, Js.<JsString.@Nullable LocaleCompareLocalesUnionType>uncheckedCast(locales));
  }

  public native int localeCompare(
      @Nullable String compareString,
      JsString.@Nullable LocaleCompareLocalesUnionType locales,
      @Nullable JsObject options);
  ...
  public native int localeCompare(
      @Nullable String compareString, JsString.@Nullable LocaleCompareLocalesUnionType locales);

  @JsOverlay
  public final int localeCompare(
      @Nullable String compareString, String locales, @Nullable JsObject options) {
    return localeCompare(
        compareString,
        Js.<JsString.@Nullable LocaleCompareLocalesUnionType>uncheckedCast(locales),
        options);
  ...
  @JsOverlay
  public final int localeCompare(
      @Nullable String compareString, String locales, @Nullable Object options) {
    return localeCompare(compareString, locales, Js.<@Nullable JsObject>uncheckedCast(options));
  }
  ...
  @JsOverlay
  public final JsIteratorIterable<RegExpResult, @Nullable Object, @Nullable Object> matchAll(
      JsRegExp regexp) {
    return matchAll(Js.<JsString.MatchAllRegexpUnionType>uncheckedCast(regexp));
  }

  public native JsIteratorIterable<RegExpResult, @Nullable Object, @Nullable Object> matchAll(
      JsString.MatchAllRegexpUnionType regexp);
  ...
  public final String replace(JsRegExp pattern, JsString.ReplaceReplacementFn replacement) {
    return replace(
        Js.<JsString.@Nullable ReplacePatternUnionType>uncheckedCast(pattern),
        Js.<JsString.@Nullable ReplaceReplacementUnionType>uncheckedCast(replacement));
  }

  @JsOverlay
  public final String replace(
      JsRegExp pattern, JsString.@Nullable ReplaceReplacementUnionType replacement) {
    return replace(
        Js.<JsString.@Nullable ReplacePatternUnionType>uncheckedCast(pattern), replacement);
  }
  ...
  @JsOverlay
  public final String replace(
      JsString.@Nullable ReplacePatternUnionType pattern,
      JsString.ReplaceReplacementFn replacement) {
    return replace(
        pattern, Js.<JsString.@Nullable ReplaceReplacementUnionType>uncheckedCast(replacement));
  }

  public native String replace(
      JsString.@Nullable ReplacePatternUnionType pattern,
      JsString.@Nullable ReplaceReplacementUnionType replacement);

  @JsOverlay
  public final String replace(
      JsString.@Nullable ReplacePatternUnionType pattern, String replacement) {
    return replace(
        pattern, Js.<JsString.@Nullable ReplaceReplacementUnionType>uncheckedCast(replacement));
  }
  ...
  @JsOverlay
  public final String replace(
      String pattern, JsString.@Nullable ReplaceReplacementUnionType replacement) {
    return replace(
        Js.<JsString.@Nullable ReplacePatternUnionType>uncheckedCast(pattern), replacement);
  }
  ...
  public final String replaceAll(
    ...
    return replaceAll(
        ...
        Js.<JsString.@Nullable ReplaceAllReplacementUnionType>uncheckedCast(replacement));
  }

  @JsOverlay
  public final String replaceAll(
      JsRegExp searchValue, JsString.@Nullable ReplaceAllReplacementUnionType replacement) {
    return replaceAll(
  ...
  public native String replaceAll(
      JsString.ReplaceAllSearchValueUnionType searchValue,
      JsString.@Nullable ReplaceAllReplacementUnionType replacement);
  ...
  @JsOverlay
  public final String replaceAll(
      String searchValue, JsString.@Nullable ReplaceAllReplacementUnionType replacement) {
    return replaceAll(
        Js.<JsString.ReplaceAllSearchValueUnionType>uncheckedCast(searchValue), replacement);
  }
  ...
  public final String toLocaleLowerCase(JsArray<String> locales) {
    return toLocaleLowerCase(
        Js.<JsString.@Nullable ToLocaleLowerCaseLocalesUnionType>uncheckedCast(locales));
  }
  ...
  public native String toLocaleLowerCase(
      JsString.@Nullable ToLocaleLowerCaseLocalesUnionType locales);
  ...
  public final String toLocaleUpperCase(JsArray<String> locales) {
    return toLocaleUpperCase(
        Js.<JsString.@Nullable ToLocaleUpperCaseLocalesUnionType>uncheckedCast(locales));
  }
  ...
  public native String toLocaleUpperCase(
      JsString.@Nullable ToLocaleUpperCaseLocalesUnionType locales);
