...
public class TypedArray extends ArrayBufferView
    implements JsIterable<Double, @Nullable Object, @Nullable Object>, JsArrayLike<Double> {
  @JsFunction
  ...
  public interface ReduceCallbackFn<INIT extends @Nullable Object, RET extends @Nullable Object> {
    ...
    public interface P0UnionType<INIT extends @Nullable Object, RET extends @Nullable Object> {
      @JsOverlay
      static <INIT extends @Nullable Object, RET extends @Nullable Object>
          TypedArray.ReduceCallbackFn.P0UnionType<INIT, RET> of(Object o) {
        return Js.cast(o);
      }
  ...
  public interface ReduceRightCallbackFn<
      INIT extends @Nullable Object, RET extends @Nullable Object> {
    @JsType(isNative = true, name = "?", namespace = JsPackage.GLOBAL)
    public interface P0UnionType<INIT extends @Nullable Object, RET extends @Nullable Object> {
      @JsOverlay
      static <INIT extends @Nullable Object, RET extends @Nullable Object>
          TypedArray.ReduceRightCallbackFn.P0UnionType<INIT, RET> of(Object o) {
        return Js.cast(o);
      }
  ...
  public native <S extends @Nullable Object> boolean every(
      TypedArray.EveryCallbackFn callback, S thisArg);
  ...
  public native <S extends @Nullable Object> TypedArray filter(
      TypedArray.FilterCallbackFn callback, S thisArg);

  public native TypedArray filter(TypedArray.FilterCallbackFn callback);

  public native <S extends @Nullable Object> double find(
      TypedArray.FindCallbackFn callback, S thisArg);

  public native double find(TypedArray.FindCallbackFn callback);

  public native <S extends @Nullable Object> int findIndex(
      TypedArray.FindIndexCallbackFn callback, S thisArg);

  public native int findIndex(TypedArray.FindIndexCallbackFn callback);

  public native <S extends @Nullable Object> double findLast(
      TypedArray.FindLastCallbackFn callback, S thisArg);
  ...
  public native <S extends @Nullable Object> int findLastIndex(
      TypedArray.FindLastIndexCallbackFn callback, S thisArg);
  ...
  public native <S extends @Nullable Object> void forEach(
      TypedArray.ForEachCallbackFn callback, S thisArg);
  ...
  public native <S extends @Nullable Object> TypedArray map(
      TypedArray.MapCallbackFn callback, S thisArg);

  public native TypedArray map(TypedArray.MapCallbackFn callback);

  public native <INIT extends @Nullable Object, RET extends @Nullable Object> RET reduce(
      TypedArray.ReduceCallbackFn<? super INIT, RET> callback, INIT initialValue);

  public native <INIT extends @Nullable Object, RET extends @Nullable Object> RET reduce(
      TypedArray.ReduceCallbackFn<? super INIT, RET> callback);

  public native <INIT extends @Nullable Object, RET extends @Nullable Object> RET reduceRight(
  ...
  public native <S extends @Nullable Object> boolean some(
      TypedArray.SomeCallbackFn callback, S thisArg);
