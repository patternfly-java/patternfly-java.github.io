...
public class Uint8ClampedArray extends TypedArray {
  ...
  public interface ConstructorLengthUnionType {
    @JsOverlay
    static Uint8ClampedArray.@Nullable ConstructorLengthUnionType of(@Nullable Object o) {
      return Js.cast(o);
    }
  ...
  public static native <S extends @Nullable Object> Uint8ClampedArray from(
  ...
  @JsOverlay
  public static final <S extends @Nullable Object> Uint8ClampedArray from(
  ...
  public Uint8ClampedArray(
      Uint8ClampedArray.@Nullable ConstructorLengthUnionType length, int byteOffset, int length0) {}

  public Uint8ClampedArray(
      Uint8ClampedArray.@Nullable ConstructorLengthUnionType length, int byteOffset) {}

  public Uint8ClampedArray(Uint8ClampedArray.@Nullable ConstructorLengthUnionType length) {}
