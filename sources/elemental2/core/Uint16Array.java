...
public class Uint16Array extends TypedArray {
  ...
  public static native <S extends @Nullable Object> Uint16Array from(
  ...
  @JsOverlay
  public static final <S extends @Nullable Object> Uint16Array from(
  ...
  @JsOverlay
  public static final Uint16Array from(
      JsIterable<Double, @Nullable Object, @Nullable Object> source, Uint16Array.FromMapFn mapFn) {
    return from(Js.<Uint16Array.FromSourceUnionType>uncheckedCast(source), mapFn);
  }
  ...
  @JsOverlay
  public static final <S extends @Nullable Object> Uint16Array from(
      String source, Uint16Array.FromMapFn mapFn, S thisArg) {
    return from(Js.<Uint16Array.FromSourceUnionType>uncheckedCast(source), mapFn, thisArg);
  }
  ...
  public Uint16Array(
      Uint16Array.@Nullable ConstructorLengthUnionType length, int byteOffset, int length0) {}
