...
public class Float32Array extends TypedArray {
  ...
  public interface ConstructorLengthUnionType {
    @JsOverlay
    static Float32Array.@Nullable ConstructorLengthUnionType of(@Nullable Object o) {
      return Js.cast(o);
    }
  ...
  public static native <S extends @Nullable Object> Float32Array from(
  ...
  @JsOverlay
  public static final <S extends @Nullable Object> Float32Array from(
  ...
  public static final Float32Array from(
      JsIterable<Double, @Nullable Object, @Nullable Object> source, Float32Array.FromMapFn mapFn) {
    return from(Js.<Float32Array.FromSourceUnionType>uncheckedCast(source), mapFn);
  }
  ...
  public Float32Array(
      Float32Array.@Nullable ConstructorLengthUnionType length, int byteOffset, int length0) {}

  public Float32Array(Float32Array.@Nullable ConstructorLengthUnionType length, int byteOffset) {}

  public Float32Array(Float32Array.@Nullable ConstructorLengthUnionType length) {}
