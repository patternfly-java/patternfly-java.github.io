...
public class JsObject {
  ...
  public static final JsObject assign(Object target, @Nullable Object... var_args) {
    return assign(
        Js.<JsObject>uncheckedCast(target), Js.<@Nullable JsObject[]>uncheckedCast(var_args));
  }
  ...
  public static native JsObject create(
      @Nullable JsObject proto,
      @Nullable JsPropertyMap<ObjectPropertyDescriptor<@Nullable Object>> properties);

  public static native JsObject create(@Nullable JsObject proto);

  @JsOverlay
  public static final JsObject create(
      @Nullable Object proto,
      @Nullable JsPropertyMap<ObjectPropertyDescriptor<@Nullable Object>> properties) {
  ...
  public static native <T extends @Nullable Object> T defineProperties(
      T obj, JsPropertyMap<ObjectPropertyDescriptor<T>> props);

  public static native <T extends @Nullable Object> T defineProperty(
      T obj, JsObject.DefinePropertyPropUnionType prop, ObjectPropertyDescriptor<T> descriptor);

  @JsOverlay
  public static final <T extends @Nullable Object> T defineProperty(
  ...
  public static native <T extends @Nullable Object>
      JsArray<JsArray<JsObject.EntriesArrayArrayUnionType<T>>> entries(JsPropertyMap<T> obj);

  public static native <T extends @Nullable Object> T freeze(T obj);

  public static native JsObject fromEntries(
      JsIterable<@Nullable Object, @Nullable Object, @Nullable Object> iter);

  public static native <T extends @Nullable Object>
      ObjectPropertyDescriptor<T> getOwnPropertyDescriptor(
          T obj, JsObject.GetOwnPropertyDescriptorPropUnionType prop);

  @JsOverlay
  public static final <T extends @Nullable Object>
      ObjectPropertyDescriptor<T> getOwnPropertyDescriptor(T obj, Object prop) {
  ...
  @JsOverlay
  public static final <T extends @Nullable Object>
      ObjectPropertyDescriptor<T> getOwnPropertyDescriptor(T obj, String prop) {
    return getOwnPropertyDescriptor(
        obj, Js.<JsObject.GetOwnPropertyDescriptorPropUnionType>uncheckedCast(prop));
  }
  ...
  @Deprecated public @Nullable JsObject __parent__;
