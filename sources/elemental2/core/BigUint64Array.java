...
public class BigUint64Array extends TypedArray {
  ...
  public interface ConstructorLengthOrArrayOrBufferUnionType {
    @JsOverlay
    static BigUint64Array.@Nullable ConstructorLengthOrArrayOrBufferUnionType of(
        @Nullable Object o) {
      return Js.cast(o);
    }
  ...
  public static native <S extends @Nullable Object> BigUint64Array from(
  ...
  @JsOverlay
  public static final <S extends @Nullable Object> BigUint64Array from(
  ...
  @JsOverlay
  public static final <S extends @Nullable Object> BigUint64Array from(
      JsIterable<JsBigint, @Nullable Object, @Nullable Object> source,
      BigUint64Array.FromMapFn mapFn,
      S thisArg) {
    return from(Js.<BigUint64Array.FromSourceUnionType>uncheckedCast(source), mapFn, thisArg);
  }
  ...
  public BigUint64Array(
      BigUint64Array.@Nullable ConstructorLengthOrArrayOrBufferUnionType lengthOrArrayOrBuffer,
      double byteOffset,
      double bufferLength) {}
