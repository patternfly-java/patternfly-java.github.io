...
class $Overlay {
 ...
 static m_of__java_lang_Object__elemental2_core_JsArray_FromMapFn_P0UnionType(/** * */ o) {
  $Overlay.$clinit();
  return /**@type {?}*/ (Js.m_cast__java_lang_Object__java_lang_Object(o));
 }
 /** @nodts @template T @return {?string} */
 static m_asString__$devirt__elemental2_core_JsArray_FromMapFn_P0UnionType__java_lang_String(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return Js.m_asString__java_lang_Object__java_lang_String($thisArg);
 }
 /** @nodts @template T @return {T} */
 static m_asT__$devirt__elemental2_core_JsArray_FromMapFn_P0UnionType__java_lang_Object(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return Js.m_cast__java_lang_Object__java_lang_Object($thisArg);
 }
 /** @nodts @template T @return {boolean} */
 static m_isString__$devirt__elemental2_core_JsArray_FromMapFn_P0UnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
