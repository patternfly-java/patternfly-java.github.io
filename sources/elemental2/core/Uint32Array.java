...
public class Uint32Array extends TypedArray {
  ...
  public interface ConstructorLengthUnionType {
    @JsOverlay
    static Uint32Array.@Nullable ConstructorLengthUnionType of(@Nullable Object o) {
      return Js.cast(o);
    }
  ...
  public static native <S extends @Nullable Object> Uint32Array from(
  ...
  @JsOverlay
  public static final <S extends @Nullable Object> Uint32Array from(
  ...
  @JsOverlay
  public static final Uint32Array from(
      JsIterable<Double, @Nullable Object, @Nullable Object> source, Uint32Array.FromMapFn mapFn) {
    return from(Js.<Uint32Array.FromSourceUnionType>uncheckedCast(source), mapFn);
  }
  ...
  @JsOverlay
  public static final <S extends @Nullable Object> Uint32Array from(
      String source, Uint32Array.FromMapFn mapFn, S thisArg) {
    return from(Js.<Uint32Array.FromSourceUnionType>uncheckedCast(source), mapFn, thisArg);
  }
  ...
  public Uint32Array(
      Uint32Array.@Nullable ConstructorLengthUnionType length, int byteOffset, int length0) {}

  public Uint32Array(Uint32Array.@Nullable ConstructorLengthUnionType length, int byteOffset) {}

  public Uint32Array(Uint32Array.@Nullable ConstructorLengthUnionType length) {}
