...
public class Float64Array extends TypedArray {
  ...
  public interface ConstructorLengthUnionType {
    @JsOverlay
    static Float64Array.@Nullable ConstructorLengthUnionType of(@Nullable Object o) {
      return Js.cast(o);
    }
  ...
  public static native <S extends @Nullable Object> Float64Array from(
  ...
  @JsOverlay
  public static final <S extends @Nullable Object> Float64Array from(
  ...
  public static final <S extends @Nullable Object> Float64Array from(
      ...
      Float64Array.FromMapFn mapFn,
      S thisArg) {
    return from(Js.<Float64Array.FromSourceUnionType>uncheckedCast(source), mapFn, thisArg);
  }

  @JsOverlay
  public static final Float64Array from(
      JsIterable<Double, @Nullable Object, @Nullable Object> source, Float64Array.FromMapFn mapFn) {
    return from(Js.<Float64Array.FromSourceUnionType>uncheckedCast(source), mapFn);
  }
  ...
  public Float64Array(
      Float64Array.@Nullable ConstructorLengthUnionType length, int byteOffset, int length0) {}

  public Float64Array(Float64Array.@Nullable ConstructorLengthUnionType length, int byteOffset) {}

  public Float64Array(Float64Array.@Nullable ConstructorLengthUnionType length) {}
