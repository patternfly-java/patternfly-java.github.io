...
public class Int8Array extends TypedArray {
  ...
  public static native <S extends @Nullable Object> Int8Array from(
  ...
  @JsOverlay
  public static final <S extends @Nullable Object> Int8Array from(
  ...
  public static final Int8Array from(
      JsIterable<Double, @Nullable Object, @Nullable Object> source, Int8Array.FromMapFn mapFn) {
    return from(Js.<Int8Array.FromSourceUnionType>uncheckedCast(source), mapFn);
  }
  ...
  @JsOverlay
  public static final <S extends @Nullable Object> Int8Array from(
      String source, Int8Array.FromMapFn mapFn, S thisArg) {
    return from(Js.<Int8Array.FromSourceUnionType>uncheckedCast(source), mapFn, thisArg);
  }
  ...
  @JsOverlay
  public static final <S extends @Nullable Object> Int8Array from(
      double[] source, Int8Array.FromMapFn mapFn, S thisArg) {
  ...
  public Int8Array(
      Int8Array.@Nullable ConstructorLengthUnionType length, int byteOffset, int length0) {}
