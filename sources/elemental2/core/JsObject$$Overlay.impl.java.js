...
class $Overlay {
 ...
 static m_assign__java_lang_Object__arrayOf_java_lang_Object__elemental2_core_JsObject(/** * */ target, /** Array<*> */ var_args) {
  $Overlay.$clinit();
  return Object.assign(/**@type {Object}*/ (Js.m_uncheckedCast__java_lang_Object__java_lang_Object(target)), ...(/**@type {Array<Object>}*/ (Js.m_uncheckedCast__java_lang_Object__java_lang_Object(var_args))));
 }
 /** @final @nodts @return {Object} */
 static m_assign__java_lang_Object__elemental2_core_JsObject(/** * */ target) {
  $Overlay.$clinit();
  return Object.assign(/**@type {Object}*/ (Js.m_uncheckedCast__java_lang_Object__java_lang_Object(target)));
 }
 /** @final @nodts @return {Object} */
