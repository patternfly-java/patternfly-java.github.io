...
class $Overlay {
 ...
 static m_of__java_lang_Object__elemental2_core_JsSet_ConstructorIterableUnionType(/** * */ o) {
  $Overlay.$clinit();
  return /**@type {?}*/ (Js.m_cast__java_lang_Object__java_lang_Object(o));
 }
 /** @nodts @template VALUE @return {Array<VALUE>} */
 static m_asJsArray__$devirt__elemental2_core_JsSet_ConstructorIterableUnionType__elemental2_core_JsArray(/** ? */ $thisArg) {
  $Overlay.$clinit();
 ...
 static m_asJsIterable__$devirt__elemental2_core_JsSet_ConstructorIterableUnionType__elemental2_core_JsIterable(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {Iterable<VALUE, *, *>}*/ (Js.m_cast__java_lang_Object__java_lang_Object($thisArg));
 }
 /** @nodts @template VALUE @return {boolean} */
 static m_isJsArray__$devirt__elemental2_core_JsSet_ConstructorIterableUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
