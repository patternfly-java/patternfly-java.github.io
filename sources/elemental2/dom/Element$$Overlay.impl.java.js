...
class $Overlay {
 ...
 /** @final @nodts */
 static m_setAttribute__$devirt__elemental2_dom_Element__java_lang_String__elemental2_core_TrustedScript__void(/** !Element */ $thisArg, /** ?string */ name, /** TrustedScript */ value) {
  $Overlay.$clinit();
  $thisArg.setAttribute(name, /**@type {?}*/ (Js.m_uncheckedCast__java_lang_Object__java_lang_Object(value)));
 }
 /** @final @nodts */
