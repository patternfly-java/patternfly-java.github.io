...
public interface RTCInboundRtpStreamStats extends RTCReceivedRtpStreamStats {
  ...
  public interface GetEstimatedPlayoutTimestampUnionType {
    @JsOverlay
    static RTCInboundRtpStreamStats.@Nullable GetEstimatedPlayoutTimestampUnionType of(
        @Nullable Object o) {
      return Js.cast(o);
    }
  ...
  public interface GetLastPacketReceivedTimestampUnionType {
    @JsOverlay
    static RTCInboundRtpStreamStats.@Nullable GetLastPacketReceivedTimestampUnionType of(
        @Nullable Object o) {
      return Js.cast(o);
    }
  ...
  @JsProperty
  RTCInboundRtpStreamStats.@Nullable GetEstimatedPlayoutTimestampUnionType
  ...
  @JsProperty
  RTCInboundRtpStreamStats.@Nullable GetLastPacketReceivedTimestampUnionType
