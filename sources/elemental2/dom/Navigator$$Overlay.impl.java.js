...
class $Overlay {
 ...
 /** @final @nodts @return {Promise<MediaKeySystemAccess>} */
 static m_requestMediaKeySystemAccess__$devirt__elemental2_dom_Navigator__java_lang_String__arrayOf_elemental2_dom_MediaKeySystemConfiguration__elemental2_promise_Promise(/** !Navigator */ $thisArg, /** ?string */ keySystem, /** Array<MediaKeySystemConfiguration> */ supportedConfigurations) {
  $Overlay.$clinit();
  return $thisArg.requestMediaKeySystemAccess(keySystem, /**@type {Array<MediaKeySystemConfiguration>}*/ (Js.m_uncheckedCast__java_lang_Object__java_lang_Object(supportedConfigurations)));
 }
 /** @final @nodts */
