...
class $Overlay {
 ...
 static m_asTrustedScript__$devirt__elemental2_dom_Element_SetAttributeValueUnionType__elemental2_core_TrustedScript(/** ? */ $thisArg) {
  $Overlay.$clinit();
 ...
 /** @nodts @return {boolean} */
 static m_isTrustedScript__$devirt__elemental2_dom_Element_SetAttributeValueUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
