...
public class BaseRenderingContext2D implements CanvasDrawingStyles, CanvasPathMethods {
  ...
  public interface SetTransformM11OrMatrixUnionType {
    @JsOverlay
    static BaseRenderingContext2D.@Nullable SetTransformM11OrMatrixUnionType of(
        @Nullable Object o) {
      return Js.cast(o);
    }
  ...
  public native void clip(
      BaseRenderingContext2D.@Nullable ClipOptFillRuleOrPathUnionType optFillRuleOrPath,
      String optFillRule);
  ...
  public final void clip(Path2D optFillRuleOrPath, String optFillRule) {
    clip(
        Js.<BaseRenderingContext2D.@Nullable ClipOptFillRuleOrPathUnionType>uncheckedCast(
            optFillRuleOrPath),
        optFillRule);
  }
  ...
  public native @Nullable CanvasPattern createPattern(
      BaseRenderingContext2D.@Nullable CreatePatternImageUnionType image, String repetition);

  @JsOverlay
  public final @Nullable CanvasPattern createPattern(HTMLCanvasElement image, String repetition) {
    return createPattern(
        Js.<BaseRenderingContext2D.@Nullable CreatePatternImageUnionType>uncheckedCast(image),
        repetition);
  }
  ...
  public native void drawImage(
      BaseRenderingContext2D.@Nullable DrawImageImageUnionType image,
      double dx,
      double dy,
      double dw,
      double dh,
  ...
  public native void drawImage(
      BaseRenderingContext2D.@Nullable DrawImageImageUnionType image, double dx, double dy);
  ...
  public final void drawImage(
      ...
      double sh) {
    drawImage(
        Js.<BaseRenderingContext2D.@Nullable DrawImageImageUnionType>uncheckedCast(image),
        dx,
        dy,
        dw,
        dh,
  ...
  public final void drawImage(HTMLCanvasElement image, double dx, double dy) {
    drawImage(
        Js.<BaseRenderingContext2D.@Nullable DrawImageImageUnionType>uncheckedCast(image), dx, dy);
  }
  ...
  public native void fill(
      BaseRenderingContext2D.@Nullable FillOptFillRuleOrPathUnionType optFillRuleOrPath,
      String optFillRule);
  ...
  public final void fill(Path2D optFillRuleOrPath, String optFillRule) {
    fill(
        Js.<BaseRenderingContext2D.@Nullable FillOptFillRuleOrPathUnionType>uncheckedCast(
            optFillRuleOrPath),
        optFillRule);
  }
  ...
  public native boolean isPointInPath(
      BaseRenderingContext2D.IsPointInPathPathOrXUnionType pathOrX,
      double xOrY,
      BaseRenderingContext2D.IsPointInPathYOrFillRuleUnionType yOrFillRule,
      String fillRule);
  ...
  @JsOverlay
  public final boolean isPointInPath(
      BaseRenderingContext2D.IsPointInPathPathOrXUnionType pathOrX,
      double xOrY,
      String yOrFillRule,
      String fillRule) {
    return isPointInPath(
        pathOrX,
        xOrY,
        Js.<BaseRenderingContext2D.IsPointInPathYOrFillRuleUnionType>uncheckedCast(yOrFillRule),
        fillRule);
  }
  ...
  public native boolean isPointInPath(
      BaseRenderingContext2D.IsPointInPathPathOrXUnionType pathOrX, double xOrY);
  ...
  public final boolean isPointInPath(
      ...
      String fillRule) {
    return isPointInPath(
        Js.<BaseRenderingContext2D.IsPointInPathPathOrXUnionType>uncheckedCast(pathOrX),
        xOrY,
        yOrFillRule,
        fillRule);
  }
  ...
  @JsOverlay
  public final boolean isPointInPath(
      Path2D pathOrX, double xOrY, String yOrFillRule, String fillRule) {
    return isPointInPath(
        Js.<BaseRenderingContext2D.IsPointInPathPathOrXUnionType>uncheckedCast(pathOrX),
        xOrY,
        Js.<BaseRenderingContext2D.IsPointInPathYOrFillRuleUnionType>uncheckedCast(yOrFillRule),
  ...
  @JsOverlay
  public final boolean isPointInPath(
      Path2D pathOrX, double xOrY, double yOrFillRule, String fillRule) {
    return isPointInPath(
        Js.<BaseRenderingContext2D.IsPointInPathPathOrXUnionType>uncheckedCast(pathOrX),
        xOrY,
        Js.<BaseRenderingContext2D.IsPointInPathYOrFillRuleUnionType>uncheckedCast(yOrFillRule),
  ...
  public final boolean isPointInPath(Path2D pathOrX, double xOrY) {
    return isPointInPath(
        Js.<BaseRenderingContext2D.IsPointInPathPathOrXUnionType>uncheckedCast(pathOrX), xOrY);
  }
  ...
  @JsOverlay
  public final boolean isPointInPath(
      double pathOrX, double xOrY, String yOrFillRule, String fillRule) {
    return isPointInPath(
        Js.<BaseRenderingContext2D.IsPointInPathPathOrXUnionType>uncheckedCast(pathOrX),
        xOrY,
        Js.<BaseRenderingContext2D.IsPointInPathYOrFillRuleUnionType>uncheckedCast(yOrFillRule),
  ...
  @JsOverlay
  public final boolean isPointInPath(
      double pathOrX, double xOrY, double yOrFillRule, String fillRule) {
    return isPointInPath(
        Js.<BaseRenderingContext2D.IsPointInPathPathOrXUnionType>uncheckedCast(pathOrX),
        xOrY,
        Js.<BaseRenderingContext2D.IsPointInPathYOrFillRuleUnionType>uncheckedCast(yOrFillRule),
  ...
  public native void putImageData(
      @Nullable ImageData imagedata, int dx, int dy, int dirtyX, int dirtyY, int dirtyWidth);

  public native void putImageData(
      @Nullable ImageData imagedata, int dx, int dy, int dirtyX, int dirtyY);
  ...
  public final void setTransform(
      DOMMatrixReadOnly m11OrMatrix, double m12, double m21, double m22, double dx, double dy) {
    setTransform(
        Js.<BaseRenderingContext2D.@Nullable SetTransformM11OrMatrixUnionType>uncheckedCast(
            m11OrMatrix),
        m12,
        m21,
        m22,
  ...
  @JsOverlay
  public final void setTransform(
      DOMMatrixReadOnly m11OrMatrix, double m12, double m21, double m22, double dx) {
    setTransform(
        Js.<BaseRenderingContext2D.@Nullable SetTransformM11OrMatrixUnionType>uncheckedCast(
            m11OrMatrix),
        m12,
  ...
  @JsOverlay
  public final void setTransform(
      DOMMatrixReadOnly m11OrMatrix, double m12, double m21, double m22) {
    setTransform(
        Js.<BaseRenderingContext2D.@Nullable SetTransformM11OrMatrixUnionType>uncheckedCast(
            m11OrMatrix),
        m12,
  ...
  public native void setTransform(
      BaseRenderingContext2D.@Nullable SetTransformM11OrMatrixUnionType m11OrMatrix,
      double m12,
      double m21,
      double m22,
      double dx,
  ...
  public native void setTransform(
      BaseRenderingContext2D.@Nullable SetTransformM11OrMatrixUnionType m11OrMatrix, double m12);
  ...
  @JsOverlay
  public final void setTransform(
      double m11OrMatrix, double m12, double m21, double m22, double dx, double dy) {
    setTransform(
        Js.<BaseRenderingContext2D.@Nullable SetTransformM11OrMatrixUnionType>uncheckedCast(
            m11OrMatrix),
        m12,
  ...
  @JsOverlay
  public final void setTransform(
      double m11OrMatrix, double m12, double m21, double m22, double dx) {
    setTransform(
        Js.<BaseRenderingContext2D.@Nullable SetTransformM11OrMatrixUnionType>uncheckedCast(
            m11OrMatrix),
        m12,
