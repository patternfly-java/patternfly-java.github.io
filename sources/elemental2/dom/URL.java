...
public class URL {
  ...
  public static native boolean canParse(
      URL.CanParseUrlUnionType url, URL.CanParseBaseUnionType base);
  ...
  public static final boolean canParse(String url, String base) {
    return canParse(
        Js.<URL.CanParseUrlUnionType>uncheckedCast(url),
        Js.<URL.CanParseBaseUnionType>uncheckedCast(base));
  }
