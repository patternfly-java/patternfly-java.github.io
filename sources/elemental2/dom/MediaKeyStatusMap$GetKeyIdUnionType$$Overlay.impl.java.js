goog.module('elemental2.dom.MediaKeyStatusMap.GetKeyIdUnionType.$Overlay$impl');
...
class $Overlay {
 /** @nodts @return {?} */
 static m_of__java_lang_Object__elemental2_dom_MediaKeyStatusMap_GetKeyIdUnionType(/** * */ o) {
  $Overlay.$clinit();
  return /**@type {?}*/ (Js.m_cast__java_lang_Object__java_lang_Object(o));
 }
 /** @nodts @return {ArrayBuffer} */
 static m_asArrayBuffer__$devirt__elemental2_dom_MediaKeyStatusMap_GetKeyIdUnionType__elemental2_core_ArrayBuffer(/** ? */ $thisArg) {
  $Overlay.$clinit();
 ...
 static m_asArrayBufferView__$devirt__elemental2_dom_MediaKeyStatusMap_GetKeyIdUnionType__elemental2_core_ArrayBufferView(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {ArrayBufferView}*/ ($Casts.$to(Js.m_cast__java_lang_Object__java_lang_Object($thisArg), ArrayBufferView_$Overlay));
 }
 /** @nodts @return {boolean} */
 static m_isArrayBuffer__$devirt__elemental2_dom_MediaKeyStatusMap_GetKeyIdUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return ArrayBuffer_$Overlay.$isInstance($thisArg);
 }
 /** @nodts @return {boolean} */
 static m_isArrayBufferView__$devirt__elemental2_dom_MediaKeyStatusMap_GetKeyIdUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
...
//# sourceMappingURL=MediaKeyStatusMap$GetKeyIdUnionType$$Overlay.js.map
