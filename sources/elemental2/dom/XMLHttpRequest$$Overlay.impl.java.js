...
class $Overlay {
 /** @final @nodts */
 static m_open__$devirt__elemental2_dom_XMLHttpRequest__java_lang_String__java_lang_String__java_lang_Boolean__java_lang_String__java_lang_String__void(/** !XMLHttpRequest */ $thisArg, /** ?string */ method, /** ?string */ url, /** ?boolean */ async_1, /** ?string */ user, /** ?string */ password) {
  $Overlay.$clinit();
  $thisArg.open(method, /**@type {?}*/ (Js.m_uncheckedCast__java_lang_Object__java_lang_Object(url)), async_1, user, password);
 }
 /** @final @nodts */
 static m_open__$devirt__elemental2_dom_XMLHttpRequest__java_lang_String__java_lang_String__java_lang_Boolean__java_lang_String__void(/** !XMLHttpRequest */ $thisArg, /** ?string */ method, /** ?string */ url, /** ?boolean */ async_1, /** ?string */ user) {
  $Overlay.$clinit();
  $thisArg.open(method, /**@type {?}*/ (Js.m_uncheckedCast__java_lang_Object__java_lang_Object(url)), async_1, user);
 }
 /** @final @nodts */
 static m_open__$devirt__elemental2_dom_XMLHttpRequest__java_lang_String__java_lang_String__java_lang_Boolean__void(/** !XMLHttpRequest */ $thisArg, /** ?string */ method, /** ?string */ url, /** ?boolean */ async_1) {
  $Overlay.$clinit();
 ...
 /** @final @nodts */
 static m_open__$devirt__elemental2_dom_XMLHttpRequest__java_lang_String__elemental2_dom_URL__java_lang_Boolean__java_lang_String__java_lang_String__void(/** !XMLHttpRequest */ $thisArg, /** ?string */ method, /** URL */ url, /** ?boolean */ async_1, /** ?string */ user, /** ?string */ password) {
  $Overlay.$clinit();
  $thisArg.open(method, /**@type {?}*/ (Js.m_uncheckedCast__java_lang_Object__java_lang_Object(url)), async_1, user, password);
 }
 /** @final @nodts */
 static m_open__$devirt__elemental2_dom_XMLHttpRequest__java_lang_String__elemental2_dom_URL__java_lang_Boolean__java_lang_String__void(/** !XMLHttpRequest */ $thisArg, /** ?string */ method, /** URL */ url, /** ?boolean */ async_1, /** ?string */ user) {
  $Overlay.$clinit();
  $thisArg.open(method, /**@type {?}*/ (Js.m_uncheckedCast__java_lang_Object__java_lang_Object(url)), async_1, user);
 }
 /** @final @nodts */
 static m_open__$devirt__elemental2_dom_XMLHttpRequest__java_lang_String__elemental2_dom_URL__java_lang_Boolean__void(/** !XMLHttpRequest */ $thisArg, /** ?string */ method, /** URL */ url, /** ?boolean */ async_1) {
  $Overlay.$clinit();
  $thisArg.open(method, /**@type {?}*/ (Js.m_uncheckedCast__java_lang_Object__java_lang_Object(url)), async_1);
 }
 /** @final @nodts */
