...
public class Worker implements EventTarget {
  ...
  public final void postMessage(@Nullable Object message, JsArray<Transferable> transferOrOptions) {
    postMessage(
        message,
        Js.<Worker.@Nullable PostMessageTransferOrOptionsUnionType>uncheckedCast(
            transferOrOptions));
  }

  public native void postMessage(
      @Nullable Object message,
      Worker.@Nullable PostMessageTransferOrOptionsUnionType transferOrOptions);
  ...
  public final void webkitPostMessage(
    ...
    webkitPostMessage(
        message,
        Js.<Worker.@Nullable WebkitPostMessageTransferOrOptionsUnionType>uncheckedCast(
            transferOrOptions));
  }
  ...
  public native void webkitPostMessage(
      @Nullable Object message,
      Worker.@Nullable WebkitPostMessageTransferOrOptionsUnionType transferOrOptions);
