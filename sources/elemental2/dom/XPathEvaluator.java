...
public class XPathEvaluator {
  ...
  public native @Nullable XPathResult evaluate(
      String expr,
  ...
  public native @Nullable XPathResult evaluate(
      String expr, @Nullable Node contextNode, @Nullable XPathNSResolver resolver, int type);

  public native @Nullable XPathResult evaluate(
      String expr, @Nullable Node contextNode, @Nullable XPathNSResolver resolver);
