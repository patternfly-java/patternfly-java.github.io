...
public class DOMImplementation {
  public native @Nullable Document createDocument(
      @Nullable String namespaceURI, String publicId, @Nullable DocumentType doctype);

  public native @Nullable Document createDocument(@Nullable String namespaceURI, String publicId);

  public native @Nullable DocumentType createDocumentType(
