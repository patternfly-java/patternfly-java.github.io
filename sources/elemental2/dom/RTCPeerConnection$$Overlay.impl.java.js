...
class $Overlay {
 ...
 /** @final @nodts @return {RTCDataChannel} */
 static m_createDataChannel__$devirt__elemental2_dom_RTCPeerConnection__java_lang_String__elemental2_dom_RTCDataChannelInitInterface___elemental2_dom_RTCDataChannel(/** !RTCPeerConnection */ $thisArg, /** ?string */ label, /** RTCDataChannelInitInterface_ */ dataChannelDict) {
  $Overlay.$clinit();
  return $thisArg.createDataChannel(label, /**@type {?}*/ (Js.m_uncheckedCast__java_lang_Object__java_lang_Object(dataChannelDict)));
 }
 /** @final @nodts @return {RTCDataChannel} */
