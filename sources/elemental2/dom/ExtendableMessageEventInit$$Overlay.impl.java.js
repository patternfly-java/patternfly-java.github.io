...
/** @nodts */
class $Overlay {
 /** @nodts @template T @return {ExtendableMessageEventInit<T>} */
 static m_create__elemental2_dom_ExtendableMessageEventInit() {
  $Overlay.$clinit();
  return /**@type {ExtendableMessageEventInit<T>}*/ (Js.m_uncheckedCast__java_lang_Object__java_lang_Object(/**@type {Object<string, *>}*/ (JsPropertyMap_$Overlay.m_of__jsinterop_base_JsPropertyMap())));
 }
 /** @nodts @template T */
