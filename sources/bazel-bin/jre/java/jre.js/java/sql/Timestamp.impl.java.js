...
class Timestamp extends j_u_Date {
 ...
 static m_valueOf__java_lang_String__java_sql_Timestamp(/** ?string */ s) {
  ...
  if (components.length != 2) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(IllegalArgumentException.$create__java_lang_String('Invalid escape format: ' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(s)));
  }
  ...
  if (hasNanos) {
   ...
   Asserts.$assert__boolean__void(len > 0);
   if (len > 9) {
    throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(IllegalArgumentException.$create__java_lang_String('Invalid escape format: ' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(s)));
   }
   if (len < 9) {
   ...
   try {
    nanos = Integer.m_valueOf__java_lang_String__java_lang_Integer(nanosString).intValue();
   } catch (__$jsexc) {
 ...
 static m_padNine__int__java_lang_String(/** number */ value) {
  ...
  Asserts.$assert__boolean__void(toReturn.m_length__int() == 9);
 ...
 $ctor__java_sql_Timestamp__long__void(/** !$Long */ time) {
  ...
  this.f_nanos__java_sql_Timestamp_ = Math.imul(Primitives.m_narrowLongToInt__long__int($LongUtils.remainder(time, $Long.fromInt(1000))), 1000000);
 }
 ...
 m_setNanos__int__void(/** number */ n) {
  if (n < 0 || n > 999999999) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(IllegalArgumentException.$create__java_lang_String('nanos out of range ' + n));
  }
  this.f_nanos__java_sql_Timestamp_ = n;
  super.m_setTime__long__void($LongUtils.plus($LongUtils.times($LongUtils.divide(this.m_getTime__long(), $Long.fromInt(1000)), $Long.fromInt(1000)), Primitives.m_widenIntToLong__int__long(Primitives.m_coerceDivision__int__int(this.f_nanos__java_sql_Timestamp_ / 1000000))));
 }
 /** @override @nodts */
