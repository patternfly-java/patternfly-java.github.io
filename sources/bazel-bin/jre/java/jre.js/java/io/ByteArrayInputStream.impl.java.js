...
class ByteArrayInputStream extends InputStream {
 ...
 m_read__int() {
  let /** number */ $value;
  return this.f_pos__java_io_ByteArrayInputStream < this.f_count__java_io_ByteArrayInputStream ? this.f_buf__java_io_ByteArrayInputStream[($value = this.f_pos__java_io_ByteArrayInputStream, this.f_pos__java_io_ByteArrayInputStream = this.f_pos__java_io_ByteArrayInputStream + 1 | 0, $value)] & 255 : -1;
 }
 /** @override @nodts @return {number} */
 ...
 m_skip__long__long(/** !$Long */ byteCount) {
  ...
  this.f_pos__java_io_ByteArrayInputStream = $LongUtils.less(Primitives.m_widenIntToLong__int__long(this.f_count__java_io_ByteArrayInputStream - this.f_pos__java_io_ByteArrayInputStream | 0), byteCount) ? this.f_count__java_io_ByteArrayInputStream : Primitives.m_narrowLongToInt__long__int($LongUtils.plus(Primitives.m_widenIntToLong__int__long(this.f_pos__java_io_ByteArrayInputStream), byteCount));
  return Primitives.m_widenIntToLong__int__long(this.f_pos__java_io_ByteArrayInputStream - temp | 0);
 }
 /** @nodts */
 static $clinit() {
  ByteArrayInputStream.$clinit = () =>{};
