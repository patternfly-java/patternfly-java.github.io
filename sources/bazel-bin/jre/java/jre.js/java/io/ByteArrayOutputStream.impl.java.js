...
class ByteArrayOutputStream extends OutputStream {
 ...
 $ctor__java_io_ByteArrayOutputStream__int__void(/** number */ size) {
  ...
  if (size >= 0) {
   ...
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(IllegalArgumentException.$create__java_lang_String('size < 0'));
  }
 }
 /** @override @nodts */
 m_close__void() {
 ...
 m_toString__int__java_lang_String(/** number */ hibyte) {
  ...
  for (let i = 0; i < newBuf.length; i = i + 1 | 0) {
   $Arrays.$set(newBuf, i, Primitives.m_narrowIntToChar__int__int((hibyte & 255) << 8 | this.f_buf__java_io_ByteArrayOutputStream[i] & 255));
  }
 ...
 /** @nodts @return {?string} */
 m_toString__java_nio_charset_Charset__java_lang_String(/** Charset */ charset) {
  return j_l_String.$create__arrayOf_byte__int__int__java_nio_charset_Charset(this.f_buf__java_io_ByteArrayOutputStream, 0, this.f_count__java_io_ByteArrayOutputStream, charset);
 }
 /** @override @nodts */
 ...
 m_write__int__void(/** number */ oneByte) {
  ...
  let /** number */ $value;
  $Arrays.$set(this.f_buf__java_io_ByteArrayOutputStream, ($value = this.f_count__java_io_ByteArrayOutputStream, this.f_count__java_io_ByteArrayOutputStream = this.f_count__java_io_ByteArrayOutputStream + 1 | 0, $value), Primitives.m_narrowIntToByte__int__int(oneByte));
 }
 /** @nodts */
