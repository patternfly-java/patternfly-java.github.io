...
class RoundingMode extends Enum {
 ...
 static m_valueOf__int__java_math_RoundingMode(/** number */ mode) {
  ...
  switch (mode) {
   ...
   default:
    throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(IllegalArgumentException.$create__java_lang_String('Invalid rounding mode'));
  }
 }
 /** @nodts @return {!RoundingMode} */
 static m_valueOf__java_lang_String__java_math_RoundingMode(/** string */ name) {
  ...
  if ($Equality.$same(RoundingMode.f_namesToValuesMap__java_math_RoundingMode_, null)) {
   RoundingMode.f_namesToValuesMap__java_math_RoundingMode_ = (/**@type {Map<?string, !RoundingMode>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(RoundingMode.m_values__arrayOf_java_math_RoundingMode())));
  }
  return /**@type {RoundingMode}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, RoundingMode.f_namesToValuesMap__java_math_RoundingMode_));
 }
 /** @nodts @return {!Array<!RoundingMode>} */
 static m_values__arrayOf_java_math_RoundingMode() {
  RoundingMode.$clinit();
  return /**@type {!Array<!RoundingMode>}*/ ($Arrays.$stampType([RoundingMode.f_UP__java_math_RoundingMode, RoundingMode.f_DOWN__java_math_RoundingMode, RoundingMode.f_CEILING__java_math_RoundingMode, RoundingMode.f_FLOOR__java_math_RoundingMode, RoundingMode.f_HALF_UP__java_math_RoundingMode, RoundingMode.f_HALF_DOWN__java_math_RoundingMode, RoundingMode.f_HALF_EVEN__java_math_RoundingMode, RoundingMode.f_UNNECESSARY__java_math_RoundingMode], RoundingMode));
 }
 /** @nodts */
 static $clinit() {
  RoundingMode.$clinit = () =>{};
