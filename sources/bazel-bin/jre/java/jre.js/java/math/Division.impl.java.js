...
class Division extends j_l_Object {
 ...
 static m_divide__arrayOf_int__int__arrayOf_int__int__arrayOf_int__int__arrayOf_int(/** Array<number> */ quot, /** number */ quotLength, /** Array<number> */ a, /** number */ aLength, /** Array<number> */ b, /** number */ bLength) {
  ...
  while (i >= 0) {
   ...
   if (normA[j] == firstDivisorDigit) {
    ...
    let product = $LongUtils.plus($LongUtils.leftShift($LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(normA[j]), $Long.fromBits(-1, 0) /* 4294967295 */), 32), $LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(normA[j - 1 | 0]), $Long.fromBits(-1, 0) /* 4294967295 */));
    let res = Division.m_divideLongByInt__long__int__long(product, firstDivisorDigit);
    guessDigit = Primitives.m_narrowLongToInt__long__int(res);
    let rem = Primitives.m_narrowLongToInt__long__int($LongUtils.rightShiftSigned(res, 32));
    if (guessDigit != 0) {
     ...
     do {
      ...
      leftHand = $LongUtils.times($LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(guessDigit), $Long.fromBits(-1, 0) /* 4294967295 */), $LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(normB[normBLength - 2 | 0]), $Long.fromBits(-1, 0) /* 4294967295 */));
      rightHand = $LongUtils.plus($LongUtils.leftShift(Primitives.m_widenIntToLong__int__long(rem), 32), $LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(normA[j - 2 | 0]), $Long.fromBits(-1, 0) /* 4294967295 */));
      let longR = $LongUtils.plus($LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(rem), $Long.fromBits(-1, 0) /* 4294967295 */), $LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(firstDivisorDigit), $Long.fromBits(-1, 0) /* 4294967295 */));
      if (Integer.m_numberOfLeadingZeros__int__int(Primitives.m_narrowLongToInt__long__int($LongUtils.rightShiftUnsigned(longR, 32))) < 32) {
       rOverflowed = true;
      } else {
       rem = Primitives.m_narrowLongToInt__long__int(longR);
      }
   ...
   if (guessDigit != 0) {
    ...
    if (borrow != 0) {
     ...
     for (let k = 0; k < normBLength; k = k + 1 | 0) {
      carry = $LongUtils.plus(carry, $LongUtils.plus($LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(normA[j - normBLength + k | 0]), $Long.fromBits(-1, 0) /* 4294967295 */), $LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(normB[k]), $Long.fromBits(-1, 0) /* 4294967295 */)));
      $Arrays.$set(normA, j - normBLength + k | 0, Primitives.m_narrowLongToInt__long__int(carry));
 ...
 static m_divideAndRemainderByInteger__java_math_BigInteger__int__int__arrayOf_java_math_BigInteger(/** BigInteger */ val, /** number */ divisor, /** number */ divisorSign) {
  ...
  if (valLen == 1) {
   let a = $LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(valDigits[0]), $Long.fromBits(-1, 0) /* 4294967295 */);
   let b = $LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(divisor), $Long.fromBits(-1, 0) /* 4294967295 */);
   ...
   return /**@type {!Array<BigInteger>}*/ ($Arrays.$stampType([BigInteger.m_valueOf__long__java_math_BigInteger(quo), BigInteger.m_valueOf__long__java_math_BigInteger(rem)], BigInteger));
  }
  ...
  remainderDigits = (/**@type {!Array<number>}*/ ($Arrays.$stampType([Division.m_divideArrayByInt__arrayOf_int__arrayOf_int__int__int__int(quotientDigits, valDigits, valLen, divisor)], $int)));
  ...
  return /**@type {!Array<BigInteger>}*/ ($Arrays.$stampType([result0, result1], BigInteger));
 }
 /** @nodts @return {number} */
 static m_divideArrayByInt__arrayOf_int__arrayOf_int__int__int__int(/** Array<number> */ dest, /** Array<number> */ src, /** number */ srcLength, /** number */ divisor) {
  ...
  let bLong = $LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(divisor), $Long.fromBits(-1, 0) /* 4294967295 */);
  for (let i = srcLength - 1 | 0; i >= 0; i = i - 1 | 0) {
   let temp = $LongUtils.bitOr($LongUtils.leftShift(rem, 32), $LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(src[i]), $Long.fromBits(-1, 0) /* 4294967295 */));
   let /** !$Long */ quot;
   if ($LongUtils.greaterEquals(temp, $Long.fromInt(0))) {
    ...
    let bPos = Primitives.m_widenIntToLong__int__long(divisor >>> 1 | 0);
   ...
   $Arrays.$set(dest, i, Primitives.m_narrowLongToInt__long__int($LongUtils.bitAnd(quot, $Long.fromBits(-1, 0) /* 4294967295 */)));
  }
  return Primitives.m_narrowLongToInt__long__int(rem);
 }
 /** @nodts @return {!$Long} */
 static m_divideLongByInt__long__int__long(/** !$Long */ a, /** number */ b) {
  ...
  let /** !$Long */ quot;
  let /** !$Long */ rem;
  let bLong = $LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(b), $Long.fromBits(-1, 0) /* 4294967295 */);
  if ($LongUtils.greaterEquals(a, $Long.fromInt(0))) {
   ...
   let bPos = Primitives.m_widenIntToLong__int__long(b >>> 1 | 0);
   quot = $LongUtils.divide(aPos, bPos);
   rem = $LongUtils.remainder(aPos, bPos);
  ...
  if (!doSub) {
   ...
   for (let i = modulusLen - 1 | 0; i >= 0; i = i - 1 | 0) {
    if (res[i] != modulusDigits[i]) {
     doSub = res[i] != 0 && $LongUtils.greater($LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(res[i]), $Long.fromBits(-1, 0) /* 4294967295 */), $LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(modulusDigits[i]), $Long.fromBits(-1, 0) /* 4294967295 */));
     break;
    }
   }
  }
 ...
 static m_modInverseLorencz__java_math_BigInteger__java_math_BigInteger__java_math_BigInteger(/** BigInteger */ a, /** BigInteger */ modulo) {
  ...
  while (!Division.m_isPowerOfTwo__java_math_BigInteger__int__boolean(u, coefU) && !Division.m_isPowerOfTwo__java_math_BigInteger__int__boolean(v, coefV)) {
   ...
   if (v.m_signum__int() == 0 || u.m_signum__int() == 0) {
    throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(ArithmeticException.$create__java_lang_String('BigInteger not invertible.'));
   }
  }
 ...
 static m_multiplyAndSubtract__arrayOf_int__int__arrayOf_int__int__int__int(/** Array<number> */ a, /** number */ start, /** Array<number> */ b, /** number */ bLen, /** number */ c) {
  ...
  for (let i = 0; i < bLen; i = i + 1 | 0) {
   carry0 = Multiplication.m_unsignedMultAddAdd__int__int__int__int__long(b[i], c, Primitives.m_narrowLongToInt__long__int(carry0), 0);
   carry1 = $LongUtils.plus($LongUtils.minus($LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(a[start + i | 0]), $Long.fromBits(-1, 0) /* 4294967295 */), $LongUtils.bitAnd(carry0, $Long.fromBits(-1, 0) /* 4294967295 */)), carry1);
   $Arrays.$set(a, start + i | 0, Primitives.m_narrowLongToInt__long__int(carry1));
   carry1 = $LongUtils.rightShiftSigned(carry1, 32);
   carry0 = $LongUtils.rightShiftUnsigned(carry0, 32);
  }
  carry1 = $LongUtils.plus($LongUtils.minus($LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(a[start + bLen | 0]), $Long.fromBits(-1, 0) /* 4294967295 */), carry0), carry1);
  $Arrays.$set(a, start + bLen | 0, Primitives.m_narrowLongToInt__long__int(carry1));
  return Primitives.m_narrowLongToInt__long__int($LongUtils.rightShiftSigned(carry1, 32));
 }
 /** @nodts @return {BigInteger} */
 ...
 static m_remainderArrayByInt__arrayOf_int__int__int__int(/** Array<number> */ src, /** number */ srcLength, /** number */ divisor) {
  ...
  for (let i = srcLength - 1 | 0; i >= 0; i = i - 1 | 0) {
   let temp = $LongUtils.plus($LongUtils.leftShift(result, 32), $LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(src[i]), $Long.fromBits(-1, 0) /* 4294967295 */));
   let res = Division.m_divideLongByInt__long__int__long(temp, divisor);
   result = Primitives.m_widenIntToLong__int__long(Primitives.m_narrowLongToInt__long__int($LongUtils.rightShiftSigned(res, 32)));
  }
  return Primitives.m_narrowLongToInt__long__int(result);
 }
 /** @nodts @return {BigInteger} */
 ...
 static m_calcN__java_math_BigInteger__int(/** BigInteger */ a) {
  let m0 = $LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(a.f_digits__java_math_BigInteger[0]), $Long.fromBits(-1, 0) /* 4294967295 */);
  ...
  return Primitives.m_narrowLongToInt__long__int($LongUtils.bitAnd(n2, $Long.fromBits(-1, 0) /* 4294967295 */));
 }
 /** @nodts @return {number} */
 ...
 static m_monReduction__arrayOf_int__java_math_BigInteger__int__void(/** Array<number> */ res, /** BigInteger */ modulus, /** number */ n2) {
  ...
  for (let i = 0; i < modulusLen; i = i + 1 | 0) {
   ...
   let m = Primitives.m_narrowLongToInt__long__int(Multiplication.m_unsignedMultAddAdd__int__int__int__int__long(res[i], n2, 0, 0));
   for (let j = 0; j < modulusLen; j = j + 1 | 0) {
    innnerCarry = Multiplication.m_unsignedMultAddAdd__int__int__int__int__long(m, modulusDigits[j], res[i + j | 0], Primitives.m_narrowLongToInt__long__int(innnerCarry));
    $Arrays.$set(res, i + j | 0, Primitives.m_narrowLongToInt__long__int(innnerCarry));
    innnerCarry = $LongUtils.rightShiftUnsigned(innnerCarry, 32);
   }
   outerCarry = $LongUtils.plus(outerCarry, $LongUtils.plus($LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(res[i + modulusLen | 0]), $Long.fromBits(-1, 0) /* 4294967295 */), innnerCarry));
   $Arrays.$set(res, i + modulusLen | 0, Primitives.m_narrowLongToInt__long__int(outerCarry));
   outerCarry = $LongUtils.rightShiftUnsigned(outerCarry, 32);
  }
  $Arrays.$set(res, modulusLen << 1, Primitives.m_narrowLongToInt__long__int(outerCarry));
