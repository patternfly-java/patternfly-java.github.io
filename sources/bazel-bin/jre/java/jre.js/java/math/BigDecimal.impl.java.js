...
class BigDecimal extends j_l_Number {
 ...
 static m_valueOf__double__java_math_BigDecimal(/** number */ val) {
  ...
  if (Double.m_isInfinite__double__boolean(val) || Double.m_isNaN__double__boolean(val)) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(NumberFormatException.$create__java_lang_String('Infinite or NaN'));
  }
 ...
 static m_valueOf__long__java_math_BigDecimal(/** !$Long */ unscaledVal) {
  BigDecimal.$clinit();
  if ($LongUtils.greaterEquals(unscaledVal, $Long.fromInt(0)) && $LongUtils.less(unscaledVal, Primitives.m_widenIntToLong__int__long(BigDecimal.f_BI_SCALED_BY_ZERO_LENGTH__java_math_BigDecimal_))) {
   return BigDecimal.f_BI_SCALED_BY_ZERO__java_math_BigDecimal_[Primitives.m_narrowLongToInt__long__int(unscaledVal)];
  }
 ...
 static m_addAndMult10__java_math_BigDecimal__java_math_BigDecimal__double__java_math_BigDecimal(/** BigDecimal */ thisValue, /** BigDecimal */ augend, /** number */ diffScale) {
  if (diffScale < BigDecimal.f_DOUBLE_TEN_POW__java_math_BigDecimal_.length && (Math.max(thisValue.f_bitLength__java_math_BigDecimal_, augend.f_bitLength__java_math_BigDecimal_ + BigDecimal.f_DOUBLE_TEN_POW_BIT_LENGTH__java_math_BigDecimal_[Primitives.m_narrowDoubleToInt__int__int(diffScale)] | 0) + 1 | 0) < BigDecimal.f_SMALL_VALUE_BITS__java_math_BigDecimal_) {
   return BigDecimal.m_valueOf__double__double__java_math_BigDecimal(thisValue.f_smallValue__java_math_BigDecimal_ + augend.f_smallValue__java_math_BigDecimal_ * BigDecimal.f_DOUBLE_TEN_POW__java_math_BigDecimal_[Primitives.m_narrowDoubleToInt__int__int(diffScale)], thisValue.f_scale__java_math_BigDecimal_);
  }
  return BigDecimal.$create__java_math_BigInteger__double(thisValue.m_getUnscaledValue__java_math_BigInteger_$p_java_math_BigDecimal().m_add__java_math_BigInteger__java_math_BigInteger(Multiplication.m_multiplyByTenPow__java_math_BigInteger__int__java_math_BigInteger(augend.m_getUnscaledValue__java_math_BigInteger_$p_java_math_BigDecimal(), Primitives.m_narrowDoubleToInt__int__int(diffScale))), thisValue.f_scale__java_math_BigDecimal_);
 }
 /** @nodts @return {number} */
 static m_bitLength__double__int(/** number */ value) {
  if (value > - BigDecimal.f_POW47__java_math_BigDecimal_ && value < BigDecimal.f_POW47__java_math_BigDecimal_) {
   ...
   let result = Primitives.m_narrowDoubleToInt__int__int(Math.floor(Math.log(value) / BigDecimal.f_LOG2__java_math_BigDecimal_));
   if (!negative || value != Math.pow(2, result)) {
    result = result + 1 | 0;
   }
   return result;
  }
  return BigDecimal.m_bitLength__long__int(Primitives.m_narrowDoubleToLong__int__long(value));
 }
 /** @nodts @return {number} */
 ...
 static m_divideBigIntegers__java_math_BigInteger__java_math_BigInteger__int__java_math_RoundingMode__java_math_BigDecimal(/** BigInteger */ scaledDividend, /** BigInteger */ scaledDivisor, /** number */ scale, /** RoundingMode */ roundingMode) {
  ...
  if (compRem != 0) {
   if (quotient.m_bitLength__int() < BigDecimal.f_SMALL_VALUE_BITS__java_math_BigDecimal_) {
    return BigDecimal.m_valueOf__long__int__java_math_BigDecimal($LongUtils.plus(quotient.m_longValue__long(), Primitives.m_widenIntToLong__int__long(compRem)), scale);
   }
   quotient = quotient.m_add__java_math_BigInteger__java_math_BigInteger(BigInteger.m_valueOf__long__java_math_BigInteger(Primitives.m_widenIntToLong__int__long(compRem)));
   return BigDecimal.$create__java_math_BigInteger__int(quotient, scale);
  }
  return BigDecimal.$create__java_math_BigInteger__int(quotient, scale);
 }
 ...
 static m_dividePrimitiveDoubles__double__double__int__java_math_RoundingMode__java_math_BigDecimal(/** number */ scaledDividend, /** number */ scaledDivisor, /** number */ scale, /** RoundingMode */ roundingMode) {
  ...
  if (remainder != 0) {
   ...
   quotient += BigDecimal.m_roundingBehavior__int__int__java_math_RoundingMode__int(Primitives.m_narrowDoubleToInt__int__int(quotient) & 1, Math.imul(sign, 5 + compRem), roundingMode);
  }
 ...
 static m_roundingBehavior__int__int__java_math_RoundingMode__int(/** number */ parityBit, /** number */ fraction, /** RoundingMode */ roundingMode) {
  ...
  switch (roundingMode.ordinal()) {
   case RoundingMode.$ordinal_UNNECESSARY__java_math_RoundingMode:
    if (fraction != 0) {
     throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(ArithmeticException.$create__java_lang_String('Rounding necessary'));
    }
    break;
 ...
 static m_toIntScale__double__int(/** number */ doubleScale) {
  if (doubleScale < Integer.f_MIN_VALUE__java_lang_Integer) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(ArithmeticException.$create__java_lang_String('Overflow'));
  } else if (doubleScale > Integer.f_MAX_VALUE__java_lang_Integer) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(ArithmeticException.$create__java_lang_String('Underflow'));
  } else {
   return Primitives.m_narrowDoubleToInt__int__int(doubleScale);
  }
 }
 /** @nodts @return {BigDecimal} */
 ...
 static m_zeroScaledBy__double__java_math_BigDecimal(/** number */ doubleScale) {
  if (doubleScale == Primitives.m_narrowDoubleToInt__int__int(doubleScale)) {
   return BigDecimal.m_valueOf__long__int__java_math_BigDecimal($Long.fromInt(0), Primitives.m_narrowDoubleToInt__int__int(doubleScale));
  }
  if (doubleScale >= 0) {
 ...
 $ctor__java_math_BigDecimal__arrayOf_char__int__int__void(/** Array<number> */ in_1, /** number */ offset, /** number */ len) {
  ...
  try {
   ...
   if (StringIndexOutOfBoundsException.$isInstance(__$exc)) {
    ...
    throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(NumberFormatException.$create__java_lang_String(e.m_getMessage__java_lang_String()));
   } else {
 ...
 $ctor__java_math_BigDecimal__int__void(/** number */ val) {
  this.$ctor__java_math_BigDecimal__long__int__void(Primitives.m_widenIntToLong__int__long(val), 0);
 }
 ...
 $ctor__java_math_BigDecimal__long__int__void(/** !$Long */ smallValue, /** number */ scale) {
  ...
  if (this.f_bitLength__java_math_BigDecimal_ < BigDecimal.f_SMALL_VALUE_BITS__java_math_BigDecimal_) {
   this.f_smallValue__java_math_BigDecimal_ = Primitives.m_widenLongToDouble__long__double(smallValue);
  } else {
 ...
 m_add__java_math_BigDecimal__java_math_MathContext__java_math_BigDecimal(/** BigDecimal */ augend, /** MathContext */ mc) {
  ...
  if (largerSignum == smaller.m_signum__int()) {
   tempBI = Multiplication.m_multiplyByPositiveInt__java_math_BigInteger__int__java_math_BigInteger(larger.m_getUnscaledValue__java_math_BigInteger_$p_java_math_BigDecimal(), 10).m_add__java_math_BigInteger__java_math_BigInteger(BigInteger.m_valueOf__long__java_math_BigInteger(Primitives.m_widenIntToLong__int__long(largerSignum)));
  } else {
   tempBI = larger.m_getUnscaledValue__java_math_BigInteger_$p_java_math_BigDecimal().m_subtract__java_math_BigInteger__java_math_BigInteger(BigInteger.m_valueOf__long__java_math_BigInteger(Primitives.m_widenIntToLong__int__long(largerSignum)));
   tempBI = Multiplication.m_multiplyByPositiveInt__java_math_BigInteger__int__java_math_BigInteger(tempBI, 10).m_add__java_math_BigInteger__java_math_BigInteger(BigInteger.m_valueOf__long__java_math_BigInteger(Primitives.m_widenIntToLong__int__long(Math.imul(largerSignum, 9))));
  }
 ...
 m_byteValueExact__byte() {
  return Primitives.m_narrowLongToByte__long__int(this.m_valueExact__int__long_$p_java_math_BigDecimal(8));
 }
 /** @nodts @return {number} */
 m_compareTo__java_math_BigDecimal__int(/** BigDecimal */ val) {
  ...
  if (thisSign == valueSign) {
   if (this.f_scale__java_math_BigDecimal_ == val.f_scale__java_math_BigDecimal_ && this.f_bitLength__java_math_BigDecimal_ < BigDecimal.f_SMALL_VALUE_BITS__java_math_BigDecimal_ && val.f_bitLength__java_math_BigDecimal_ < BigDecimal.f_SMALL_VALUE_BITS__java_math_BigDecimal_) {
    return this.f_smallValue__java_math_BigDecimal_ < val.f_smallValue__java_math_BigDecimal_ ? -1 : this.f_smallValue__java_math_BigDecimal_ > val.f_smallValue__java_math_BigDecimal_ ? 1 : 0;
   }
 ...
 m_divide__java_math_BigDecimal__java_math_BigDecimal(/** BigDecimal */ divisor) {
  ...
  if (divisor.m_isZero__boolean_$p_java_math_BigDecimal()) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(ArithmeticException.$create__java_lang_String('Division by zero'));
  }
  ...
  if (!q.m_abs__java_math_BigInteger().equals(BigInteger.f_ONE__java_math_BigInteger)) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(ArithmeticException.$create__java_lang_String('Non-terminating decimal expansion; no exact representable decimal result'));
  }
 ...
 m_divide__java_math_BigDecimal__int__java_math_BigDecimal(/** BigDecimal */ divisor, /** number */ roundingMode) {
  return this.m_divide__java_math_BigDecimal__int__java_math_RoundingMode__java_math_BigDecimal(divisor, Primitives.m_narrowDoubleToInt__int__int(this.f_scale__java_math_BigDecimal_), RoundingMode.m_valueOf__int__java_math_RoundingMode(roundingMode));
 }
 /** @nodts @return {BigDecimal} */
 ...
 m_divide__java_math_BigDecimal__int__java_math_RoundingMode__java_math_BigDecimal(/** BigDecimal */ divisor, /** number */ scale, /** RoundingMode */ roundingMode) {
  ...
  if (this.f_bitLength__java_math_BigDecimal_ < BigDecimal.f_SMALL_VALUE_BITS__java_math_BigDecimal_ && divisor.f_bitLength__java_math_BigDecimal_ < BigDecimal.f_SMALL_VALUE_BITS__java_math_BigDecimal_) {
   if (diffScale == 0) {
    ...
    if (diffScale < BigDecimal.f_DOUBLE_TEN_POW__java_math_BigDecimal_.length && (divisor.f_bitLength__java_math_BigDecimal_ + BigDecimal.f_DOUBLE_TEN_POW_BIT_LENGTH__java_math_BigDecimal_[Primitives.m_narrowDoubleToInt__int__int(diffScale)] | 0) < BigDecimal.f_SMALL_VALUE_BITS__java_math_BigDecimal_) {
     return BigDecimal.m_dividePrimitiveDoubles__double__double__int__java_math_RoundingMode__java_math_BigDecimal(this.f_smallValue__java_math_BigDecimal_, divisor.f_smallValue__java_math_BigDecimal_ * BigDecimal.f_DOUBLE_TEN_POW__java_math_BigDecimal_[Primitives.m_narrowDoubleToInt__int__int(diffScale)], scale, roundingMode);
    }
   } else {
    if (- diffScale < BigDecimal.f_DOUBLE_TEN_POW__java_math_BigDecimal_.length && (this.f_bitLength__java_math_BigDecimal_ + BigDecimal.f_DOUBLE_TEN_POW_BIT_LENGTH__java_math_BigDecimal_[Primitives.m_narrowDoubleToInt__int__int(- diffScale)] | 0) < BigDecimal.f_SMALL_VALUE_BITS__java_math_BigDecimal_) {
     return BigDecimal.m_dividePrimitiveDoubles__double__double__int__java_math_RoundingMode__java_math_BigDecimal(this.f_smallValue__java_math_BigDecimal_ * BigDecimal.f_DOUBLE_TEN_POW__java_math_BigDecimal_[Primitives.m_narrowDoubleToInt__int__int(- diffScale)], divisor.f_smallValue__java_math_BigDecimal_, scale, roundingMode);
    }
   }
  }
  ...
  if (diffScale > 0) {
   scaledDivisor = Multiplication.m_multiplyByTenPow__java_math_BigInteger__int__java_math_BigInteger(scaledDivisor, Primitives.m_narrowDoubleToInt__int__int(diffScale));
  } else if (diffScale < 0) {
   scaledDividend = Multiplication.m_multiplyByTenPow__java_math_BigInteger__int__java_math_BigInteger(scaledDividend, Primitives.m_narrowDoubleToInt__int__int(- diffScale));
  }
 ...
 m_divide__java_math_BigDecimal__java_math_MathContext__java_math_BigDecimal(/** BigDecimal */ divisor, /** MathContext */ mc) {
  let traillingZeros = Primitives.m_widenLongToDouble__long__double($LongUtils.plus(Primitives.m_widenIntToLong__int__long(mc.m_getPrecision__int()), $Long.fromInt(2))) + divisor.m_approxPrecision__double_$p_java_math_BigDecimal() - this.m_approxPrecision__double_$p_java_math_BigDecimal();
  let diffScale = this.f_scale__java_math_BigDecimal_ - divisor.f_scale__java_math_BigDecimal_;
  ...
  let quotAndRem = /**@type {!Array<BigInteger>}*/ ($Arrays.$stampType([this.m_getUnscaledValue__java_math_BigInteger_$p_java_math_BigDecimal()], BigInteger));
  ...
  if (quotAndRem[1].m_signum__int() != 0) {
   ...
   integerQuot = integerQuot.m_multiply__java_math_BigInteger__java_math_BigInteger(BigInteger.f_TEN__java_math_BigInteger).m_add__java_math_BigInteger__java_math_BigInteger(BigInteger.m_valueOf__long__java_math_BigInteger(Primitives.m_widenIntToLong__int__long(Math.imul(quotAndRem[0].m_signum__int(), 5 + compRem))));
   newScale++;
  } else {
 ...
 m_divide__java_math_BigDecimal__java_math_RoundingMode__java_math_BigDecimal(/** BigDecimal */ divisor, /** RoundingMode */ roundingMode) {
  return this.m_divide__java_math_BigDecimal__int__java_math_RoundingMode__java_math_BigDecimal(divisor, Primitives.m_narrowDoubleToInt__int__int(this.f_scale__java_math_BigDecimal_), roundingMode);
 }
 ...
 m_divideToIntegralValue__java_math_BigDecimal__java_math_MathContext__java_math_BigDecimal(/** BigDecimal */ divisor, /** MathContext */ mc) {
  ...
  if (quotPrecision <= 0) {
   ...
   if (quotAndRem[1].m_signum__int() != 0 && exp > 0) {
    ...
    if (compRemDiv > 0) {
     throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(ArithmeticException.$create__java_lang_String('Division impossible'));
    }
   }
  }
 ...
 m_floatValue__float() {
  ...
  if (powerOfTwo < -149 || floatResult == 0) {
   floatResult *= 0;
 ...
 hashCode() {
  ...
  if (this.f_bitLength__java_math_BigDecimal_ < BigDecimal.f_SMALL_VALUE_BITS__java_math_BigDecimal_) {
   let longValue = Primitives.m_narrowDoubleToLong__int__long(this.f_smallValue__java_math_BigDecimal_);
   this.f_hashCode__java_math_BigDecimal_ = Primitives.m_narrowLongToInt__long__int($LongUtils.bitAnd(longValue, $Long.fromInt(-1)));
   this.f_hashCode__java_math_BigDecimal_ = Math.imul(33, this.f_hashCode__java_math_BigDecimal_) + Primitives.m_narrowLongToInt__long__int($LongUtils.bitAnd($LongUtils.rightShiftSigned(longValue, 32), $Long.fromInt(-1))) | 0;
   this.f_hashCode__java_math_BigDecimal_ = Math.imul(17, this.f_hashCode__java_math_BigDecimal_) + Primitives.m_narrowDoubleToInt__int__int(this.f_scale__java_math_BigDecimal_) | 0;
   return this.f_hashCode__java_math_BigDecimal_;
  }
  this.f_hashCode__java_math_BigDecimal_ = Math.imul(17, this.f_intVal__java_math_BigDecimal_.hashCode()) + Primitives.m_narrowDoubleToInt__int__int(this.f_scale__java_math_BigDecimal_) | 0;
  return this.f_hashCode__java_math_BigDecimal_;
 }
 /** @override @nodts @return {number} */
 m_intValue__int() {
  return this.f_scale__java_math_BigDecimal_ <= -32 || this.f_scale__java_math_BigDecimal_ > this.m_approxPrecision__double_$p_java_math_BigDecimal() ? 0 : this.m_toBigInteger__java_math_BigInteger().m_intValue__int();
 }
 /** @nodts @return {number} */
 m_intValueExact__int() {
  return Primitives.m_narrowLongToInt__long__int(this.m_valueExact__int__long_$p_java_math_BigDecimal(32));
 }
 /** @override @nodts @return {!$Long} */
 m_longValue__long() {
  return this.f_scale__java_math_BigDecimal_ <= -64 || this.f_scale__java_math_BigDecimal_ > this.m_approxPrecision__double_$p_java_math_BigDecimal() ? $Long.fromInt(0) : this.m_toBigInteger__java_math_BigInteger().m_longValue__long();
 }
 /** @nodts @return {!$Long} */
 ...
 m_pow__int__java_math_BigDecimal(/** number */ n) {
  ...
  if (n < 0 || n > 999999999) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(ArithmeticException.$create__java_lang_String('Invalid Operation'));
  }
 ...
 m_pow__int__java_math_MathContext__java_math_BigDecimal(/** number */ n, /** MathContext */ mc) {
  ...
  let mcPrecision = mc.m_getPrecision__int();
  let elength = Primitives.m_narrowDoubleToInt__int__int(Math.log10(m)) + 1 | 0;
 ...
 m_precision__int() {
  ...
  this.f_precision__java_math_BigDecimal_ = Primitives.m_narrowDoubleToInt__int__int(decimalDigits);
  return this.f_precision__java_math_BigDecimal_;
 }
 /** @nodts @return {BigDecimal} */
 ...
 /** @nodts @return {number} */
 m_scale__int() {
  return Primitives.m_narrowDoubleToInt__int__int(this.f_scale__java_math_BigDecimal_);
 }
 /** @nodts @return {BigDecimal} */
 ...
 m_setScale__int__java_math_RoundingMode__java_math_BigDecimal(/** number */ newScale, /** RoundingMode */ roundingMode) {
  ...
  if (diffScale > 0) {
   if (diffScale < BigDecimal.f_DOUBLE_TEN_POW__java_math_BigDecimal_.length && (this.f_bitLength__java_math_BigDecimal_ + BigDecimal.f_DOUBLE_TEN_POW_BIT_LENGTH__java_math_BigDecimal_[Primitives.m_narrowDoubleToInt__int__int(diffScale)] | 0) < BigDecimal.f_SMALL_VALUE_BITS__java_math_BigDecimal_) {
    return BigDecimal.m_valueOf__double__double__java_math_BigDecimal(this.f_smallValue__java_math_BigDecimal_ * BigDecimal.f_DOUBLE_TEN_POW__java_math_BigDecimal_[Primitives.m_narrowDoubleToInt__int__int(diffScale)], newScale);
   }
   return BigDecimal.$create__java_math_BigInteger__int(Multiplication.m_multiplyByTenPow__java_math_BigInteger__int__java_math_BigInteger(this.m_getUnscaledValue__java_math_BigInteger_$p_java_math_BigDecimal(), Primitives.m_narrowDoubleToInt__int__int(diffScale)), newScale);
  }
  if (this.f_bitLength__java_math_BigDecimal_ < BigDecimal.f_SMALL_VALUE_BITS__java_math_BigDecimal_ && - diffScale < BigDecimal.f_DOUBLE_TEN_POW__java_math_BigDecimal_.length) {
   return BigDecimal.m_dividePrimitiveDoubles__double__double__int__java_math_RoundingMode__java_math_BigDecimal(this.f_smallValue__java_math_BigDecimal_, BigDecimal.f_DOUBLE_TEN_POW__java_math_BigDecimal_[Primitives.m_narrowDoubleToInt__int__int(- diffScale)], newScale, roundingMode);
  }
 ...
 m_shortValueExact__short() {
  return Primitives.m_narrowLongToShort__long__int(this.m_valueExact__int__long_$p_java_math_BigDecimal(16));
 }
 /** @nodts @return {number} */
 m_signum__int() {
  if (this.f_bitLength__java_math_BigDecimal_ < BigDecimal.f_SMALL_VALUE_BITS__java_math_BigDecimal_) {
   return this.f_smallValue__java_math_BigDecimal_ < 0 ? -1 : this.f_smallValue__java_math_BigDecimal_ > 0 ? 1 : 0;
  }
 ...
 m_subtract__java_math_BigDecimal__java_math_BigDecimal(/** BigDecimal */ subtrahend) {
  ...
  if (diffScale == 0) {
   ...
   if (diffScale < BigDecimal.f_DOUBLE_TEN_POW__java_math_BigDecimal_.length && (Math.max(this.f_bitLength__java_math_BigDecimal_, subtrahend.f_bitLength__java_math_BigDecimal_ + BigDecimal.f_DOUBLE_TEN_POW_BIT_LENGTH__java_math_BigDecimal_[Primitives.m_narrowDoubleToInt__int__int(diffScale)] | 0) + 1 | 0) < BigDecimal.f_SMALL_VALUE_BITS__java_math_BigDecimal_) {
    return BigDecimal.m_valueOf__double__double__java_math_BigDecimal(this.f_smallValue__java_math_BigDecimal_ - subtrahend.f_smallValue__java_math_BigDecimal_ * BigDecimal.f_DOUBLE_TEN_POW__java_math_BigDecimal_[Primitives.m_narrowDoubleToInt__int__int(diffScale)], this.f_scale__java_math_BigDecimal_);
   }
   return BigDecimal.$create__java_math_BigInteger__double(this.m_getUnscaledValue__java_math_BigInteger_$p_java_math_BigDecimal().m_subtract__java_math_BigInteger__java_math_BigInteger(Multiplication.m_multiplyByTenPow__java_math_BigInteger__int__java_math_BigInteger(subtrahend.m_getUnscaledValue__java_math_BigInteger_$p_java_math_BigDecimal(), Primitives.m_narrowDoubleToInt__int__int(diffScale))), this.f_scale__java_math_BigDecimal_);
  } else {
   diffScale = - diffScale;
   if (diffScale < BigDecimal.f_DOUBLE_TEN_POW__java_math_BigDecimal_.length && (Math.max(this.f_bitLength__java_math_BigDecimal_ + BigDecimal.f_DOUBLE_TEN_POW_BIT_LENGTH__java_math_BigDecimal_[Primitives.m_narrowDoubleToInt__int__int(diffScale)] | 0, subtrahend.f_bitLength__java_math_BigDecimal_) + 1 | 0) < BigDecimal.f_SMALL_VALUE_BITS__java_math_BigDecimal_) {
    return BigDecimal.m_valueOf__double__double__java_math_BigDecimal(this.f_smallValue__java_math_BigDecimal_ * BigDecimal.f_DOUBLE_TEN_POW__java_math_BigDecimal_[Primitives.m_narrowDoubleToInt__int__int(diffScale)] - subtrahend.f_smallValue__java_math_BigDecimal_, subtrahend.f_scale__java_math_BigDecimal_);
   }
   return BigDecimal.$create__java_math_BigInteger__double(Multiplication.m_multiplyByTenPow__java_math_BigInteger__int__java_math_BigInteger(this.m_getUnscaledValue__java_math_BigInteger_$p_java_math_BigDecimal(), Primitives.m_narrowDoubleToInt__int__int(diffScale)).m_subtract__java_math_BigInteger__java_math_BigInteger(subtrahend.m_getUnscaledValue__java_math_BigInteger_$p_java_math_BigDecimal()), subtrahend.f_scale__java_math_BigDecimal_);
  }
 }
 /** @nodts @return {BigDecimal} */
  ...
  if (subtrahend.m_approxPrecision__double_$p_java_math_BigDecimal() < diffScale - 1) {
   if (mc.m_getPrecision__int() < this.m_approxPrecision__double_$p_java_math_BigDecimal()) {
    ...
    if (thisSignum != subtrahend.m_signum__int()) {
     tempBI = Multiplication.m_multiplyByPositiveInt__java_math_BigInteger__int__java_math_BigInteger(this.m_getUnscaledValue__java_math_BigInteger_$p_java_math_BigDecimal(), 10).m_add__java_math_BigInteger__java_math_BigInteger(BigInteger.m_valueOf__long__java_math_BigInteger(Primitives.m_widenIntToLong__int__long(thisSignum)));
    } else {
     tempBI = this.m_getUnscaledValue__java_math_BigInteger_$p_java_math_BigDecimal().m_subtract__java_math_BigInteger__java_math_BigInteger(BigInteger.m_valueOf__long__java_math_BigInteger(Primitives.m_widenIntToLong__int__long(thisSignum)));
     tempBI = Multiplication.m_multiplyByPositiveInt__java_math_BigInteger__int__java_math_BigInteger(tempBI, 10).m_add__java_math_BigInteger__java_math_BigInteger(BigInteger.m_valueOf__long__java_math_BigInteger(Primitives.m_widenIntToLong__int__long(Math.imul(thisSignum, 9))));
    }
 ...
 m_toEngineeringString__java_lang_String() {
  ...
  if (this.f_scale__java_math_BigDecimal_ > 0 && exponent >= -6) {
   if (exponent >= 0) {
    result.m_insert__int__char__java_lang_StringBuilder(end - Primitives.m_narrowDoubleToInt__int__int(this.f_scale__java_math_BigDecimal_) | 0, 46 /* '.' */);
   } else {
    result.m_insert__int__java_lang_String__java_lang_StringBuilder(begin - 1 | 0, '0.');
    result.m_insert__int__arrayOf_char__int__int__java_lang_StringBuilder(begin + 1 | 0, BigDecimal.f_CH_ZEROS__java_math_BigDecimal_, 0, - Primitives.m_narrowDoubleToInt__int__int(exponent) - 1 | 0);
   }
  } else {
   let delta = end - begin | 0;
   let rem = Primitives.m_narrowDoubleToInt__int__int(exponent % 3);
   if (rem != 0) {
   ...
   if (exponent != 0) {
    ...
    result.m_insert__int__java_lang_String__java_lang_StringBuilder(end = end + 1 | 0, Long.m_toString__long__java_lang_String(Primitives.m_narrowDoubleToLong__int__long(exponent)));
   }
  }
 ...
 m_toPlainString__java_lang_String() {
  ...
  let result = StringBuilder.$create__int(j_l_String.m_length__java_lang_String__int(intStr) + 1 + j_l_Math.m_abs__int__int(Primitives.m_narrowDoubleToInt__int__int(this.f_scale__java_math_BigDecimal_)) | 0);
  if (begin == 1) {
  ...
  if (this.f_scale__java_math_BigDecimal_ > 0) {
   ...
   if (delta >= 0) {
    ...
    result.m_append__arrayOf_char__int__int__java_lang_StringBuilder(BigDecimal.f_CH_ZEROS__java_math_BigDecimal_, 0, Primitives.m_narrowDoubleToInt__int__int(delta));
    ...
    delta = begin - delta;
    result.m_append__java_lang_String__java_lang_StringBuilder(j_l_String.m_substring__java_lang_String__int__int__java_lang_String(intStr, begin, Primitives.m_narrowDoubleToInt__int__int(delta)));
    result.m_append__char__java_lang_StringBuilder(46 /* '.' */);
    result.m_append__java_lang_String__java_lang_StringBuilder(j_l_String.m_substring__java_lang_String__int__java_lang_String(intStr, Primitives.m_narrowDoubleToInt__int__int(delta)));
   }
  } else {
   result.m_append__java_lang_String__java_lang_StringBuilder(j_l_String.m_substring__java_lang_String__int__java_lang_String(intStr, begin));
 ...
 toString() {
  ...
  if (this.f_bitLength__java_math_BigDecimal_ < 32) {
   this.f_toStringImage__java_math_BigDecimal_ = Conversion.m_toDecimalScaledString__long__int__java_lang_String(Primitives.m_narrowDoubleToLong__int__long(this.f_smallValue__java_math_BigDecimal_), Primitives.m_narrowDoubleToInt__int__int(this.f_scale__java_math_BigDecimal_));
   return this.f_toStringImage__java_math_BigDecimal_;
  }
  let intString = this.m_getUnscaledValue__java_math_BigInteger_$p_java_math_BigDecimal().toString();
  if (this.f_scale__java_math_BigDecimal_ == 0) {
 ...
 m_getUnscaledValue__java_math_BigInteger_$p_java_math_BigDecimal() {
  if ($Equality.$same(this.f_intVal__java_math_BigDecimal_, null)) {
   this.f_intVal__java_math_BigDecimal_ = BigInteger.m_valueOf__long__java_math_BigInteger(Primitives.m_narrowDoubleToLong__int__long(this.f_smallValue__java_math_BigDecimal_));
  }
 ...
 m_initFrom__java_lang_String__void_$p_java_math_BigDecimal(/** ?string */ val) {
  ...
  if (offset < last && j_l_String.m_charAt__java_lang_String__int__char(val, offset) == 43 /* '+' */) {
   ...
   if (offset < last && (j_l_String.m_charAt__java_lang_String__int__char(val, offset) == 43 /* '+' */ || j_l_String.m_charAt__java_lang_String__int__char(val, offset) == 45 /* '-' */)) {
    throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(NumberFormatException.$create__java_lang_String('For input string: \"' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(val) + '\"'));
   }
  }
  ...
  if (offset < last && (j_l_String.m_charAt__java_lang_String__int__char(val, offset) == 101 /* 'e' */ || j_l_String.m_charAt__java_lang_String__int__char(val, offset) == 69 /* 'E' */)) {
   ...
   if (this.f_scale__java_math_BigDecimal_ != Primitives.m_narrowDoubleToInt__int__int(this.f_scale__java_math_BigDecimal_)) {
    throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(NumberFormatException.$create__java_lang_String('Exponent overflow.'));
   }
  }
 ...
 m_inplaceRound__java_math_MathContext__void_$p_java_math_BigDecimal(/** MathContext */ mc) {
  ...
  if (integerAndFraction[1].m_signum__int() != 0) {
   ...
   if (compRem != 0) {
    $Arrays.$set(integerAndFraction, 0, integerAndFraction[0].m_add__java_math_BigInteger__java_math_BigInteger(BigInteger.m_valueOf__long__java_math_BigInteger(Primitives.m_widenIntToLong__int__long(compRem))));
   }
 ...
 m_isZero__boolean_$p_java_math_BigDecimal() {
  return this.f_bitLength__java_math_BigDecimal_ == 0 && this.f_smallValue__java_math_BigDecimal_ != -1;
 }
 /** @nodts @return {BigDecimal} */
 m_movePoint__double__java_math_BigDecimal_$p_java_math_BigDecimal(/** number */ newScale) {
  ...
  if (- newScale < BigDecimal.f_DOUBLE_TEN_POW__java_math_BigDecimal_.length && (this.f_bitLength__java_math_BigDecimal_ + BigDecimal.f_DOUBLE_TEN_POW_BIT_LENGTH__java_math_BigDecimal_[Primitives.m_narrowDoubleToInt__int__int(- newScale)] | 0) < BigDecimal.f_SMALL_VALUE_BITS__java_math_BigDecimal_) {
   return BigDecimal.m_valueOf__double__double__java_math_BigDecimal(this.f_smallValue__java_math_BigDecimal_ * BigDecimal.f_DOUBLE_TEN_POW__java_math_BigDecimal_[Primitives.m_narrowDoubleToInt__int__int(- newScale)], 0);
  }
  return BigDecimal.$create__java_math_BigInteger__int(Multiplication.m_multiplyByTenPow__java_math_BigInteger__int__java_math_BigInteger(this.m_getUnscaledValue__java_math_BigInteger_$p_java_math_BigDecimal(), Primitives.m_narrowDoubleToInt__int__int(- newScale)), 0);
 }
 /** @nodts */
 m_setUnscaledValue__java_math_BigInteger__void_$p_java_math_BigDecimal(/** BigInteger */ unscaledValue) {
  ...
  if (this.f_bitLength__java_math_BigDecimal_ < BigDecimal.f_SMALL_VALUE_BITS__java_math_BigDecimal_) {
   this.f_smallValue__java_math_BigDecimal_ = Primitives.m_widenLongToDouble__long__double(unscaledValue.m_longValue__long());
  }
 }
 /** @nodts */
 m_smallRound__java_math_MathContext__int__void_$p_java_math_BigDecimal(/** MathContext */ mc, /** number */ discardedPrecision) {
  let sizeOfFraction = Primitives.m_narrowDoubleToLong__int__long(BigDecimal.f_DOUBLE_TEN_POW__java_math_BigDecimal_[discardedPrecision]);
  let newScale = $LongUtils.minus(Primitives.m_narrowDoubleToLong__int__long(this.f_scale__java_math_BigDecimal_), Primitives.m_widenIntToLong__int__long(discardedPrecision));
  let unscaledVal = Primitives.m_narrowDoubleToLong__int__long(this.f_smallValue__java_math_BigDecimal_);
  ...
  if ($LongUtils.notEquals(fraction, $Long.fromInt(0))) {
   ...
   integer = $LongUtils.plus(integer, Primitives.m_widenIntToLong__int__long(BigDecimal.m_roundingBehavior__int__int__java_math_RoundingMode__int(Primitives.m_narrowLongToInt__long__int(integer) & 1, Math.imul(Long.m_signum__long__int(fraction), 5 + compRem), mc.m_getRoundingMode__java_math_RoundingMode())));
   if (Math.log10(Primitives.m_widenLongToDouble__long__double(j_l_Math.m_abs__long__long(integer))) >= mc.m_getPrecision__int()) {
    integer = $LongUtils.divide(integer, $Long.fromInt(10));
    newScale = $LongUtils.minus(newScale, $Long.fromInt(1));
   }
  }
  this.f_scale__java_math_BigDecimal_ = BigDecimal.m_toIntScale__double__int(Primitives.m_widenLongToDouble__long__double(newScale));
  this.f_precision__java_math_BigDecimal_ = mc.m_getPrecision__int();
  this.f_smallValue__java_math_BigDecimal_ = Primitives.m_widenLongToDouble__long__double(integer);
 ...
 /** @nodts @return {BigDecimal} */
 static get f_TWO__java_math_BigDecimal() {
  return (BigDecimal.$clinit(), BigDecimal.$static_TWO__java_math_BigDecimal);
 }
 /** @nodts @return {BigDecimal} */
 ...
 static $clinit() {
  ...
  BigDecimal.$static_TWO__java_math_BigDecimal = BigDecimal.$create__long__int($Long.fromInt(2), 0);
  ...
  BigDecimal.f_DOUBLE_TEN_POW__java_math_BigDecimal_ = (/**@type {!Array<number>}*/ ($Arrays.$stampType([1, 10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000, 1000000000, 1.0E10, 1.0E11, 1.0E12, 1.0E13, 1.0E14, 1.0E15, 1.0E16], $double)));
  ...
  for (; i < BigDecimal.f_ZERO_SCALED_BY__java_math_BigDecimal_.length; i = i + 1 | 0) {
   $Arrays.$set(BigDecimal.f_BI_SCALED_BY_ZERO__java_math_BigDecimal_, i, BigDecimal.$create__long__int(Primitives.m_widenIntToLong__int__long(i), 0));
...
/**@private {BigDecimal} @nodts*/
BigDecimal.$static_TWO__java_math_BigDecimal;
/**@private {BigDecimal} @nodts*/
