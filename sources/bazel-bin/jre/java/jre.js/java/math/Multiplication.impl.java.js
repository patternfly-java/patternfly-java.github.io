...
class Multiplication extends j_l_Object {
 ...
 static m_multiplyByPositiveInt__java_math_BigInteger__int__java_math_BigInteger(/** BigInteger */ val, /** number */ factor) {
  ...
  if (aNumberLength == 1) {
   ...
   let resLo = Primitives.m_narrowLongToInt__long__int(res);
   let resHi = Primitives.m_narrowLongToInt__long__int($LongUtils.rightShiftUnsigned(res, 32));
   return resHi == 0 ? BigInteger.$create__int__int(resSign, resLo) : BigInteger.$create__int__int__arrayOf_int(resSign, 2, /**@type {!Array<number>}*/ ($Arrays.$stampType([resLo, resHi], $int)));
  }
 ...
 static m_multiplyPAP__java_math_BigInteger__java_math_BigInteger__java_math_BigInteger(/** BigInteger */ a, /** BigInteger */ b) {
  ...
  let resSign = a.f_sign__java_math_BigInteger != b.f_sign__java_math_BigInteger ? -1 : 1;
  if (resLength == 2) {
   ...
   let valueLo = Primitives.m_narrowLongToInt__long__int(val);
   let valueHi = Primitives.m_narrowLongToInt__long__int($LongUtils.rightShiftUnsigned(val, 32));
   return valueHi == 0 ? BigInteger.$create__int__int(resSign, valueLo) : BigInteger.$create__int__int__arrayOf_int(resSign, 2, /**@type {!Array<number>}*/ ($Arrays.$stampType([valueLo, valueHi], $int)));
  }
 ...
 static m_multPAP__arrayOf_int__arrayOf_int__arrayOf_int__int__int__void(/** Array<number> */ a, /** Array<number> */ b, /** Array<number> */ t, /** number */ aLen, /** number */ bLen) {
  ...
  for (let i = 0; i < aLen; i = i + 1 | 0) {
   ...
   for (let j = 0; j < bLen; j = j + 1 | 0) {
    carry = Multiplication.m_unsignedMultAddAdd__int__int__int__int__long(aI, b[j], t[i + j | 0], Primitives.m_narrowLongToInt__long__int(carry));
    $Arrays.$set(t, i + j | 0, Primitives.m_narrowLongToInt__long__int(carry));
    carry = $LongUtils.rightShiftUnsigned(carry, 32);
   }
   $Arrays.$set(t, i + bLen | 0, Primitives.m_narrowLongToInt__long__int(carry));
  }
 }
 /** @nodts @return {BigInteger} */
 ...
 static m_powerOf10__double__java_math_BigInteger(/** number */ exp) {
  Multiplication.$clinit();
  let intExp = Primitives.m_narrowDoubleToInt__int__int(exp);
  ...
  if (exp > 1000000) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(ArithmeticException.$create__java_lang_String('power of ten too big'));
  }
  ...
  let res = powerOfFive;
  let longExp = Primitives.m_narrowDoubleToLong__int__long(exp - Integer.f_MAX_VALUE__java_lang_Integer);
  intExp = Primitives.m_narrowDoubleToInt__int__int(exp % Integer.f_MAX_VALUE__java_lang_Integer);
  while ($LongUtils.greater(longExp, Primitives.m_widenIntToLong__int__long(Integer.f_MAX_VALUE__java_lang_Integer))) {
   res = res.m_multiply__java_math_BigInteger__java_math_BigInteger(powerOfFive);
   longExp = $LongUtils.minus(longExp, Primitives.m_widenIntToLong__int__long(Integer.f_MAX_VALUE__java_lang_Integer));
  }
  ...
  longExp = Primitives.m_narrowDoubleToLong__int__long(exp - Integer.f_MAX_VALUE__java_lang_Integer);
  while ($LongUtils.greater(longExp, Primitives.m_widenIntToLong__int__long(Integer.f_MAX_VALUE__java_lang_Integer))) {
   res = res.m_shiftLeft__int__java_math_BigInteger(Integer.f_MAX_VALUE__java_lang_Integer);
   longExp = $LongUtils.minus(longExp, Primitives.m_widenIntToLong__int__long(Integer.f_MAX_VALUE__java_lang_Integer));
  }
 ...
 static m_square__arrayOf_int__int__arrayOf_int__arrayOf_int(/** Array<number> */ a, /** number */ aLen, /** Array<number> */ res) {
  ...
  for (let i = 0; i < aLen; i = i + 1 | 0) {
   ...
   for (let j = i + 1 | 0; j < aLen; j = j + 1 | 0) {
    carry = Multiplication.m_unsignedMultAddAdd__int__int__int__int__long(a[i], a[j], res[i + j | 0], Primitives.m_narrowLongToInt__long__int(carry));
    $Arrays.$set(res, i + j | 0, Primitives.m_narrowLongToInt__long__int(carry));
    carry = $LongUtils.rightShiftUnsigned(carry, 32);
   }
   $Arrays.$set(res, i + aLen | 0, Primitives.m_narrowLongToInt__long__int(carry));
  }
  ...
  for (let i_1 = 0, index = 0; i_1 < aLen; i_1 = i_1 + 1 | 0, index = index + 1 | 0) {
   carry = Multiplication.m_unsignedMultAddAdd__int__int__int__int__long(a[i_1], a[i_1], res[index], Primitives.m_narrowLongToInt__long__int(carry));
   $Arrays.$set(res, index, Primitives.m_narrowLongToInt__long__int(carry));
   carry = $LongUtils.rightShiftUnsigned(carry, 32);
   index = index + 1 | 0;
   carry = $LongUtils.plus(carry, $LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(res[index]), $Long.fromBits(-1, 0) /* 4294967295 */));
   $Arrays.$set(res, index, Primitives.m_narrowLongToInt__long__int(carry));
   carry = $LongUtils.rightShiftUnsigned(carry, 32);
  }
  return res;
 ...
 static m_unsignedMultAddAdd__int__int__int__int__long(/** number */ a, /** number */ b, /** number */ c, /** number */ d) {
  Multiplication.$clinit();
  return $LongUtils.plus($LongUtils.plus($LongUtils.times($LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(a), $Long.fromBits(-1, 0) /* 4294967295 */), $LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(b), $Long.fromBits(-1, 0) /* 4294967295 */)), $LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(c), $Long.fromBits(-1, 0) /* 4294967295 */)), $LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(d), $Long.fromBits(-1, 0) /* 4294967295 */));
 }
 /** @nodts @return {number} */
 static m_multiplyByInt__arrayOf_int__arrayOf_int__int__int__int(/** Array<number> */ res, /** Array<number> */ a, /** number */ aSize, /** number */ factor) {
  ...
  for (let i = 0; i < aSize; i = i + 1 | 0) {
   carry = Multiplication.m_unsignedMultAddAdd__int__int__int__int__long(a[i], factor, Primitives.m_narrowLongToInt__long__int(carry), 0);
   $Arrays.$set(res, i, Primitives.m_narrowLongToInt__long__int(carry));
   carry = $LongUtils.rightShiftUnsigned(carry, 32);
  }
  return Primitives.m_narrowLongToInt__long__int(carry);
 }
 ...
 static $clinit() {
  ...
  Multiplication.$static_fivePows__java_math_Multiplication = (/**@type {!Array<number>}*/ ($Arrays.$stampType([1, 5, 25, 125, 625, 3125, 15625, 78125, 390625, 1953125, 9765625, 48828125, 244140625, 1220703125], $int)));
  Multiplication.$static_tenPows__java_math_Multiplication = (/**@type {!Array<number>}*/ ($Arrays.$stampType([1, 10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000, 1000000000], $int)));
  let /** number */ i;
