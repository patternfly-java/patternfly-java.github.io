...
class BigInteger extends Number {
 ...
 static m_fromBits__long__java_math_BigInteger(/** !$Long */ bits) {
  let lowBits = Primitives.m_narrowLongToInt__long__int(bits);
 ...
 static m_setFromString__java_math_BigInteger__java_lang_String__int__void(/** BigInteger */ bi, /** ?string */ val, /** number */ radix) {
  ...
  let bigRadixDigitsLength = Primitives.m_coerceDivision__int__int(stringLength / charsPerInt);
  let topChars = Primitives.m_coerceDivision__int__int(stringLength % charsPerInt);
  if (topChars != 0) {
 ...
 $ctor__java_math_BigInteger__arrayOf_byte__void(/** Array<number> */ val) {
  ...
  if (val.length == 0) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(NumberFormatException.$create__java_lang_String('Zero length BigInteger'));
  }
  if (val[0] < 0) {
 ...
 $ctor__java_math_BigInteger__int__arrayOf_byte__void(/** number */ signum, /** Array<number> */ magnitude) {
  ...
  if (signum < -1 || signum > 1) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(NumberFormatException.$create__java_lang_String('Invalid signum value'));
  }
  if (signum == 0) {
   for (let $array = magnitude, $index = 0; $index < $array.length; $index++) {
    ...
    {
     if (element != 0) {
      throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(NumberFormatException.$create__java_lang_String('signum-magnitude mismatch'));
     }
    }
   }
  }
  if (magnitude.length == 0) {
   ...
   this.f_digits__java_math_BigInteger = (/**@type {!Array<number>}*/ ($Arrays.$stampType([0], $int)));
  } else {
 ...
 $ctor__java_math_BigInteger__int__int__java_util_Random__void(/** number */ bitLength, /** number */ certainty, /** Random */ rnd) {
  ...
  this.$init__void_$p_java_math_BigInteger();
  if (bitLength < 2) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(ArithmeticException.$create__java_lang_String('bitLength < 2'));
  }
 ...
 $ctor__java_math_BigInteger__java_lang_String__int__void(/** ?string */ val, /** number */ radix) {
  ...
  if (radix < Character.f_MIN_RADIX__java_lang_Character || radix > Character.f_MAX_RADIX__java_lang_Character) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(NumberFormatException.$create__java_lang_String('Radix out of range'));
  }
 ...
 $ctor__java_math_BigInteger__int__int__void(/** number */ sign, /** number */ bits) {
  this.$ctor__java_math_BigInteger__int__int__arrayOf_int__void(sign, 1, /**@type {!Array<number>}*/ ($Arrays.$stampType([bits], $int)));
 }
 ...
 $ctor__java_math_BigInteger__int__int__int__void(/** number */ sign, /** number */ lowBits, /** number */ highBits) {
  this.$ctor__java_math_BigInteger__int__int__arrayOf_int__void(sign, 2, /**@type {!Array<number>}*/ ($Arrays.$stampType([lowBits, highBits], $int)));
 }
 //Factory method corresponding to constructor 'BigInteger(int, int[])'.
 /** @nodts @return {!BigInteger} */
 ...
 m_byteValueExact__byte() {
  ...
  throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(ArithmeticException.$create__java_lang_String('out of byte range'));
 }
 /** @nodts @return {BigInteger} */
 ...
 m_divide__java_math_BigInteger__java_math_BigInteger(/** BigInteger */ divisor) {
  if (divisor.f_sign__java_math_BigInteger == 0) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(ArithmeticException.$create__java_lang_String('BigInteger divide by zero'));
  }
  ...
  if ((thisLen + divisorLen | 0) == 2) {
   let val = $LongUtils.divide($LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(this.f_digits__java_math_BigInteger[0]), $Long.fromBits(-1, 0) /* 4294967295 */), $LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(divisor.f_digits__java_math_BigInteger[0]), $Long.fromBits(-1, 0) /* 4294967295 */));
   if (thisSign != divisorSign) {
    val = $LongUtils.negate(val);
   }
   return BigInteger.m_valueOf__long__java_math_BigInteger(val);
  }
  let cmp = thisLen != divisorLen ? thisLen > divisorLen ? 1 : -1 : Elementary.m_compareArrays__arrayOf_int__arrayOf_int__int__int(this.f_digits__java_math_BigInteger, divisor.f_digits__java_math_BigInteger, thisLen);
  ...
  let resSign = thisSign == divisorSign ? 1 : -1;
  if (divisorLen == 1) {
 ...
 m_divideAndRemainder__java_math_BigInteger__arrayOf_java_math_BigInteger(/** BigInteger */ divisor) {
  ...
  let thisLen = this.f_numberLength__java_math_BigInteger;
  let cmp = thisLen != divisorLen ? thisLen > divisorLen ? 1 : -1 : Elementary.m_compareArrays__arrayOf_int__arrayOf_int__int__int(thisDigits, divisorDigits, thisLen);
  if (cmp < 0) {
   return /**@type {!Array<BigInteger>}*/ ($Arrays.$stampType([BigInteger.$static_ZERO__java_math_BigInteger, this], BigInteger));
  }
  let thisSign = this.f_sign__java_math_BigInteger;
  let quotientLength = thisLen - divisorLen + 1 | 0;
  let remainderLength = divisorLen;
  let quotientSign = thisSign == divisorSign ? 1 : -1;
 ...
 m_flipBit__int__java_math_BigInteger(/** number */ n) {
  if (n < 0) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(ArithmeticException.$create__java_lang_String('Negative bit address'));
  }
  return BitLevel.m_flipBit__java_math_BigInteger__int__java_math_BigInteger(this, n);
 }
 /** @override @nodts @return {number} */
 ...
 m_intValueExact__int() {
  ...
  throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(ArithmeticException.$create__java_lang_String('out of int range'));
 }
 ...
 m_longValueExact__long() {
  ...
  throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(ArithmeticException.$create__java_lang_String('out of long range'));
 }
 /** @nodts @return {BigInteger} */
 ...
 m_mod__java_math_BigInteger__java_math_BigInteger(/** BigInteger */ m) {
  if (m.f_sign__java_math_BigInteger <= 0) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(ArithmeticException.$create__java_lang_String('BigInteger: modulus not positive'));
  }
 ...
 m_nextProbablePrime__java_math_BigInteger() {
  if (this.f_sign__java_math_BigInteger < 0) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(ArithmeticException.$create__java_lang_String('start < 0: ' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(this)));
  }
 ...
 m_pow__int__java_math_BigInteger(/** number */ exp) {
  if (exp < 0) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(ArithmeticException.$create__java_lang_String('Negative exponent'));
  }
  if (exp == 0) {
   return BigInteger.$static_ONE__java_math_BigInteger;
 ...
 m_remainder__java_math_BigInteger__java_math_BigInteger(/** BigInteger */ divisor) {
  ...
  let thisLen = this.f_numberLength__java_math_BigInteger;
  let divisorLen = divisor.f_numberLength__java_math_BigInteger;
  if ((thisLen != divisorLen ? thisLen > divisorLen ? 1 : -1 : Elementary.m_compareArrays__arrayOf_int__arrayOf_int__int__int(this.f_digits__java_math_BigInteger, divisor.f_digits__java_math_BigInteger, thisLen)) == BigInteger.f_LESS__java_math_BigInteger) {
   return this;
  }
 ...
 m_shortValueExact__short() {
  ...
  throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(ArithmeticException.$create__java_lang_String('out of short range'));
 }
 /** @nodts @return {number} */
 m_signum__int() {
  return this.f_sign__java_math_BigInteger;
 ...
 m_toByteArray__arrayOf_byte() {
  if (this.f_sign__java_math_BigInteger == 0) {
   return /**@type {!Array<number>}*/ ($Arrays.$stampType([0], $byte));
  }
  let temp = this;
  ...
  if ((bytesLen - (this.f_numberLength__java_math_BigInteger << 2) | 0) == 1) {
   $Arrays.$set(bytes, 0, Primitives.m_narrowIntToByte__int__int(this.f_sign__java_math_BigInteger < 0 ? -1 : 0));
   highBytes = 4;
  ...
  if (this.f_sign__java_math_BigInteger < 0) {
   ...
   for (let i = 0; i < bytesInInteger; i = i + 1 | 0, digit >>= 8) {
    $Arrays.$set(bytes, bytesLen = bytesLen - 1 | 0, Primitives.m_narrowIntToByte__int__int(digit));
   }
 ...
 m_getFirstNonzeroDigit__int_$pp_java_math() {
  if (this.f_firstNonzeroDigit__java_math_BigInteger_ == -2) {
   let /** number */ i;
   if (this.f_sign__java_math_BigInteger == 0) {
    i = -1;
   } else {
 ...
 m_unCache__void_$pp_java_math() {
  this.f_firstNonzeroDigit__java_math_BigInteger_ = -2;
 }
 /** @nodts */
 m_putBytesNegativeToIntegers__arrayOf_byte__void_$p_java_math_BigInteger(/** Array<number> */ byteValues) {
  ...
  this.f_digits__java_math_BigInteger = (/**@type {!Array<number>}*/ ($Arrays.$create([this.f_numberLength__java_math_BigInteger], $int)));
  let i = 0;
  $Arrays.$set(this.f_digits__java_math_BigInteger, this.f_numberLength__java_math_BigInteger - 1 | 0, -1);
