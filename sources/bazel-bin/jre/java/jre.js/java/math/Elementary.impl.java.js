...
class Elementary extends j_l_Object {
 ...
 static m_add__java_math_BigInteger__java_math_BigInteger__java_math_BigInteger(/** BigInteger */ op1, /** BigInteger */ op2) {
  ...
  if ((op1Len + op2Len | 0) == 2) {
   let a = $LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(op1.f_digits__java_math_BigInteger[0]), $Long.fromBits(-1, 0) /* 4294967295 */);
   let b = $LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(op2.f_digits__java_math_BigInteger[0]), $Long.fromBits(-1, 0) /* 4294967295 */);
   let /** !$Long */ res;
   let /** number */ valueLo;
   let /** number */ valueHi;
   if (op1Sign == op2Sign) {
    res = $LongUtils.plus(a, b);
    valueLo = Primitives.m_narrowLongToInt__long__int(res);
    valueHi = Primitives.m_narrowLongToInt__long__int($LongUtils.rightShiftUnsigned(res, 32));
    return valueHi == 0 ? BigInteger.$create__int__int(op1Sign, valueLo) : BigInteger.$create__int__int__arrayOf_int(op1Sign, 2, /**@type {!Array<number>}*/ ($Arrays.$stampType([valueLo, valueHi], $int)));
   }
   ...
   let cmp = op1Len != op2Len ? op1Len > op2Len ? 1 : -1 : Elementary.m_compareArrays__arrayOf_int__arrayOf_int__int__int(op1.f_digits__java_math_BigInteger, op2.f_digits__java_math_BigInteger, op1Len);
 ...
 static m_inplaceAdd__arrayOf_int__int__int__int(/** Array<number> */ a, /** number */ aSize, /** number */ addend) {
  Elementary.$clinit();
  let carry = $LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(addend), $Long.fromBits(-1, 0) /* 4294967295 */);
  for (let i = 0; $LongUtils.notEquals(carry, $Long.fromInt(0)) && i < aSize; i = i + 1 | 0) {
   carry = $LongUtils.plus(carry, $LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(a[i]), $Long.fromBits(-1, 0) /* 4294967295 */));
   $Arrays.$set(a, i, Primitives.m_narrowLongToInt__long__int(carry));
 ...
 static m_add__arrayOf_int__arrayOf_int__int__arrayOf_int__int__void(/** Array<number> */ res, /** Array<number> */ a, /** number */ aSize, /** Array<number> */ b, /** number */ bSize) {
  let /** number */ i;
  let carry = $LongUtils.plus($LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(a[0]), $Long.fromBits(-1, 0) /* 4294967295 */), $LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(b[0]), $Long.fromBits(-1, 0) /* 4294967295 */));
  $Arrays.$set(res, 0, Primitives.m_narrowLongToInt__long__int(carry));
  carry = $LongUtils.rightShiftSigned(carry, 32);
  if (aSize >= bSize) {
   for (i = 1; i < bSize; i = i + 1 | 0) {
    carry = $LongUtils.plus(carry, $LongUtils.plus($LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(a[i]), $Long.fromBits(-1, 0) /* 4294967295 */), $LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(b[i]), $Long.fromBits(-1, 0) /* 4294967295 */)));
   ...
   for (; i < bSize; i = i + 1 | 0) {
    carry = $LongUtils.plus(carry, $LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(b[i]), $Long.fromBits(-1, 0) /* 4294967295 */));
    $Arrays.$set(res, i, Primitives.m_narrowLongToInt__long__int(carry));
    carry = $LongUtils.rightShiftSigned(carry, 32);
   }
  }
 ...
 static m_inverseSubtract__arrayOf_int__arrayOf_int__int__arrayOf_int__int__void(/** Array<number> */ res, /** Array<number> */ a, /** number */ aSize, /** Array<number> */ b, /** number */ bSize) {
  ...
  if (aSize < bSize) {
   for (i = 0; i < aSize; i = i + 1 | 0) {
    borrow = $LongUtils.plus(borrow, $LongUtils.minus($LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(b[i]), $Long.fromBits(-1, 0) /* 4294967295 */), $LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(a[i]), $Long.fromBits(-1, 0) /* 4294967295 */)));
    $Arrays.$set(res, i, Primitives.m_narrowLongToInt__long__int(borrow));
    borrow = $LongUtils.rightShiftSigned(borrow, 32);
   }
   for (; i < bSize; i = i + 1 | 0) {
    borrow = $LongUtils.plus(borrow, $LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(b[i]), $Long.fromBits(-1, 0) /* 4294967295 */));
    $Arrays.$set(res, i, Primitives.m_narrowLongToInt__long__int(borrow));
    borrow = $LongUtils.rightShiftSigned(borrow, 32);
   }
  } else {
   ...
   for (; i < aSize; i = i + 1 | 0) {
    borrow = $LongUtils.minus(borrow, $LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(a[i]), $Long.fromBits(-1, 0) /* 4294967295 */));
    $Arrays.$set(res, i, Primitives.m_narrowLongToInt__long__int(borrow));
    borrow = $LongUtils.rightShiftSigned(borrow, 32);
   }
  }
 ...
 static m_subtract__arrayOf_int__arrayOf_int__int__arrayOf_int__int__void(/** Array<number> */ res, /** Array<number> */ a, /** number */ aSize, /** Array<number> */ b, /** number */ bSize) {
  ...
  let borrow = $Long.fromInt(0);
  for (i = 0; i < bSize; i = i + 1 | 0) {
   borrow = $LongUtils.plus(borrow, $LongUtils.minus($LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(a[i]), $Long.fromBits(-1, 0) /* 4294967295 */), $LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(b[i]), $Long.fromBits(-1, 0) /* 4294967295 */)));
   $Arrays.$set(res, i, Primitives.m_narrowLongToInt__long__int(borrow));
   borrow = $LongUtils.rightShiftSigned(borrow, 32);
  }
  for (; i < aSize; i = i + 1 | 0) {
   borrow = $LongUtils.plus(borrow, $LongUtils.bitAnd(Primitives.m_widenIntToLong__int__long(a[i]), $Long.fromBits(-1, 0) /* 4294967295 */));
   $Arrays.$set(res, i, Primitives.m_narrowLongToInt__long__int(borrow));
   borrow = $LongUtils.rightShiftSigned(borrow, 32);
  }
 }
