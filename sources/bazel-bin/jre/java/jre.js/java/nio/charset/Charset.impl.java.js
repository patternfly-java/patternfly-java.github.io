...
class Charset extends j_l_Object {
 ...
 static m_forName__java_lang_String__java_nio_charset_Charset(/** ?string */ charsetName) {
  ...
  throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(UnsupportedCharsetException.$create__java_lang_String(charsetName));
 }
 /** @nodts */
