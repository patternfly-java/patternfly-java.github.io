...
class StackTraceElement extends j_l_Object {
 ...
 $ctor__java_lang_StackTraceElement__java_lang_String__java_lang_String__java_lang_String__int__void(/** ?string */ className, /** ?string */ methodName, /** ?string */ fileName, /** number */ lineNumber) {
  this.$ctor__java_lang_Object__void();
  Asserts.$assert__boolean__void(!$Equality.$same(className, null));
  Asserts.$assert__boolean__void(!$Equality.$same(methodName, null));
 ...
 hashCode() {
  return Objects.m_hash__arrayOf_java_lang_Object__int([Integer.valueOf(this.f_lineNumber__java_lang_StackTraceElement_), this.f_className__java_lang_StackTraceElement_, this.f_methodName__java_lang_StackTraceElement_, this.f_fileName__java_lang_StackTraceElement_]);
 }
