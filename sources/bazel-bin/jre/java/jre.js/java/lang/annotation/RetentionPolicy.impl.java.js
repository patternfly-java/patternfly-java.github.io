...
class RetentionPolicy extends Enum {
 ...
 static m_valueOf__java_lang_String__java_lang_annotation_RetentionPolicy(/** string */ name) {
  ...
  if ($Equality.$same(RetentionPolicy.f_namesToValuesMap__java_lang_annotation_RetentionPolicy_, null)) {
   RetentionPolicy.f_namesToValuesMap__java_lang_annotation_RetentionPolicy_ = (/**@type {Map<?string, !RetentionPolicy>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(RetentionPolicy.m_values__arrayOf_java_lang_annotation_RetentionPolicy())));
  }
  return /**@type {RetentionPolicy}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, RetentionPolicy.f_namesToValuesMap__java_lang_annotation_RetentionPolicy_));
 }
 /** @nodts @return {!Array<!RetentionPolicy>} */
 static m_values__arrayOf_java_lang_annotation_RetentionPolicy() {
  RetentionPolicy.$clinit();
  return /**@type {!Array<!RetentionPolicy>}*/ ($Arrays.$stampType([RetentionPolicy.f_CLASS__java_lang_annotation_RetentionPolicy, RetentionPolicy.f_RUNTIME__java_lang_annotation_RetentionPolicy, RetentionPolicy.f_SOURCE__java_lang_annotation_RetentionPolicy], RetentionPolicy));
 }
 /** @nodts */
 static $clinit() {
  RetentionPolicy.$clinit = () =>{};
