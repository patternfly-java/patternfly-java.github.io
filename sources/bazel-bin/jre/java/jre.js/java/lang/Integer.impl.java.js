...
class Integer extends Number {
 ...
 static m_decode__java_lang_String__java_lang_Integer(/** ?string */ s) {
  Integer.$clinit();
  return Integer.valueOf(Number.m___decodeAndValidateInt__java_lang_String__int__int__int(s, Integer.f_MIN_VALUE__java_lang_Integer, Integer.f_MAX_VALUE__java_lang_Integer));
 }
 /** @nodts @return {number} */
 ...
 static m_valueOf__java_lang_String__int__java_lang_Integer(/** ?string */ s, /** number */ radix) {
  Integer.$clinit();
  return Integer.valueOf(Integer.m_parseInt__java_lang_String__int__int(s, radix));
 }
 ...
 m_byteValue__byte() {
  return Primitives.m_narrowIntToByte__int__int(this.f_value__java_lang_Integer_);
 }
 /** @nodts @return {number} */
 ...
 m_longValue__long() {
  return Primitives.m_widenIntToLong__int__long(this.f_value__java_lang_Integer_);
 }
 /** @override @nodts @return {number} */
 m_shortValue__short() {
  return Primitives.m_narrowIntToShort__int__int(this.f_value__java_lang_Integer_);
 }
