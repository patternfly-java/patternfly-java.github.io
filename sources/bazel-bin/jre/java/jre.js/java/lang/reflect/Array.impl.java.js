...
let $boolean = goog.forwardDeclare('javaemul.internal.primitives.$boolean$impl');
...
let $float = goog.forwardDeclare('javaemul.internal.primitives.$float$impl');
...
let $short = goog.forwardDeclare('javaemul.internal.primitives.$short$impl');
...
class j_l_reflect_Array extends j_l_Object {
 ...
 static m_get__java_lang_Object__int__java_lang_Object(/** * */ array, /** number */ index) {
  ...
  if ($Arrays.$instanceIsOfType(array, $boolean, 1)) {
   ...
   return Integer.valueOf(j_l_reflect_Array.m_getIntImpl__java_lang_Object__int__int(array, index));
 ...
 static m_getDouble__java_lang_Object__int__double(/** * */ array, /** number */ index) {
  ...
  if ($Arrays.$instanceIsOfType(array, $double, 1)) {
   ...
   return Primitives.m_widenLongToDouble__long__double(j_l_reflect_Array.m_getLongImpl__java_lang_Object__int__long(array, index));
  } else if ($Arrays.$instanceIsOfType(array, $short, 1)) {
 ...
 static m_getFloat__java_lang_Object__int__float(/** * */ array, /** number */ index) {
  ...
  if ($Arrays.$instanceIsOfType(array, $float, 1)) {
   ...
   return Primitives.m_widenLongToFloat__long__double(j_l_reflect_Array.m_getLongImpl__java_lang_Object__int__long(array, index));
  } else if ($Arrays.$instanceIsOfType(array, $short, 1)) {
   return j_l_reflect_Array.m_getShortImpl__java_lang_Object__int__short(array, index);
  } else {
   InternalPreconditions.m_checkArgument__boolean__void(false);
 ...
 static m_getLong__java_lang_Object__int__long(/** * */ array, /** number */ index) {
  ...
  if ($Arrays.$instanceIsOfType(array, $long, 1)) {
   ...
   return Primitives.m_widenByteToLong__int__long(j_l_reflect_Array.m_getByteImpl__java_lang_Object__int__byte(array, index));
  } else if ($Arrays.$instanceIsOfType(array, $char, 1)) {
   return Primitives.m_widenCharToLong__int__long(j_l_reflect_Array.m_getCharImpl__java_lang_Object__int__char(array, index));
  } else if ($Arrays.$instanceIsOfType(array, $int, 1)) {
   return Primitives.m_widenIntToLong__int__long(j_l_reflect_Array.m_getIntImpl__java_lang_Object__int__int(array, index));
  } else if ($Arrays.$instanceIsOfType(array, $short, 1)) {
   return Primitives.m_widenShortToLong__int__long(j_l_reflect_Array.m_getShortImpl__java_lang_Object__int__short(array, index));
  } else {
   InternalPreconditions.m_checkArgument__boolean__void(false);
 ...
 static m_set__java_lang_Object__int__java_lang_Object__void(/** * */ array, /** number */ index, /** * */ value) {
  ...
  if ($Arrays.$instanceIsOfType(array, j_l_Object, 1)) {
   ...
   if (Boolean.$isInstance(value)) {
    ...
    j_l_reflect_Array.m_setInt__java_lang_Object__int__int__void(array, index, (/**@type {Integer}*/ ($Casts.$to(value, Integer))).intValue());
   } else if (Long.$isInstance(value)) {
    j_l_reflect_Array.m_setLong__java_lang_Object__int__long__void(array, index, Long.m_longValue__java_lang_Long__long(/**@type {$Long}*/ ($Casts.$to(value, Long))));
 ...
 static m_setByte__java_lang_Object__int__byte__void(/** * */ array, /** number */ index, /** number */ value) {
  ...
  if ($Arrays.$instanceIsOfType(array, $byte, 1)) {
   ...
   j_l_reflect_Array.m_setLongImpl__java_lang_Object__int__long__void(array, index, Primitives.m_widenByteToLong__int__long(value));
  } else if ($Arrays.$instanceIsOfType(array, $short, 1)) {
 ...
 static m_setChar__java_lang_Object__int__char__void(/** * */ array, /** number */ index, /** number */ value) {
  ...
  if ($Arrays.$instanceIsOfType(array, $char, 1)) {
   ...
   j_l_reflect_Array.m_setLongImpl__java_lang_Object__int__long__void(array, index, Primitives.m_widenCharToLong__int__long(value));
  } else {
   InternalPreconditions.m_checkArgument__boolean__void(false);
  }
 }
 ...
 static m_setInt__java_lang_Object__int__int__void(/** * */ array, /** number */ index, /** number */ value) {
  ...
  if ($Arrays.$instanceIsOfType(array, $int, 1)) {
   ...
   j_l_reflect_Array.m_setLongImpl__java_lang_Object__int__long__void(array, index, Primitives.m_widenIntToLong__int__long(value));
  } else {
   InternalPreconditions.m_checkArgument__boolean__void(false);
  }
 }
 ...
 static m_setLong__java_lang_Object__int__long__void(/** * */ array, /** number */ index, /** !$Long */ value) {
  ...
  if ($Arrays.$instanceIsOfType(array, $long, 1)) {
   ...
   j_l_reflect_Array.m_setDoubleImpl__java_lang_Object__int__double__void(array, index, Primitives.m_widenLongToDouble__long__double(value));
  } else if ($Arrays.$instanceIsOfType(array, $float, 1)) {
   j_l_reflect_Array.m_setFloatImpl__java_lang_Object__int__float__void(array, index, Primitives.m_widenLongToFloat__long__double(value));
  } else {
   InternalPreconditions.m_checkArgument__boolean__void(false);
  }
 }
 ...
 static m_setShort__java_lang_Object__int__short__void(/** * */ array, /** number */ index, /** number */ value) {
  ...
  if ($Arrays.$instanceIsOfType(array, $short, 1)) {
   ...
   j_l_reflect_Array.m_setLongImpl__java_lang_Object__int__long__void(array, index, Primitives.m_widenShortToLong__int__long(value));
  } else {
   InternalPreconditions.m_checkArgument__boolean__void(false);
  }
 }
 ...
 static $loadModules() {
  ...
  $boolean = goog.module.get('javaemul.internal.primitives.$boolean$impl');
  ...
  $float = goog.module.get('javaemul.internal.primitives.$float$impl');
  $int = goog.module.get('javaemul.internal.primitives.$int$impl');
  $long = goog.module.get('javaemul.internal.primitives.$long$impl');
  $short = goog.module.get('javaemul.internal.primitives.$short$impl');
