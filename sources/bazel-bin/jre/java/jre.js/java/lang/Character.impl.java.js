...
class Character extends j_l_Object {
 ...
 static m_toTitleCase__char__char(/** number */ c) {
  ...
  if (c >= 452 /* '\u01C4' */ && c <= 460 /* '\u01CC' */ || c >= 497 /* '\u01F1' */ && c <= 499 /* '\u01F3' */) {
   return Primitives.m_narrowIntToChar__int__int(Math.imul(Primitives.m_coerceDivision__int__int((c + 1 | 0) / 3), 3));
 ...
 static m_toChars__int__arrayOf_char(/** number */ codePoint) {
  ...
  if (codePoint >= Character.f_MIN_SUPPLEMENTARY_CODE_POINT__java_lang_Character) {
   return /**@type {!Array<number>}*/ ($Arrays.$stampType([Character.m_highSurrogate__int__char(codePoint), Character.m_lowSurrogate__int__char(codePoint)], $char));
  } else {
   return /**@type {!Array<number>}*/ ($Arrays.$stampType([Primitives.m_narrowIntToChar__int__int(codePoint)], $char));
  }
 }
 /** @nodts @return {number} */
 static m_toChars__int__arrayOf_char__int__int(/** number */ codePoint, /** Array<number> */ dst, /** number */ dstIndex) {
  ...
  if (codePoint >= Character.f_MIN_SUPPLEMENTARY_CODE_POINT__java_lang_Character) {
   let /** number */ $value;
   $Arrays.$set(dst, ($value = dstIndex, dstIndex = dstIndex + 1 | 0, $value), Character.m_highSurrogate__int__char(codePoint));
   $Arrays.$set(dst, dstIndex, Character.m_lowSurrogate__int__char(codePoint));
   return 2;
  } else {
   $Arrays.$set(dst, dstIndex, Primitives.m_narrowIntToChar__int__int(codePoint));
   return 1;
  }
 }
 /** @nodts @return {number} */
 ...
 static m_forDigit__int__char(/** number */ digit) {
  ...
  return Primitives.m_narrowIntToChar__int__int(overBaseTen < 0 ? 48 /* '0' */ + digit | 0 : 97 /* 'a' */ + overBaseTen | 0);
 }
 /** @nodts @return {number} */
 static m_highSurrogate__int__char(/** number */ codePoint) {
  Character.$clinit();
  return Primitives.m_narrowIntToChar__int__int(Character.f_MIN_HIGH_SURROGATE__java_lang_Character + ((codePoint - Character.f_MIN_SUPPLEMENTARY_CODE_POINT__java_lang_Character | 0) >> 10 & 1023) | 0);
 }
 /** @nodts @return {number} */
 static m_lowSurrogate__int__char(/** number */ codePoint) {
  Character.$clinit();
  return Primitives.m_narrowIntToChar__int__int(Character.f_MIN_LOW_SURROGATE__java_lang_Character + ((codePoint - Character.f_MIN_SUPPLEMENTARY_CODE_POINT__java_lang_Character | 0) & 1023) | 0);
 }
 /** @nodts @return {!Character} */
