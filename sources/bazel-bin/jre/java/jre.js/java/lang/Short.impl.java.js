...
class Short extends Number {
 ...
 static m_decode__java_lang_String__java_lang_Short(/** ?string */ s) {
  Short.$clinit();
  return Short.m_valueOf__short__java_lang_Short(Primitives.m_narrowIntToShort__int__int(Number.m___decodeAndValidateInt__java_lang_String__int__int__int(s, Short.f_MIN_VALUE__java_lang_Short, Short.f_MAX_VALUE__java_lang_Short)));
 }
 /** @nodts @return {number} */
 ...
 static m_parseShort__java_lang_String__int__short(/** ?string */ s, /** number */ radix) {
  Short.$clinit();
  return Primitives.m_narrowIntToShort__int__int(Number.m___parseAndValidateInt__java_lang_String__int__int__int__int(s, radix, Short.f_MIN_VALUE__java_lang_Short, Short.f_MAX_VALUE__java_lang_Short));
 }
 /** @nodts @return {number} */
 static m_reverseBytes__short__short(/** number */ s) {
  Short.$clinit();
  return Primitives.m_narrowIntToShort__int__int((s & 255) << 8 | (s & 65280) >> 8);
 }
 /** @nodts @return {?string} */
 ...
 m_byteValue__byte() {
  return Primitives.m_narrowShortToByte__int__int(this.f_value__java_lang_Short_);
 }
 /** @nodts @return {number} */
 ...
 m_longValue__long() {
  return Primitives.m_widenShortToLong__int__long(this.f_value__java_lang_Short_);
 }
 /** @override @nodts @return {number} */
 m_shortValue__short() {
  return this.f_value__java_lang_Short_;
