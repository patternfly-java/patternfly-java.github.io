...
class $1 extends j_l_Object {
 ...
 m_forEachRemaining__java_lang_Object__void(/** IntConsumer */ arg0) {
  OfInt.m_forEachRemaining__$default__java_util_PrimitiveIterator_OfInt__java_util_function_IntConsumer__void(this, /**@type {IntConsumer}*/ ($Casts.$to(arg0, /**@type {Function}*/ (IntConsumer))));
 }
 //Default method forwarding stub.
