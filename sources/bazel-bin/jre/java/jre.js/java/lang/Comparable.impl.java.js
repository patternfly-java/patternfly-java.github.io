...
class Comparable {
 ...
 static $isInstance(/** * */ instance) {
  ...
  if (j_l_String.m_equals__java_lang_String__java_lang_Object__boolean(type, 'boolean') || j_l_String.m_equals__java_lang_String__java_lang_Object__boolean(type, 'number') || j_l_String.m_equals__java_lang_String__java_lang_Object__boolean(type, 'string') || Long.$isInstance(instance)) {
   return true;
  }
  return !$Equality.$same(instance, null) && instance.$implements__java_lang_Comparable == true;
 }
 /** @nodts @template T @return {!(Comparable<T>|boolean|number|string|!$Long)} */
...
$Util.$setClassMetadataForInterface(/**@type {Function}*/ (Comparable), 'java.lang.Comparable');
