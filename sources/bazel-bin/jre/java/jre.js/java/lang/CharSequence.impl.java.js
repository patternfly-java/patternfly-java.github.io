...
class CharSequence {
 ...
 static m_chars__$default__java_lang_CharSequence__java_util_stream_IntStream(/** !(CharSequence|string) */ $thisArg) {
  CharSequence.$clinit();
  return StreamSupport.m_intStream__java_util_function_Supplier__int__boolean__java_util_stream_IntStream(Supplier.$adapt(/**  @return {OfInt}*/ (() =>{
   let it = $1.$create__java_lang_CharSequence($thisArg);
   return Spliterators.m_spliterator__java_util_PrimitiveIterator_OfInt__long__int__java_util_Spliterator_OfInt(it, Primitives.m_widenIntToLong__int__long($CharSequences.m_length__java_lang_CharSequence__int($thisArg)), Spliterator.f_ORDERED__java_util_Spliterator);
...
$Util.$setClassMetadataForInterface(/**@type {Function}*/ (CharSequence), 'java.lang.CharSequence');
