...
class Boolean extends j_l_Object {
 ...
 static m_valueOf__boolean__java_lang_Boolean(/** boolean */ b) {
  Boolean.$clinit();
  return b ? Boolean.$static_TRUE__java_lang_Boolean : Boolean.$static_FALSE__java_lang_Boolean;
 }
 /** @nodts @return {?boolean} */
 ...
 /** @nodts @return {boolean} */
 static $create__boolean__int(/** boolean */ value, /** number */ ignored) {
  let /** ?boolean */ $thisArg;
  $thisArg = value;
  return $thisArg;
 }
 ...
 static $clinit() {
  ...
  Boolean.$loadModules();
  j_l_Object.$clinit();
  Boolean.$static_FALSE__java_lang_Boolean = Boolean.$create__boolean__int(false, 0);
  Boolean.$static_TRUE__java_lang_Boolean = Boolean.$create__boolean__int(true, 0);
