...
class AssertionError extends j_l_Error {
 ...
 $ctor__java_lang_AssertionError__java_lang_Object__void(/** * */ message) {
  this.$ctor__java_lang_Error__java_lang_String__java_lang_Throwable__void(j_l_String.m_valueOf__java_lang_Object__java_lang_String(message), Throwable.$isInstance(message) ? /**@type {Throwable}*/ (message) : null);
 }
