...
class Float extends Number {
 ...
 m_byteValue__byte() {
  return Primitives.m_narrowFloatToByte__int__int(this.f_value__java_lang_Float_);
 }
 /** @nodts @return {number} */
 ...
 /** @override @nodts @return {number} */
 m_intValue__int() {
  return Primitives.m_narrowFloatToInt__int__int(this.f_value__java_lang_Float_);
 }
 /** @nodts @return {boolean} */
 ...
 m_longValue__long() {
  return Primitives.m_narrowFloatToLong__int__long(this.f_value__java_lang_Float_);
 }
 /** @override @nodts @return {number} */
 m_shortValue__short() {
  return Primitives.m_narrowFloatToShort__int__int(this.f_value__java_lang_Float_);
 }
