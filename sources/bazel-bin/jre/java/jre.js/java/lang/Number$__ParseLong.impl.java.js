...
class ____ParseLong extends j_l_Object {
 ...
 static $clinit() {
  ...
  j_l_Object.$clinit();
  ____ParseLong.$static_maxDigitsForRadix__java_lang_Number___ParseLong_ = (/**@type {!Array<number>}*/ ($Arrays.$stampType([-1, -1, 30, 19, 15, 13, 11, 11, 10, 9, 9, 8, 8, 8, 8, 7, 7, 7, 7, 7, 7, 7, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 5], $int)));
  ____ParseLong.$static_maxDigitsRadixPower__java_lang_Number___ParseLong_ = (/**@type {!Array<number>}*/ ($Arrays.$create([37], $int)));
  ____ParseLong.$static_maxLengthForRadix__java_lang_Number___ParseLong_ = (/**@type {!Array<number>}*/ ($Arrays.$stampType([-1, -1, 63, 40, 32, 28, 25, 23, 21, 20, 19, 19, 18, 18, 17, 17, 16, 16, 16, 15, 15, 15, 15, 14, 14, 14, 14, 14, 14, 13, 13, 13, 13, 13, 13, 13, 13], $int)));
  ...
  for (let i = 2; i <= 36; i = i + 1 | 0) {
   $Arrays.$set(____ParseLong.$static_maxDigitsRadixPower__java_lang_Number___ParseLong_, i, Primitives.m_narrowDoubleToInt__int__int(Math.pow(i, ____ParseLong.$static_maxDigitsForRadix__java_lang_Number___ParseLong_[i])));
   $Arrays.$set(____ParseLong.$static_maxValueForRadix__java_lang_Number___ParseLong_, i, $LongUtils.divide(Long.f_MAX_VALUE__java_lang_Long, Primitives.m_widenIntToLong__int__long(____ParseLong.$static_maxDigitsRadixPower__java_lang_Number___ParseLong_[i])));
  }
 }
