...
class IntegralToString extends j_l_Object {
 ...
 static m_toPowerOfTwoUnsignedString__long__int__java_lang_String(/** !$Long */ value, /** number */ shift) {
  ...
  let mask = radix - 1 | 0;
  let bufSize = Primitives.m_coerceDivision__int__int(64 / shift) + 1 | 0;
  let buf = /**@type {!Array<number>}*/ ($Arrays.$create([bufSize], $char));
  let pos = bufSize;
  do {
   $Arrays.$set(buf, pos = pos - 1 | 0, Character.m_forDigit__int__char(Primitives.m_narrowLongToInt__long__int(value) & mask));
