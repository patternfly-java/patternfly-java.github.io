...
class Byte extends Number {
 ...
 static m_decode__java_lang_String__java_lang_Byte(/** ?string */ s) {
  Byte.$clinit();
  return Byte.m_valueOf__byte__java_lang_Byte(Primitives.m_narrowIntToByte__int__int(Number.m___decodeAndValidateInt__java_lang_String__int__int__int(s, Byte.f_MIN_VALUE__java_lang_Byte, Byte.f_MAX_VALUE__java_lang_Byte)));
 }
 /** @nodts @return {number} */
 ...
 static m_parseByte__java_lang_String__int__byte(/** ?string */ s, /** number */ radix) {
  Byte.$clinit();
  return Primitives.m_narrowIntToByte__int__int(Number.m___parseAndValidateInt__java_lang_String__int__int__int__int(s, radix, Byte.f_MIN_VALUE__java_lang_Byte, Byte.f_MAX_VALUE__java_lang_Byte));
 }
 /** @nodts @return {?string} */
 ...
 m_longValue__long() {
  return Primitives.m_widenByteToLong__int__long(this.f_value__java_lang_Byte_);
 }
 /** @override @nodts @return {number} */
 m_shortValue__short() {
  return this.f_value__java_lang_Byte_;
