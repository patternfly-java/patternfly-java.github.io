...
class Double extends Number {
 ...
 static m_byteValue__java_lang_Double__byte(/** number */ $thisArg) {
  Double.$clinit();
  return Primitives.m_narrowDoubleToByte__int__int(Double.m_doubleValue__java_lang_Double__double($thisArg));
 }
 /** @nodts @return {number} */
 ...
 static m_intValue__java_lang_Double__int(/** number */ $thisArg) {
  Double.$clinit();
  return Primitives.m_narrowDoubleToInt__int__int(Double.m_doubleValue__java_lang_Double__double($thisArg));
 }
 /** @nodts @return {boolean} */
 ...
 static m_longValue__java_lang_Double__long(/** number */ $thisArg) {
  Double.$clinit();
  return Primitives.m_narrowDoubleToLong__int__long(Double.m_doubleValue__java_lang_Double__double($thisArg));
 }
 /** @nodts @return {number} */
 static m_shortValue__java_lang_Double__short(/** number */ $thisArg) {
  Double.$clinit();
  return Primitives.m_narrowDoubleToShort__int__int(Double.m_doubleValue__java_lang_Double__double($thisArg));
 }
 /** @nodts @return {?string} */
