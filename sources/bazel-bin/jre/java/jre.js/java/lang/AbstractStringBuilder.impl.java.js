...
class AbstractStringBuilder extends j_l_Object {
 ...
 m_setLength__int__void(/** number */ newLength) {
  ...
  let delta = newLength - oldLength | 0;
  if (delta < 0) {
   ...
   this.f_string__java_lang_AbstractStringBuilder = j_l_String.m_valueOf__java_lang_Object__java_lang_String(this.f_string__java_lang_AbstractStringBuilder) + j_l_String.m_valueOf__java_lang_Object__java_lang_String(j_l_String.m_repeat__java_lang_String__int__java_lang_String('\u0000', delta));
  }
 }
 /** @nodts @return {number} */
 m_capacity__int() {
 ...
 /** @nodts */
 m_append0__arrayOf_char__int__int__void_$pp_java_lang(/** Array<number> */ x, /** number */ start, /** number */ len) {
 ...
 /** @nodts */
 m_append0__java_lang_String__void_$pp_java_lang(/** ?string */ x) {
