...
class Number extends j_l_Object {
 ...
 static $isInstance(/** * */ instance) {
  Number.$clinit();
  return j_l_String.m_equals__java_lang_String__java_lang_Object__boolean('number', typeof(instance)) || Long.$isInstance(instance) || $Overlay.$isInstance(instance);
 }
 /** @nodts @return {number} */
 ...
 static m___parseAndValidateDouble__java_lang_String__double(/** ?string */ s) {
  ...
  if (!Number.m___isValidDouble__java_lang_String__boolean(s)) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(NumberFormatException.m_forInputString__java_lang_String__java_lang_NumberFormatException(s));
  }
  return parseFloat(s);
 }
 /** @nodts @return {number} */
 static m___parseAndValidateInt__java_lang_String__int__int__int__int(/** ?string */ s, /** number */ radix, /** number */ lowerBound, /** number */ upperBound) {
  ...
  if ($Equality.$same(s, null)) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(NumberFormatException.m_forNullInputString__java_lang_NumberFormatException());
  }
  if (radix < Character.f_MIN_RADIX__java_lang_Character || radix > Character.f_MAX_RADIX__java_lang_Character) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(NumberFormatException.m_forRadix__int__java_lang_NumberFormatException(radix));
  }
  ...
  for (let i = startIndex; i < length; i = i + 1 | 0) {
   if (Character.m_digit__char__int__int(j_l_String.m_charAt__java_lang_String__int__char(s, i), radix) == -1) {
    throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(NumberFormatException.m_forInputString__java_lang_String__java_lang_NumberFormatException(s));
   }
  }
 ...
 static m___parseAndValidateLong__java_lang_String__int__long(/** ?string */ s, /** number */ radix) {
  ...
  if (length == 0) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(NumberFormatException.m_forInputString__java_lang_String__java_lang_NumberFormatException(orig));
  }
  ...
  let radixPower = Primitives.m_widenIntToLong__int__long(____ParseLong.f_maxDigitsRadixPower__java_lang_Number___ParseLong_[radix]);
  let minValue = $LongUtils.negate(____ParseLong.f_maxValueForRadix__java_lang_Number___ParseLong_[radix]);
  let firstTime = true;
  let head = Primitives.m_coerceDivision__int__int(length % maxDigits);
  if (head > 0) {
   toReturn = Primitives.m_widenIntToLong__int__long(- parseInt(j_l_String.m_substring__java_lang_String__int__int__java_lang_String(s, 0, head), radix) | 0);
  ...
  while (length >= maxDigits) {
   ...
   toReturn = $LongUtils.minus(toReturn, Primitives.m_widenIntToLong__int__long(head));
  }
 ...
 /** @nodts @return {number} */
 m_byteValue__byte() {
  return Primitives.m_narrowIntToByte__int__int(this.m_intValue__int());
 }
 ...
 /** @nodts @return {number} */
 m_shortValue__short() {
  return Primitives.m_narrowIntToShort__int__int(this.m_intValue__int());
 }
 /** @nodts */
 static $clinit() {
  Number.$clinit = () =>{};
