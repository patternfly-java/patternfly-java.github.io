...
class j_l_String extends j_l_Object {
 ...
 static m_join__java_lang_CharSequence__arrayOf_java_lang_CharSequence__java_lang_String(/** (CharSequence|string) */ delimiter, /** Array<(CharSequence|string)> */ elements) {
  j_l_String.$clinit();
  return ArrayHelper.m_join__arrayOf_java_lang_Object__java_lang_Object__java_lang_String(elements, delimiter);
 }
 /** @nodts @return {?string} */
 static m_join__java_lang_CharSequence__java_util_Collection__java_lang_String(/** (CharSequence|string) */ delimiter, /** Collection<?> */ elements) {
  j_l_String.$clinit();
  return ArrayHelper.m_join__arrayOf_java_lang_Object__java_lang_Object__java_lang_String(elements.m_toArray__arrayOf_java_lang_Object(), delimiter);
 }
 /** @nodts @return {?string} */
 static m_join__java_lang_CharSequence__java_lang_Iterable__java_lang_String(/** (CharSequence|string) */ delimiter, /** Iterable<?> */ elements) {
  j_l_String.$clinit();
  if (Collection.$isInstance(elements)) {
   return j_l_String.m_join__java_lang_CharSequence__java_util_Collection__java_lang_String(delimiter, /**@type {Collection<(CharSequence|string)>}*/ ($Casts.$to(elements, /**@type {Function}*/ (Collection))));
  }
  ...
  for (let $iterator = elements.m_iterator__java_util_Iterator(); $iterator.m_hasNext__boolean(); ) {
   let e = /**@type {(CharSequence|string)}*/ ($Casts.$to($iterator.m_next__java_lang_Object(), /**@type {Function}*/ (CharSequence)));
   {
 ...
 static m_valueOf__arrayOf_char__int__int__java_lang_String(/** Array<number> */ x, /** number */ offset, /** number */ count) {
  ...
  if (offset == 0 && end == x.length && end < ArrayHelper.f_ARRAY_PROCESS_BATCH_SIZE__javaemul_internal_ArrayHelper) {
   return j_l_String.m_fromCharCode__arrayOf_java_lang_Object__java_lang_String(/**@type {Array<*>}*/ (JsUtils.uncheckedCast(x)));
  }
  ...
  for (let batchStart = offset; batchStart < end; ) {
   let batchEnd = Math.min(batchStart + ArrayHelper.f_ARRAY_PROCESS_BATCH_SIZE__javaemul_internal_ArrayHelper | 0, end);
 ...
 static m_getCharset__java_lang_String__java_nio_charset_Charset(/** ?string */ charsetName) {
  try {
   ...
   if (UnsupportedCharsetException.$isInstance(__$exc)) {
    ...
    throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(UnsupportedEncodingException.$create__java_lang_String(charsetName));
   } else {
 ...
 static $create__arrayOf_int__int__int(/** Array<number> */ codePoints, /** number */ offset, /** number */ count) {
  j_l_String.$clinit();
  let /** ?string */ $thisArg;
  $thisArg = j_l_String.m_createImpl__arrayOf_int__int__int__java_lang_String(codePoints, offset, count);
  return $thisArg;
 }
 /** @nodts @return {?string} */
 ...
 /** @nodts @return {?string} */
 static m_createImpl__arrayOf_int__int__int__java_lang_String(/** Array<number> */ codePoints, /** number */ offset, /** number */ count) {
  ...
  return j_l_String.m_valueOf__arrayOf_char__int__int__java_lang_String(chars, 0, charIdx);
 }
 /** @nodts @return {string} */
 ...
 static m_contains__java_lang_String__java_lang_CharSequence__boolean(/** string */ $thisArg, /** (CharSequence|string) */ s) {
  j_l_String.$clinit();
  return j_l_String.m_indexOf__java_lang_String__java_lang_String__int($thisArg, $CharSequences.m_toString__java_lang_CharSequence__java_lang_String(s)) != -1;
 }
 /** @nodts @return {boolean} */
 ...
 /** @nodts @return {boolean} */
 static m_isBlank__java_lang_String__boolean(/** string */ $thisArg) {
  j_l_String.$clinit();
  return j_l_String.m_isEmpty__java_lang_String__boolean($thisArg) || StringUtil.m_isWhitespace__java_lang_String__boolean($thisArg);
 }
 /** @nodts @return {number} */
 ...
 /** @nodts @return {?string} */
 static m_repeat__java_lang_String__int__java_lang_String(/** string */ $thisArg, /** number */ count) {
  j_l_String.$clinit();
  InternalPreconditions.m_checkArgument__boolean__void(count >= 0);
  return j_l_String.m_asNativeString__java_lang_String__java_lang_String_NativeString($thisArg).repeat(count);
 }
 /** @nodts @return {?string} */
 ...
 static m_split__java_lang_String__java_lang_String__int__arrayOf_java_lang_String(/** string */ $thisArg, /** ?string */ regex, /** number */ maxMatch) {
  ...
  while (true) {
   ...
   if ($Equality.$same(matchObj, null) || $Equality.$same(trail, '') || count == (maxMatch - 1 | 0) && maxMatch > 0) {
    ...
    trail = j_l_String.m_substring__java_lang_String__int__int__java_lang_String(trail, matchIndex + j_l_String.m_length__java_lang_String__int(matchObj.at(0)) | 0, j_l_String.m_length__java_lang_String__int(trail));
  ...
  if (maxMatch == 0 && j_l_String.m_length__java_lang_String__int($thisArg) > 0) {
   ...
   if (lastNonEmpty < out.length) {
    ArrayHelper.m_setLength__java_lang_Object__int__java_lang_Object(out, lastNonEmpty);
   }
  }
  return out;
 }
 /** @nodts @return {Stream<?string>} */
 static m_lines__java_lang_String__java_util_stream_Stream(/** string */ $thisArg) {
  j_l_String.$clinit();
  let lines = j_l_String.m_splitLines__java_lang_String__arrayOf_java_lang_String($thisArg);
  let limit = lines.length;
  if (lines.length > 0 && j_l_String.m_isEmpty__java_lang_String__boolean(lines[lines.length - 1 | 0])) {
   limit = lines.length - 1 | 0;
  }
  return /**@type {Stream<?string>}*/ (Arrays.m_stream__arrayOf_java_lang_Object__int__int__java_util_stream_Stream(lines, 0, limit));
 }
 /** @nodts @return {Array<?string>} */
 static m_splitLines__java_lang_String__arrayOf_java_lang_String(/** string */ $thisArg) {
  return j_l_String.m_asNativeString__java_lang_String__java_lang_String_NativeString($thisArg).split(new RegExp('\r?\n|\r'));
 }
 /** @nodts @return {boolean} */
 ...
 /** @nodts @return {?string} */
 static m_strip__java_lang_String__java_lang_String(/** string */ $thisArg) {
  j_l_String.$clinit();
  return j_l_String.m_stripTrailing__java_lang_String__java_lang_String(j_l_String.m_stripLeading__java_lang_String__java_lang_String($thisArg));
 }
 /** @nodts @return {?string} */
 static m_stripLeading__java_lang_String__java_lang_String(/** string */ $thisArg) {
  j_l_String.$clinit();
  return StringUtil.m_stripLeading__java_lang_String__java_lang_String($thisArg);
 }
 /** @nodts @return {?string} */
 static m_stripTrailing__java_lang_String__java_lang_String(/** string */ $thisArg) {
  j_l_String.$clinit();
  return StringUtil.m_stripTrailing__java_lang_String__java_lang_String($thisArg);
 }
 /** @nodts @return {?string} */
 static m_stripIndent__java_lang_String__java_lang_String(/** string */ $thisArg) {
  j_l_String.$clinit();
  if (j_l_String.m_isEmpty__java_lang_String__boolean($thisArg)) {
   return $thisArg;
  }
  let lines = j_l_String.m_splitLines__java_lang_String__arrayOf_java_lang_String($thisArg);
  let outdent = j_l_String.m_computeOutdent__arrayOf_java_lang_String__int(lines);
  for (let i = 0; i < lines.length; i = i + 1 | 0) {
   let line = j_l_String.m_stripTrailing__java_lang_String__java_lang_String(lines[i]);
   if (!j_l_String.m_isEmpty__java_lang_String__boolean(line) && outdent > 0) {
    line = outdent < j_l_String.m_length__java_lang_String__int(line) ? j_l_String.m_substring__java_lang_String__int__java_lang_String(line, outdent) : '';
   }
   $Arrays.$set(lines, i, line);
  }
  return j_l_String.m_join__java_lang_CharSequence__arrayOf_java_lang_CharSequence__java_lang_String('\n', lines);
 }
 /** @nodts @return {number} */
 static m_computeOutdent__arrayOf_java_lang_String__int(/** Array<?string> */ lines) {
  let minLeadingWhitespace = Integer.f_MAX_VALUE__java_lang_Integer;
  for (let i = 0; i < lines.length; i = i + 1 | 0) {
   let line = lines[i];
   if (i != (lines.length - 1 | 0) && j_l_String.m_isBlank__java_lang_String__boolean(line)) {
    continue;
   }
   minLeadingWhitespace = Math.min(minLeadingWhitespace, StringUtil.m_countLeadingWhitespace__java_lang_String__int(line));
 ...
 static $clinit() {
  ...
  j_l_Object.$clinit();
  CharSequence.$clinit();
  j_l_String.$static_CASE_INSENSITIVE_ORDER__java_lang_String = Comparator.$adapt(/**  @return {number}*/ ((/** ?string */ a, /** ?string */ b) =>{
