...
class PriorityQueue extends AbstractQueue {
 ...
 static m_getParent__int__int(/** number */ node) {
  return Primitives.m_coerceDivision__int__int((node - 1 | 0) / 2);
 }
 /** @nodts @return {number} */
 ...
 /** @override @return {boolean} */
 contains(/** * */ o) {
  return this.m_indexOf__java_lang_Object__int_$p_java_util_PriorityQueue(o) != -1;
 }
 ...
 m_toArray__arrayOf_java_lang_Object() {
  return this.f_heap__java_util_PriorityQueue_.m_toArray__arrayOf_java_lang_Object();
 }
 ...
 m_indexOf__java_lang_Object__int_$p_java_util_PriorityQueue(/** * */ o) {
  return $Equality.$same(o, null) ? -1 : this.f_heap__java_util_PriorityQueue_.indexOf(o);
 }
 /** @nodts @return {boolean} */
