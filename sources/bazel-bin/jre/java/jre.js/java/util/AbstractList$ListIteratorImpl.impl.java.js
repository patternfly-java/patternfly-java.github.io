...
class ListIteratorImpl extends IteratorImpl {
 ...
 m_add__java_lang_Object__void(/** E */ o) {
  ...
  this.f_last__java_util_AbstractList_IteratorImpl = -1;
 }
 ...
 m_set__java_lang_Object__void(/** E */ o) {
  InternalPreconditions.m_checkState__boolean__void(this.f_last__java_util_AbstractList_IteratorImpl != -1);
