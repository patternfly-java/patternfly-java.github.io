...
class AbstractDoubleSpliterator extends BaseSpliterator {
 ...
 m_trySplit__java_util_Spliterator_OfPrimitive() {
  return /**@type {OfDouble}*/ ($Casts.$to(this.m_trySplit__java_util_Spliterator(), /**@type {Function}*/ (OfDouble)));
 }
 //Bridge method.
 /** @final @override @nodts */
 m_forEachRemaining__java_lang_Object__void(/** DoubleConsumer */ arg0) {
  OfPrimitive.m_forEachRemaining__$default__java_util_Spliterator_OfPrimitive__java_lang_Object__void(this, /**@type {DoubleConsumer}*/ ($Casts.$to(arg0, /**@type {Function}*/ (DoubleConsumer))));
 }
 //Default method forwarding stub.
 /** @nodts */
