...
class Collection {
 ...
 /** @nodts @template E @return {!Array<E>} */
 static m__private_jsToArray____$default__java_util_Collection__arrayOf_java_lang_Object(/** !Collection<E> */ $thisArg) {
  Collection.$clinit();
  return /**@type {!Array<E>}*/ (JsUtils.uncheckedCast($thisArg.m_toArray__arrayOf_java_lang_Object()));
 }
 /** @nodts */
 static $clinit() {
  Collection.$clinit = () =>{};
...
$Util.$setClassMetadataForInterface(/**@type {Function}*/ (Collection), 'java.util.Collection');
