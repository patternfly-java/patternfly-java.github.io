...
class DoubleConsumerIterator extends j_l_Object {
 ...
 $ctor__java_util_Spliterators_DoubleConsumerIterator__java_util_Spliterator_OfDouble__void(/** OfDouble */ spliterator) {
  ...
  this.f_spliterator__java_util_Spliterators_DoubleConsumerIterator_ = (/**@type {OfDouble}*/ ($Casts.$to(InternalPreconditions.m_checkNotNull__java_lang_Object__java_lang_Object(spliterator), /**@type {Function}*/ (OfDouble))));
 }
 /** @override @nodts */
 ...
 //Default method forwarding stub.
 /** @override @return {IIterableResult<?number>} */
 next() {
  return /**@type {IIterableResult<?number>}*/ (Iterator.m__private_jsNext____$default__java_util_Iterator__javaemul_internal_JsIterableHelper_IIterableResult(this));
 }
 //Bridge method.
 ...
 m_forEachRemaining__java_lang_Object__void(/** DoubleConsumer */ arg0) {
  PrimitiveIterator_OfDouble.m_forEachRemaining__$default__java_util_PrimitiveIterator_OfDouble__java_util_function_DoubleConsumer__void(this, /**@type {DoubleConsumer}*/ ($Casts.$to(arg0, /**@type {Function}*/ (DoubleConsumer))));
 }
 //Default method forwarding stub.
 /** @override @nodts @return {?number} */
