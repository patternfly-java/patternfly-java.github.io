...
class BitSet extends j_l_Object {
 ...
 constructor() {
  ...
  /**@type {number} @nodts*/
  this.f_wordLength__java_util_BitSet_ = 0;
 }
 ...
 $ctor__java_util_BitSet__int__void(/** number */ nbits) {
  ...
  this.f_array__java_util_BitSet_ = (/**@type {Array<number>}*/ ($Arrays.$castTo(ArrayHelper.m_setLength__java_lang_Object__int__java_lang_Object(/**@type {!Array<number>}*/ ($Arrays.$create([0], $int)), length), $int, 1)));
 }
 //Factory method corresponding to constructor 'BitSet(int[])'.
 /** @nodts @return {!BitSet} */
 ...
 $ctor__java_util_BitSet__arrayOf_int__void(/** Array<number> */ array) {
  ...
  this.f_wordLength__java_util_BitSet_ = array.length;
  this.m_updateWordLength__void_$p_java_util_BitSet();
 }
 /** @nodts */
 m_updateWordLength__void_$p_java_util_BitSet() {
  let i = this.f_wordLength__java_util_BitSet_ - 1 | 0;
  for (; i >= 0 && BitSet.m_wordAt__arrayOf_int__int__int(this.f_array__java_util_BitSet_, i) == 0; i = i - 1 | 0) {}
  this.f_wordLength__java_util_BitSet_ = i + 1 | 0;
 }
 /** @nodts */
 static m_checkIndex__int__void(/** number */ bitIndex) {
  if (bitIndex < 0) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(IndexOutOfBoundsException.$create__java_lang_String('bitIndex < 0: ' + bitIndex));
  }
 }
 /** @nodts */
 static m_checkRange__int__int__void(/** number */ fromIndex, /** number */ toIndex) {
  if (fromIndex < 0 || toIndex < 0 || fromIndex > toIndex) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(IndexOutOfBoundsException.$create__java_lang_String('fromIndex: ' + fromIndex + ', toIndex: ' + toIndex));
  }
 }
 /** @nodts @return {number} */
 static m_wordIndex__int__int(/** number */ bitIndex) {
  return Primitives.m_coerceDivision__int__int(bitIndex / BitSet.f_BITS_PER_WORD__java_util_BitSet_);
 }
 /** @nodts @return {number} */
 ...
 /** @nodts */
 m_setInternal__int__int__void_$p_java_util_BitSet(/** number */ fromIndex, /** number */ toIndex) {
  let first = BitSet.m_wordIndex__int__int(fromIndex);
  let last = BitSet.m_wordIndex__int__int(toIndex);
  this.m_maybeGrowArrayToIndex__int__void_$p_java_util_BitSet(last);
  let startBit = BitSet.m_bitOffset__int__int(fromIndex);
  let endBit = BitSet.m_bitOffset__int__int(toIndex);
  if (first == last) {
   BitSet.m_maskInWord__arrayOf_int__int__int__int__void(this.f_array__java_util_BitSet_, first, startBit, endBit);
  } else {
   BitSet.m_maskInWord__arrayOf_int__int__int__int__void(this.f_array__java_util_BitSet_, first, startBit, BitSet.f_BITS_PER_WORD__java_util_BitSet_);
   Arrays.m_fill__arrayOf_int__int__int__int__void(this.f_array__java_util_BitSet_, first + 1 | 0, last, BitSet.f_WORD_MASK__java_util_BitSet_);
   BitSet.m_maskInWord__arrayOf_int__int__int__int__void(this.f_array__java_util_BitSet_, last, 0, endBit);
  }
  if (last >= this.f_wordLength__java_util_BitSet_) {
   this.f_wordLength__java_util_BitSet_ = last + 1 | 0;
  }
 }
 /** @nodts */
 m_maybeGrowArrayToIndex__int__void_$p_java_util_BitSet(/** number */ newMaxIndex) {
  let newLength = newMaxIndex + 1 | 0;
  if (newLength > this.f_array__java_util_BitSet_.length) {
   this.f_array__java_util_BitSet_ = (/**@type {Array<number>}*/ ($Arrays.$castTo(ArrayHelper.m_grow__java_lang_Object__int__java_lang_Object(this.f_array__java_util_BitSet_, newLength), $int, 1)));
  }
 }
 /** @nodts */
 ...
 m_and__java_util_BitSet__void(/** BitSet */ set) {
  ...
  let limit = Math.min(this.f_wordLength__java_util_BitSet_, set.f_wordLength__java_util_BitSet_);
  let index = 0;
  ...
  Arrays.m_fill__arrayOf_int__int__int__int__void(this.f_array__java_util_BitSet_, limit, this.f_wordLength__java_util_BitSet_, 0);
  this.m_updateWordLength__void_$p_java_util_BitSet();
 }
 /** @nodts */
 ...
 m_cardinality__int() {
  let count = 0;
  for (let i = 0; i < this.f_wordLength__java_util_BitSet_; i = i + 1 | 0) {
 ...
 /** @nodts */
 m_clear__void() {
  Arrays.m_fill__arrayOf_int__int__int__int__void(this.f_array__java_util_BitSet_, 0, this.f_wordLength__java_util_BitSet_, 0);
  this.f_wordLength__java_util_BitSet_ = 0;
 }
 /** @nodts */
 m_clear__int__void(/** number */ bitIndex) {
  ...
  if (index >= this.f_wordLength__java_util_BitSet_) {
   return;
  }
  let word = BitSet.m_wordAt__arrayOf_int__int__int(this.f_array__java_util_BitSet_, index);
  if (word != 0) {
 ...
 m_clear__int__int__void(/** number */ fromIndex, /** number */ toIndex) {
  ...
  let first = BitSet.m_wordIndex__int__int(fromIndex);
  if (first >= this.f_wordLength__java_util_BitSet_) {
   return;
  }
  let last = BitSet.m_wordIndex__int__int(toIndex);
  if (last >= this.f_wordLength__java_util_BitSet_) {
   ...
   this.f_wordLength__java_util_BitSet_ = first + 1 | 0;
  }
  let startBit = BitSet.m_bitOffset__int__int(fromIndex);
  let endBit = BitSet.m_bitOffset__int__int(toIndex);
  if (first == last) {
 ...
 m_clone__java_lang_Object() {
  return BitSet.$create__arrayOf_int(Arrays.m_copyOf__arrayOf_int__int__arrayOf_int(this.f_array__java_util_BitSet_, this.f_wordLength__java_util_BitSet_));
 }
 ...
 equals(/** * */ obj) {
  ...
  if (this.f_wordLength__java_util_BitSet_ != other.f_wordLength__java_util_BitSet_) {
   return false;
  }
  for (let index = 0; index < this.f_wordLength__java_util_BitSet_; index = index + 1 | 0) {
 ...
 m_flip__int__void(/** number */ bitIndex) {
  ...
  this.m_maybeGrowArrayToIndex__int__void_$p_java_util_BitSet(index);
  let word = BitSet.m_wordAt__arrayOf_int__int__int(this.f_array__java_util_BitSet_, index);
  ...
  if (index >= this.f_wordLength__java_util_BitSet_) {
   this.f_wordLength__java_util_BitSet_ = index + 1 | 0;
  } else {
   this.m_updateWordLength__void_$p_java_util_BitSet();
  }
 }
 ...
 m_flip__int__int__void(/** number */ fromIndex, /** number */ toIndex) {
  ...
  if (fromIndex >= length) {
   this.m_setInternal__int__int__void_$p_java_util_BitSet(fromIndex, toIndex);
   return;
  }
  if (toIndex >= length) {
   this.m_setInternal__int__int__void_$p_java_util_BitSet(length, toIndex);
   toIndex = length;
  }
  let first = BitSet.m_wordIndex__int__int(fromIndex);
  let last = BitSet.m_wordIndex__int__int(toIndex);
 ...
 m_get__int__boolean(/** number */ bitIndex) {
  BitSet.m_checkIndex__int__void(bitIndex);
  let index = BitSet.m_wordIndex__int__int(bitIndex);
  return index < this.f_wordLength__java_util_BitSet_ && ((BitSet.m_wordAt__arrayOf_int__int__int(this.f_array__java_util_BitSet_, index) >>> BitSet.m_bitOffset__int__int(bitIndex) | 0) & 1) == 1;
 }
 /** @nodts @return {BitSet} */
 ...
 hashCode() {
  ...
  let lastIndex = this.f_wordLength__java_util_BitSet_ - 1 | 0;
  ...
  for (let i = 0; i <= lastIndex; i = i + 1 | 0) {
   ...
   hash = Math.imul(hash, fnvPrime) ^ value & 255;
   hash = Math.imul(hash, fnvPrime) ^ (value >>> 8 | 0) & 255;
   hash = Math.imul(hash, fnvPrime) ^ (value >>> 16 | 0) & 255;
   hash = Math.imul(hash, fnvPrime) ^ (value >>> 24 | 0);
  }
  return hash;
 }
 /** @nodts @return {boolean} */
 ...
 m_nextClearBit__int__int(/** number */ fromIndex) {
  ...
  let length = this.f_wordLength__java_util_BitSet_;
  if (index >= length) {
   return fromIndex;
  }
 ...
 m_or__java_util_BitSet__void(/** BitSet */ set) {
  ...
  this.m_maybeGrowArrayToIndex__int__void_$p_java_util_BitSet(set.f_wordLength__java_util_BitSet_ - 1 | 0);
  for (let index = 0; index < set.f_wordLength__java_util_BitSet_; index = index + 1 | 0) {
  ...
  this.f_wordLength__java_util_BitSet_ = Math.max(this.f_wordLength__java_util_BitSet_, set.f_wordLength__java_util_BitSet_);
 }
 /** @nodts */
 ...
 toString() {
  ...
  while ((next = this.m_nextSetBit__int__int(next + 1 | 0)) != -1) {
 ...
 m_xor__java_util_BitSet__void(/** BitSet */ set) {
  ...
  if (this.f_wordLength__java_util_BitSet_ <= set.f_wordLength__java_util_BitSet_) {
   this.f_wordLength__java_util_BitSet_ = set.f_wordLength__java_util_BitSet_;
   this.m_updateWordLength__void_$p_java_util_BitSet();
  }
 }
 ...
 m_toByteArray__arrayOf_byte() {
  ...
  let nbytes = Primitives.m_coerceDivision__int__int(nbits / Byte.f_SIZE__java_lang_Byte);
  if (Primitives.m_coerceDivision__int__int(nbits % Byte.f_SIZE__java_lang_Byte) != 0) {
   nbytes = nbytes + 1 | 0;
  }
 ...
 m_toLongArray__arrayOf_long() {
  let nbits = this.m_length__int();
  let nlongs = Primitives.m_coerceDivision__int__int(nbits / Long.f_SIZE__java_lang_Long);
  if (Primitives.m_coerceDivision__int__int(nbits % Long.f_SIZE__java_lang_Long) != 0) {
   nlongs = nlongs + 1 | 0;
  }
 ...
 static m_getByte__arrayOf_int__int__byte(/** Array<number> */ words, /** number */ bitIndex) {
  ...
  return Primitives.m_narrowIntToByte__int__int(b & 255);
 }
 /** @nodts @return {number} */
 ...
 static m_addInt__arrayOf_int__int__int__void(/** Array<number> */ words, /** number */ bits, /** number */ bitIndex) {
  if (bits != 0) {
   BitSet.m_addByte__arrayOf_int__byte__int__void(words, Primitives.m_narrowIntToByte__int__int(bits & 255), bitIndex);
   BitSet.m_addByte__arrayOf_int__byte__int__void(words, Primitives.m_narrowIntToByte__int__int(bits >> 8 & 255), bitIndex + Byte.f_SIZE__java_lang_Byte | 0);
   BitSet.m_addByte__arrayOf_int__byte__int__void(words, Primitives.m_narrowIntToByte__int__int(bits >> 16 & 255), bitIndex + Math.imul(2, Byte.f_SIZE__java_lang_Byte) | 0);
   BitSet.m_addByte__arrayOf_int__byte__int__void(words, Primitives.m_narrowIntToByte__int__int(bits >> 24 & 255), bitIndex + Math.imul(3, Byte.f_SIZE__java_lang_Byte) | 0);
  }
 }
 /** @nodts */
 static m_addLong__arrayOf_int__long__int__void(/** Array<number> */ words, /** !$Long */ bits, /** number */ bitIndex) {
  if (vmbootstrap_$LongUtils.notEquals(bits, $Long.fromInt(0))) {
   let low = Primitives.m_narrowLongToInt__long__int(bits);
   BitSet.m_addInt__arrayOf_int__int__int__void(words, low, bitIndex);
   let high = Primitives.m_narrowLongToInt__long__int(vmbootstrap_$LongUtils.rightShiftUnsigned(bits, 32));
