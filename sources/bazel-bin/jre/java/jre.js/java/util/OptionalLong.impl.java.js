...
class OptionalLong extends j_l_Object {
 ...
 /** @nodts */
 m_ifPresentOrElse__java_util_function_LongConsumer__java_lang_Runnable__void(/** LongConsumer */ action, /** Runnable */ emptyAction) {
  if (this.f_present__java_util_OptionalLong_) {
   action.m_accept__long__void(this.f_ref__java_util_OptionalLong_);
  } else {
 ...
 m_stream__java_util_stream_LongStream() {
  if (this.f_present__java_util_OptionalLong_) {
   return LongStream.m_of__long__java_util_stream_LongStream(this.f_ref__java_util_OptionalLong_);
  } else {
