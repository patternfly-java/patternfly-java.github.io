...
class TreeMap extends AbstractMap {
 ...
 /** @override @return {V} */
 get(/** * */ key) {
  let entry = this.m_findByObject__java_lang_Object__java_util_TreeMap_Node_$pp_java_util(key);
  return !$Equality.$same(entry, null) ? entry.getValue() : null;
 }
 /** @override @return {boolean} */
 containsKey(/** * */ key) {
  return !$Equality.$same(this.m_findByObject__java_lang_Object__java_util_TreeMap_Node_$pp_java_util(key), null);
 }
 /** @override @return {V} */
 put(/** K */ key, /** V */ value) {
 ...
 remove(/** * */ key) {
  ...
  return !$Equality.$same(node, null) ? node.getValue() : null;
 }
 /** @nodts @return {V} */
 m_putInternal__java_lang_Object__java_lang_Object__java_lang_Object_$p_java_util_TreeMap(/** K */ key, /** V */ value) {
  return this.m_find__java_lang_Object__java_util_TreeMap_Relation__java_util_TreeMap_Node_$p_java_util_TreeMap(key, Relation.CREATE).setValue(value);
 }
 /** @nodts @return {V} */
 ...
 m_find__java_lang_Object__java_util_TreeMap_Relation__java_util_TreeMap_Node_$p_java_util_TreeMap(/** K */ key, /** ?Relation */ relation) {
  ...
  while (true) {
   let comparison = this.f_comparator__java_util_TreeMap_.m_compare__java_lang_Object__java_lang_Object__int(key, nearest.getKey());
   if (comparison == 0) {
    switch ((InternalPreconditions.m_checkNotNull__boolean__void(!$Equality.$same(relation, null)), relation)) {
     case Relation.LOWER:
   ...
   if ($Equality.$same(child, null)) {
    switch ((InternalPreconditions.m_checkNotNull__boolean__void(!$Equality.$same(relation, null)), relation)) {
     ...
     case Relation.CREATE:
      let created = /**@type {!Node<K, V>}*/ (Node.$create__java_util_TreeMap_Node__java_lang_Object(nearest, key));
      if (comparison < 0) {
 ...
 /** @nodts @return {Node<K, V>} */
 m_findByObject__java_lang_Object__java_util_TreeMap_Node_$pp_java_util(/** * */ key) {
  let node = this.f_root__java_util_TreeMap_;
  while (!$Equality.$same(node, null)) {
   let c = this.f_comparator__java_util_TreeMap_.m_compare__java_lang_Object__java_lang_Object__int(/**@type {?K}*/ (key), node.getKey());
   if (c == 0) {
    return node;
   }
 ...
 m_findByEntry__java_util_Map_Entry__java_util_TreeMap_Node_$p_java_util_TreeMap(/** Entry<?, ?> */ entry) {
  let mine = this.m_findByObject__java_lang_Object__java_util_TreeMap_Node_$pp_java_util(entry.getKey());
  let valuesEqual = !$Equality.$same(mine, null) && Objects.m_equals__java_lang_Object__java_lang_Object__boolean(mine.getValue(), entry.getValue());
 ...
 m_removeInternalByKey__java_lang_Object__java_util_TreeMap_Node_$p_java_util_TreeMap(/** * */ key) {
  let node = this.m_findByObject__java_lang_Object__java_util_TreeMap_Node_$pp_java_util(key);
 ...
 m_firstKey__java_lang_Object() {
  ...
  return this.f_root__java_util_TreeMap_.m_first__java_util_TreeMap_Node_$pp_java_util().getKey();
 }
 /** @override @nodts @return {Entry<K, V>} */
 ...
 m_lastKey__java_lang_Object() {
  InternalPreconditions.m_checkElement__boolean__void(!$Equality.$same(this.f_root__java_util_TreeMap_, null));
  return this.f_root__java_util_TreeMap_.m_last__java_util_TreeMap_Node_$pp_java_util().getKey();
 }
 /** @override @nodts @return {Entry<K, V>} */
 ...
 static m_getKeyOrNull__java_util_Map_Entry__java_lang_Object(/** Entry<K_1, ?> */ entry) {
  TreeMap.$clinit();
  return $Equality.$same(entry, null) ? null : entry.getKey();
 }
 /** @nodts */
 static $clinit() {
  TreeMap.$clinit = () =>{};
...
Cloneable.$markImplementor(TreeMap);
