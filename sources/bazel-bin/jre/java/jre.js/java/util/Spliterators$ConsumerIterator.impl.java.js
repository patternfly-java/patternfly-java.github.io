...
class ConsumerIterator extends j_l_Object {
 ...
 $ctor__java_util_Spliterators_ConsumerIterator__java_util_Spliterator__void(/** Spliterator<?> */ spliterator) {
  ...
  this.f_spliterator__java_util_Spliterators_ConsumerIterator_ = (/**@type {Spliterator<*>}*/ ($Casts.$to(InternalPreconditions.m_checkNotNull__java_lang_Object__java_lang_Object(spliterator), /**@type {Function}*/ (Spliterator))));
 }
 /** @override @nodts */
