...
class Predicate {
 ...
 static m_isEqual__java_lang_Object__java_util_function_Predicate(/** * */ targetRef) {
  Predicate.$clinit();
  return $Equality.$same(targetRef, null) ? Predicate.$adapt(/**  @return {boolean}*/ ((/** T_1 */ arg0) =>{
   return Objects.m_isNull__java_lang_Object__boolean(arg0);
  })) : Predicate.$adapt(/**  @return {boolean}*/ ((/** T_1 */ arg0_1) =>{
 ...
 /** @nodts @template T_1 @return {Predicate<T_1>} */
 static m_not__java_util_function_Predicate__java_util_function_Predicate(/** Predicate<?> */ other) {
  Predicate.$clinit();
  return /**@type {Predicate<T_1>}*/ (other.m_negate__java_util_function_Predicate());
 }
 ...
 static m_negate__$default__java_util_function_Predicate__java_util_function_Predicate(/** !Predicate<T> */ $thisArg) {
  Predicate.$clinit();
  return Predicate.$adapt(/**  @return {boolean}*/ ((/** T */ t) =>{
...
$Util.$setClassMetadataForInterface(/**@type {Function}*/ (Predicate), 'java.util.function.Predicate');
