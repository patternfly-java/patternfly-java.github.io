...
class IntUnaryOperator {
 ...
 static m_identity__java_util_function_IntUnaryOperator() {
  ...
  return IntUnaryOperator.$adapt(/**  @return {number}*/ ((/** number */ operand) =>{
   return operand;
  }));
 }
...
$Util.$setClassMetadataForInterface(/**@type {Function}*/ (IntUnaryOperator), 'java.util.function.IntUnaryOperator');
