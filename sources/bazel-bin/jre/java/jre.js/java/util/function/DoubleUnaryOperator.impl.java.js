...
class DoubleUnaryOperator {
 ...
 static m_identity__java_util_function_DoubleUnaryOperator() {
  ...
  return DoubleUnaryOperator.$adapt(/**  @return {number}*/ ((/** number */ operand) =>{
   return operand;
  }));
 }
...
$Util.$setClassMetadataForInterface(/**@type {Function}*/ (DoubleUnaryOperator), 'java.util.function.DoubleUnaryOperator');
