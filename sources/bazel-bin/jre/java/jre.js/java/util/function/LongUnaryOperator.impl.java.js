...
class LongUnaryOperator {
 ...
 static m_identity__java_util_function_LongUnaryOperator() {
  ...
  return LongUnaryOperator.$adapt(/**  @return {!$Long}*/ ((/** !$Long */ operand) =>{
   return operand;
  }));
 }
...
$Util.$setClassMetadataForInterface(/**@type {Function}*/ (LongUnaryOperator), 'java.util.function.LongUnaryOperator');
