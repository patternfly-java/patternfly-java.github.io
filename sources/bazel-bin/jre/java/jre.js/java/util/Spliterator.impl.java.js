...
class Spliterator {
 ...
 static m_getExactSizeIfKnown__$default__java_util_Spliterator__long(/** !Spliterator<T> */ $thisArg) {
  Spliterator.$clinit();
  return $thisArg.m_hasCharacteristics__int__boolean(Spliterator.f_SIZED__java_util_Spliterator) ? $thisArg.m_estimateSize__long() : $Long.fromInt(-1);
 }
...
$Util.$setClassMetadataForInterface(/**@type {Function}*/ (Spliterator), 'java.util.Spliterator');
