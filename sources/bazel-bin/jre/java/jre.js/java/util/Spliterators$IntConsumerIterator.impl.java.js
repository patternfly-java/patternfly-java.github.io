...
class IntConsumerIterator extends j_l_Object {
 ...
 $ctor__java_util_Spliterators_IntConsumerIterator__java_util_Spliterator_OfInt__void(/** OfInt */ spliterator) {
  ...
  this.f_spliterator__java_util_Spliterators_IntConsumerIterator_ = (/**@type {OfInt}*/ ($Casts.$to(InternalPreconditions.m_checkNotNull__java_lang_Object__java_lang_Object(spliterator), /**@type {Function}*/ (OfInt))));
 }
 /** @override @nodts */
 ...
 //Default method forwarding stub.
 /** @override @return {IIterableResult<Integer>} */
 next() {
  return /**@type {IIterableResult<Integer>}*/ (Iterator.m__private_jsNext____$default__java_util_Iterator__javaemul_internal_JsIterableHelper_IIterableResult(this));
 }
 //Bridge method.
 ...
 m_forEachRemaining__java_lang_Object__void(/** IntConsumer */ arg0) {
  PrimitiveIterator_OfInt.m_forEachRemaining__$default__java_util_PrimitiveIterator_OfInt__java_util_function_IntConsumer__void(this, /**@type {IntConsumer}*/ ($Casts.$to(arg0, /**@type {Function}*/ (IntConsumer))));
 }
 //Default method forwarding stub.
