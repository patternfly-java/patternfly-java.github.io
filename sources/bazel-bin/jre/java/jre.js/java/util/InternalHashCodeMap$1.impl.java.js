...
class $1 extends j_l_Object {
 ...
 /** @override @nodts */
 m_remove__void() {
  this.$outer_this__java_util_InternalHashCodeMap_1.m_remove__java_lang_Object__java_lang_Object(this.f_lastEntry__java_util_InternalHashCodeMap_1.getKey());
