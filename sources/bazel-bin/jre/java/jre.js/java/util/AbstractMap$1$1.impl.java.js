...
class $1_$1 extends j_l_Object {
 ...
 m_next__java_lang_Object() {
  let entry = /**@type {Entry<K, V>}*/ ($Casts.$to(this.$captured_outerIter__java_util_AbstractMap_1_1.m_next__java_lang_Object(), /**@type {Function}*/ (Entry)));
  return entry.getKey();
 }
 /** @override @nodts */
 m_remove__void() {
 ...
 /** @override @return {IIterableResult<K>} */
 next() {
  return /**@type {IIterableResult<K>}*/ (Iterator.m__private_jsNext____$default__java_util_Iterator__javaemul_internal_JsIterableHelper_IIterableResult(this));
 }
 //Default method forwarding stub.
 /** @override @nodts */
