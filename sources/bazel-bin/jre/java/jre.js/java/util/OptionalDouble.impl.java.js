...
class OptionalDouble extends j_l_Object {
 ...
 /** @nodts */
 m_ifPresentOrElse__java_util_function_DoubleConsumer__java_lang_Runnable__void(/** DoubleConsumer */ action, /** Runnable */ emptyAction) {
  if (this.m_isPresent__boolean()) {
   action.m_accept__double__void(this.f_ref__java_util_OptionalDouble_);
  } else {
   emptyAction.m_run__void();
  }
 }
 /** @nodts @return {number} */
 ...
 /** @nodts @return {number} */
 m_orElseThrow__double() {
  return this.m_getAsDouble__double();
 }
 ...
 m_orElseThrow__java_util_function_Supplier__double(/** Supplier<X> */ exceptionSupplier) {
  ...
  throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(/**@type {!Throwable}*/ ($Casts.$to(exceptionSupplier.m_get__java_lang_Object(), Throwable)));
 }
 /** @nodts @return {DoubleStream} */
 m_stream__java_util_stream_DoubleStream() {
  if (this.m_isPresent__boolean()) {
   return DoubleStream.m_of__double__java_util_stream_DoubleStream(this.f_ref__java_util_OptionalDouble_);
  } else {
   return DoubleStream.m_empty__java_util_stream_DoubleStream();
  }
 }
