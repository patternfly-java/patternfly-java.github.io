...
class BaseArraySpliterator extends j_l_Object {
 ...
 m_estimateSize__long() {
  return Primitives.m_widenIntToLong__int__long(this.f_limit__java_util_Spliterators_BaseArraySpliterator_ - this.f_index__java_util_Spliterators_BaseArraySpliterator_ | 0);
 }
 /** @nodts */
