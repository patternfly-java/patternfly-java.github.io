...
class OfLong {
 ...
 static m_tryAdvance__$default__java_util_Spliterator_OfLong__java_util_function_Consumer__boolean(/** !OfLong */ $thisArg, /** Consumer<?> */ consumer) {
  ...
  if (LongConsumer.$isInstance(consumer)) {
   return $thisArg.m_tryAdvance__java_lang_Object__boolean(/**@type {LongConsumer}*/ ($Casts.$to(consumer, /**@type {Function}*/ (LongConsumer))));
  } else {
 ...
 static m_forEachRemaining__$default__java_util_Spliterator_OfLong__java_util_function_Consumer__void(/** !OfLong */ $thisArg, /** Consumer<?> */ consumer) {
  OfLong.$clinit();
  if (LongConsumer.$isInstance(consumer)) {
   $thisArg.m_forEachRemaining__java_lang_Object__void(/**@type {LongConsumer}*/ ($Casts.$to(consumer, /**@type {Function}*/ (LongConsumer))));
  } else {
...
$Util.$setClassMetadataForInterface(/**@type {Function}*/ (OfLong), 'java.util.Spliterator$OfLong');
