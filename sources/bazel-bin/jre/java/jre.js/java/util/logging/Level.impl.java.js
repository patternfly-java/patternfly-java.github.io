...
class Level extends j_l_Object {
 ...
 static m_parse__java_lang_String__java_util_logging_Level(/** ?string */ name) {
  ...
  switch (InternalPreconditions.m_checkNotNull__java_lang_Object__java_lang_Object(value)) {
   ...
   default:
    throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(IllegalArgumentException.$create__java_lang_String('Invalid level \"' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(name) + '\"'));
  }
 }
 /** @nodts @return {!Level} */
 static $create__() {
