...
class ConcurrentHashMap extends AbstractMap {
 ...
 entrySet() {
  return this.f_backingMap__java_util_concurrent_ConcurrentHashMap_.entrySet();
 }
 ...
 getOrDefault(/** * */ arg0, /** V */ arg1) {
  return ConcurrentMap.m_getOrDefault__$default__java_util_concurrent_ConcurrentMap__java_lang_Object__java_lang_Object__java_lang_Object(this, arg0, arg1);
 }
 /** @nodts */
 static $clinit() {
  ConcurrentHashMap.$clinit = () =>{};
