...
class AtomicLong extends Number {
 ...
 m_intValue__int() {
  return Primitives.m_narrowLongToInt__long__int(this.f_value__java_util_concurrent_atomic_AtomicLong_);
 }
 ...
 /** @override @nodts @return {number} */
 m_floatValue__float() {
  return Primitives.m_widenLongToFloat__long__double(this.f_value__java_util_concurrent_atomic_AtomicLong_);
 }
 /** @override @nodts @return {number} */
 m_doubleValue__double() {
  return Primitives.m_widenLongToDouble__long__double(this.f_value__java_util_concurrent_atomic_AtomicLong_);
 }
 /** @nodts */
 static $clinit() {
  AtomicLong.$clinit = () =>{};
