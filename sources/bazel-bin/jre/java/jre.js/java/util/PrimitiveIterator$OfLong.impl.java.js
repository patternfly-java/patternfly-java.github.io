...
class OfLong {
 ...
 static m_next__$default__java_util_PrimitiveIterator_OfLong__java_lang_Long(/** !OfLong */ $thisArg) {
  OfLong.$clinit();
  return $thisArg.m_nextLong__long();
 }
 /** @nodts */
 ...
 static m_forEachRemaining__$default__java_util_PrimitiveIterator_OfLong__java_util_function_Consumer__void(/** !OfLong */ $thisArg, /** Consumer<?> */ consumer) {
  ...
  if (LongConsumer.$isInstance(consumer)) {
   $thisArg.m_forEachRemaining__java_util_function_LongConsumer__void(/**@type {LongConsumer}*/ ($Casts.$to(consumer, /**@type {Function}*/ (LongConsumer))));
  } else {
...
$Util.$setClassMetadataForInterface(/**@type {Function}*/ (OfLong), 'java.util.PrimitiveIterator$OfLong');
