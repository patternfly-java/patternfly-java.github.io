...
class j_u_Date extends j_l_Object {
 ...
 static m_parse__java_lang_String__long(/** ?string */ s) {
  ...
  return Primitives.m_narrowDoubleToLong__int__long(parsed);
 }
 /** @nodts @return {!$Long} */
 static m_UTC__int__int__int__int__int__int__long(/** number */ year, /** number */ month, /** number */ date, /** number */ hrs, /** number */ min, /** number */ sec) {
  j_u_Date.$clinit();
  return Primitives.m_narrowDoubleToLong__int__long(Date.UTC(year + 1900 | 0, month, date, hrs, min, sec, 0));
 }
 /** @nodts @return {?string} */
 ...
 $ctor__java_util_Date__long__void(/** !$Long */ date) {
  this.$ctor__java_lang_Object__void();
  this.f_jsdate__java_util_Date_ = new Date(Primitives.m_widenLongToDouble__long__double(date));
 }
 ...
 /** @nodts @return {!$Long} */
 m_getTime__long() {
  return Primitives.m_narrowDoubleToLong__int__long(this.f_jsdate__java_util_Date_.getTime());
 }
 /** @nodts @return {number} */
 ...
 hashCode() {
  ...
  return Primitives.m_narrowLongToInt__long__int($LongUtils.bitXor(time, $LongUtils.rightShiftUnsigned(time, 32)));
 }
 /** @nodts */
 ...
 m_setMinutes__int__void(/** number */ minutes) {
  let hours = this.m_getHours__int() + Primitives.m_coerceDivision__int__int(minutes / 60) | 0;
 ...
 m_setSeconds__int__void(/** number */ seconds) {
  let hours = this.m_getHours__int() + Primitives.m_coerceDivision__int__int(seconds / Math.imul(60, 60)) | 0;
  this.f_jsdate__java_util_Date_.setSeconds(seconds);
  this.m_fixDaylightSavings__int__void_$p_java_util_Date(hours);
 }
 /** @nodts */
 m_setTime__long__void(/** !$Long */ time) {
  this.f_jsdate__java_util_Date_.setTime(Primitives.m_widenLongToDouble__long__double(time));
 }
 /** @nodts */
 ...
 toString() {
  ...
  let hourOffset = j_l_String.m_valueOf__java_lang_Object__java_lang_String(offset >= 0 ? '+' : '') + Primitives.m_coerceDivision__int__int(offset / 60);
  let minuteOffset = j_u_Date.m_padTwo__int__java_lang_String(Primitives.m_coerceDivision__int__int(j_l_Math.m_abs__int__int(offset) % 60));
 ...
 m_fixDaylightSavings__int__void_$p_java_util_Date(/** number */ requestedHours) {
  requestedHours = Primitives.m_coerceDivision__int__int(requestedHours % 24);
  if (this.f_jsdate__java_util_Date_.getHours() != requestedHours) {
   ...
   if (timeDiff > 0) {
    let timeDiffHours = Primitives.m_coerceDivision__int__int(timeDiff / 60);
    let timeDiffMinutes = Primitives.m_coerceDivision__int__int(timeDiff % 60);
  ...
  this.f_jsdate__java_util_Date_.setTime(originalTimeInMillis + Primitives.m_widenLongToDouble__long__double(j_u_Date.f_ONE_HOUR_IN_MILLISECONDS__java_util_Date_));
  if (this.f_jsdate__java_util_Date_.getHours() != requestedHours) {
