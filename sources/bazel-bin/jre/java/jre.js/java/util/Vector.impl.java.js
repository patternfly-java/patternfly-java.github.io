...
class Vector extends AbstractList {
 ...
 m_toArray__arrayOf_java_lang_Object() {
  return this.f_arrayList__java_util_Vector_.m_toArray__arrayOf_java_lang_Object();
 }
 ...
 static m_checkArrayElementIndex__int__int__void(/** number */ index, /** number */ size) {
  if (index < 0 || index >= size) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(ArrayIndexOutOfBoundsException.$create__());
  }
 }
 /** @nodts */
 static m_checkArrayIndexOutOfBounds__boolean__int__void(/** boolean */ expression, /** number */ index) {
  if (!expression) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(ArrayIndexOutOfBoundsException.$create__java_lang_String(j_l_String.m_valueOf__int__java_lang_String(index)));
  }
 }
 /** @nodts */
 static $clinit() {
