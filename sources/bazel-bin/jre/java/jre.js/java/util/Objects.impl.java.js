...
class Objects extends j_l_Object {
 ...
 static m_requireNonNull__java_lang_Object__java_lang_String__java_lang_Object(/** T */ obj, /** ?string */ message) {
  Objects.$clinit();
  if ($Equality.$same(obj, null)) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(NullPointerException.$create__java_lang_String(message));
  }
  return obj;
 }
 /** @nodts @template T @return {T} */
 static m_requireNonNull__java_lang_Object__java_util_function_Supplier__java_lang_Object(/** T */ obj, /** Supplier<?string> */ messageSupplier) {
  Objects.$clinit();
  if ($Equality.$same(obj, null)) {
   throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(NullPointerException.$create__java_lang_String(/**@type {?string}*/ ($Casts.$to(messageSupplier.m_get__java_lang_Object(), j_l_String))));
  }
  return obj;
 }
 /** @nodts @template T @return {T} */
 static m_requireNonNullElse__java_lang_Object__java_lang_Object__java_lang_Object(/** T */ obj, /** T */ defaultValue) {
  Objects.$clinit();
  if ($Equality.$same(obj, null)) {
   return Objects.m_requireNonNull__java_lang_Object__java_lang_String__java_lang_Object(defaultValue, 'defaultObj');
  }
  return obj;
 }
 /** @nodts @template T @return {T} */
 static m_requireNonNullElseGet__java_lang_Object__java_util_function_Supplier__java_lang_Object(/** T */ obj, /** Supplier<T> */ defaultValueSupplier) {
  Objects.$clinit();
  if ($Equality.$same(obj, null)) {
   return Objects.m_requireNonNull__java_lang_Object__java_lang_Object(defaultValueSupplier.m_get__java_lang_Object());
  }
  return obj;
 }
 /** @nodts @return {?string} */
