...
class UnmodifiableEntrySet extends UnmodifiableSet {
 ...
 m_toArray__arrayOf_java_lang_Object() {
  let array = super.m_toArray__arrayOf_java_lang_Object();
 ...
 m_wrap__arrayOf_java_lang_Object__int__void_$p_java_util_Collections_UnmodifiableMap_UnmodifiableEntrySet(/** Array<*> */ array, /** number */ size) {
  for (let i = 0; i < size; i = i + 1 | 0) {
   $Arrays.$set(array, i, /**@type {!UnmodifiableEntry<K, V>}*/ (UnmodifiableEntry.$create__java_util_Map_Entry(/**@type {Entry<K, V>}*/ ($Casts.$to(array[i], /**@type {Function}*/ (Entry))))));
  }
 }
 /** @nodts */
 static $clinit() {
