...
class OptionalInt extends j_l_Object {
 ...
 /** @nodts */
 m_ifPresentOrElse__java_util_function_IntConsumer__java_lang_Runnable__void(/** IntConsumer */ action, /** Runnable */ emptyAction) {
  if (this.f_present__java_util_OptionalInt_) {
   action.m_accept__int__void(this.f_ref__java_util_OptionalInt_);
  } else {
 ...
 m_stream__java_util_stream_IntStream() {
  if (this.f_present__java_util_OptionalInt_) {
   return IntStream.m_of__int__java_util_stream_IntStream(this.f_ref__java_util_OptionalInt_);
  } else {
