...
class EntrySet extends AbstractSet {
 ...
 contains(/** * */ o) {
  return Entry.$isInstance(o) && !$Equality.$same(this.$outer_this__java_util_TreeMap_EntrySet.m_findByEntry__java_util_Map_Entry__java_util_TreeMap_Node_$p_java_util_TreeMap(/**@type {Entry<*, *>}*/ ($Casts.$to(o, /**@type {Function}*/ (Entry)))), null);
 }
 /** @override @return {boolean} */
 remove(/** * */ o) {
  ...
  let node = this.$outer_this__java_util_TreeMap_EntrySet.m_findByEntry__java_util_Map_Entry__java_util_TreeMap_Node_$p_java_util_TreeMap(/**@type {Entry<*, *>}*/ ($Casts.$to(o, /**@type {Function}*/ (Entry))));
