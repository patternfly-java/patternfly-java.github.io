...
class $LambdaAdaptor$3 extends j_l_Object {
 ...
 constructor(/** ?function(T, T):number */ fn) {
  ...
  this.f_fn__java_util_Comparator_$LambdaAdaptor$3;
  this.$ctor__java_util_Comparator_$LambdaAdaptor$3__java_util_Comparator_$JsFunction__void(fn);
 }
 /** @nodts */
 $ctor__java_util_Comparator_$LambdaAdaptor$3__java_util_Comparator_$JsFunction__void(/** ?function(T, T):number */ fn) {
  this.$ctor__java_lang_Object__void();
  this.f_fn__java_util_Comparator_$LambdaAdaptor$3 = fn;
 }
 /** @override @nodts @return {number} */
 m_compare__java_lang_Object__java_lang_Object__int(/** T */ arg0, /** T */ arg1) {
  let /** ?function(T, T):number */ $function;
  return ($function = this.f_fn__java_util_Comparator_$LambdaAdaptor$3, $function(arg0, arg1));
 }
...
$Util.$setClassMetadata($LambdaAdaptor$3, 'java.util.Comparator$$LambdaAdaptor$3');

exports = $LambdaAdaptor$3;

//# sourceMappingURL=Comparator$$LambdaAdaptor$3.js.map
