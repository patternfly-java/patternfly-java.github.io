...
class OfInt {
 ...
 static m_next__$default__java_util_PrimitiveIterator_OfInt__java_lang_Integer(/** !OfInt */ $thisArg) {
  OfInt.$clinit();
  return Integer.valueOf($thisArg.m_nextInt__int());
 }
 /** @nodts */
 ...
 static m_forEachRemaining__$default__java_util_PrimitiveIterator_OfInt__java_util_function_Consumer__void(/** !OfInt */ $thisArg, /** Consumer<?> */ consumer) {
  ...
  if (IntConsumer.$isInstance(consumer)) {
   $thisArg.m_forEachRemaining__java_util_function_IntConsumer__void(/**@type {IntConsumer}*/ ($Casts.$to(consumer, /**@type {Function}*/ (IntConsumer))));
  } else {
...
$Util.$setClassMetadataForInterface(/**@type {Function}*/ (OfInt), 'java.util.PrimitiveIterator$OfInt');
