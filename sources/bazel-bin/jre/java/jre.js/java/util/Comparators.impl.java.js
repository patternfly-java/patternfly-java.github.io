...
class Comparators extends j_l_Object {
 ...
 /** @nodts @return {Comparator<(Comparable<*>|boolean|number|string|!$Long)>} */
...
/**@type {Comparator<(Comparable<*>|boolean|number|string|!$Long)>} @nodts*/
Comparators.f_INTERNAL_NATURAL_ORDER__java_util_Comparators_;
/**@private {Comparator<(Comparable<*>|boolean|number|string|!$Long)>} @nodts*/
