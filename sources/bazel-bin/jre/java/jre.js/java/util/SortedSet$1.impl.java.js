...
class $1 extends IteratorSpliterator {
 ...
 static $create__java_util_SortedSet__java_util_Collection__int(/** !SortedSet<E> */ $outer_this, /** Collection<?> */ collection, /** number */ characteristics) {
  $1.$clinit();
  let $instance = new $1();
  $instance.$ctor__java_util_SortedSet_1__java_util_SortedSet__java_util_Collection__int__void($outer_this, collection, characteristics);
  return $instance;
 }
 /** @nodts */
 $ctor__java_util_SortedSet_1__java_util_SortedSet__java_util_Collection__int__void(/** !SortedSet<E> */ $outer_this, /** Collection<?> */ collection, /** number */ characteristics) {
  this.$outer_this__java_util_SortedSet_1 = $outer_this;
  this.$ctor__java_util_Spliterators_IteratorSpliterator__java_util_Collection__int__void(collection, characteristics);
 }
