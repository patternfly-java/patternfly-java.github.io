...
class ChainEntry extends SimpleEntry {
 ...
 m_addToEnd__void() {
  ...
  Asserts.$assert__boolean__void(!$Equality.$same(this.$outer_this__java_util_LinkedHashMap_ChainEntry.f_head__java_util_LinkedHashMap_, null) && !$Equality.$same(tail, null));
  Asserts.$assert__boolean__void($Equality.$same(this.f_next__java_util_LinkedHashMap_ChainEntry_, null) && $Equality.$same(this.f_prev__java_util_LinkedHashMap_ChainEntry_, null));
