...
class Optional extends j_l_Object {
 ...
 /** @nodts */
 m_ifPresentOrElse__java_util_function_Consumer__java_lang_Runnable__void(/** Consumer<?> */ consumer, /** Runnable */ emptyConsumer) {
  if (this.m_isPresent__boolean()) {
   consumer.m_accept__java_lang_Object__void(this.f_ref__java_util_Optional_);
  } else {
   emptyConsumer.m_run__void();
  }
 }
 ...
 /** @nodts @return {T} */
 m_orElseThrow__java_lang_Object() {
  return this.m_get__java_lang_Object();
 }
 ...
 m_stream__java_util_stream_Stream() {
  if (this.m_isPresent__boolean()) {
   return /**@type {Stream<T>}*/ (Stream.m_of__java_lang_Object__java_util_stream_Stream(this.f_ref__java_util_Optional_));
  } else {
   return /**@type {Stream<T>}*/ (Stream.m_empty__java_util_stream_Stream());
  }
 }
