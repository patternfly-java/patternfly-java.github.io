...
class IdentityHashMap extends AbstractHashMap {
 ...
 hashCode() {
  ...
  for (let $iterator = this.entrySet().m_iterator__java_util_Iterator(); $iterator.m_hasNext__boolean(); ) {
   ...
   {
    hashCode = hashCode + System.m_identityHashCode__java_lang_Object__int(entry.getKey()) | 0;
    hashCode = hashCode + System.m_identityHashCode__java_lang_Object__int(entry.getValue()) | 0;
   }
  }
  return hashCode;
 }
