...
class OfDouble {
 ...
 static m_forEachRemaining__$default__java_util_PrimitiveIterator_OfDouble__java_util_function_Consumer__void(/** !OfDouble */ $thisArg, /** Consumer<?> */ consumer) {
  ...
  if (DoubleConsumer.$isInstance(consumer)) {
   $thisArg.m_forEachRemaining__java_util_function_DoubleConsumer__void(/**@type {DoubleConsumer}*/ ($Casts.$to(consumer, /**@type {Function}*/ (DoubleConsumer))));
  } else {
...
$Util.$setClassMetadataForInterface(/**@type {Function}*/ (OfDouble), 'java.util.PrimitiveIterator$OfDouble');
