goog.module('java.util.Map.Entry.$LambdaAdaptor$1$impl');
...
class $LambdaAdaptor$1 extends j_l_Object {
 ...
 constructor(/** ?function(T, T):number */ fn) {
  ...
  this.f_fn__java_util_Map_Entry_$LambdaAdaptor$1;
  this.$ctor__java_util_Map_Entry_$LambdaAdaptor$1__java_util_Comparator_$JsFunction__void(fn);
 }
 /** @nodts */
 $ctor__java_util_Map_Entry_$LambdaAdaptor$1__java_util_Comparator_$JsFunction__void(/** ?function(T, T):number */ fn) {
  this.$ctor__java_lang_Object__void();
  this.f_fn__java_util_Map_Entry_$LambdaAdaptor$1 = fn;
 }
 /** @override @nodts @return {number} */
 m_compare__java_lang_Object__java_lang_Object__int(/** T */ arg0, /** T */ arg1) {
  let /** ?function(T, T):number */ $function;
  return ($function = this.f_fn__java_util_Map_Entry_$LambdaAdaptor$1, $function(arg0, arg1));
 }
...
$Util.$setClassMetadata($LambdaAdaptor$1, 'java.util.Map$Entry$$LambdaAdaptor$1');

exports = $LambdaAdaptor$1;

//# sourceMappingURL=Map$Entry$$LambdaAdaptor$1.js.map
