...
class UnmodifiableEntry extends j_l_Object {
 ...
 /** @override @return {K} */
 getKey() {
  return this.f_entry__java_util_Collections_UnmodifiableMap_UnmodifiableEntrySet_UnmodifiableEntry_.getKey();
 }
 /** @override @return {V} */
 getValue() {
  return this.f_entry__java_util_Collections_UnmodifiableMap_UnmodifiableEntrySet_UnmodifiableEntry_.getValue();
 }
