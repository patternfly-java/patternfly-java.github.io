...
class LongConsumerIterator extends j_l_Object {
 ...
 $ctor__java_util_Spliterators_LongConsumerIterator__java_util_Spliterator_OfLong__void(/** OfLong */ spliterator) {
  ...
  this.f_spliterator__java_util_Spliterators_LongConsumerIterator_ = (/**@type {OfLong}*/ ($Casts.$to(InternalPreconditions.m_checkNotNull__java_lang_Object__java_lang_Object(spliterator), /**@type {Function}*/ (OfLong))));
 }
 /** @override @nodts */
 ...
 //Default method forwarding stub.
 /** @override @return {IIterableResult<$Long>} */
 next() {
  return /**@type {IIterableResult<$Long>}*/ (Iterator.m__private_jsNext____$default__java_util_Iterator__javaemul_internal_JsIterableHelper_IIterableResult(this));
 }
 //Bridge method.
 ...
 m_forEachRemaining__java_lang_Object__void(/** LongConsumer */ arg0) {
  PrimitiveIterator_OfLong.m_forEachRemaining__$default__java_util_PrimitiveIterator_OfLong__java_util_function_LongConsumer__void(this, /**@type {LongConsumer}*/ ($Casts.$to(arg0, /**@type {Function}*/ (LongConsumer))));
 }
 //Default method forwarding stub.
 /** @override @nodts @return {$Long} */
