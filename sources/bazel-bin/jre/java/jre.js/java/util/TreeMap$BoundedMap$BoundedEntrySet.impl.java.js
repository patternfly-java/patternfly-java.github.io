...
class BoundedEntrySet extends AbstractSet {
 ...
 size() {
  ...
  for (let $iterator = this.m_iterator__java_util_Iterator(); $iterator.m_hasNext__boolean(); ) {
   let ignored = /**@type {Entry<K, V>}*/ ($Casts.$to($iterator.m_next__java_lang_Object(), /**@type {Function}*/ (Entry)));
   {
    count = count + 1 | 0;
   }
  }
 ...
 contains(/** * */ o) {
  ...
  let entry = /**@type {Entry<*, *>}*/ ($Casts.$to(o, /**@type {Function}*/ (Entry)));
  return this.$outer_this__java_util_TreeMap_BoundedMap_BoundedEntrySet.m_isInBounds__java_lang_Object__boolean_$p_java_util_TreeMap_BoundedMap(entry.getKey()) && !$Equality.$same(this.$outer_this__java_util_TreeMap_BoundedMap_BoundedEntrySet.$outer_this__java_util_TreeMap_BoundedMap.m_findByEntry__java_util_Map_Entry__java_util_TreeMap_Node_$p_java_util_TreeMap(entry), null);
 }
 /** @override @return {boolean} */
 remove(/** * */ o) {
  if (!Entry.$isInstance(o)) {
  ...
  let entry = /**@type {Entry<*, *>}*/ ($Casts.$to(o, /**@type {Function}*/ (Entry)));
  return this.$outer_this__java_util_TreeMap_BoundedMap_BoundedEntrySet.m_isInBounds__java_lang_Object__boolean_$p_java_util_TreeMap_BoundedMap(entry.getKey()) && this.$outer_this__java_util_TreeMap_BoundedMap_BoundedEntrySet.$outer_this__java_util_TreeMap_BoundedMap.entrySet().remove(entry);
 }
 /** @nodts */
 static $clinit() {
  BoundedEntrySet.$clinit = () =>{};
