...
class OfDouble {
 ...
 static m_tryAdvance__$default__java_util_Spliterator_OfDouble__java_util_function_Consumer__boolean(/** !OfDouble */ $thisArg, /** Consumer<?> */ consumer) {
  ...
  if (DoubleConsumer.$isInstance(consumer)) {
   return $thisArg.m_tryAdvance__java_lang_Object__boolean(/**@type {DoubleConsumer}*/ ($Casts.$to(consumer, /**@type {Function}*/ (DoubleConsumer))));
  } else {
 ...
 static m_forEachRemaining__$default__java_util_Spliterator_OfDouble__java_util_function_Consumer__void(/** !OfDouble */ $thisArg, /** Consumer<?> */ consumer) {
  OfDouble.$clinit();
  if (DoubleConsumer.$isInstance(consumer)) {
   $thisArg.m_forEachRemaining__java_lang_Object__void(/**@type {DoubleConsumer}*/ ($Casts.$to(consumer, /**@type {Function}*/ (DoubleConsumer))));
  } else {
...
$Util.$setClassMetadataForInterface(/**@type {Function}*/ (OfDouble), 'java.util.Spliterator$OfDouble');
