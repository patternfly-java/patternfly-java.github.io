...
class ArrayDeque extends AbstractCollection {
 ...
 m_ensureCapacity__void_$p_java_util_ArrayDeque() {
  ...
  if (this.f_head__java_util_ArrayDeque_ != 0) {
   ...
   this.f_array__java_util_ArrayDeque_ = (/**@type {Array<E>}*/ ($Arrays.$castTo(ArrayHelper.m_setLength__java_lang_Object__int__java_lang_Object(this.f_array__java_util_ArrayDeque_, newLength), j_l_Object, 1)));
  }
