...
class $2 extends MapIterator {
 ...
 static $create__java_util_TreeMap_KeySet__java_util_TreeMap_Node(/** !KeySet<K, V> */ $outer_this, /** Node<K, V> */ next) {
  $2.$clinit();
  let $instance = new $2();
  $instance.$ctor__java_util_TreeMap_KeySet_2__java_util_TreeMap_KeySet__java_util_TreeMap_Node__void($outer_this, next);
  return $instance;
 }
 /** @nodts */
 $ctor__java_util_TreeMap_KeySet_2__java_util_TreeMap_KeySet__java_util_TreeMap_Node__void(/** !KeySet<K, V> */ $outer_this, /** Node<K, V> */ next) {
  this.$outer_this__java_util_TreeMap_KeySet_2 = $outer_this;
  this.$ctor__java_util_TreeMap_MapIterator__java_util_TreeMap__java_util_TreeMap_Node__void($outer_this.$outer_this__java_util_TreeMap_KeySet, next);
 }
 /** @override @nodts @return {K} */
 m_next__java_lang_Object() {
  return this.m_stepBackward__java_util_TreeMap_Node().getKey();
 }
 /** @nodts */
 static $clinit() {
  $2.$clinit = () =>{};
