...
class BoundedMap extends AbstractMap {
 ...
 m_bound__java_util_TreeMap_Node__java_util_TreeMap_Bound__java_util_TreeMap_Bound__java_util_TreeMap_Node_$p_java_util_TreeMap_BoundedMap(/** Node<K, V> */ node, /** ?Bound */ fromBound, /** ?Bound */ toBound) {
  return !$Equality.$same(node, null) && this.m_isInBounds__java_lang_Object__java_util_TreeMap_Bound__java_util_TreeMap_Bound__boolean_$p_java_util_TreeMap_BoundedMap(node.getKey(), fromBound, toBound) ? node : null;
 }
 ...
 m_endpoint__boolean__java_util_TreeMap_Node_$p_java_util_TreeMap_BoundedMap(/** boolean */ first) {
  let /** Node<K, V> */ node = null;
  if (this.f_ascending__java_util_TreeMap_BoundedMap_ == first) {
   switch ((InternalPreconditions.m_checkNotNull__boolean__void(!$Equality.$same(this.f_fromBound__java_util_TreeMap_BoundedMap_, null)), this.f_fromBound__java_util_TreeMap_BoundedMap_)) {
    case Bound.NO_BOUND:
   ...
   switch ((InternalPreconditions.m_checkNotNull__boolean__void(!$Equality.$same(this.f_toBound__java_util_TreeMap_BoundedMap_, null)), this.f_toBound__java_util_TreeMap_BoundedMap_)) {
    case Bound.NO_BOUND:
