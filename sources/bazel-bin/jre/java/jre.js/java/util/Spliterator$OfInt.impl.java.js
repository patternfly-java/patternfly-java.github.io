...
class OfInt {
 ...
 static m_tryAdvance__$default__java_util_Spliterator_OfInt__java_util_function_Consumer__boolean(/** !OfInt */ $thisArg, /** Consumer<?> */ consumer) {
  ...
  if (IntConsumer.$isInstance(consumer)) {
   return $thisArg.m_tryAdvance__java_lang_Object__boolean(/**@type {IntConsumer}*/ ($Casts.$to(consumer, /**@type {Function}*/ (IntConsumer))));
  } else {
   return $thisArg.m_tryAdvance__java_lang_Object__boolean(/**@type {!IntConsumer}*/ (IntConsumer.$adapt((/** number */ arg0) =>{
    consumer.m_accept__java_lang_Object__void(Integer.valueOf(arg0));
   })));
  }
 }
 /** @nodts */
 static m_forEachRemaining__$default__java_util_Spliterator_OfInt__java_util_function_Consumer__void(/** !OfInt */ $thisArg, /** Consumer<?> */ consumer) {
  OfInt.$clinit();
  if (IntConsumer.$isInstance(consumer)) {
   $thisArg.m_forEachRemaining__java_lang_Object__void(/**@type {IntConsumer}*/ ($Casts.$to(consumer, /**@type {Function}*/ (IntConsumer))));
  } else {
...
$Util.$setClassMetadataForInterface(/**@type {Function}*/ (OfInt), 'java.util.Spliterator$OfInt');
