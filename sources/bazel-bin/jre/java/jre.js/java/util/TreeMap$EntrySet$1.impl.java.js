...
class $1 extends MapIterator {
 ...
 static $create__java_util_TreeMap_EntrySet__java_util_TreeMap_Node(/** !EntrySet<K, V> */ $outer_this, /** Node<K, V> */ next) {
  $1.$clinit();
  let $instance = new $1();
  $instance.$ctor__java_util_TreeMap_EntrySet_1__java_util_TreeMap_EntrySet__java_util_TreeMap_Node__void($outer_this, next);
  return $instance;
 }
 /** @nodts */
 $ctor__java_util_TreeMap_EntrySet_1__java_util_TreeMap_EntrySet__java_util_TreeMap_Node__void(/** !EntrySet<K, V> */ $outer_this, /** Node<K, V> */ next) {
  this.$outer_this__java_util_TreeMap_EntrySet_1 = $outer_this;
  this.$ctor__java_util_TreeMap_MapIterator__java_util_TreeMap__java_util_TreeMap_Node__void($outer_this.$outer_this__java_util_TreeMap_EntrySet, next);
 }
