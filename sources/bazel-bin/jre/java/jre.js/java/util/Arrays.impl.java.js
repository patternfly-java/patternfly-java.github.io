...
class Arrays extends j_l_Object {
 ...
 /** @nodts @template T, U @return {Array<T>} */
 static m_copyOf__arrayOf_java_lang_Object__int__java_lang_Class__arrayOf_java_lang_Object(/** Array<U> */ original, /** number */ newLength, /** Class<?> */ newType) {
  Arrays.$clinit();
   ...
   let obj = $array[$index];
   {
    if (!$Equality.$same(obj, null) && $Objects.m_getClass__java_lang_Object__java_lang_Class(obj).m_isArray__boolean()) {
     if ($Arrays.$instanceIsOfType(obj, j_l_Object, 1)) {
      ...
      Asserts.$assertWithMessage__boolean__java_lang_Object__void(false, 'Unexpected array type: ' + j_l_String.m_valueOf__java_lang_Object__java_lang_String($Objects.m_getClass__java_lang_Object__java_lang_Class(obj).m_getName__java_lang_String()));
     }
    } else {
