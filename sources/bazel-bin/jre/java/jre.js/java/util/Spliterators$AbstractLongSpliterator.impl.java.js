...
class AbstractLongSpliterator extends BaseSpliterator {
 ...
 m_trySplit__java_util_Spliterator_OfPrimitive() {
  return /**@type {OfLong}*/ ($Casts.$to(this.m_trySplit__java_util_Spliterator(), /**@type {Function}*/ (OfLong)));
 }
 //Bridge method.
 /** @final @override @nodts */
 m_forEachRemaining__java_lang_Object__void(/** LongConsumer */ arg0) {
  OfPrimitive.m_forEachRemaining__$default__java_util_Spliterator_OfPrimitive__java_lang_Object__void(this, /**@type {LongConsumer}*/ ($Casts.$to(arg0, /**@type {Function}*/ (LongConsumer))));
 }
 //Default method forwarding stub.
 /** @nodts */
