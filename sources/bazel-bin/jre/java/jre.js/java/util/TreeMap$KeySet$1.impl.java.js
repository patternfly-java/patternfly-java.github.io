...
class $1 extends MapIterator {
 ...
 static $create__java_util_TreeMap_KeySet__java_util_TreeMap_Node(/** !KeySet<K, V> */ $outer_this, /** Node<K, V> */ next) {
  $1.$clinit();
  let $instance = new $1();
  $instance.$ctor__java_util_TreeMap_KeySet_1__java_util_TreeMap_KeySet__java_util_TreeMap_Node__void($outer_this, next);
  return $instance;
 }
 /** @nodts */
 $ctor__java_util_TreeMap_KeySet_1__java_util_TreeMap_KeySet__java_util_TreeMap_Node__void(/** !KeySet<K, V> */ $outer_this, /** Node<K, V> */ next) {
 ...
 m_next__java_lang_Object() {
  return this.m_stepForward__java_util_TreeMap_Node().getKey();
 }
 /** @nodts */
 static $clinit() {
  $1.$clinit = () =>{};
