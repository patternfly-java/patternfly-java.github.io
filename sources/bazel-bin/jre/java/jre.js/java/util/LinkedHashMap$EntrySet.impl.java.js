...
class EntrySet extends AbstractSet {
 ...
 contains(/** * */ o) {
  if (Entry.$isInstance(o)) {
   return this.$outer_this__java_util_LinkedHashMap_EntrySet.m_containsEntry__java_util_Map_Entry__boolean_$pp_java_util(/**@type {Entry<*, *>}*/ ($Casts.$to(o, /**@type {Function}*/ (Entry))));
  }
  return false;
 }
