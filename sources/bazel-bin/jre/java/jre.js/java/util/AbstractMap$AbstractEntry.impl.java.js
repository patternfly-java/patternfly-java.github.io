...
class AbstractEntry extends j_l_Object {
 ...
 equals(/** * */ other) {
  ...
  return Objects.m_equals__java_lang_Object__java_lang_Object__boolean(this.f_key__java_util_AbstractMap_AbstractEntry_, entry.getKey()) && Objects.m_equals__java_lang_Object__java_lang_Object__boolean(this.f_value__java_util_AbstractMap_AbstractEntry_, entry.getValue());
 }
