...
class $LambdaAdaptor extends j_l_Object {
 ...
 constructor(/** ?function(T, T):number */ fn) {
  ...
  this.f_fn__java_util_Comparator_$LambdaAdaptor;
  this.$ctor__java_util_Comparator_$LambdaAdaptor__java_util_Comparator_$JsFunction__void(fn);
 }
 /** @nodts */
 $ctor__java_util_Comparator_$LambdaAdaptor__java_util_Comparator_$JsFunction__void(/** ?function(T, T):number */ fn) {
  this.$ctor__java_lang_Object__void();
  this.f_fn__java_util_Comparator_$LambdaAdaptor = fn;
 }
 /** @override @nodts @return {number} */
 m_compare__java_lang_Object__java_lang_Object__int(/** T */ arg0, /** T */ arg1) {
  let /** ?function(T, T):number */ $function;
  return ($function = this.f_fn__java_util_Comparator_$LambdaAdaptor, $function(arg0, arg1));
 }
...
$Util.$setClassMetadata($LambdaAdaptor, 'java.util.Comparator$$LambdaAdaptor');

exports = $LambdaAdaptor;

//# sourceMappingURL=Comparator$$LambdaAdaptor.js.map
