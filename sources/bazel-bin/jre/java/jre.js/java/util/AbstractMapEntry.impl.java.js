...
class AbstractMapEntry extends j_l_Object {
 ...
 equals(/** * */ other) {
  ...
  let entry = /**@type {Entry<*, *>}*/ ($Casts.$to(other, /**@type {Function}*/ (Entry)));
  return Objects.m_equals__java_lang_Object__java_lang_Object__boolean(this.getKey(), entry.getKey()) && Objects.m_equals__java_lang_Object__java_lang_Object__boolean(this.getValue(), entry.getValue());
 }
 /** @final @override @return {number} */
 hashCode() {
  return Objects.m_hashCode__java_lang_Object__int(this.getKey()) ^ Objects.m_hashCode__java_lang_Object__int(this.getValue());
 }
 /** @final @override @return {?string} */
 toString() {
  return j_l_String.m_valueOf__java_lang_Object__java_lang_String(this.getKey()) + '=' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(this.getValue());
 }
 /** @nodts */
 static $clinit() {
