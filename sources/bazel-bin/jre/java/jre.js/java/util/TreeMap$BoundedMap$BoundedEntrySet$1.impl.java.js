...
class $1 extends BoundedIterator {
 ...
 static $create__java_util_TreeMap_BoundedMap_BoundedEntrySet__java_util_TreeMap_Node(/** !BoundedEntrySet<K, V> */ $outer_this, /** Node<K, V> */ next) {
  $1.$clinit();
  let $instance = new $1();
  $instance.$ctor__java_util_TreeMap_BoundedMap_BoundedEntrySet_1__java_util_TreeMap_BoundedMap_BoundedEntrySet__java_util_TreeMap_Node__void($outer_this, next);
  return $instance;
 }
 /** @nodts */
 $ctor__java_util_TreeMap_BoundedMap_BoundedEntrySet_1__java_util_TreeMap_BoundedMap_BoundedEntrySet__java_util_TreeMap_Node__void(/** !BoundedEntrySet<K, V> */ $outer_this, /** Node<K, V> */ next) {
  this.$outer_this__java_util_TreeMap_BoundedMap_BoundedEntrySet_1 = $outer_this;
  this.$ctor__java_util_TreeMap_BoundedMap_BoundedIterator__java_util_TreeMap_BoundedMap__java_util_TreeMap_Node__void($outer_this.$outer_this__java_util_TreeMap_BoundedMap_BoundedEntrySet, next);
 }
