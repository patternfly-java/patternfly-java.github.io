...
class EntryIterator extends j_l_Object {
 ...
 $ctor__java_util_LinkedHashMap_EntrySet_EntryIterator__java_util_LinkedHashMap_EntrySet__void(/** !EntrySet<K, V> */ $outer_this) {
  ...
  this.f_next__java_util_LinkedHashMap_EntrySet_EntryIterator_ = $outer_this.$outer_this__java_util_LinkedHashMap_EntrySet.f_head__java_util_LinkedHashMap_.f_next__java_util_LinkedHashMap_ChainEntry_;
  this.f_lastModCount__java_util_LinkedHashMap_EntrySet_EntryIterator_ = $outer_this.$outer_this__java_util_LinkedHashMap_EntrySet.f_map__java_util_LinkedHashMap_.f_modCount__java_util_AbstractHashMap;
 }
 ...
 m_remove__void() {
  ...
  this.$outer_this__java_util_LinkedHashMap_EntrySet_EntryIterator.$outer_this__java_util_LinkedHashMap_EntrySet.f_map__java_util_LinkedHashMap_.remove(this.f_last__java_util_LinkedHashMap_EntrySet_EntryIterator_.getKey());
 ...
 /** @override @return {IIterableResult<Entry<K, V>>} */
 next() {
  return /**@type {IIterableResult<Entry<K, V>>}*/ (Iterator.m__private_jsNext____$default__java_util_Iterator__javaemul_internal_JsIterableHelper_IIterableResult(this));
 }
 //Bridge method.
