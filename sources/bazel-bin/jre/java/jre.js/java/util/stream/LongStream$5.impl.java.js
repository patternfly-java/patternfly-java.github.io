...
class $5 extends AbstractLongSpliterator {
 ...
 /** @nodts @return {!$5} */
 static $create__long__long__long__int(/** !$Long */ $captured_startInclusive, /** !$Long */ $captured_endInclusive, /** !$Long */ size, /** number */ characteristics) {
  $5.$clinit();
  let $instance = new $5();
  $instance.$ctor__java_util_stream_LongStream_5__long__long__long__int__void($captured_startInclusive, $captured_endInclusive, size, characteristics);
  return $instance;
 }
 /** @nodts */
 $ctor__java_util_stream_LongStream_5__long__long__long__int__void(/** !$Long */ $captured_startInclusive, /** !$Long */ $captured_endInclusive, /** !$Long */ size, /** number */ characteristics) {
