...
class $4 extends AbstractDoubleSpliterator {
 ...
 static $create__java_util_stream_StreamImpl__java_util_Spliterator__long__int(/** !StreamImpl<T> */ $outer_this, /** Spliterator<?> */ $captured_spliteratorOfStreams, /** !$Long */ size, /** number */ characteristics) {
  $4.$clinit();
  let $instance = new $4();
  $instance.$ctor__java_util_stream_StreamImpl_4__java_util_stream_StreamImpl__java_util_Spliterator__long__int__void($outer_this, $captured_spliteratorOfStreams, size, characteristics);
  return $instance;
 }
 /** @nodts */
 $ctor__java_util_stream_StreamImpl_4__java_util_stream_StreamImpl__java_util_Spliterator__long__int__void(/** !StreamImpl<T> */ $outer_this, /** Spliterator<?> */ $captured_spliteratorOfStreams, /** !$Long */ size, /** number */ characteristics) {
