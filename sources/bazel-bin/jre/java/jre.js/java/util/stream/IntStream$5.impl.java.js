...
class $5 extends AbstractIntSpliterator {
 ...
 /** @nodts @return {!$5} */
 static $create__int__int__long__int(/** number */ $captured_startInclusive, /** number */ $captured_endInclusive, /** !$Long */ size, /** number */ characteristics) {
  $5.$clinit();
  let $instance = new $5();
  $instance.$ctor__java_util_stream_IntStream_5__int__int__long__int__void($captured_startInclusive, $captured_endInclusive, size, characteristics);
  return $instance;
 }
 /** @nodts */
 $ctor__java_util_stream_IntStream_5__int__int__long__int__void(/** number */ $captured_startInclusive, /** number */ $captured_endInclusive, /** !$Long */ size, /** number */ characteristics) {
