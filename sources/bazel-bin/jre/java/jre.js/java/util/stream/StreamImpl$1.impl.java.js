...
class $1 extends AbstractSpliterator {
 ...
 static $create__java_util_stream_StreamImpl__java_util_Spliterator__long__int(/** !StreamImpl<T> */ $outer_this, /** Spliterator<?> */ $captured_spliteratorOfStreams, /** !$Long */ size, /** number */ characteristics) {
  $1.$clinit();
  let $instance = new $1();
  $instance.$ctor__java_util_stream_StreamImpl_1__java_util_stream_StreamImpl__java_util_Spliterator__long__int__void($outer_this, $captured_spliteratorOfStreams, size, characteristics);
  return $instance;
 }
 /** @nodts */
 $ctor__java_util_stream_StreamImpl_1__java_util_stream_StreamImpl__java_util_Spliterator__long__int__void(/** !StreamImpl<T> */ $outer_this, /** Spliterator<?> */ $captured_spliteratorOfStreams, /** !$Long */ size, /** number */ characteristics) {
 ...
 m_advanceToNextSpliterator__boolean_$p_java_util_stream_StreamImpl_1() {
  while ($Equality.$same(this.f_next__java_util_stream_StreamImpl_1, null)) {
   if (!this.$captured_spliteratorOfStreams__java_util_stream_StreamImpl_1.m_tryAdvance__java_util_function_Consumer__boolean(Consumer.$adapt((/** ? */ n) =>{
    let n_1 = /**@type {?}*/ ($Casts.$to(n, /**@type {Function}*/ (Stream)));
