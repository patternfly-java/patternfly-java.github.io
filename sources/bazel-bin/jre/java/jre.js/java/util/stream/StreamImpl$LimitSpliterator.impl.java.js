...
class LimitSpliterator extends AbstractSpliterator {
 ...
 m_tryAdvance__java_util_function_Consumer__boolean(/** Consumer<?> */ action) {
  if ($LongUtils.greaterEquals(Primitives.m_widenIntToLong__int__long(this.f_position__java_util_stream_StreamImpl_LimitSpliterator_), this.f_limit__java_util_stream_StreamImpl_LimitSpliterator_)) {
   return false;
  }
