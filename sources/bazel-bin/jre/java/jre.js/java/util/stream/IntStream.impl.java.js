...
let $6 = goog.forwardDeclare('java.util.stream.IntStream.$6$impl');
let $7 = goog.forwardDeclare('java.util.stream.IntStream.$7$impl');
...
class IntStream {
 ...
 static m_concat__java_util_stream_IntStream__java_util_stream_IntStream__java_util_stream_IntStream(/** IntStream */ a, /** IntStream */ b) {
  IntStream.$clinit();
  let spliteratorOfStreams = (/**@type {List<IntStream>}*/ (Arrays.m_asList__arrayOf_java_lang_Object__java_util_List(/**@type {!Array<IntStream>}*/ ($Arrays.$stampType([a, b], /**@type {Function}*/ (IntStream)))))).m_spliterator__java_util_Spliterator();
  ...
  return /**@type {IntStream}*/ ($Casts.$to((/**@type {IntStream}*/ ($Casts.$to(result.m_onClose__java_lang_Runnable__java_util_stream_BaseStream(Runnable.$adapt(() =>{
   a.m_close__void();
  })), /**@type {Function}*/ (IntStream)))).m_onClose__java_lang_Runnable__java_util_stream_BaseStream(Runnable.$adapt(() =>{
   b.m_close__void();
  })), /**@type {Function}*/ (IntStream)));
 }
 /** @nodts @return {IntStream} */
 ...
 static m_iterate__int__java_util_function_IntUnaryOperator__java_util_stream_IntStream(/** number */ seed, /** IntUnaryOperator */ f) {
  IntStream.$clinit();
  return IntStream.m_iterate__int__java_util_function_IntPredicate__java_util_function_IntUnaryOperator__java_util_stream_IntStream(seed, IntPredicate.$adapt(/**  @return {boolean}*/ ((/** number */ ignore) =>{
   return true;
  })), f);
 }
 /** @nodts @return {IntStream} */
 static m_iterate__int__java_util_function_IntPredicate__java_util_function_IntUnaryOperator__java_util_stream_IntStream(/** number */ seed, /** IntPredicate */ hasNext, /** IntUnaryOperator */ f) {
  IntStream.$clinit();
  let spliterator = $4.$create__int__java_util_function_IntUnaryOperator__java_util_function_IntPredicate__long__int(seed, f, hasNext, Long.f_MAX_VALUE__java_lang_Long, Spliterator.f_IMMUTABLE__java_util_Spliterator | Spliterator.f_ORDERED__java_util_Spliterator);
  return StreamSupport.m_intStream__java_util_Spliterator_OfInt__boolean__java_util_stream_IntStream(spliterator, false);
 }
 /** @nodts @return {IntStream} */
 ...
 static m_of__int__java_util_stream_IntStream(/** number */ t) {
  IntStream.$clinit();
  return IntStream.m_of__arrayOf_int__java_util_stream_IntStream(/**@type {!Array<number>}*/ ($Arrays.$stampType([t], $int)));
 }
 /** @nodts @return {IntStream} */
 ...
 /** @abstract @nodts @return {IntStream} */
 m_dropWhile__java_util_function_IntPredicate__java_util_stream_IntStream(/** IntPredicate */ predicate) {}
 /** @abstract @nodts @return {IntStream} */
 m_takeWhile__java_util_function_IntPredicate__java_util_stream_IntStream(/** IntPredicate */ predicate) {}
 /** @abstract @nodts @return {Array<number>} */
 m_toArray__arrayOf_int() {}
 /** @nodts @return {IntStream} */
 static m_dropWhile__$default__java_util_stream_IntStream__java_util_function_IntPredicate__java_util_stream_IntStream(/** !IntStream */ $thisArg, /** IntPredicate */ predicate) {
  IntStream.$clinit();
  let prev = $thisArg.m_spliterator__java_util_Spliterator_OfInt();
  let spliterator = $6.$create__java_util_stream_IntStream__java_util_Spliterator_OfInt__java_util_function_IntPredicate__long__int($thisArg, prev, predicate, prev.m_estimateSize__long(), prev.m_characteristics__int() & ~(Spliterator.f_SIZED__java_util_Spliterator | Spliterator.f_SUBSIZED__java_util_Spliterator));
  return StreamSupport.m_intStream__java_util_Spliterator_OfInt__boolean__java_util_stream_IntStream(spliterator, false);
 }
 /** @nodts @return {IntStream} */
 static m_takeWhile__$default__java_util_stream_IntStream__java_util_function_IntPredicate__java_util_stream_IntStream(/** !IntStream */ $thisArg, /** IntPredicate */ predicate) {
  IntStream.$clinit();
  let original = $thisArg.m_spliterator__java_util_Spliterator_OfInt();
  let spliterator = $7.$create__java_util_stream_IntStream__java_util_Spliterator_OfInt__java_util_function_IntPredicate__long__int($thisArg, original, predicate, original.m_estimateSize__long(), original.m_characteristics__int() & ~(Spliterator.f_SIZED__java_util_Spliterator | Spliterator.f_SUBSIZED__java_util_Spliterator));
  return StreamSupport.m_intStream__java_util_Spliterator_OfInt__boolean__java_util_stream_IntStream(spliterator, false);
 }
 /** @nodts */
 static $clinit() {
 ...
 static $loadModules() {
  ...
  $6 = goog.module.get('java.util.stream.IntStream.$6$impl');
  $7 = goog.module.get('java.util.stream.IntStream.$7$impl');
...
$Util.$setClassMetadataForInterface(/**@type {Function}*/ (IntStream), 'java.util.stream.IntStream');
