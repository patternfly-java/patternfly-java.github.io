...
class DoubleStreamImpl extends TerminatableStream {
 ...
 m_toArray__arrayOf_double() {
  this.m_terminate__void_$pp_java_util_stream();
  let entries = PrimitiveLists.m_createForDouble__javaemul_internal_PrimitiveLists_Double();
  ...
  return $Overlay.m_toArray__$devirt__javaemul_internal_PrimitiveLists_Double__arrayOf_double(entries);
 }
 ...
 m_summaryStatistics__java_util_DoubleSummaryStatistics() {
  return /**@type {DoubleSummaryStatistics}*/ ($Casts.$to(this.m_collect__java_util_function_Supplier__java_util_function_ObjDoubleConsumer__java_util_function_BiConsumer__java_lang_Object(Supplier.$adapt(/**  @return {DoubleSummaryStatistics}*/ (() =>{
   return DoubleSummaryStatistics.$create__();
  })), ObjDoubleConsumer.$adapt((/** DoubleSummaryStatistics */ doubleSummaryStatistics, /** number */ value) =>{
  ...
  }), BiConsumer.$adapt((/** DoubleSummaryStatistics */ arg0, /** DoubleSummaryStatistics */ arg1) =>{
 ...
 m_distinct__java_util_stream_DoubleStream() {
  ...
  return this.m_filter__java_util_function_DoublePredicate__java_util_stream_DoubleStream(DoublePredicate.$adapt(/**  @return {boolean}*/ ((/** number */ arg0) =>{
 ...
 m_boxed__java_util_stream_Stream() {
  return /**@type {Stream<?number>}*/ (this.m_mapToObj__java_util_function_DoubleFunction__java_util_stream_Stream(DoubleFunction.$adapt(/**  @return {?number}*/ ((/** number */ arg0) =>{
 ...
 /** @override @nodts @return {DoubleStream} */
 m_dropWhile__java_util_function_DoublePredicate__java_util_stream_DoubleStream(/** DoublePredicate */ arg0) {
  return DoubleStream.m_dropWhile__$default__java_util_stream_DoubleStream__java_util_function_DoublePredicate__java_util_stream_DoubleStream(this, arg0);
 }
 //Default method forwarding stub.
 /** @override @nodts @return {DoubleStream} */
 m_takeWhile__java_util_function_DoublePredicate__java_util_stream_DoubleStream(/** DoublePredicate */ arg0) {
  return DoubleStream.m_takeWhile__$default__java_util_stream_DoubleStream__java_util_function_DoublePredicate__java_util_stream_DoubleStream(this, arg0);
 }
 /** @nodts */
 static $clinit() {
  DoubleStreamImpl.$clinit = () =>{};
