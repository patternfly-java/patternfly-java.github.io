...
class $5 extends AbstractSpliterator {
 ...
 static $create__java_util_stream_StreamImpl__java_util_Comparator__long__int(/** !StreamImpl<T> */ $outer_this, /** Comparator<?> */ $captured_comparator, /** !$Long */ size, /** number */ characteristics) {
  $5.$clinit();
  let $instance = new $5();
  $instance.$ctor__java_util_stream_StreamImpl_5__java_util_stream_StreamImpl__java_util_Comparator__long__int__void($outer_this, $captured_comparator, size, characteristics);
  return $instance;
 }
 /** @nodts */
 $ctor__java_util_stream_StreamImpl_5__java_util_stream_StreamImpl__java_util_Comparator__long__int__void(/** !StreamImpl<T> */ $outer_this, /** Comparator<?> */ $captured_comparator, /** !$Long */ size, /** number */ characteristics) {
 ...
 m_getComparator__java_util_Comparator() {
  return $Equality.$same(this.$captured_comparator__java_util_stream_StreamImpl_5, /**@type {Comparator<(Comparable|boolean|number|string|!$Long)>}*/ (Comparator.m_naturalOrder__java_util_Comparator())) ? null : this.$captured_comparator__java_util_stream_StreamImpl_5;
 }
 ...
 m_tryAdvance__java_util_function_Consumer__boolean(/** Consumer<?> */ action) {
  if ($Equality.$same(this.f_ordered__java_util_stream_StreamImpl_5, null)) {
   ...
   this.$outer_this__java_util_stream_StreamImpl_5.f_spliterator__java_util_stream_StreamImpl_.m_forEachRemaining__java_util_function_Consumer__void(Consumer.$adapt((/** T */ arg0) =>{
    list.add(arg0);
   }));
