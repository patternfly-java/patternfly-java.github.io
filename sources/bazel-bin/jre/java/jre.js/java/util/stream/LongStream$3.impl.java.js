...
class $3 extends AbstractLongSpliterator {
 ...
 /** @nodts @return {!$3} */
 static $create__java_util_function_LongSupplier__long__int(/** LongSupplier */ $captured_s, /** !$Long */ size, /** number */ characteristics) {
  $3.$clinit();
  let $instance = new $3();
  $instance.$ctor__java_util_stream_LongStream_3__java_util_function_LongSupplier__long__int__void($captured_s, size, characteristics);
  return $instance;
 }
 /** @nodts */
 $ctor__java_util_stream_LongStream_3__java_util_function_LongSupplier__long__int__void(/** LongSupplier */ $captured_s, /** !$Long */ size, /** number */ characteristics) {
