...
class $3 extends AbstractSpliterator {
 ...
 static $create__java_util_function_Supplier__long__int(/** Supplier<T> */ $captured_s, /** !$Long */ size, /** number */ characteristics) {
  $3.$clinit();
  let $instance = new $3();
  $instance.$ctor__java_util_stream_Stream_3__java_util_function_Supplier__long__int__void($captured_s, size, characteristics);
  return $instance;
 }
 /** @nodts */
 $ctor__java_util_stream_Stream_3__java_util_function_Supplier__long__int__void(/** Supplier<T> */ $captured_s, /** !$Long */ size, /** number */ characteristics) {
