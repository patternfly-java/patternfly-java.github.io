...
class $3 extends AbstractDoubleSpliterator {
 ...
 /** @nodts @return {!$3} */
 static $create__java_util_function_DoubleSupplier__long__int(/** DoubleSupplier */ $captured_s, /** !$Long */ size, /** number */ characteristics) {
  $3.$clinit();
  let $instance = new $3();
  $instance.$ctor__java_util_stream_DoubleStream_3__java_util_function_DoubleSupplier__long__int__void($captured_s, size, characteristics);
  return $instance;
 }
 /** @nodts */
 $ctor__java_util_stream_DoubleStream_3__java_util_function_DoubleSupplier__long__int__void(/** DoubleSupplier */ $captured_s, /** !$Long */ size, /** number */ characteristics) {
