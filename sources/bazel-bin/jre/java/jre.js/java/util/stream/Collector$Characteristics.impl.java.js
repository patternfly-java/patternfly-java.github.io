...
class Characteristics extends Enum {
 ...
 static m_valueOf__java_lang_String__java_util_stream_Collector_Characteristics(/** string */ name) {
  ...
  if ($Equality.$same(Characteristics.f_namesToValuesMap__java_util_stream_Collector_Characteristics_, null)) {
   Characteristics.f_namesToValuesMap__java_util_stream_Collector_Characteristics_ = (/**@type {Map<?string, !Characteristics>}*/ (Enums.m_createMapFromValues__arrayOf_java_lang_Enum__javaemul_internal_Enums_NativeMap(Characteristics.m_values__arrayOf_java_util_stream_Collector_Characteristics())));
  }
  return /**@type {Characteristics}*/ (Enums.m_getValueFromNameAndMap__java_lang_String__javaemul_internal_Enums_NativeMap__java_lang_Object(name, Characteristics.f_namesToValuesMap__java_util_stream_Collector_Characteristics_));
 }
 /** @nodts @return {!Array<!Characteristics>} */
 static m_values__arrayOf_java_util_stream_Collector_Characteristics() {
  Characteristics.$clinit();
  return /**@type {!Array<!Characteristics>}*/ ($Arrays.$stampType([Characteristics.f_CONCURRENT__java_util_stream_Collector_Characteristics, Characteristics.f_IDENTITY_FINISH__java_util_stream_Collector_Characteristics, Characteristics.f_UNORDERED__java_util_stream_Collector_Characteristics], Characteristics));
 }
 /** @nodts */
 static $clinit() {
  Characteristics.$clinit = () =>{};
