...
class $2 extends AbstractIntSpliterator {
 ...
 static $create__java_util_Spliterator__long__int(/** Spliterator<?> */ $captured_spliteratorOfStreams, /** !$Long */ size, /** number */ characteristics) {
  $2.$clinit();
  let $instance = new $2();
  $instance.$ctor__java_util_stream_IntStream_2__java_util_Spliterator__long__int__void($captured_spliteratorOfStreams, size, characteristics);
  return $instance;
 }
 /** @nodts */
 $ctor__java_util_stream_IntStream_2__java_util_Spliterator__long__int__void(/** Spliterator<?> */ $captured_spliteratorOfStreams, /** !$Long */ size, /** number */ characteristics) {
