...
class $3 extends AbstractLongSpliterator {
 ...
 /** @nodts @return {!$3} */
 static $create__java_util_stream_LongStreamImpl__java_util_function_LongConsumer__long__int(/** !LongStreamImpl */ $outer_this, /** LongConsumer */ $captured_action, /** !$Long */ size, /** number */ characteristics) {
  $3.$clinit();
  let $instance = new $3();
  $instance.$ctor__java_util_stream_LongStreamImpl_3__java_util_stream_LongStreamImpl__java_util_function_LongConsumer__long__int__void($outer_this, $captured_action, size, characteristics);
  return $instance;
 }
 /** @nodts */
 $ctor__java_util_stream_LongStreamImpl_3__java_util_stream_LongStreamImpl__java_util_function_LongConsumer__long__int__void(/** !LongStreamImpl */ $outer_this, /** LongConsumer */ $captured_action, /** !$Long */ size, /** number */ characteristics) {
