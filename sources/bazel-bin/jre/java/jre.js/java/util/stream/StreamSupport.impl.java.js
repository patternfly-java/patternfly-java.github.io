...
class StreamSupport extends j_l_Object {
 ...
 static m_doubleStream__java_util_function_Supplier__int__boolean__java_util_stream_DoubleStream(/** Supplier<?> */ supplier, /** number */ characteristics, /** boolean */ parallel) {
  StreamSupport.$clinit();
  return (/**@type {Stream<OfDouble>}*/ ((/**@type {Stream<Supplier<?>>}*/ (Stream.m_of__java_lang_Object__java_util_stream_Stream(supplier))).m_map__java_util_function_Function__java_util_stream_Stream(j_u_function_Function.$adapt(/**  @return {?}*/ ((/** Supplier<?> */ arg0) =>{
   let arg0_1 = /**@type {Supplier<OfDouble>}*/ ($Casts.$to(arg0, /**@type {Function}*/ (Supplier)));
   return /**@type {?}*/ ($Casts.$to(arg0_1.m_get__java_lang_Object(), /**@type {Function}*/ (OfDouble)));
  }))))).m_flatMapToDouble__java_util_function_Function__java_util_stream_DoubleStream(j_u_function_Function.$adapt(/**  @return {DoubleStream}*/ ((/** ? */ doubleSpliterator) =>{
   let doubleSpliterator_1 = /**@type {?}*/ ($Casts.$to(doubleSpliterator, /**@type {Function}*/ (OfDouble)));
 ...
 static m_intStream__java_util_function_Supplier__int__boolean__java_util_stream_IntStream(/** Supplier<?> */ supplier, /** number */ characteristics, /** boolean */ parallel) {
  StreamSupport.$clinit();
  return (/**@type {Stream<OfInt>}*/ ((/**@type {Stream<Supplier<?>>}*/ (Stream.m_of__java_lang_Object__java_util_stream_Stream(supplier))).m_map__java_util_function_Function__java_util_stream_Stream(j_u_function_Function.$adapt(/**  @return {?}*/ ((/** Supplier<?> */ arg0) =>{
   let arg0_1 = /**@type {Supplier<OfInt>}*/ ($Casts.$to(arg0, /**@type {Function}*/ (Supplier)));
   return /**@type {?}*/ ($Casts.$to(arg0_1.m_get__java_lang_Object(), /**@type {Function}*/ (OfInt)));
  }))))).m_flatMapToInt__java_util_function_Function__java_util_stream_IntStream(j_u_function_Function.$adapt(/**  @return {IntStream}*/ ((/** ? */ intSpliterator) =>{
   let intSpliterator_1 = /**@type {?}*/ ($Casts.$to(intSpliterator, /**@type {Function}*/ (OfInt)));
 ...
 static m_longStream__java_util_function_Supplier__int__boolean__java_util_stream_LongStream(/** Supplier<?> */ supplier, /** number */ characteristics, /** boolean */ parallel) {
  StreamSupport.$clinit();
  return (/**@type {Stream<OfLong>}*/ ((/**@type {Stream<Supplier<?>>}*/ (Stream.m_of__java_lang_Object__java_util_stream_Stream(supplier))).m_map__java_util_function_Function__java_util_stream_Stream(j_u_function_Function.$adapt(/**  @return {?}*/ ((/** Supplier<?> */ arg0) =>{
   let arg0_1 = /**@type {Supplier<OfLong>}*/ ($Casts.$to(arg0, /**@type {Function}*/ (Supplier)));
   return /**@type {?}*/ ($Casts.$to(arg0_1.m_get__java_lang_Object(), /**@type {Function}*/ (OfLong)));
  }))))).m_flatMapToLong__java_util_function_Function__java_util_stream_LongStream(j_u_function_Function.$adapt(/**  @return {LongStream}*/ ((/** ? */ longSpliterator) =>{
   let longSpliterator_1 = /**@type {?}*/ ($Casts.$to(longSpliterator, /**@type {Function}*/ (OfLong)));
 ...
 static m_stream__java_util_function_Supplier__int__boolean__java_util_stream_Stream(/** Supplier<?> */ supplier, /** number */ characteristics, /** boolean */ parallel) {
  StreamSupport.$clinit();
  return /**@type {Stream<T>}*/ ((/**@type {Stream<Spliterator>}*/ ((/**@type {Stream<Supplier<?>>}*/ (Stream.m_of__java_lang_Object__java_util_stream_Stream(supplier))).m_map__java_util_function_Function__java_util_stream_Stream(j_u_function_Function.$adapt(/**  @return {?}*/ ((/** Supplier<?> */ arg0) =>{
   let arg0_1 = /**@type {Supplier<Spliterator>}*/ ($Casts.$to(arg0, /**@type {Function}*/ (Supplier)));
   return /**@type {?}*/ ($Casts.$to(arg0_1.m_get__java_lang_Object(), /**@type {Function}*/ (Spliterator)));
  }))))).m_flatMap__java_util_function_Function__java_util_stream_Stream(j_u_function_Function.$adapt(/**  @return {Stream<?>}*/ ((/** ? */ spliterator) =>{
   let spliterator_1 = /**@type {?}*/ ($Casts.$to(spliterator, /**@type {Function}*/ (Spliterator)));
