...
class $2 extends AbstractIntSpliterator {
 ...
 /** @nodts @return {!$2} */
 static $create__java_util_stream_IntStreamImpl__long__int(/** !IntStreamImpl */ $outer_this, /** !$Long */ size, /** number */ characteristics) {
  $2.$clinit();
  let $instance = new $2();
  $instance.$ctor__java_util_stream_IntStreamImpl_2__java_util_stream_IntStreamImpl__long__int__void($outer_this, size, characteristics);
  return $instance;
 }
 /** @nodts */
 $ctor__java_util_stream_IntStreamImpl_2__java_util_stream_IntStreamImpl__long__int__void(/** !IntStreamImpl */ $outer_this, /** !$Long */ size, /** number */ characteristics) {
