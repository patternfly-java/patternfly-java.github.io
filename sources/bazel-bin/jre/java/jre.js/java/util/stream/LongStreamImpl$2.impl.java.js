...
class $2 extends AbstractLongSpliterator {
 ...
 /** @nodts @return {!$2} */
 static $create__java_util_stream_LongStreamImpl__long__int(/** !LongStreamImpl */ $outer_this, /** !$Long */ size, /** number */ characteristics) {
  $2.$clinit();
  let $instance = new $2();
  $instance.$ctor__java_util_stream_LongStreamImpl_2__java_util_stream_LongStreamImpl__long__int__void($outer_this, size, characteristics);
  return $instance;
 }
 /** @nodts */
 $ctor__java_util_stream_LongStreamImpl_2__java_util_stream_LongStreamImpl__long__int__void(/** !LongStreamImpl */ $outer_this, /** !$Long */ size, /** number */ characteristics) {
