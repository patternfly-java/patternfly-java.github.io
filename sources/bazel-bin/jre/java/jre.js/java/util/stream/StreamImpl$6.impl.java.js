...
class $6 extends AbstractSpliterator {
 ...
 static $create__java_util_stream_StreamImpl__java_util_function_Consumer__long__int(/** !StreamImpl<T> */ $outer_this, /** Consumer<?> */ $captured_action, /** !$Long */ size, /** number */ characteristics) {
  $6.$clinit();
  let $instance = new $6();
  $instance.$ctor__java_util_stream_StreamImpl_6__java_util_stream_StreamImpl__java_util_function_Consumer__long__int__void($outer_this, $captured_action, size, characteristics);
  return $instance;
 }
 /** @nodts */
 $ctor__java_util_stream_StreamImpl_6__java_util_stream_StreamImpl__java_util_function_Consumer__long__int__void(/** !StreamImpl<T> */ $outer_this, /** Consumer<?> */ $captured_action, /** !$Long */ size, /** number */ characteristics) {
 ...
 m_tryAdvance__java_util_function_Consumer__boolean(/** Consumer<?> */ innerAction) {
  return this.$outer_this__java_util_stream_StreamImpl_6.f_spliterator__java_util_stream_StreamImpl_.m_tryAdvance__java_util_function_Consumer__boolean(Consumer.$adapt((/** T */ item) =>{
