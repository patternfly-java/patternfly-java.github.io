...
class $2 extends AbstractDoubleSpliterator {
 ...
 /** @nodts @return {!$2} */
 static $create__java_util_stream_DoubleStreamImpl__long__int(/** !DoubleStreamImpl */ $outer_this, /** !$Long */ size, /** number */ characteristics) {
  $2.$clinit();
  let $instance = new $2();
  $instance.$ctor__java_util_stream_DoubleStreamImpl_2__java_util_stream_DoubleStreamImpl__long__int__void($outer_this, size, characteristics);
  return $instance;
 }
 /** @nodts */
 $ctor__java_util_stream_DoubleStreamImpl_2__java_util_stream_DoubleStreamImpl__long__int__void(/** !DoubleStreamImpl */ $outer_this, /** !$Long */ size, /** number */ characteristics) {
