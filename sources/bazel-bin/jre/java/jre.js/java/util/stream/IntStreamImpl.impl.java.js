...
class IntStreamImpl extends TerminatableStream {
 ...
 m_summaryStatistics__java_util_IntSummaryStatistics() {
  return /**@type {IntSummaryStatistics}*/ ($Casts.$to(this.m_collect__java_util_function_Supplier__java_util_function_ObjIntConsumer__java_util_function_BiConsumer__java_lang_Object(Supplier.$adapt(/**  @return {IntSummaryStatistics}*/ (() =>{
   return IntSummaryStatistics.$create__();
  })), ObjIntConsumer.$adapt((/** IntSummaryStatistics */ intSummaryStatistics, /** number */ value) =>{
  ...
  }), BiConsumer.$adapt((/** IntSummaryStatistics */ arg0, /** IntSummaryStatistics */ arg1) =>{
 ...
 m_sum__int() {
  return Primitives.m_narrowLongToInt__long__int(this.m_summaryStatistics__java_util_IntSummaryStatistics().m_getSum__long());
 }
 ...
 m_toArray__arrayOf_int() {
  this.m_terminate__void_$pp_java_util_stream();
  let entries = PrimitiveLists.m_createForInt__javaemul_internal_PrimitiveLists_Int();
  this.f_spliterator__java_util_stream_IntStreamImpl_.m_forEachRemaining__java_lang_Object__void(IntConsumer.$adapt((/** number */ value) =>{
   entries.push(value);
  }));
  return $Overlay.m_toArray__$devirt__javaemul_internal_PrimitiveLists_Int__arrayOf_int(entries);
 }
 /** @override @nodts */
 ...
 m_distinct__java_util_stream_IntStream() {
  ...
  return this.m_filter__java_util_function_IntPredicate__java_util_stream_IntStream(IntPredicate.$adapt(/**  @return {boolean}*/ ((/** number */ arg0) =>{
   return seen.add(Integer.valueOf(arg0));
  })));
 }
 /** @override @nodts @return {IntStream} */
 ...
 m_asLongStream__java_util_stream_LongStream() {
  return this.m_mapToLong__java_util_function_IntToLongFunction__java_util_stream_LongStream(IntToLongFunction.$adapt(/**  @return {!$Long}*/ ((/** number */ i) =>{
   return Primitives.m_widenIntToLong__int__long(i);
  })));
 }
 /** @override @nodts @return {DoubleStream} */
 m_asDoubleStream__java_util_stream_DoubleStream() {
  return this.m_mapToDouble__java_util_function_IntToDoubleFunction__java_util_stream_DoubleStream(IntToDoubleFunction.$adapt(/**  @return {number}*/ ((/** number */ i) =>{
   return i;
  })));
 }
 /** @override @nodts @return {Stream<Integer>} */
 m_boxed__java_util_stream_Stream() {
  return /**@type {Stream<Integer>}*/ (this.m_mapToObj__java_util_function_IntFunction__java_util_stream_Stream(IntFunction.$adapt(/**  @return {Integer}*/ ((/** number */ arg0) =>{
 ...
 /** @override @nodts @return {IntStream} */
 m_dropWhile__java_util_function_IntPredicate__java_util_stream_IntStream(/** IntPredicate */ arg0) {
  return IntStream.m_dropWhile__$default__java_util_stream_IntStream__java_util_function_IntPredicate__java_util_stream_IntStream(this, arg0);
 }
 //Default method forwarding stub.
 /** @override @nodts @return {IntStream} */
 m_takeWhile__java_util_function_IntPredicate__java_util_stream_IntStream(/** IntPredicate */ arg0) {
  return IntStream.m_takeWhile__$default__java_util_stream_IntStream__java_util_function_IntPredicate__java_util_stream_IntStream(this, arg0);
 }
 /** @nodts */
 static $clinit() {
  IntStreamImpl.$clinit = () =>{};
