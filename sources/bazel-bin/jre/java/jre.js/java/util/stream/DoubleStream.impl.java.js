...
let $5 = goog.forwardDeclare('java.util.stream.DoubleStream.$5$impl');
let $6 = goog.forwardDeclare('java.util.stream.DoubleStream.$6$impl');
...
class DoubleStream {
 ...
 static m_concat__java_util_stream_DoubleStream__java_util_stream_DoubleStream__java_util_stream_DoubleStream(/** DoubleStream */ a, /** DoubleStream */ b) {
  DoubleStream.$clinit();
  let spliteratorOfStreams = (/**@type {List<DoubleStream>}*/ (Arrays.m_asList__arrayOf_java_lang_Object__java_util_List(/**@type {!Array<DoubleStream>}*/ ($Arrays.$stampType([a, b], /**@type {Function}*/ (DoubleStream)))))).m_spliterator__java_util_Spliterator();
  ...
  return /**@type {DoubleStream}*/ ($Casts.$to((/**@type {DoubleStream}*/ ($Casts.$to(result.m_onClose__java_lang_Runnable__java_util_stream_BaseStream(Runnable.$adapt(() =>{
   a.m_close__void();
  })), /**@type {Function}*/ (DoubleStream)))).m_onClose__java_lang_Runnable__java_util_stream_BaseStream(Runnable.$adapt(() =>{
   b.m_close__void();
  })), /**@type {Function}*/ (DoubleStream)));
 }
 /** @nodts @return {DoubleStream} */
 ...
 static m_iterate__double__java_util_function_DoubleUnaryOperator__java_util_stream_DoubleStream(/** number */ seed, /** DoubleUnaryOperator */ f) {
  DoubleStream.$clinit();
  return DoubleStream.m_iterate__double__java_util_function_DoublePredicate__java_util_function_DoubleUnaryOperator__java_util_stream_DoubleStream(seed, DoublePredicate.$adapt(/**  @return {boolean}*/ ((/** number */ ignore) =>{
   return true;
  })), f);
 }
 /** @nodts @return {DoubleStream} */
 static m_iterate__double__java_util_function_DoublePredicate__java_util_function_DoubleUnaryOperator__java_util_stream_DoubleStream(/** number */ seed, /** DoublePredicate */ hasNext, /** DoubleUnaryOperator */ f) {
  DoubleStream.$clinit();
  let spliterator = $4.$create__double__java_util_function_DoubleUnaryOperator__java_util_function_DoublePredicate__long__int(seed, f, hasNext, Long.f_MAX_VALUE__java_lang_Long, Spliterator.f_IMMUTABLE__java_util_Spliterator | Spliterator.f_ORDERED__java_util_Spliterator);
  return StreamSupport.m_doubleStream__java_util_Spliterator_OfDouble__boolean__java_util_stream_DoubleStream(spliterator, false);
 }
 /** @nodts @return {DoubleStream} */
 ...
 static m_of__double__java_util_stream_DoubleStream(/** number */ t) {
  DoubleStream.$clinit();
  return DoubleStream.m_of__arrayOf_double__java_util_stream_DoubleStream(/**@type {!Array<number>}*/ ($Arrays.$stampType([t], $double)));
 }
 ...
 /** @abstract @nodts @return {DoubleStream} */
 m_dropWhile__java_util_function_DoublePredicate__java_util_stream_DoubleStream(/** DoublePredicate */ predicate) {}
 /** @abstract @nodts @return {DoubleStream} */
 m_takeWhile__java_util_function_DoublePredicate__java_util_stream_DoubleStream(/** DoublePredicate */ predicate) {}
 /** @abstract @nodts @return {Array<number>} */
 m_toArray__arrayOf_double() {}
 /** @nodts @return {DoubleStream} */
 static m_dropWhile__$default__java_util_stream_DoubleStream__java_util_function_DoublePredicate__java_util_stream_DoubleStream(/** !DoubleStream */ $thisArg, /** DoublePredicate */ predicate) {
  DoubleStream.$clinit();
  let prev = $thisArg.m_spliterator__java_util_Spliterator_OfDouble();
  let spliterator = $5.$create__java_util_stream_DoubleStream__java_util_Spliterator_OfDouble__java_util_function_DoublePredicate__long__int($thisArg, prev, predicate, prev.m_estimateSize__long(), prev.m_characteristics__int() & ~(Spliterator.f_SIZED__java_util_Spliterator | Spliterator.f_SUBSIZED__java_util_Spliterator));
  return StreamSupport.m_doubleStream__java_util_Spliterator_OfDouble__boolean__java_util_stream_DoubleStream(spliterator, false);
 }
 /** @nodts @return {DoubleStream} */
 static m_takeWhile__$default__java_util_stream_DoubleStream__java_util_function_DoublePredicate__java_util_stream_DoubleStream(/** !DoubleStream */ $thisArg, /** DoublePredicate */ predicate) {
  DoubleStream.$clinit();
  let original = $thisArg.m_spliterator__java_util_Spliterator_OfDouble();
  let spliterator = $6.$create__java_util_stream_DoubleStream__java_util_Spliterator_OfDouble__java_util_function_DoublePredicate__long__int($thisArg, original, predicate, original.m_estimateSize__long(), original.m_characteristics__int() & ~(Spliterator.f_SIZED__java_util_Spliterator | Spliterator.f_SUBSIZED__java_util_Spliterator));
  return StreamSupport.m_doubleStream__java_util_Spliterator_OfDouble__boolean__java_util_stream_DoubleStream(spliterator, false);
 }
 /** @nodts */
 static $clinit() {
 ...
 static $loadModules() {
  ...
  $5 = goog.module.get('java.util.stream.DoubleStream.$5$impl');
  $6 = goog.module.get('java.util.stream.DoubleStream.$6$impl');
...
$Util.$setClassMetadataForInterface(/**@type {Function}*/ (DoubleStream), 'java.util.stream.DoubleStream');
