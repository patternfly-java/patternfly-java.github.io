...
class LimitSpliterator extends AbstractDoubleSpliterator {
 ...
 m_tryAdvance__java_util_function_DoubleConsumer__boolean(/** DoubleConsumer */ action) {
  if ($LongUtils.greaterEquals(Primitives.m_widenIntToLong__int__long(this.f_position__java_util_stream_DoubleStreamImpl_LimitSpliterator_), this.f_limit__java_util_stream_DoubleStreamImpl_LimitSpliterator_)) {
   return false;
  }
