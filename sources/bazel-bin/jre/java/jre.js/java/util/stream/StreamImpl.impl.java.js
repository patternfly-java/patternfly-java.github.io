...
class StreamImpl extends TerminatableStream {
 ...
 m_count__long() {
  ...
  while (this.f_spliterator__java_util_stream_StreamImpl_.m_tryAdvance__java_util_function_Consumer__boolean(Consumer.$adapt((/** T */ a) =>{}))) {
 ...
 m_toArray__arrayOf_java_lang_Object() {
  return this.m_toArray__java_util_function_IntFunction__arrayOf_java_lang_Object(IntFunction.$adapt(/**  @return {Array<*>}*/ ((/** number */ arg0) =>{
 ...
 m_toArray__java_util_function_IntFunction__arrayOf_java_lang_Object(/** IntFunction<Array<A>> */ generator) {
  let collected = /**@type {List<T>}*/ ($Casts.$to(this.m_collect__java_util_stream_Collector__java_lang_Object(/**@type {Collector<T, *, List<T>>}*/ (Collectors.m_toList__java_util_stream_Collector())), /**@type {Function}*/ (List)));
 ...
 m_reduce__java_lang_Object__java_util_function_BiFunction__java_util_function_BinaryOperator__java_lang_Object(/** U */ identity, /** BiFunction<U, ?, U> */ accumulator, /** BinaryOperator<U> */ combiner) {
  ...
  this.f_spliterator__java_util_stream_StreamImpl_.m_forEachRemaining__java_util_function_Consumer__void(Consumer.$adapt((/** T */ item) =>{
 ...
 m_distinct__java_util_stream_Stream() {
  ...
  return this.m_filter__java_util_function_Predicate__java_util_stream_Stream(Predicate.$adapt(/**  @return {boolean}*/ ((/** T */ arg0) =>{
 ...
 /** @override @nodts @return {Stream<T>} */
 m_dropWhile__java_util_function_Predicate__java_util_stream_Stream(/** Predicate<?> */ arg0) {
  return /**@type {Stream<T>}*/ (Stream.m_dropWhile__$default__java_util_stream_Stream__java_util_function_Predicate__java_util_stream_Stream(this, arg0));
 }
 //Default method forwarding stub.
 /** @override @nodts @return {Stream<T>} */
 m_takeWhile__java_util_function_Predicate__java_util_stream_Stream(/** Predicate<?> */ arg0) {
  return /**@type {Stream<T>}*/ (Stream.m_takeWhile__$default__java_util_stream_Stream__java_util_function_Predicate__java_util_stream_Stream(this, arg0));
 }
 /** @nodts */
 static $clinit() {
  StreamImpl.$clinit = () =>{};
