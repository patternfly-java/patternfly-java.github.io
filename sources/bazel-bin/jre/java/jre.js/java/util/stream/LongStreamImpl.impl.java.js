...
class LongStreamImpl extends TerminatableStream {
 ...
 m_toArray__arrayOf_long() {
  this.m_terminate__void_$pp_java_util_stream();
  let entries = PrimitiveLists.m_createForLong__javaemul_internal_PrimitiveLists_Long();
  ...
  return $Overlay.m_toArray__$devirt__javaemul_internal_PrimitiveLists_Long__arrayOf_long(entries);
 }
 ...
 m_summaryStatistics__java_util_LongSummaryStatistics() {
  return /**@type {LongSummaryStatistics}*/ ($Casts.$to(this.m_collect__java_util_function_Supplier__java_util_function_ObjLongConsumer__java_util_function_BiConsumer__java_lang_Object(Supplier.$adapt(/**  @return {LongSummaryStatistics}*/ (() =>{
   return LongSummaryStatistics.$create__();
  })), ObjLongConsumer.$adapt((/** LongSummaryStatistics */ longSummaryStatistics, /** !$Long */ value) =>{
  ...
  }), BiConsumer.$adapt((/** LongSummaryStatistics */ arg0, /** LongSummaryStatistics */ arg1) =>{
 ...
 m_distinct__java_util_stream_LongStream() {
  ...
  return this.m_filter__java_util_function_LongPredicate__java_util_stream_LongStream(LongPredicate.$adapt(/**  @return {boolean}*/ ((/** !$Long */ arg0) =>{
 ...
 m_asDoubleStream__java_util_stream_DoubleStream() {
  return this.m_mapToDouble__java_util_function_LongToDoubleFunction__java_util_stream_DoubleStream(LongToDoubleFunction.$adapt(/**  @return {number}*/ ((/** !$Long */ x) =>{
   return Primitives.m_widenLongToDouble__long__double(x);
  })));
 }
 /** @override @nodts @return {Stream<$Long>} */
 m_boxed__java_util_stream_Stream() {
  return /**@type {Stream<$Long>}*/ (this.m_mapToObj__java_util_function_LongFunction__java_util_stream_Stream(LongFunction.$adapt(/**  @return {$Long}*/ ((/** !$Long */ arg0) =>{
 ...
 /** @override @nodts @return {LongStream} */
 m_dropWhile__java_util_function_LongPredicate__java_util_stream_LongStream(/** LongPredicate */ arg0) {
  return LongStream.m_dropWhile__$default__java_util_stream_LongStream__java_util_function_LongPredicate__java_util_stream_LongStream(this, arg0);
 }
 //Default method forwarding stub.
 /** @override @nodts @return {LongStream} */
 m_takeWhile__java_util_function_LongPredicate__java_util_stream_LongStream(/** LongPredicate */ arg0) {
  return LongStream.m_takeWhile__$default__java_util_stream_LongStream__java_util_function_LongPredicate__java_util_stream_LongStream(this, arg0);
 }
 /** @nodts */
 static $clinit() {
  LongStreamImpl.$clinit = () =>{};
