...
class $3 extends AbstractIntSpliterator {
 ...
 /** @nodts @return {!$3} */
 static $create__java_util_stream_IntStreamImpl__java_util_function_IntConsumer__long__int(/** !IntStreamImpl */ $outer_this, /** IntConsumer */ $captured_action, /** !$Long */ size, /** number */ characteristics) {
  $3.$clinit();
  let $instance = new $3();
  $instance.$ctor__java_util_stream_IntStreamImpl_3__java_util_stream_IntStreamImpl__java_util_function_IntConsumer__long__int__void($outer_this, $captured_action, size, characteristics);
  return $instance;
 }
 /** @nodts */
 $ctor__java_util_stream_IntStreamImpl_3__java_util_stream_IntStreamImpl__java_util_function_IntConsumer__long__int__void(/** !IntStreamImpl */ $outer_this, /** IntConsumer */ $captured_action, /** !$Long */ size, /** number */ characteristics) {
