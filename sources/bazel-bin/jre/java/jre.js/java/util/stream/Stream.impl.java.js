...
let $5 = goog.forwardDeclare('java.util.stream.Stream.$5$impl');
let $6 = goog.forwardDeclare('java.util.stream.Stream.$6$impl');
...
class Stream {
 ...
 static m_concat__java_util_stream_Stream__java_util_stream_Stream__java_util_stream_Stream(/** Stream<?> */ a, /** Stream<?> */ b) {
  Stream.$clinit();
  let spliteratorOfStreams = (/**@type {List<Stream<?>>}*/ (Arrays.m_asList__arrayOf_java_lang_Object__java_util_List(/**@type {!Array<Stream<?>>}*/ ($Arrays.$stampType([a, b], /**@type {Function}*/ (Stream)))))).m_spliterator__java_util_Spliterator();
  ...
  return /**@type {Stream<T_1>}*/ ($Casts.$to((/**@type {Stream<T_1>}*/ ($Casts.$to(result.m_onClose__java_lang_Runnable__java_util_stream_BaseStream(Runnable.$adapt(() =>{
   a.m_close__void();
  })), /**@type {Function}*/ (Stream)))).m_onClose__java_lang_Runnable__java_util_stream_BaseStream(Runnable.$adapt(() =>{
   b.m_close__void();
 ...
 static m_iterate__java_lang_Object__java_util_function_UnaryOperator__java_util_stream_Stream(/** T_1 */ seed, /** UnaryOperator<T_1> */ f) {
  Stream.$clinit();
  return /**@type {Stream<T_1>}*/ (Stream.m_iterate__java_lang_Object__java_util_function_Predicate__java_util_function_UnaryOperator__java_util_stream_Stream(seed, Predicate.$adapt(/**  @return {boolean}*/ ((/** T_1 */ ignore) =>{
   return true;
  })), f));
 }
 /** @nodts @template T_1 @return {Stream<T_1>} */
 static m_iterate__java_lang_Object__java_util_function_Predicate__java_util_function_UnaryOperator__java_util_stream_Stream(/** T_1 */ seed, /** Predicate<?> */ hasNext, /** UnaryOperator<T_1> */ f) {
  Stream.$clinit();
  let spliterator = /**@type {!$4<T_1>}*/ ($4.$create__java_lang_Object__java_util_function_UnaryOperator__java_util_function_Predicate__long__int(seed, f, hasNext, Long.f_MAX_VALUE__java_lang_Long, Spliterator.f_IMMUTABLE__java_util_Spliterator | Spliterator.f_ORDERED__java_util_Spliterator));
  return /**@type {Stream<T_1>}*/ (StreamSupport.m_stream__java_util_Spliterator__boolean__java_util_stream_Stream(spliterator, false));
 }
 /** @nodts @template T_1 @return {Stream<T_1>} */
 ...
 /** @nodts @template T_1 @return {Stream<T_1>} */
 static m_ofNullable__java_lang_Object__java_util_stream_Stream(/** T_1 */ t) {
  Stream.$clinit();
  if ($Equality.$same(t, null)) {
   return /**@type {Stream<T_1>}*/ (Stream.m_empty__java_util_stream_Stream());
  } else {
   return /**@type {Stream<T_1>}*/ (Stream.m_of__java_lang_Object__java_util_stream_Stream(t));
  }
 }
 ...
 /** @abstract @nodts @return {Stream<T>} */
 m_dropWhile__java_util_function_Predicate__java_util_stream_Stream(/** Predicate<?> */ predicate) {}
 /** @abstract @nodts @return {Stream<T>} */
 m_takeWhile__java_util_function_Predicate__java_util_stream_Stream(/** Predicate<?> */ predicate) {}
 ...
 static m_dropWhile__$default__java_util_stream_Stream__java_util_function_Predicate__java_util_stream_Stream(/** !Stream<T> */ $thisArg, /** Predicate<?> */ predicate) {
  Stream.$clinit();
  let prev = $thisArg.m_spliterator__java_util_Spliterator();
  let spliterator = /**@type {!$5<T>}*/ ($5.$create__java_util_stream_Stream__java_util_Spliterator__java_util_function_Predicate__long__int($thisArg, prev, predicate, prev.m_estimateSize__long(), prev.m_characteristics__int() & ~(Spliterator.f_SIZED__java_util_Spliterator | Spliterator.f_SUBSIZED__java_util_Spliterator)));
  return /**@type {Stream<T>}*/ (StreamSupport.m_stream__java_util_Spliterator__boolean__java_util_stream_Stream(spliterator, false));
 }
 /** @nodts @template T @return {Stream<T>} */
 static m_takeWhile__$default__java_util_stream_Stream__java_util_function_Predicate__java_util_stream_Stream(/** !Stream<T> */ $thisArg, /** Predicate<?> */ predicate) {
  Stream.$clinit();
  let original = $thisArg.m_spliterator__java_util_Spliterator();
  let spliterator = /**@type {!$6<T>}*/ ($6.$create__java_util_stream_Stream__java_util_Spliterator__java_util_function_Predicate__long__int($thisArg, original, predicate, original.m_estimateSize__long(), original.m_characteristics__int() & ~(Spliterator.f_SIZED__java_util_Spliterator | Spliterator.f_SUBSIZED__java_util_Spliterator)));
  return /**@type {Stream<T>}*/ (StreamSupport.m_stream__java_util_Spliterator__boolean__java_util_stream_Stream(spliterator, false));
 }
 /** @nodts */
 static $clinit() {
 ...
 static $loadModules() {
  ...
  $5 = goog.module.get('java.util.stream.Stream.$5$impl');
  $6 = goog.module.get('java.util.stream.Stream.$6$impl');
...
$Util.$setClassMetadataForInterface(/**@type {Function}*/ (Stream), 'java.util.stream.Stream');
