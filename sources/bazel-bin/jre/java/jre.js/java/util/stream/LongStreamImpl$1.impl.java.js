...
class $1 extends AbstractLongSpliterator {
 ...
 /** @nodts @return {!$1} */
 static $create__java_util_stream_LongStreamImpl__java_util_Spliterator__long__int(/** !LongStreamImpl */ $outer_this, /** Spliterator<?> */ $captured_spliteratorOfStreams, /** !$Long */ size, /** number */ characteristics) {
  $1.$clinit();
  let $instance = new $1();
  $instance.$ctor__java_util_stream_LongStreamImpl_1__java_util_stream_LongStreamImpl__java_util_Spliterator__long__int__void($outer_this, $captured_spliteratorOfStreams, size, characteristics);
  return $instance;
 }
 /** @nodts */
 $ctor__java_util_stream_LongStreamImpl_1__java_util_stream_LongStreamImpl__java_util_Spliterator__long__int__void(/** !LongStreamImpl */ $outer_this, /** Spliterator<?> */ $captured_spliteratorOfStreams, /** !$Long */ size, /** number */ characteristics) {
 ...
 m_advanceToNextSpliterator__boolean_$p_java_util_stream_LongStreamImpl_1() {
  while ($Equality.$same(this.f_next__java_util_stream_LongStreamImpl_1, null)) {
   if (!this.$captured_spliteratorOfStreams__java_util_stream_LongStreamImpl_1.m_tryAdvance__java_util_function_Consumer__boolean(Consumer.$adapt((/** ? */ n) =>{
    let n_1 = /**@type {?}*/ ($Casts.$to(n, /**@type {Function}*/ (LongStream)));
