...
class LimitSpliterator extends AbstractIntSpliterator {
 ...
 m_tryAdvance__java_util_function_IntConsumer__boolean(/** IntConsumer */ action) {
  if ($LongUtils.greaterEquals(Primitives.m_widenIntToLong__int__long(this.f_position__java_util_stream_IntStreamImpl_LimitSpliterator_), this.f_limit__java_util_stream_IntStreamImpl_LimitSpliterator_)) {
   return false;
  }
