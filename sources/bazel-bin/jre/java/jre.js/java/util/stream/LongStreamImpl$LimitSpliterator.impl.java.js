...
class LimitSpliterator extends AbstractLongSpliterator {
 ...
 m_tryAdvance__java_util_function_LongConsumer__boolean(/** LongConsumer */ action) {
  if ($LongUtils.greaterEquals(Primitives.m_widenIntToLong__int__long(this.f_position__java_util_stream_LongStreamImpl_LimitSpliterator_), this.f_limit__java_util_stream_LongStreamImpl_LimitSpliterator_)) {
   return false;
  }
