...
class $3 extends AbstractIntSpliterator {
 ...
 /** @nodts @return {!$3} */
 static $create__java_util_function_IntSupplier__long__int(/** IntSupplier */ $captured_s, /** !$Long */ size, /** number */ characteristics) {
  $3.$clinit();
  let $instance = new $3();
  $instance.$ctor__java_util_stream_IntStream_3__java_util_function_IntSupplier__long__int__void($captured_s, size, characteristics);
  return $instance;
 }
 /** @nodts */
 $ctor__java_util_stream_IntStream_3__java_util_function_IntSupplier__long__int__void(/** IntSupplier */ $captured_s, /** !$Long */ size, /** number */ characteristics) {
