...
class AbstractSequentialList extends AbstractList {
 ...
 getAtIndex(/** number */ index) {
  ...
  try {
   ...
   if (NoSuchElementException.$isInstance(__$exc)) {
    ...
    throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(IndexOutOfBoundsException.$create__java_lang_String('Can\'t get element ' + index));
   } else {
 ...
 removeAtIndex(/** number */ index) {
  ...
  try {
   ...
   if (NoSuchElementException.$isInstance(__$exc)) {
    let e = /**@type {NoSuchElementException}*/ (__$exc);
    throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(IndexOutOfBoundsException.$create__java_lang_String('Can\'t remove element ' + index));
   } else {
    throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(__$exc);
   }
  }
 ...
 setAtIndex(/** number */ index, /** E */ element) {
  ...
  try {
   ...
   if (NoSuchElementException.$isInstance(__$exc)) {
    let e = /**@type {NoSuchElementException}*/ (__$exc);
    throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(IndexOutOfBoundsException.$create__java_lang_String('Can\'t set element ' + index));
   } else {
    throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(__$exc);
   }
  }
