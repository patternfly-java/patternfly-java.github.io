...
class $1 extends j_l_Object {
 ...
 m_next__java_util_Map_Entry() {
  return /**@type {!UnmodifiableEntry<K, V>}*/ (UnmodifiableEntry.$create__java_util_Map_Entry(/**@type {Entry<K, V>}*/ ($Casts.$to(this.$captured_it__java_util_Collections_UnmodifiableMap_UnmodifiableEntrySet_1.m_next__java_lang_Object(), /**@type {Function}*/ (Entry)))));
 }
 /** @override @nodts */
 m_remove__void() {
