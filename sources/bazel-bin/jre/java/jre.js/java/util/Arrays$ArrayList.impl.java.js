...
let ArrayIterator = goog.forwardDeclare('javaemul.internal.ArrayIterator$impl');
...
class ArrayList extends AbstractList {
 ...
 m_iterator__java_util_Iterator() {
  return /**@type {!ArrayIterator<E>}*/ (ArrayIterator.$create__arrayOf_java_lang_Object(this.f_array__java_util_Arrays_ArrayList_));
 }
 ...
 static $loadModules() {
  ...
  ArrayIterator = goog.module.get('javaemul.internal.ArrayIterator$impl');
