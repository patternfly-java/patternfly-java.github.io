...
class StringData extends j_l_Object {
 ...
 static $clinit() {
  ...
  j_l_Object.$clinit();
  StringData.$static_DAYS__java_util_Date_StringData = (/**@type {!Array<?string>}*/ ($Arrays.$stampType(['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'], j_l_String)));
  StringData.$static_MONTHS__java_util_Date_StringData = (/**@type {!Array<?string>}*/ ($Arrays.$stampType(['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'], j_l_String)));
 }
