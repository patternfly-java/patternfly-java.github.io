...
class $2 extends BoundedIterator {
 ...
 static $create__java_util_TreeMap_BoundedMap_BoundedKeySet__java_util_TreeMap_Node(/** !BoundedKeySet<K, V> */ $outer_this, /** Node<K, V> */ next) {
  $2.$clinit();
  let $instance = new $2();
  $instance.$ctor__java_util_TreeMap_BoundedMap_BoundedKeySet_2__java_util_TreeMap_BoundedMap_BoundedKeySet__java_util_TreeMap_Node__void($outer_this, next);
  return $instance;
 }
 /** @nodts */
 $ctor__java_util_TreeMap_BoundedMap_BoundedKeySet_2__java_util_TreeMap_BoundedMap_BoundedKeySet__java_util_TreeMap_Node__void(/** !BoundedKeySet<K, V> */ $outer_this, /** Node<K, V> */ next) {
 ...
 m_next__java_lang_Object() {
  return (this.$outer_this__java_util_TreeMap_BoundedMap_BoundedKeySet_2.$outer_this__java_util_TreeMap_BoundedMap_BoundedKeySet.f_ascending__java_util_TreeMap_BoundedMap_ ? this.m_stepBackward__java_util_TreeMap_Node() : this.m_stepForward__java_util_TreeMap_Node()).getKey();
 }
 /** @nodts */
 static $clinit() {
  $2.$clinit = () =>{};
