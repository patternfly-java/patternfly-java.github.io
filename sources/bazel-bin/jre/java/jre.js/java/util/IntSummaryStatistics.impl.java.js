...
class IntSummaryStatistics extends j_l_Object {
 ...
 m_accept__int__void(/** number */ value) {
  ...
  this.f_sum__java_util_IntSummaryStatistics_ = $LongUtils.plus(this.f_sum__java_util_IntSummaryStatistics_, Primitives.m_widenIntToLong__int__long(value));
 }
 /** @nodts */
 ...
 m_getAverage__double() {
  return $LongUtils.greater(this.f_count__java_util_IntSummaryStatistics_, $Long.fromInt(0)) ? Primitives.m_widenLongToDouble__long__double(this.f_sum__java_util_IntSummaryStatistics_) / Primitives.m_widenLongToDouble__long__double(this.f_count__java_util_IntSummaryStatistics_) : 0;
 }
 /** @nodts @return {!$Long} */
 m_getCount__long() {
