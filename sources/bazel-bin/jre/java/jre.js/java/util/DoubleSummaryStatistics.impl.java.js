...
class DoubleSummaryStatistics extends j_l_Object {
 ...
 m_getAverage__double() {
  return $LongUtils.greater(this.f_count__java_util_DoubleSummaryStatistics_, $Long.fromInt(0)) ? this.m_getSum__double() / Primitives.m_widenLongToDouble__long__double(this.f_count__java_util_DoubleSummaryStatistics_) : 0;
 }
 /** @nodts @return {!$Long} */
 m_getCount__long() {
