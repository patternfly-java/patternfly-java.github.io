...
class AbstractIntSpliterator extends BaseSpliterator {
 ...
 m_trySplit__java_util_Spliterator_OfPrimitive() {
  return /**@type {OfInt}*/ ($Casts.$to(this.m_trySplit__java_util_Spliterator(), /**@type {Function}*/ (OfInt)));
 }
 //Bridge method.
 /** @final @override @nodts */
 m_forEachRemaining__java_lang_Object__void(/** IntConsumer */ arg0) {
  OfPrimitive.m_forEachRemaining__$default__java_util_Spliterator_OfPrimitive__java_lang_Object__void(this, /**@type {IntConsumer}*/ ($Casts.$to(arg0, /**@type {Function}*/ (IntConsumer))));
 }
 //Default method forwarding stub.
 /** @nodts */
