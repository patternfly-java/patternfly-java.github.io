...
class TreeSet extends AbstractSet {
 ...
 $ctor__java_util_TreeSet__java_util_SortedSet__void(/** SortedSet<E> */ s) {
  this.$ctor__java_util_TreeSet__java_util_Comparator__void((/**@type {SortedSet<E>}*/ ($Casts.$to(InternalPreconditions.m_checkNotNull__java_lang_Object__java_lang_Object(s), /**@type {Function}*/ (SortedSet)))).m_comparator__java_util_Comparator());
  this.addAll(s);
 }
...
Cloneable.$markImplementor(TreeSet);
