...
class EmptyListIterator extends j_l_Object {
 ...
 /** @override @return {IIterableResult<*>} */
 next() {
  return /**@type {IIterableResult<*>}*/ (Iterator.m__private_jsNext____$default__java_util_Iterator__javaemul_internal_JsIterableHelper_IIterableResult(this));
 }
 //Default method forwarding stub.
 /** @override @nodts */
