...
class LongSummaryStatistics extends j_l_Object {
 ...
 m_accept__int__void(/** number */ value) {
  this.m_accept__long__void(Primitives.m_widenIntToLong__int__long(value));
 }
 /** @override @nodts */
 ...
 m_getAverage__double() {
  return $LongUtils.greater(this.f_count__java_util_LongSummaryStatistics_, $Long.fromInt(0)) ? Primitives.m_widenLongToDouble__long__double(this.f_sum__java_util_LongSummaryStatistics_) / Primitives.m_widenLongToDouble__long__double(this.f_count__java_util_LongSummaryStatistics_) : 0;
 }
 /** @nodts @return {!$Long} */
 m_getCount__long() {
