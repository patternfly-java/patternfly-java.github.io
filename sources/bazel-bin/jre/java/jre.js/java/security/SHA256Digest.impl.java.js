...
class SHA256Digest extends MessageDigest {
 ...
 m_int2bytes__int__arrayOf_byte__int__void_$p_java_security_SHA256Digest(/** number */ input, /** Array<number> */ output, /** number */ outOff) {
  $Arrays.$set(output, outOff, Primitives.m_narrowIntToByte__int__int((input >>> 24 | 0) & 255));
  $Arrays.$set(output, outOff + 1 | 0, Primitives.m_narrowIntToByte__int__int((input >>> 16 | 0) & 255));
  $Arrays.$set(output, outOff + 2 | 0, Primitives.m_narrowIntToByte__int__int((input >>> 8 | 0) & 255));
  $Arrays.$set(output, outOff + 3 | 0, Primitives.m_narrowIntToByte__int__int(input & 255));
 }
 /** @nodts */
 m_doPadding__void_$p_java_security_SHA256Digest() {
  ...
  $Arrays.$set(this.f_blockBuffer__java_security_SHA256Digest_, 14, Primitives.m_narrowLongToInt__long__int($LongUtils.rightShiftUnsigned(length, 32)));
  $Arrays.$set(this.f_blockBuffer__java_security_SHA256Digest_, 15, this.m_enforceOverflow__int__int_$p_java_security_SHA256Digest(Primitives.m_narrowLongToInt__long__int(length)));
  this.m_computeBlock__void_$p_java_security_SHA256Digest();
 }
 /** @nodts */
 ...
 static $clinit() {
  ...
  SHA256Digest.f_K__java_security_SHA256Digest_ = (/**@type {!Array<number>}*/ ($Arrays.$stampType([1116352408, 1899447441, -1245643825, -373957723, 961987163, 1508970993, -1841331548, -1424204075, -670586216, 310598401, 607225278, 1426881987, 1925078388, -2132889090, -1680079193, -1046744716, -459576895, -272742522, 264347078, 604807628, 770255983, 1249150122, 1555081692, 1996064986, -1740746414, -1473132947, -1341970488, -1084653625, -958395405, -710438585, 113926993, 338241895, 666307205, 773529912, 1294757372, 1396182291, 1695183700, 1986661051, -2117940946, -1838011259, -1564481375, -1474664885, -1035236496, -949202525, -778901479, -694614492, -200395387, 275423344, 430227734, 506948616, 659060556, 883997877, 958139571, 1322822218, 1537002063, 1747873779, 1955562222, 2024104815, -2067236844, -1933114872, -1866530822, -1538233109, -1090935817, -965641998], $int)));
  SHA256Digest.f_H__java_security_SHA256Digest_ = (/**@type {!Array<number>}*/ ($Arrays.$stampType([1779033703, -1150833019, 1013904242, -1521486534, 1359893119, -1694144372, 528734635, 1541459225], $int)));
 }
