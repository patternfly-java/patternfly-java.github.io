...
class MessageDigest extends MessageDigestSpi {
 ...
 static m_getInstance__java_lang_String__java_security_MessageDigest(/** ?string */ algorithm) {
  ...
  switch (InternalPreconditions.m_checkNotNull__java_lang_Object__java_lang_Object(algorithm)) {
   ...
   default:
    throw Exceptions.m_toJs__java_lang_Throwable__javaemul_internal_ThrowableUtils_JsObject(NoSuchAlgorithmException.$create__java_lang_String(j_l_String.m_valueOf__java_lang_Object__java_lang_String(algorithm) + ' not supported'));
  }
 }
