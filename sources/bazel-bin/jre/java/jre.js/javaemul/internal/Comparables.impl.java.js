...
class $Comparables extends j_l_Object {
 ...
 /** @nodts @return {number} */
 static m_compareTo__java_lang_Comparable__java_lang_Object__int(/** (Comparable|boolean|number|string|!$Long) */ a, /** * */ b) {
  $Comparables.$clinit();
  ...
  if (Long.$isInstance(a)) {
   return Long.m_compareTo__java_lang_Long__java_lang_Long__int(/**@type {$Long}*/ (JsUtils.uncheckedCast(a)), /**@type {$Long}*/ ($Casts.$to(b, Long)));
  }
