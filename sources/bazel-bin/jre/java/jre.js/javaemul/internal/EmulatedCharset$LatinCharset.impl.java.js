...
class LatinCharset extends EmulatedCharset {
 ...
 m_getBytes__arrayOf_char__int__int__boolean__arrayOf_byte(/** Array<number> */ buffer, /** number */ offset, /** number */ count, /** boolean */ throwOnInvalid) {
  ...
  bytes = (/**@type {Array<number>}*/ ($Arrays.$castTo(ArrayHelper.m_setLength__java_lang_Object__int__java_lang_Object(bytes, count), $byte, 1)));
  for (let i = offset; i < n; i = i + 1 | 0) {
   $Arrays.$set(bytes, i, Primitives.m_narrowIntToByte__int__int(buffer[i] & 255));
  }
  return bytes;
 }
 /** @override @nodts @return {Array<number>} */
 m_getBytes__java_lang_String__boolean__arrayOf_byte(/** ?string */ str, /** boolean */ throwOnInvalid) {
  ...
  let bytes = /**@type {!Array<number>}*/ ($Arrays.$create([0], $byte));
  bytes = (/**@type {Array<number>}*/ ($Arrays.$castTo(ArrayHelper.m_setLength__java_lang_Object__int__java_lang_Object(bytes, n), $byte, 1)));
  for (let i = 0; i < n; i = i + 1 | 0) {
   $Arrays.$set(bytes, i, Primitives.m_narrowIntToByte__int__int(j_l_String.m_charAt__java_lang_String__int__char(str, i) & 255));
  }
  return bytes;
 }
 /** @override @nodts @return {Array<number>} */
 m_decodeString__arrayOf_byte__int__int__boolean__arrayOf_char(/** Array<number> */ bytes, /** number */ ofs, /** number */ len, /** boolean */ throwOnInvalid) {
  ...
  chars = (/**@type {Array<number>}*/ ($Arrays.$castTo(ArrayHelper.m_setLength__java_lang_Object__int__java_lang_Object(chars, len), $char, 1)));
  for (let i = 0; i < len; i = i + 1 | 0) {
   $Arrays.$set(chars, i, Primitives.m_narrowIntToChar__int__int(bytes[ofs + i | 0] & 255));
  }
  return chars;
 }
 /** @nodts */
