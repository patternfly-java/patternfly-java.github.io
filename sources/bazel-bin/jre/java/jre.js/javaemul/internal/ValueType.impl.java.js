...
class ValueType extends j_l_Object {
 ...
 static m_equals__javaemul_internal_ValueType__java_lang_Object__boolean(/** ValueType */ thisObject, /** * */ o) {
  ...
  for (let $array = thisKeys, $index = 0; $index < $array.length; $index++) {
   let p = $array[$index];
   {
    ...
    if (!Objects.m_equals__java_lang_Object__java_lang_Object__boolean(p1, p2)) {
     return false;
    }
   }
  }
 ...
 static m_hashCode__javaemul_internal_ValueType__int(/** ValueType */ thisObject) {
  ...
  for (let $array = ValueType.filteredkeys(thisObject), $index = 0; $index < $array.length; $index++) {
   let key = $array[$index];
   {
    ...
    hashCode = Math.imul(1000003, hashCode) ^ $Objects.m_hashCode__java_lang_Object__int(value);
   }
  }
  return hashCode;
 }
 ...
 static m_cleanMangledPropertyName__java_lang_String__java_lang_String(/** ?string */ name) {
  ...
  let index = j_l_String.m_startsWith__java_lang_String__java_lang_String__boolean(name, 'f_') ? j_l_String.m_indexOf__java_lang_String__java_lang_String__int__int(name, '__', 2) : -1;
  if (index != -1) {
  ...
  return index == -1 ? name : j_l_String.m_substring__java_lang_String__int__int__java_lang_String(name, 0, index);
 }
 // /** @return {Array<?string>} */
