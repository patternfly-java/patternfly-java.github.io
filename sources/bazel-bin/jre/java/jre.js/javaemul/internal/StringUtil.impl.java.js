...
class StringUtil extends j_l_Object {
 ...
 /** @nodts @return {RegExp} */
 static m_getLeadingWhitespaceRegex__javaemul_internal_NativeRegExp() {
  if ($Equality.$same(StringUtil.f_leadingWhitespaceRegex__javaemul_internal_StringUtil_, null)) {
   StringUtil.f_leadingWhitespaceRegex__javaemul_internal_StringUtil_ = new RegExp('^(' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(StringUtil.f_whitespaceRegexStr__javaemul_internal_StringUtil_) + ')+');
  }
  return StringUtil.f_leadingWhitespaceRegex__javaemul_internal_StringUtil_;
 }
 /** @nodts @return {number} */
 static m_countLeadingWhitespace__java_lang_String__int(/** ?string */ str) {
  StringUtil.$clinit();
  let match = StringUtil.m_getLeadingWhitespaceRegex__javaemul_internal_NativeRegExp().exec(str);
  if ($Equality.$same(match, null)) {
   return 0;
  }
  return j_l_String.m_length__java_lang_String__int(match.at(0));
 }
 /** @nodts @return {RegExp} */
 static m_getTrailingWhitespaceRegex__javaemul_internal_NativeRegExp() {
  if ($Equality.$same(StringUtil.f_trailingWhitespaceRegex__javaemul_internal_StringUtil_, null)) {
   StringUtil.f_trailingWhitespaceRegex__javaemul_internal_StringUtil_ = new RegExp('(' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(StringUtil.f_whitespaceRegexStr__javaemul_internal_StringUtil_) + ')+$');
  }
  return StringUtil.f_trailingWhitespaceRegex__javaemul_internal_StringUtil_;
 }
 /** @nodts @return {number} */
 static m_countTrailingWhitespace__java_lang_String__int(/** ?string */ str) {
  StringUtil.$clinit();
  let match = StringUtil.m_getTrailingWhitespaceRegex__javaemul_internal_NativeRegExp().exec(str);
  if ($Equality.$same(match, null)) {
   return 0;
  }
  return j_l_String.m_length__java_lang_String__int(match.at(0));
 ...
 /** @nodts @return {?string} */
 static m_stripLeading__java_lang_String__java_lang_String(/** ?string */ str) {
  StringUtil.$clinit();
  return j_l_String.m_nativeReplace__java_lang_String__javaemul_internal_NativeRegExp__java_lang_String__java_lang_String(str, StringUtil.m_getLeadingWhitespaceRegex__javaemul_internal_NativeRegExp(), '');
 }
 /** @nodts @return {?string} */
 static m_stripTrailing__java_lang_String__java_lang_String(/** ?string */ str) {
  StringUtil.$clinit();
  return j_l_String.m_nativeReplace__java_lang_String__javaemul_internal_NativeRegExp__java_lang_String__java_lang_String(str, StringUtil.m_getTrailingWhitespaceRegex__javaemul_internal_NativeRegExp(), '');
 }
 /** @nodts @return {boolean} */
...
/**@type {RegExp} @nodts*/
StringUtil.f_leadingWhitespaceRegex__javaemul_internal_StringUtil_;
/**@type {RegExp} @nodts*/
StringUtil.f_trailingWhitespaceRegex__javaemul_internal_StringUtil_;
/**@const {string} @nodts*/
