...
let $Overlay = goog.forwardDeclare('javaemul.internal.LongUtils.NativeLong.$Overlay$impl');
...
class $LongUtils extends j_l_Object {
 ...
 /** @return {boolean} */
 static isNativeLong(/** * */ instance) {
  $LongUtils.$clinit();
  return $Overlay.$isInstance(instance);
 }
 /** @nodts */
 static $clinit() {
  $LongUtils.$clinit = () =>{};
 ...
 static $loadModules() {
  ...
  $Overlay = goog.module.get('javaemul.internal.LongUtils.NativeLong.$Overlay$impl');
