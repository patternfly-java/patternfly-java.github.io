...
class ArrayHelper extends j_l_Object {
 ...
 static m_clone__java_lang_Object__java_lang_Object(/** T */ array) {
  ...
  return /**@type {?T}*/ (ArrayStamper.m_stampJavaTypeInfo__java_lang_Object__java_lang_Object__java_lang_Object(result, array));
 }
 /** @nodts @template T @return {T} */
 static m_clone__java_lang_Object__int__int__java_lang_Object(/** T */ array, /** number */ fromIndex, /** number */ toIndex) {
  ...
  if (requestedLength > length) {
   ...
   if ($Equality.$same(initialValue, null)) {
    ArrayHelper.m_setLength__java_lang_Object__int__java_lang_Object(result, requestedLength);
   } else {
 ...
 /** @nodts @template T @return {T} */
 static m_setLength__java_lang_Object__int__java_lang_Object(/** T */ array, /** number */ length) {
  ArrayHelper.$clinit();
  ArrayHelper.m_asNativeArray__java_lang_Object__javaemul_internal_ArrayHelper_NativeArray(array).length = length;
  return array;
 }
 /** @nodts @template T @return {T} */
 static m_grow__java_lang_Object__int__java_lang_Object(/** T */ array, /** number */ length) {
  ArrayHelper.$clinit();
  return ArrayHelper.m_setLength__java_lang_Object__int__java_lang_Object(array, length);
 }
 /** @nodts */
 static m_push__arrayOf_java_lang_Object__java_lang_Object__void(/** Array<*> */ array, /** * */ o) {
  ArrayHelper.$clinit();
  ArrayHelper.m_asNativeArray__java_lang_Object__javaemul_internal_ArrayHelper_NativeArray(array).push(o);
 }
 /** @nodts @return {?string} */
 static m_join__arrayOf_java_lang_Object__java_lang_Object__java_lang_String(/** Array<*> */ array, /** * */ separator) {
  ArrayHelper.$clinit();
  return ArrayHelper.m_asNativeArray__java_lang_Object__javaemul_internal_ArrayHelper_NativeArray(array).join(separator);
 }
 /** @nodts */
 ...
 static m_concat__java_lang_Object__java_lang_Object__java_lang_Object(/** T */ a, /** T */ b) {
  ArrayHelper.$clinit();
  let result = ArrayHelper.m_clone__java_lang_Object__java_lang_Object(a);
  ArrayHelper.m_setLength__java_lang_Object__int__java_lang_Object(result, ArrayHelper.m_getLength__java_lang_Object__int(a) + ArrayHelper.m_getLength__java_lang_Object__int(b) | 0);
 ...
 static m_getIntComparator__javaemul_internal_ArrayHelper_CompareFunction() {
  return /**@type {?function(*, *):number}*/ (JsUtils.uncheckedCast(/**@type {function(number, number):number}*/ (/**  @return {number}*/ ((/** number */ a, /** number */ b) =>{
   return a - b;
  }))));
 }
 /** @nodts @return {?function(*, *):number} */
 static m_getDoubleComparator__javaemul_internal_ArrayHelper_CompareFunction() {
  return /**@type {?function(*, *):number}*/ (JsUtils.uncheckedCast(/**@type {function(number, number):number}*/ (/**  @return {number}*/ ((/** number */ arg0, /** number */ arg1) =>{
 ...
 static m_getLongComparator__javaemul_internal_ArrayHelper_CompareFunction() {
  return /**@type {?function(*, *):number}*/ (JsUtils.uncheckedCast(/**@type {function(!$Long, !$Long):number}*/ (/**  @return {number}*/ ((/** !$Long */ arg0, /** !$Long */ arg1) =>{
