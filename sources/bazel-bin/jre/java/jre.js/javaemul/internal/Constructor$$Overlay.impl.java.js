...
class $Overlay {
 ...
 /** @final @nodts @nosideeffects @template T @return {T} */
 static m_cache__$devirt__javaemul_internal_Constructor__java_lang_String__javaemul_internal_Constructor_Supplier__java_lang_Object(/** !Constructor */ $thisArg, /** ?string */ key, /** ?function():T */ supplier) {
  $Overlay.$clinit();
  if (Object.prototype.hasOwnProperty.call($thisArg.prototype, key)) {
   return JsUtils.getProperty($thisArg.prototype, key);
  } else {
   let t = supplier();
   JsUtils.setProperty($thisArg.prototype, key, t);
   return t;
  }
 }
