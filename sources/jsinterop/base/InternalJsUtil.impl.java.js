...
let $synthetic_java_lang_Class = goog.forwardDeclare('java.lang.Class');
...
class InternalJsUtil extends j_l_Object {
 ...
 // native static toCtor(/** Class<T> */ clazz) 
 /** @nodts @return {!InternalJsUtil} */
 static $create__() {
  let $instance = new InternalJsUtil();
  $instance.$ctor__jsinterop_base_InternalJsUtil__void();
  return $instance;
 }
 /** @nodts */
 $ctor__jsinterop_base_InternalJsUtil__void() {
