...
class Js extends j_l_Object {
 ...
 static m_asShort__java_lang_Object__short(/** * */ obj) {
  ...
  InternalPreconditions.m_checkType__boolean__void(num == Primitives.m_narrowIntToShort__int__int(num));
  return InternalJsUtil.castToAny(obj);
 }
 /** @nodts @return {number} */
 static m_asChar__java_lang_Object__char(/** * */ obj) {
  Js.$clinit();
  let num = Js.m_asInt__java_lang_Object__int(obj);
  InternalPreconditions.m_checkType__boolean__void(num == Primitives.m_narrowIntToChar__int__int(num));
  return InternalJsUtil.castToAny(obj);
 }
 /** @nodts @return {number} */
 static m_asByte__java_lang_Object__byte(/** * */ obj) {
  Js.$clinit();
  let num = Js.m_asInt__java_lang_Object__int(obj);
  InternalPreconditions.m_checkType__boolean__void(num == Primitives.m_narrowIntToByte__int__int(num));
  return InternalJsUtil.castToAny(obj);
 }
 ...
 // /** @nosideeffects @template T @return {T} */
 ...
 /** @nodts @return {boolean} */
 static m_coerceToBoolean__java_lang_Object__boolean(/** * */ b) {
  Js.$clinit();
  return Js.m_isTruthy__java_lang_Object__boolean(b);
 }
 /** @nodts @return {!Js} */
 static $create__() {
  let $instance = new Js();
